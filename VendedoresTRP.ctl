...
Begin VB.UserControl Vendedores 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton BotaoProxNum 
         Height          =   285
         Left            =   2265
         Picture         =   "VendedoresTRP.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   1
      ...
      Begin VB.ComboBox Vinculo 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "VendedoresTRP.ctx":00EA
         Left            =   1650
         List            =   "VendedoresTRP.ctx":00F7
         Style           =   2  'Dropdown List
         TabIndex        =   9
         Top             =   2100
         Width           =   2790
   ...
   Begin VB.Frame Frame1 
      ...
      Visible         =   0   'False
      Width           =   9135
      Begin TelasCprTRP.TabEndereco TabEnd 
         Height          =   4080
         Index           =   0
         Left            =   120
         TabIndex        =   101
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame7 
         ...
         Begin VB.ComboBox Moeda 
            ...
            Width           =   1050
         End
         Begin MSMask.MaskEdBox ValorAporte 
            Height          =   315
            Left            =   1125
            TabIndex        =   19
            Top             =   480
            ...
            PromptChar      =   " "
         End
         Begin MSMask.MaskEdBox PercComiAporte 
            Height          =   315
            Left            =   1125
            TabIndex        =   21
            Top             =   870
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "VendedoresTRP.ctx":011F
         Style           =   1  'Graphical
         TabIndex        =   18
         ToolTipText     =   "Fechar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "VendedoresTRP.ctx":029D
         Style           =   1  'Graphical
         TabIndex        =   17
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "VendedoresTRP.ctx":07CF
         Style           =   1  'Graphical
         TabIndex        =   16
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "VendedoresTRP.ctx":0959
         Style           =   1  'Graphical
         TabIndex        =   15
         ToolTipText     =   "Gravar"
         Top             =   90
...
Private Sub UserControl_Initialize()
    ...
    Set objCT.gobjInfoUsu = New CTVendedoresVGTRP
    Set objCT.gobjInfoUsu.gobjTelaUsu = New CTVendedoresTRP
...
Private Sub PercComiAporte_Change()
    Call objCT.gobjInfoUsu.gobjTelaUsu.PercComiAporte_Change(objCT)
End Sub
...
Private Sub ValorAporte_Change()
    Call objCT.gobjInfoUsu.gobjTelaUsu.ValorAporte_Change(objCT)
End Sub
