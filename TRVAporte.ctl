...
Begin VB.UserControl TRVAporte 
   ClientHeight    =   6000
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9510
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame6 
         ...
         Begin VB.ComboBox Forma 
            Height          =   315
            ItemData        =   "TRVAporte.ctx":00EA
            Left            =   2760
            List            =   "TRVAporte.ctx":00F4
            Style           =   2  'Dropdown List
            TabIndex        =   52
            Top             =   1110
            Width           =   2655
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame9 
         ...
         Begin VB.ComboBox FormaC 
            Height          =   315
            ItemData        =   "TRVAporte.ctx":0116
            Left            =   3345
            List            =   "TRVAporte.ctx":0120
            Style           =   2  'Dropdown List
            TabIndex        =   59
            Top             =   825
            Width           =   1305
         ...
         Begin VB.ComboBox Base 
            Height          =   315
            ItemData        =   "TRVAporte.ctx":0142
            Left            =   1095
            List            =   "TRVAporte.ctx":014C
            Style           =   2  'Dropdown List
            TabIndex        =   58
            Top             =   600
            Width           =   1620
...
Dim gobjAporte As ClassTRVAportes
Dim gobjAportePagtoCond As ClassTRVAportePagtoCond
Dim gobjAportePagtoDireto As ClassTRVAportePagtoDireto
Dim gobjAportePagtoSF As ClassTRVAportePagtoFat
Dim gobjAportePagtoSFC As ClassTRVAportePagtoFatC
...
On Error GoTo Erro_Form_Load
    ...
    Set gobjAporte = New ClassTRVAportes
    ...
    lErro = CF("Carrega_CamposGenericos", CAMPOSGENERICOS_TRVTIPOAPORTE_OCR, Tipo)
    If lErro <> SUCESSO Then gError 190568
    
    Historico.Clear
    lErro = CF("Carrega_Combo_Historico", Historico, "TRVAportes", STRING_TRV_APORTE_HISTORICO)
...
Function Trata_Parametros(Optional objTRVAporte As ClassTRVAportes) As Long

Dim lErro As Long

On Error GoTo Erro_Trata_Parametros

    If Not (objTRVAporte Is Nothing) Then

        lErro = Traz_TRVAporte_Tela(objTRVAporte)
...
Function Move_Tela_Memoria(objTRVAporte As ClassTRVAportes) As Long

Dim lErro As Long
Dim objcliente As New ClassCliente
Dim iLinha As Integer
Dim objAportePagtoD As ClassTRVAportePagtoDireto
Dim objAportePagtoC As ClassTRVAportePagtoCond
Dim objAportePagtoSF As ClassTRVAportePagtoFat
Dim objAportePagtoSFC As ClassTRVAportePagtoFatC
...
On Error GoTo Erro_Move_Tela_Memoria
    ...
    objTRVAporte.lCodigo = StrParaLong(Codigo.Text)
    objTRVAporte.dtDataEmissao = StrParaDate(DataEmissao.Text)
    objTRVAporte.lCliente = objcliente.lCodigo
    objTRVAporte.iFilialCliente = Codigo_Extrai(Filial.Text)
    objTRVAporte.iMoeda = Codigo_Extrai(Moeda)
    objTRVAporte.iTipo = Codigo_Extrai(Tipo)
    objTRVAporte.dPrevValor = StrParaDbl(Previsao.Text)
    objTRVAporte.dtPrevDataDe = StrParaDate(PrevDataDe.Text)
    objTRVAporte.dtPrevDataAte = StrParaDate(PrevDataAte.Text)
    objTRVAporte.sObservacao = Observacao.Text
    objTRVAporte.sHistorico = Historico.Text
    
    For iLinha = 1 To objGridD.iLinhasExistentes
    
        iNumPagto = iNumPagto + 1
        
        Set objAportePagtoD = New ClassTRVAportePagtoDireto
        ...
        objTRVAporte.colPagtoDireto.Add objAportePagtoD
    ...
    For iLinha = 1 To objGridC.iLinhasExistentes
        ...
        Set objAportePagtoC = New ClassTRVAportePagtoCond
        ...
        objTRVAporte.colPagtoCondicionados.Add objAportePagtoC
    ...
    For iLinha = 1 To objGridSF.iLinhasExistentes
        ...
        Set objAportePagtoSF = New ClassTRVAportePagtoFat
        ...
        objTRVAporte.colPagtoSobreFatura.Add objAportePagtoSF
    ...
    For iLinha = 1 To objGridSFC.iLinhasExistentes
        ...
        Set objAportePagtoSFC = New ClassTRVAportePagtoFatC
        ...
        objTRVAporte.colPagtoSobreFaturaCond.Add objAportePagtoSFC
...
Dim lErro As Long
Dim objTRVAporte As New ClassTRVAportes

On Error GoTo Erro_Tela_Preenche

    objTRVAporte.lCodigo = colCampoValor.Item("Codigo").vValor

    If objTRVAporte.lCodigo <> 0 Then
...
Dim lErro As Long
Dim objTRVAporte As New ClassTRVAportes
Dim objTRVAporteBD As New ClassTRVAportes
...
On Error GoTo Erro_Gravar_Registro
    ...
    lErro = Move_Tela_Memoria(objTRVAporte)
    If lErro <> SUCESSO Then gError 190590

'    lErro = Trata_Alteracao(objTRVAporte, objTRVAporte.lCodigo)
'    If lErro <> SUCESSO Then gError 190591

    objTRVAporteBD.lCodigo = objTRVAporte.lCodigo

    lErro = CF("TRVAportes_Le", objTRVAporteBD, False)
    ...
    'Grava o/a TRVAporte no Banco de Dados
    lErro = CF("TRVAportes_Grava", objTRVAporte)
...
Function Limpa_Tela_TRVAporte() As Long

Dim lErro As Long

On Error GoTo Erro_Limpa_Tela_TRVAporte
    ...
    Limpa_Tela_TRVAporte = SUCESSO

    Exit Function

Erro_Limpa_Tela_TRVAporte:

    Limpa_Tela_TRVAporte = gErr
...
Function Traz_TRVAporte_Tela(objTRVAporte As ClassTRVAportes) As Long
...
On Error GoTo Erro_Traz_TRVAporte_Tela

    Call Limpa_Tela_TRVAporte
    
    If objTRVAporte.lCodigo <> 0 Then
        Codigo.PromptInclude = False
        Codigo.Text = CStr(objTRVAporte.lCodigo)
        Codigo.PromptInclude = True
    End If

    'Lê o TRVAporte que está sendo Passado
    lErro = CF("TRVAportes_Le", objTRVAporte)
    If lErro <> SUCESSO And lErro <> ERRO_LEITURA_SEM_DADOS Then gError 190596
    
    If lErro = SUCESSO Then
        
        Cliente.Text = CStr(objTRVAporte.lCliente)
        Call Cliente_Validate(bSGECancelDummy)

        If objTRVAporte.dtDataEmissao <> DATA_NULA Then
            DataEmissao.PromptInclude = False
            DataEmissao.Text = Format(objTRVAporte.dtDataEmissao, "dd/mm/yy")
            DataEmissao.PromptInclude = True
        End If

        Call Combo_Seleciona_ItemData(Moeda, objTRVAporte.iMoeda)
        Call Combo_Seleciona_ItemData(Tipo, objTRVAporte.iTipo)

        Observacao.Text = objTRVAporte.sObservacao
        Historico.Text = objTRVAporte.sHistorico

        If objTRVAporte.dtPrevDataDe <> DATA_NULA Then
            PrevDataDe.PromptInclude = False
            PrevDataDe.Text = Format(objTRVAporte.dtPrevDataDe, "dd/mm/yy")
            PrevDataDe.PromptInclude = True
        End If
        
        If objTRVAporte.dtPrevDataAte <> DATA_NULA Then
            PrevDataAte.PromptInclude = False
            PrevDataAte.Text = Format(objTRVAporte.dtPrevDataAte, "dd/mm/yy")
            PrevDataAte.PromptInclude = True
        End If
        
        Previsao.Text = Format(objTRVAporte.dPrevValor, "STANDARD")
        
        iLinha = 0
        For Each objAportePagtoD In objTRVAporte.colPagtoDireto
            ...
            lErro = CF("Verifica_Existencia_Doc_TRV", objAportePagtoD.lNumIntDocDestino, objAportePagtoD.iTipoDocDestino, bExisteDestino, lNumTitulo, sDoc)
        ...
        objGridD.iLinhasExistentes = objTRVAporte.colPagtoDireto.Count
        
        iLinha = 0
        For Each objAportePagtoC In objTRVAporte.colPagtoCondicionados
            iLinha = iLinha + 1
            ...
            Select Case objAportePagtoC.iStatus
                ...
                Case STATUS_TRV_OCR_LIBERADO
                    GridC.TextMatrix(iLinha, iGrid_StatusC_Col) = STATUS_TRV_OCR_LIBERADO_TEXTO
                
                Case STATUS_TRV_OCR_BLOQUEADO
                    GridC.TextMatrix(iLinha, iGrid_StatusC_Col) = STATUS_TRV_OCR_BLOQUEADO_TEXTO
            
            End Select
            
            lErro = CF("Verifica_Existencia_Doc_TRV", objAportePagtoC.lNumIntDocDestino, objAportePagtoC.iTipoDocDestino, bExisteDestino, lNumTitulo, sDoc)
        ...
        objGridC.iLinhasExistentes = objTRVAporte.colPagtoCondicionados.Count
        
        iLinha = 0
        For Each objAportePagtoSF In objTRVAporte.colPagtoSobreFatura
            iLinha = iLinha + 1
        ...
        objGridSF.iLinhasExistentes = objTRVAporte.colPagtoSobreFatura.Count
        
        
        iLinha = 0
        For Each objAportePagtoSFC In objTRVAporte.colPagtoSobreFaturaCond
            iLinha = iLinha + 1
        ...
        objGridSFC.iLinhasExistentes = objTRVAporte.colPagtoSobreFaturaCond.Count
        
    End If
    
    Set gobjAporte = objTRVAporte
    ...
    Traz_TRVAporte_Tela = SUCESSO

    Exit Function

Erro_Traz_TRVAporte_Tela:

    Traz_TRVAporte_Tela = gErr
...
On Error GoTo Erro_BotaoExcluir_Click
    ...
    vbMsgRes = Rotina_Aviso(vbYesNo, "AVISO_CONFIRMA_EXCLUSAO_TRVAPORTE", objTRVAporte.lCodigo)

    If vbMsgRes = vbYes Then

        'Exclui a requisição de consumo
        lErro = CF("TRVAportes_Exclui", objTRVAporte)
...
On Error GoTo Erro_Historico_Validate
    ...
    If Len(Trim(Historico.Text)) <> 0 Then
       ...
       If Len(Historico.Text) > STRING_TRV_APORTE_HISTORICO Then gError 190626
...
Erro_Historico_Validate:
    ...
    Select Case gErr
        ...
        Case 190626
            Call Rotina_Erro(vbOKOnly, "ERRO_TAMANHO_HISTORICO", gErr, STRING_TRV_APORTE_HISTORICO, Len(Historico.Text))
...
Dim lErro As Long
Dim objTRVAporte As ClassTRVAportes

On Error GoTo Erro_objEventoCodigo_evSelecao

    Set objTRVAporte = obj1
...
On Error GoTo Erro_LabelCodigo_Click
    ...
    If Len(Trim(Codigo.Text)) <> 0 Then
        ...
        objTRVAporte.lCodigo = Codigo.Text

    End If

    Call Chama_Tela("TRVAportesLista", colSelecao, objTRVAporte, objEventoCodigo)
...
On Error GoTo Erro_Cliente_Validate
    ...
    If Len(Trim(Cliente.Text)) > 0 Then
        ...
        If Not (objcliente.objInfoUsu Is Nothing) Then
            ...
            objFilialEmpresa.iCodFilial = objClienteTRV.iFilialEmpresa
        ...
        Case Base.Name, PercentualC.Name, DataPagto.Name, FormaC.Name
            ...
            Else
                If gobjAporte.colPagtoCondicionados.Count >= iLinha Then
                    If gobjAporte.colPagtoCondicionados.Item(iLinha).iStatus <> STATUS_TRV_OCR_BLOQUEADO Then
                        objControl.Enabled = False
                    Else
                        objControl.Enabled = True
                    End If
...
On Error GoTo Erro_BotaoProxNum_Click
    ...
    lErro = CF("Config_ObterAutomatico", "FATConfig", "NUM_PROX_TRVAPORTES", "TRVOcorrencias", "Codigo", lCodigo)
...
Dim lErro As Long
Dim objAportePagtoD As New ClassTRVAportePagtoDireto
Dim objAportePagtoC As New ClassTRVAportePagtoCond
Dim objAportePagtoSF As New ClassTRVAportePagtoFat
Dim objAportePagtoSFC As New ClassTRVAportePagtoFatC
    ...
    If objGridInt.objGrid.Row - objGridInt.objGrid.FixedRows = objGridInt.iLinhasExistentes Then
        ...
        Select Case objGridInt.objGrid.Name
            ...
            Case GridC.Name
                ...
                GridC.TextMatrix(GridC.Row, iGrid_StatusC_Col) = STATUS_TRV_OCR_BLOQUEADO_TEXTO
                objAportePagtoC.iStatus = STATUS_TRV_OCR_BLOQUEADO
    ...
    If iKeyCode = vbKeyDelete Then
        ...
        Select Case objGridInt.objGrid.Name
            ...
            Case GridC.Name
                ...
                'If gobjAporte.colPagtoCondicionados.iItem(iLinha).iStatus = STATUS_TRV_OCR_LIBERADO Then gError 190695
    ...
    If GridD.Row > 0 And Not (gobjAporte Is Nothing) Then
        ...
        If GridD.Row <= gobjAporte.colPagtoDireto.Count Then
            ...
            If Button = vbRightButton Then
                ...
                giTipoAporte = FORMAPAGTO_TRV_APORTE_TIPOPAGTO_DIRETO
    ...
    If GridC.Row > 0 And Not (gobjAporte Is Nothing) Then
        ...
        If GridC.Row <= gobjAporte.colPagtoDireto.Count Then
            ...
            If Button = vbRightButton Then
                ...
                giTipoAporte = FORMAPAGTO_TRV_APORTE_TIPOPAGTO_COND
...
On Error GoTo Erro_mnuTvwAbrirDestino_Click
    ...
    If giTipoAporte = FORMAPAGTO_TRV_APORTE_TIPOPAGTO_DIRETO Then
...
On Error GoTo Erro_mnuGridHistorico_Click
    ...
    If bDetalhado Then
        sNomeBrowse = "TRVAPortesPagtoFatHistLista"
    Else
        sNomeBrowse = "TRVAPortesPagtoFatHistResLista"
    End If

    If iFrameAtual = FRAME_PAGTOSSF Then
     
        colSelecao.Add gobjAportePagtoSF.lNumIntDoc
        colSelecao.Add TRV_TIPO_APORTE_SOBREFATURA
    ...
    ElseIf iFrameAtual = FRAME_PAGTOSSFC Then
        ...
        colSelecao.Add TRV_TIPO_APORTE_SOBREFATURA_COND
...
On Error GoTo Erro_BotaoHistSFC_Click
    ...
    If gobjAportePagtoDireto.lNumIntDocDestino <> 0 Then
        ...
        If gobjAportePagtoDireto.iFormaPagto <> FORMAPAGTO_TRV_OCR_CRED Then gError 196781
         
        colSelecao.Add gobjAportePagtoDireto.lNumIntDocDestino
         
        Call Chama_Tela("TRVCreditosUtilizadosLista", colSelecao, objAporte, Nothing, "NumIntDocCredito = ? ")
...
On Error GoTo Erro_BotaoOutrosAportes_Click
    ...
    Call Chama_Tela("TRVAportesLista", colSelecao, objTRVAporte, objEventoCodigo, "Cliente = ?")
