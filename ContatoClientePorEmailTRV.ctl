...
Begin VB.UserControl ContatoClientePorEmail 
   ClientHeight    =   6900
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   10005
   ...
   Begin VB.Frame FrameTab 
      ...
      Begin VB.ComboBox Modelo 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "ContatoClientePorEmailTRV.ctx":0000
         Left            =   3225
         List            =   "ContatoClientePorEmailTRV.ctx":000A
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox Marca 
            Height          =   315
            ItemData        =   "ContatoClientePorEmailTRV.ctx":003F
            Left            =   8100
            List            =   "ContatoClientePorEmailTRV.ctx":004C
            Style           =   2  'Dropdown List
            TabIndex        =   11
            Top             =   765
            Width           =   1560
         ...
         Begin VB.Frame Frame1 
            ...
            Begin VB.Frame FrameD1 
               ...
               Begin VB.ComboBox ApenasQualifCont 
                  Height          =   315
                  ItemData        =   "ContatoClientePorEmailTRV.ctx":0072
                  Left            =   240
                  List            =   "ContatoClientePorEmailTRV.ctx":007C
                  Style           =   2  'Dropdown List
                  TabIndex        =   31
                  Top             =   45
                  Width           =   1365
            ...
            Begin VB.Frame FrameD1 
               ...
               Begin VB.ComboBox EntreQualifContDe 
                  Height          =   315
                  ItemData        =   "ContatoClientePorEmailTRV.ctx":0097
                  Left            =   2220
                  List            =   "ContatoClientePorEmailTRV.ctx":00A4
                  Style           =   2  'Dropdown List
                  TabIndex        =   35
                  Top             =   0
                  Width           =   1365
               ...
               Begin VB.ComboBox EntreQualifContAte 
                  Height          =   315
                  ItemData        =   "ContatoClientePorEmailTRV.ctx":00C2
                  Left            =   2220
                  List            =   "ContatoClientePorEmailTRV.ctx":00CF
                  Style           =   2  'Dropdown List
                  TabIndex        =   37
                  Top             =   360
                  Width           =   1365
         ...
         Begin VB.Frame Frame1 
            ...
            Begin VB.Frame FrameD4 
               ...
               Begin VB.ComboBox EntreQualifPContAte 
                  Height          =   315
                  ItemData        =   "ContatoClientePorEmailTRV.ctx":00ED
                  Left            =   2220
                  List            =   "ContatoClientePorEmailTRV.ctx":00FA
                  Style           =   2  'Dropdown List
                  TabIndex        =   24
                  Top             =   360
                  Width           =   1365
               ...
               Begin VB.ComboBox EntreQualifPContDe 
                  Height          =   315
                  ItemData        =   "ContatoClientePorEmailTRV.ctx":0118
                  Left            =   2220
                  List            =   "ContatoClientePorEmailTRV.ctx":0125
                  Style           =   2  'Dropdown List
                  TabIndex        =   22
                  Top             =   0
                  Width           =   1365
            ...
            Begin VB.Frame FrameD4 
               ...
               Begin VB.ComboBox ApenasQualifPCont 
                  Height          =   315
                  ItemData        =   "ContatoClientePorEmailTRV.ctx":0143
                  Left            =   270
                  List            =   "ContatoClientePorEmailTRV.ctx":014D
                  Style           =   2  'Dropdown List
                  TabIndex        =   18
                  Top             =   45
                  Width           =   1365
         ...
         Begin VB.Frame Frame1 
            ...
            Begin VB.Frame FrameD2 
               ...
               Begin VB.ComboBox EntreQualifPCompAte 
                  Height          =   315
                  ItemData        =   "ContatoClientePorEmailTRV.ctx":0168
                  Left            =   2220
                  List            =   "ContatoClientePorEmailTRV.ctx":0175
                  Style           =   2  'Dropdown List
                  TabIndex        =   50
                  Top             =   360
                  Width           =   1365
               ...
               Begin VB.ComboBox EntreQualifPCompDe 
                  Height          =   315
                  ItemData        =   "ContatoClientePorEmailTRV.ctx":0193
                  Left            =   2220
                  List            =   "ContatoClientePorEmailTRV.ctx":01A0
                  Style           =   2  'Dropdown List
                  TabIndex        =   48
                  Top             =   0
                  Width           =   1365
            ...
            Begin VB.Frame FrameD2 
               ...
               Begin VB.ComboBox ApenasQualifPComp 
                  Height          =   315
                  ItemData        =   "ContatoClientePorEmailTRV.ctx":01BE
                  Left            =   285
                  List            =   "ContatoClientePorEmailTRV.ctx":01C8
                  Style           =   2  'Dropdown List
                  TabIndex        =   44
                  Top             =   45
                  Width           =   1365
         ...
         Begin VB.Frame Frame1 
            ...
            Begin VB.Frame FrameD3 
               ...
               Begin VB.ComboBox EntreQualifUCompDe 
                  Height          =   315
                  ItemData        =   "ContatoClientePorEmailTRV.ctx":01E3
                  Left            =   2220
                  List            =   "ContatoClientePorEmailTRV.ctx":01F0
                  Style           =   2  'Dropdown List
                  TabIndex        =   61
                  Top             =   0
                  Width           =   1365
               ...
               Begin VB.ComboBox EntreQualifUCompAte 
                  Height          =   315
                  ItemData        =   "ContatoClientePorEmailTRV.ctx":020E
                  Left            =   2220
                  List            =   "ContatoClientePorEmailTRV.ctx":021B
                  Style           =   2  'Dropdown List
                  TabIndex        =   63
                  Top             =   360
                  Width           =   1365
            ...
            Begin VB.Frame FrameD3 
               ...
               Begin VB.ComboBox ApenasQualifUComp 
                  Height          =   315
                  ItemData        =   "ContatoClientePorEmailTRV.ctx":0239
                  Left            =   195
                  List            =   "ContatoClientePorEmailTRV.ctx":0243
                  Style           =   2  'Dropdown List
                  TabIndex        =   57
                  Top             =   45
                  Width           =   1365
   ...
   Begin VB.Frame FrameTab 
      ...
      Begin VB.ComboBox Carta 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "ContatoClientePorEmailTRV.ctx":025E
         Left            =   2340
         List            =   "ContatoClientePorEmailTRV.ctx":0268
         Style           =   2  'Dropdown List
         TabIndex        =   94
         Top             =   810
         Width           =   2235
      ...
      Begin VB.CommandButton BotaoMarcar 
         ...
         Height          =   555
         Left            =   60
         Picture         =   "ContatoClientePorEmailTRV.ctx":029D
         Style           =   1  'Graphical
         TabIndex        =   81
         Top             =   3435
         Width           =   1725
      ...
      Begin VB.CommandButton BotaoDesmarcar 
         ...
         Height          =   555
         Left            =   45
         Picture         =   "ContatoClientePorEmailTRV.ctx":12B7
         Style           =   1  'Graphical
         TabIndex        =   82
         Top             =   4200
         Width           =   1725
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   615
         Picture         =   "ContatoClientePorEmailTRV.ctx":2499
         Style           =   1  'Graphical
         TabIndex        =   76
         ToolTipText     =   "Excluir"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   120
         Picture         =   "ContatoClientePorEmailTRV.ctx":2623
         Style           =   1  'Graphical
         TabIndex        =   75
      ...
      Begin VB.CommandButton BotaoEmail 
         Height          =   360
         Left            =   1110
         Picture         =   "ContatoClientePorEmailTRV.ctx":277D
         Style           =   1  'Graphical
         TabIndex        =   77
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1635
         Picture         =   "ContatoClientePorEmailTRV.ctx":311F
         Style           =   1  'Graphical
         TabIndex        =   78
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   2145
         Picture         =   "ContatoClientePorEmailTRV.ctx":3651
         Style           =   1  'Graphical
         TabIndex        =   79
         ToolTipText     =   "Fechar"
         Top             =   75
   ...
   End
End
Attribute VB_Name = "ContatoClientePorEmail"
...
Private Sub UserControl_Initialize()
    ...
    'TRV
    Set objCT.gobjInfoUsu = New CTContatoCliEVGTRV
    Set objCT.gobjInfoUsu.gobjTelaUsu = New CTContatoCliETRV
End Sub
...
Private Sub Marca_Change()
     Call objCT.gobjInfoUsu.gobjTelaUsu.Marca_Change(objCT)
End Sub
