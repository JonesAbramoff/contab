...
Begin VB.UserControl RelOpFlCaixaOcx 
   ClientHeight    =   1500
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4815
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   75
         Picture         =   "RelOpFlCaixaOcx.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   8
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   585
         Picture         =   "RelOpFlCaixaOcx.ctx":0532
         Style           =   1  'Graphical
         TabIndex        =   7
         ToolTipText     =   "Fechar"
         Top             =   75
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   600
      Left            =   3570
      Picture         =   "RelOpFlCaixaOcx.ctx":06B0
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   795
      Width           =   1140
   ...
   End
End
Attribute VB_Name = "RelOpFlCaixaOcx"
...
On Error GoTo Erro_PreencherRelOp
    ...
    If lErro <> SUCESSO Then gError 91666

    lErro = objRelOpcoes.Limpar
    If lErro <> AD_BOOL_TRUE Then gError 91667
    
    lErro = objRelOpcoes.IncluirParametro("DINIC", EmissaoDe.Caption)
    If lErro <> AD_BOOL_TRUE Then gError 91668
    ...
    End If
    If lErro <> AD_BOOL_TRUE Then gError 91669

    'Faz a selecao
    lErro = Monta_Expressao_Selecao(objRelOpcoes)
    If lErro <> SUCESSO Then gError 91770
...
Erro_PreencherRelOp:
    ...
    Select Case gErr
        ...
        Case 91666, 91667, 91668, 91669, 91770

        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 169182)
...
On Error GoTo Erro_Trata_Parametros
    ...
    If Not (gobjRelatorio Is Nothing) Then gError 91771
...
Erro_Trata_Parametros:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 169183)
...
On Error GoTo Erro_BotaoExecutar_Click
    ...
    If lErro <> SUCESSO Then gError 91772
...
Erro_BotaoExecutar_Click:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 169184)
...
On Error GoTo Erro_EmissaoAte_Validate
    ...
    If lErro <> SUCESSO Then gError 91773
...
Erro_EmissaoAte_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 169185)
