...
Begin VB.UserControl NFiscalEntRem 
   ...
   Begin VB.Frame Frame1 
      ...
      Visible         =   0   'False
      Width           =   9420
      Begin VB.CommandButton BotaoImportarRastr 
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
         ...
         Height          =   360
         Left            =   1770
         Picture         =   "NFiscalEntRem.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   225
         Top             =   4380
         Width           =   1665
      ...
      Begin VB.Frame Frame17 
         ...
         Begin VB.ComboBox ProdutoRastro 
            Height          =   315
            ItemData        =   "NFiscalEntRem.ctx":212D
            Left            =   0
            List            =   "NFiscalEntRem.ctx":213A
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "NFiscalEntRem.ctx":2159
            Left            =   3750
            List            =   "NFiscalEntRem.ctx":2163
            Style           =   2  'Dropdown List
            TabIndex        =   159
            Top             =   180
            Visible         =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame FrameCOForn 
         ...
         End
      End
      Begin VB.Frame FrameCOCli 
         Caption         =   "Dados do Cliente para fins de beneficiamento - Dono do Material"
         Height          =   570
         Left            =   120
         TabIndex        =   216
         Top             =   4185
         Width           =   8895
         Begin VB.ComboBox FilialCliBenef 
            Height          =   315
            Left            =   6825
            TabIndex        =   71
            Top             =   210
            Width           =   1860
         End
         Begin MSMask.MaskEdBox ClienteBenef 
            Height          =   315
            Left            =   4395
            TabIndex        =   70
            Top             =   210
         ...
         Begin VB.Label Label1 
            ...
            Width           =   465
         End
         Begin VB.Label ClienteBenefLabel 
            AutoSize        =   -1  'True
            Caption         =   "Cliente:"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CommandButton BotaoTrazerNFe 
            Height          =   360
            Left            =   6165
            Picture         =   "NFiscalEntRem.ctx":217F
            Style           =   1  'Graphical
            TabIndex        =   1
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton Recebimento 
            Height          =   360
            Left            =   2685
            Picture         =   "NFiscalEntRem.ctx":2551
            Style           =   1  'Graphical
            TabIndex        =   3
            ToolTipText     =   "Trazer Dados"
            Top             =   240
         ...
         Begin VB.ComboBox TipoNFiscal 
            Height          =   315
            ItemData        =   "NFiscalEntRem.ctx":2923
            Left            =   1485
            List            =   "NFiscalEntRem.ctx":2925
            TabIndex        =   5
            Top             =   660
            Width           =   4665
         End
         Begin VB.CommandButton BotaoLimparNF 
            Height          =   315
            Left            =   5790
            Picture         =   "NFiscalEntRem.ctx":2927
            Style           =   1  'Graphical
            TabIndex        =   9
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   330
         Left            =   540
         Picture         =   "NFiscalEntRem.ctx":2E59
         Style           =   1  'Graphical
         TabIndex        =   24
         ToolTipText     =   "Excluir"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   330
         Left            =   1440
         Picture         =   "NFiscalEntRem.ctx":2FE3
         Style           =   1  'Graphical
         TabIndex        =   26
         ToolTipText     =   "Fechar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   330
         Left            =   990
         Picture         =   "NFiscalEntRem.ctx":3161
         Style           =   1  'Graphical
         TabIndex        =   25
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   330
         Left            =   90
         Picture         =   "NFiscalEntRem.ctx":3693
         Style           =   1  'Graphical
         TabIndex        =   23
         ToolTipText     =   "Gravar"
         Top             =   75
...
Private Sub TipoNFiscal_Correspondente_Recebimento(objTipoDocInfo As ClassTipoDocInfo, iTipoRecebimento As Integer)
     Call objCT.TipoNFiscal_Correspondente_Recebimento(objTipoDocInfo, iTipoRecebimento)
End Sub
...
Private Sub ClienteBenef_Change()
     Call objCT.ClienteBenef_Change
End Sub

Private Sub ClienteBenef_Validate(Cancel As Boolean)
     Call objCT.ClienteBenef_Validate(Cancel)
End Sub

Private Sub FilialCliBenef_Validate(Cancel As Boolean)
     Call objCT.FilialCliBenef_Validate(Cancel)
End Sub

Private Sub FilialCliBenef_Change()
     Call objCT.FilialCliBenef_Change
End Sub

Private Sub ClienteBenefLabel_Click()
     Call objCT.ClienteBenefLabel_Click
End Sub
...
Private Sub BotaoImportarRastr_Click()
     Call objCT.BotaoImportarRastr_Click
End Sub
