...
Begin VB.MDIForm PrincipalNovo 
   ...
   ClientTop       =   795
   ClientWidth     =   14535
   Icon            =   "principalnovoexc.frx":0000
   LinkTopic       =   "MDIForm1"
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoFacebook 
         Height          =   360
         Left            =   11490
         Picture         =   "principalnovoexc.frx":014A
         Style           =   1  'Graphical
         TabIndex        =   18
      ...
      Begin VB.CommandButton SuporteOnline 
         Height          =   315
         Left            =   9975
         Picture         =   "principalnovoexc.frx":05AB
         Style           =   1  'Graphical
         TabIndex        =   15
      ...
      Begin VB.CommandButton BotaoBrowseCria 
         Height          =   315
         Left            =   13260
         Picture         =   "principalnovoexc.frx":0C3E
         Style           =   1  'Graphical
         TabIndex        =   16
      ...
      Begin VB.CommandButton BotaoAnotacao 
         Height          =   315
         Left            =   4710
         Picture         =   "principalnovoexc.frx":1178
         Style           =   1  'Graphical
         TabIndex        =   13
      ...
      Begin VB.CommandButton BotaoConsulta 
         Height          =   360
         Left            =   907
         Picture         =   "principalnovoexc.frx":16B2
         Style           =   1  'Graphical
         TabIndex        =   12
      ...
      Begin VB.CommandButton Ultimo 
         Height          =   360
         Left            =   1740
         Picture         =   "principalnovoexc.frx":19C4
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      Begin VB.CommandButton Proximo 
         Height          =   360
         Left            =   1323
         Picture         =   "principalnovoexc.frx":1CD6
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      Begin VB.CommandButton Anterior 
         Height          =   360
         Left            =   491
         Picture         =   "principalnovoexc.frx":1E80
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      Begin VB.CommandButton Primeiro 
         Height          =   360
         Left            =   75
         Picture         =   "principalnovoexc.frx":202A
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton BotaoTestaInt 
         Height          =   315
         Left            =   12450
         Picture         =   "principalnovoexc.frx":233C
         Style           =   1  'Graphical
         TabIndex        =   7
         ToolTipText     =   "NAO USE"
         Top             =   105
      ...
      Begin VB.CommandButton BotaoGeraCodigoLight 
         Height          =   315
         Left            =   12870
         Picture         =   "principalnovoexc.frx":2876
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.ComboBox ComboModulo 
         Height          =   315
         ItemData        =   "principalnovoexc.frx":2A00
         Left            =   5730
         List            =   "principalnovoexc.frx":2A02
   ...
   Begin VB.Menu mnuRotinas 
      ...
      End
      Begin VB.Menu mnuESTRot 
         Caption         =   "Importação de xmls de NFe/CTe"
         Index           =   14
      End
   End
   Begin VB.Menu mnuRotinas 
...
Const MENU_TRVFAT_MOV_ACORDOS = 10
...
'
    ...
    vbResult = Rotina_Aviso(vbYesNo, "Deseja excluir as notas fiscais ?")
    If vbResult = vbYes Then
        For iIndice = 1 To 1500
            ...
            If lErro = SUCESSO Then
                lErro = CF("NotaFiscalSaida_Excluir", objNF, Nothing)
                If lErro <> SUCESSO Then
                    vbResult = Rotina_Aviso(vbYesNo, "Ocorreu um erro na exclusão da NF " & objNF.sSerie & " " & CStr(objNF.lNumNotaFiscal) & ". Deseja continuar excluindo ?")
                    If vbResult = vbNo Then Exit For
                End If
            End If
    ...
    vbResult = Rotina_Aviso(vbYesNo, "Deseja excluir os pedidos de compra ?")
    If vbResult = vbYes Then
        For iIndice = 1 To 20
    
            Set objPedidoCompra = New ClassPedidoCompras
    
            objPedidoCompra.lNumIntDoc = iIndice
    
            lErro = CF("PedidoCompras_Le", objPedidoCompra)
            If lErro = SUCESSO Then
                lErro = CF("PedidoCompra_Exclui", objPedidoCompra)
                If lErro <> SUCESSO Then
                    vbResult = Rotina_Aviso(vbYesNo, "Ocorreu um erro na exclusão do Pedido de Compra " & CStr(objPedidoCompra.lCodigo) & ". Deseja continuar excluindo ?")
                    If vbResult = vbNo Then Exit For
                End If
            End If
    ...
    vbResult = Rotina_Aviso(vbYesNo, "Deseja excluir os produtos ?")
    If vbResult = vbYes Then
        ...
        For Each objProduto In colProdutos
           ...
           objProdAux.sCodigo = objProduto.sCodigo
           ...
           If lErro = SUCESSO Then
                ...
                If lErro <> SUCESSO Then
                    vbResult = Rotina_Aviso(vbYesNo, "Ocorreu um erro na exclusão do Produto " & objProduto.sCodigo & ". Deseja continuar excluindo ?")
                    If vbResult = vbNo Then Exit For
                End If
            End If
