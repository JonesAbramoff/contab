...
Begin VB.UserControl NFiscalOcx 
   ClientHeight    =   5880
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9510
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox TipoNFiscal 
            Height          =   315
            ItemData        =   "NFiscalOcx.ctx":0532
            Left            =   1785
            List            =   "NFiscalOcx.ctx":0534
            TabIndex        =   4
            Top             =   180
            Width           =   3540
         End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox TabPrecoItemNF 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "NFiscalOcx.ctx":0536
            Left            =   3390
            List            =   "NFiscalOcx.ctx":0538
            Style           =   2  'Dropdown List
            TabIndex        =   246
            Top             =   1995
            Width           =   1800
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox ProdutoRastro 
            Height          =   315
            ItemData        =   "NFiscalOcx.ctx":053A
            Left            =   1350
            List            =   "NFiscalOcx.ctx":0547
            Style           =   2  'Dropdown List
            TabIndex        =   202
            Top             =   1170
            Width           =   1740
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Height          =   315
            ItemData        =   "NFiscalOcx.ctx":0566
            Left            =   3690
            List            =   "NFiscalOcx.ctx":0573
            Style           =   2  'Dropdown List
            TabIndex        =   182
            Top             =   285
            Width           =   1215
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame4 
         ...
         Begin VB.ComboBox DiretoIndireto 
            Height          =   315
            ItemData        =   "NFiscalOcx.ctx":1220
            Left            =   6240
            List            =   "NFiscalOcx.ctx":122A
            Style           =   2  'Dropdown List
            TabIndex        =   185
            Top             =   1560
            Width           =   1335
