...
Begin VB.UserControl RelOpKardexTercOcx 
   ClientHeight    =   5475
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   6540
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   120
         Picture         =   "RelOpKardexTerc.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   13
         ToolTipText     =   "Gravar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   630
         Picture         =   "RelOpKardexTerc.ctx":015A
         Style           =   1  'Graphical
         TabIndex        =   14
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "RelOpKardexTerc.ctx":02E4
         Style           =   1  'Graphical
         TabIndex        =   15
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "RelOpKardexTerc.ctx":0816
         Style           =   1  'Graphical
         TabIndex        =   16
         ToolTipText     =   "Fechar"
         Top             =   90
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   600
      Left            =   4815
      Picture         =   "RelOpKardexTerc.ctx":0994
      Style           =   1  'Graphical
      TabIndex        =   11
      Top             =   705
      Width           =   1575
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   315
      ItemData        =   "RelOpKardexTerc.ctx":0A96
      Left            =   840
      List            =   "RelOpKardexTerc.ctx":0A98
      Sorted          =   -1  'True
      TabIndex        =   0
      Top             =   150
      Width           =   2916
   ...
   End
End
Attribute VB_Name = "RelOpKardexTercOcx"
...
On Error GoTo Erro_Formata_E_Critica_Parametros
   ...
   'data inicial não pode ser maior que a data final
    If Trim(DataInicial.ClipText) <> "" And Trim(DataFinal.ClipText) <> "" Then
         If CDate(DataInicial.Text) > CDate(DataFinal.Text) Then gError 209672
    End If
...
On Error GoTo Erro_PreencherRelOp
    ...
    If bExecutando Then
        ...
        objRelEstTercSel.dtDataDe = StrParaDate(DataInicial.Text)
        objRelEstTercSel.dtDataAte = StrParaDate(DataFinal.Text)
        ...
        lErro = CF("RelMovEstTerc_Prepara", objRelEstTercSel)
        If lErro <> SUCESSO Then gError ERRO_SEM_MENSAGEM
...
Erro_DataFinal_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 209690)
...
Erro_UpDown2_DownClick:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 209694)
...
Erro_UpDown2_UpClick:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 209695)
...
Public Function Form_Load_Ocx() As Object
    ...
    Caption = "Lista dos Movimentos - Por Terceiro"
    Call Form_Load
