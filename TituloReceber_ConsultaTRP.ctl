...
Begin VB.UserControl TituloReceber_Consulta 
   ClientHeight    =   6825
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   10215
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton BotaoDocOriginal 
         ...
         Height          =   570
         Left            =   7815
         Picture         =   "TituloReceber_ConsultaTRP.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   -45
         Width           =   2055
   ...
   Begin VB.Frame Frame1 
      ...
      Begin MSMask.MaskEdBox CTBConta 
         Bindings        =   "TituloReceber_ConsultaTRP.ctx":2F16
         Height          =   225
         Left            =   210
         TabIndex        =   37
         Top             =   1230
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame1 
         ...
         Begin VB.ComboBox TipoDesconto 
            Height          =   315
            ItemData        =   "TituloReceber_ConsultaTRP.ctx":2F21
            Left            =   120
            List            =   "TituloReceber_ConsultaTRP.ctx":2F23
            TabIndex        =   18
            Top             =   300
            Width           =   1890
         End
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   675
         Left            =   1705
         Picture         =   "TituloReceber_ConsultaTRP.ctx":2F25
         Style           =   1  'Graphical
         TabIndex        =   48
         ToolTipText     =   "Excluir"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoImprimir 
         Height          =   675
         Left            =   1290
         Picture         =   "TituloReceber_ConsultaTRP.ctx":30AF
         Style           =   1  'Graphical
         TabIndex        =   47
      ...
      Begin VB.CommandButton BotaoConsulta 
         Height          =   675
         Left            =   15
         Picture         =   "TituloReceber_ConsultaTRP.ctx":31B1
         Style           =   1  'Graphical
         TabIndex        =   46
         Top             =   60
         Width           =   1245
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   675
         Left            =   2120
         Picture         =   "TituloReceber_ConsultaTRP.ctx":4F73
         Style           =   1  'Graphical
         TabIndex        =   49
         ToolTipText     =   "Limpar"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   675
         Left            =   2535
         Picture         =   "TituloReceber_ConsultaTRP.ctx":54A5
         Style           =   1  'Graphical
         TabIndex        =   50
         ToolTipText     =   "Fechar"
         Top             =   60
   ...
   End
End
Attribute VB_Name = "TituloReceber_Consulta"
...
Private Sub UserControl_Initialize()
    ...
    'TRP
    Set objCT.gobjInfoUsu = New CTTitRecConVGTRP
    Set objCT.gobjInfoUsu.gobjTelaUsu = New CTTitRecConTRP
End Sub
...
Private Sub BotaoImprimir_Click()
     Call objCT.gobjInfoUsu.gobjTelaUsu.BotaoImprimir_Click(objCT)
End Sub

Private Sub BotaoExcluir_Click()
     Call objCT.gobjInfoUsu.gobjTelaUsu.BotaoExcluir_Click(objCT)
End Sub
