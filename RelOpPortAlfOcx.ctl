VERSION 5.00
Begin VB.UserControl RelOpPortAlfOcx 
   ClientHeight    =   2130
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   3105
   ...
   End
End
Attribute VB_Name = "RelOpPortAlfOcx"
...
Private Sub BotaoOk_Click()
    ...
    gobjCompserv.sAlfandega = Alfandega.Text
