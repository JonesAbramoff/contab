...
Begin VB.UserControl NFiscalPedido 
   ClientHeight    =   5835
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9555
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame6 
         ...
         Begin VB.ComboBox TabPrecoItemNF 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "NFiscalPedidoPhar.ctx":0000
            Left            =   -20000
            List            =   "NFiscalPedidoPhar.ctx":0002
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton BotaoLimparNF 
            Height          =   300
            Left            =   5160
            Picture         =   "NFiscalPedidoPhar.ctx":0004
            Style           =   1  'Graphical
            TabIndex        =   8
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.CommandButton BotaoPedido 
         Height          =   360
         Left            =   3840
         Picture         =   "NFiscalPedidoPhar.ctx":0536
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      Begin VB.CommandButton BotaoVerPedido 
         Height          =   360
         Left            =   4230
         Picture         =   "NFiscalPedidoPhar.ctx":0908
         Style           =   1  'Graphical
         TabIndex        =   3
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton BotaoConsultaTitRec 
         ...
         Height          =   330
         Left            =   60
         Picture         =   "NFiscalPedidoPhar.ctx":0C1A
         Style           =   1  'Graphical
         TabIndex        =   173
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   330
         Left            =   892
         Picture         =   "NFiscalPedidoPhar.ctx":149C
         Style           =   1  'Graphical
         TabIndex        =   171
         ToolTipText     =   "Gravar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   330
         Left            =   1806
         Picture         =   "NFiscalPedidoPhar.ctx":15F6
         Style           =   1  'Graphical
         TabIndex        =   170
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   330
         Left            =   2265
         Picture         =   "NFiscalPedidoPhar.ctx":1B28
         Style           =   1  'Graphical
         TabIndex        =   169
         ToolTipText     =   "Fechar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   330
         Left            =   1349
         Picture         =   "NFiscalPedidoPhar.ctx":1CA6
         Style           =   1  'Graphical
         TabIndex        =   168
         ToolTipText     =   "Excluir"
         Top             =   75
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame NFiscalOcx 
         ...
         Begin VB.ComboBox DiretoIndireto 
            Height          =   315
            ItemData        =   "NFiscalPedidoPhar.ctx":1E30
            Left            =   7080
            List            =   "NFiscalPedidoPhar.ctx":1E3A
            Style           =   2  'Dropdown List
            TabIndex        =   146
            Top             =   1560
            Width           =   1335
         ...
         Begin VB.CommandButton BotaoVendedores 
            ...
            Height          =   540
            Left            =   7680
            Picture         =   "NFiscalPedidoPhar.ctx":1E50
            Style           =   1  'Graphical
            TabIndex        =   121
            Top             =   3285
            Width           =   1305
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Height          =   315
            ItemData        =   "NFiscalPedidoPhar.ctx":23FA
            Left            =   3690
            List            =   "NFiscalPedidoPhar.ctx":2407
            Style           =   2  'Dropdown List
            TabIndex        =   83
            Top             =   270
            Width           =   1215
         ...
         Begin VB.ComboBox ProdutoRastro 
            Height          =   315
            ItemData        =   "NFiscalPedidoPhar.ctx":2426
            Left            =   0
            List            =   "NFiscalPedidoPhar.ctx":2433
            Style           =   2  'Dropdown List
            TabIndex        =   82
            Top             =   0
            Width           =   1740
   ...
   End
End
Attribute VB_Name = "NFiscalPedido"
...
Private WithEvents objCT As CTNFiscalPedido
...
Private Sub UserControl_Initialize()
    ...
    Set objCT.gobjInfoUsu = New CTNFPedVGPhar
    Set objCT.gobjInfoUsu.gobjTelaUsu = New CTNFPedPhar
