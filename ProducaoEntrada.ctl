...
Begin VB.UserControl ProducaoEntrada 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Benef 
         Height          =   315
         ItemData        =   "ProducaoEntrada.ctx":0000
         Left            =   4170
         List            =   "ProducaoEntrada.ctx":000D
      ...
      Begin VB.CommandButton botaoOPCodigoPadrao 
         Height          =   285
         Left            =   3540
         Picture         =   "ProducaoEntrada.ctx":0032
         Style           =   1  'Graphical
         TabIndex        =   100
      ...
      Begin VB.CommandButton BotaoProxNum 
         Height          =   285
         Left            =   3540
         Picture         =   "ProducaoEntrada.ctx":0404
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.Label OPPadraoLabel 
         AutoSize        =   -1  'True
         Caption         =   "Ordem de Produção Padrão:"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Visible         =   0   'False
      Width           =   9285
      Begin MSMask.MaskEdBox ApropItemProd 
         Height          =   285
         Left            =   6990
         TabIndex        =   110
         Top             =   2940
         ...
         PromptChar      =   " "
      End
      Begin VB.CheckBox ApropAutomatica 
         Height          =   255
         Left            =   6450
         TabIndex        =   109
         Top             =   2910
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "ProducaoEntrada.ctx":04EE
         Style           =   1  'Graphical
         TabIndex        =   97
         ToolTipText     =   "Excluir"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "ProducaoEntrada.ctx":0678
         Style           =   1  'Graphical
         TabIndex        =   38
         ToolTipText     =   "Fechar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "ProducaoEntrada.ctx":07F6
         Style           =   1  'Graphical
         TabIndex        =   37
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "ProducaoEntrada.ctx":0D28
         Style           =   1  'Graphical
         TabIndex        =   36
         ToolTipText     =   "Gravar"
         Top             =   75
...
Public Sub HorasMaquina_Validate(Cancel As Boolean)
    objCT.HorasMaquina_Validate (Cancel)
End Sub

Private Sub ApropItemProd_Change()
     Call objCT.ApropItemProd_Change
End Sub

Private Sub ApropItemProd_GotFocus()
     Call objCT.ApropItemProd_GotFocus
End Sub

Private Sub ApropItemProd_KeyPress(KeyAscii As Integer)
     Call objCT.ApropItemProd_KeyPress(KeyAscii)
End Sub

Private Sub ApropItemProd_Validate(Cancel As Boolean)
     Call objCT.ApropItemProd_Validate(Cancel)
End Sub
