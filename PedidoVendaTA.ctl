...
Begin VB.UserControl PedidoVenda 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox TabPrecoItemPV 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "PedidoVendaTA.ctx":0000
            Left            =   2400
            List            =   "PedidoVendaTA.ctx":0002
         ...
         Begin VB.ComboBox RecebForaFaixa 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "PedidoVendaTA.ctx":0004
            Left            =   5055
            List            =   "PedidoVendaTA.ctx":000E
            Style           =   2  'Dropdown List
            TabIndex        =   214
            Top             =   1335
            Width           =   2235
         ...
         Begin VB.ComboBox UnidadeMed 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "PedidoVendaTA.ctx":0043
            Left            =   1575
            List            =   "PedidoVendaTA.ctx":0045
            Style           =   2  'Dropdown List
            TabIndex        =   40
            Top             =   240
            Width           =   720
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton BotaoProxNum 
            Height          =   285
            Left            =   2910
            Picture         =   "PedidoVendaTA.ctx":0047
            Style           =   1  'Graphical
            TabIndex        =   13
         ...
         Begin VB.ComboBox FilialFaturamento 
            Height          =   315
            ItemData        =   "PedidoVendaTA.ctx":0131
            Left            =   5190
            List            =   "PedidoVendaTA.ctx":0133
            TabIndex        =   18
            Top             =   765
            Width           =   2145
         End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame4 
         ...
         Begin VB.ComboBox DiretoIndireto 
            Height          =   315
            ItemData        =   "PedidoVendaTA.ctx":0135
            Left            =   5070
            List            =   "PedidoVendaTA.ctx":013F
            Style           =   2  'Dropdown List
            TabIndex        =   172
            Top             =   915
            Width           =   1335
         ...
         Begin VB.CommandButton BotaoVendedores 
            ...
            Height          =   645
            Left            =   7440
            Picture         =   "PedidoVendaTA.ctx":0155
            Style           =   1  'Graphical
            TabIndex        =   169
            Top             =   3300
            Width           =   1500
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton BotaoImprimirConf 
         Height          =   345
         Left            =   5460
         Picture         =   "PedidoVendaTA.ctx":06FF
         Style           =   1  'Graphical
         TabIndex        =   239
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame3 
         ...
         Begin VB.CommandButton BotaoDataRefFluxoUp 
            Height          =   150
            Left            =   8970
            Picture         =   "PedidoVendaTA.ctx":0801
            Style           =   1  'Graphical
            TabIndex        =   211
            TabStop         =   0   'False
            Top             =   675
         ...
         Begin VB.CommandButton BotaoDataRefFluxoDown 
            Height          =   150
            Left            =   8970
            Picture         =   "PedidoVendaTA.ctx":085B
            Style           =   1  'Graphical
            TabIndex        =   210
            TabStop         =   0   'False
            Top             =   825
         ...
         Begin VB.ComboBox TipoPagto 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "PedidoVendaTA.ctx":08B5
            Left            =   3045
            List            =   "PedidoVendaTA.ctx":08C5
            TabIndex        =   207
            Top             =   2310
            Width           =   1965
         End
         Begin VB.CommandButton BotaoDataReferenciaDown 
            Height          =   150
            Left            =   3105
            Picture         =   "PedidoVendaTA.ctx":0902
            Style           =   1  'Graphical
            TabIndex        =   123
            TabStop         =   0   'False
            Top             =   855
         ...
         Begin VB.CommandButton BotaoDataReferenciaUp 
            Height          =   150
            Left            =   3105
            Picture         =   "PedidoVendaTA.ctx":095C
            Style           =   1  'Graphical
            TabIndex        =   124
            TabStop         =   0   'False
            Top             =   705
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   345
         Left            =   2430
         Picture         =   "PedidoVendaTA.ctx":09B6
         Style           =   1  'Graphical
         TabIndex        =   238
         ToolTipText     =   "Fechar"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   345
         Left            =   1950
         Picture         =   "PedidoVendaTA.ctx":0B34
         Style           =   1  'Graphical
         TabIndex        =   237
         ToolTipText     =   "Limpar"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   345
         Left            =   1485
         Picture         =   "PedidoVendaTA.ctx":1066
         Style           =   1  'Graphical
         TabIndex        =   236
         ToolTipText     =   "Excluir"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   345
         Left            =   1005
         Picture         =   "PedidoVendaTA.ctx":11F0
         Style           =   1  'Graphical
         TabIndex        =   235
         ToolTipText     =   "Gravar"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoImprimir 
         Height          =   345
         Left            =   510
         Picture         =   "PedidoVendaTA.ctx":134A
         Style           =   1  'Graphical
         TabIndex        =   234
      ...
      Begin VB.CommandButton BotaoEmail 
         Height          =   345
         Left            =   45
         Picture         =   "PedidoVendaTA.ctx":144C
         Style           =   1  'Graphical
         TabIndex        =   233
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton BotaoLiberaBloqueio 
         ...
         Height          =   600
         Left            =   6825
         Picture         =   "PedidoVendaTA.ctx":1DEE
         Style           =   1  'Graphical
         TabIndex        =   99
         Top             =   3840
         Width           =   1650
      ...
      Begin VB.Frame SSFrame1 
         ...
         Begin VB.ComboBox TipoBloqueio 
            Height          =   315
            ItemData        =   "PedidoVendaTA.ctx":43E8
            Left            =   555
            List            =   "PedidoVendaTA.ctx":43EA
            TabIndex        =   92
            Top             =   330
            Width           =   1605
         End
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.CommandButton BotaoOrcamento 
         Height          =   360
         Left            =   3795
         Picture         =   "PedidoVendaTA.ctx":43EC
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton BotaoVerOrcamento 
         Height          =   360
         Left            =   4185
         Picture         =   "PedidoVendaTA.ctx":47BE
         Style           =   1  'Graphical
         TabIndex        =   6
...
Private Sub UserControl_Initialize()
    ...
    Set objCT.gobjInfoUsu = New CTPedidoVendaVGTA
    Set objCT.gobjInfoUsu.gobjTelaUsu = New CTPedidoVendaTA
