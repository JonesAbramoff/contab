...
Begin VB.UserControl RelOpEmissaoNFiscalOcx 
   ...
   Begin VB.Frame FrameNF 
      ...
      Begin VB.ComboBox TipoFormulario 
         Height          =   315
         ItemData        =   "RelOpEmissaoNFiscalGR.ctx":0000
         Left            =   1680
         List            =   "RelOpEmissaoNFiscalGR.ctx":000D
         Style           =   2  'Dropdown List
         TabIndex        =   5
         Top             =   360
         Width           =   2385
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   75
         Picture         =   "RelOpEmissaoNFiscalGR.ctx":0047
         Style           =   1  'Graphical
         TabIndex        =   2
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   585
         Picture         =   "RelOpEmissaoNFiscalGR.ctx":0579
         Style           =   1  'Graphical
         TabIndex        =   3
         ToolTipText     =   "Fechar"
         Top             =   90
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   555
      Left            =   960
      Picture         =   "RelOpEmissaoNFiscalGR.ctx":06F7
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   150
      Width           =   1845
...
Erro_BotaoExecutar_Click:
    ...
    Select Case Err
        ...
        Case 60380, 60381, 60422, 61010, 61435 'Tratado na Rotina chamada
...
Erro_Traz_Numeros_Default:
    ...
    Select Case Err
        ...
        Case 38179, 60366, 60374 'Tratado na Rotina chamada
            Serie.SetFocus
...
Erro_Timer1_Timer:
    ...
    Select Case Err
        ...
        Case 60382, 61030 'Tratado na Rotina chamada
