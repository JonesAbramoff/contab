...
Begin VB.UserControl TRPOcorrencias 
   ClientHeight    =   6000
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9510
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1545
         Picture         =   "TRPOcorrencias.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   25
         ToolTipText     =   "Fechar"
         Top             =   45
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1065
         Picture         =   "TRPOcorrencias.ctx":017E
         Style           =   1  'Graphical
         TabIndex        =   24
         ToolTipText     =   "Limpar"
         Top             =   45
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   570
         Picture         =   "TRPOcorrencias.ctx":06B0
         Style           =   1  'Graphical
         TabIndex        =   23
         ToolTipText     =   "Excluir"
         Top             =   45
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   60
         Picture         =   "TRPOcorrencias.ctx":083A
         Style           =   1  'Graphical
         TabIndex        =   22
         ToolTipText     =   "Gravar"
         Top             =   45
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Origem 
         Height          =   315
         ItemData        =   "TRPOcorrencias.ctx":0994
         Left            =   3405
         List            =   "TRPOcorrencias.ctx":099E
      ...
      Begin VB.CommandButton BotaoProxNum 
         Height          =   285
         Left            =   1770
         Picture         =   "TRPOcorrencias.ctx":09CF
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.ComboBox FormaPagto 
         Height          =   315
         ItemData        =   "TRPOcorrencias.ctx":0AB9
         Left            =   900
         List            =   "TRPOcorrencias.ctx":0AC3
         Style           =   2  'Dropdown List
         TabIndex        =   13
         Top             =   1320
         Width           =   1815
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton BotaoTrazerVou 
         Height          =   330
         Left            =   4200
         Picture         =   "TRPOcorrencias.ctx":0AE5
         Style           =   1  'Graphical
         TabIndex        =   3
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.ComboBox Tipo 
         Height          =   315
         ItemData        =   "TRPOcorrencias.ctx":0EB7
         Left            =   390
         List            =   "TRPOcorrencias.ctx":0EC4
         Style           =   2  'Dropdown List
         TabIndex        =   27
         Top             =   765
         Width           =   2115
   ...
   End
End
Attribute VB_Name = "TRPOcorrencias"
...
On Error GoTo Erro_TrazerVou_Click
    ...
    If objVoucher.iStatus = STATUS_TRP_VOU_CANCELADO And bValidaCanc Then gError 194422
...
On Error GoTo Erro_BotaoVou_Click
    ...
    objVoucher.lClienteVou = LCodigo_Extrai(ClienteVou.Caption)

    Call Chama_Tela("TRPVoucherRapidoLista", colSelecao, objVoucher, objEventoVoucher, "Cancelado <> 'Sim'")
...
On Error GoTo Erro_Form_Load
    ...
    'lErro = CF("Carrega_CamposGenericos", CAMPOSGENERICOS_TRPORIGEM_OCR, Origem)
    lErro = CF("TRPCarrega_TipoOrigemOCR", Origem)
    If lErro <> SUCESSO Then gError 190163
    
    lErro = CF("Carrega_CamposGenericos", CAMPOSGENERICOS_TRPTIPODET_OCR, Tipo)
    If lErro <> SUCESSO Then gError 190164
    
    Historico.Clear
    lErro = CF("Carrega_Combo_Historico", Historico, "TRPOcorrencias", STRING_TRP_OCR_HISTORICO)
...
Function Trata_Parametros(Optional objOcr As ClassTRPOcorrencias) As Long
...
On Error GoTo Erro_Trata_Parametros
    ...
    If Not (objOcr Is Nothing) Then
        ...
        lErro = Traz_TRPOcorrencias_Tela(objOcr)
...
Function Move_Tela_Memoria(ByVal objOcr As ClassTRPOcorrencias) As Long

Dim lErro As Long
Dim objCliente As New ClassCliente
Dim objTRPOcrDet As ClassTRPOcorrenciaDet
...
On Error GoTo Erro_Move_Tela_Memoria
    ...
    objOcr.lCliente = objCliente.lCodigo
    objOcr.iFilialCliente = Codigo_Extrai(Filial.Text)
    objOcr.dtDataEmissao = StrParaDate(DataEmissao.Text)
    objOcr.dValorTotal = StrParaDbl(ValorTotal.Caption)
    objOcr.sObservacao = Observacao.Text
    objOcr.iOrigem = Codigo_Extrai(Origem.Text)
    objOcr.sHistorico = Historico.Text
    objOcr.iStatus = STATUS_TRP_OCR_BLOQUEADO
    objOcr.iFormaPagto = Codigo_Extrai(FormaPagto.Text)
    objOcr.lNumVou = StrParaLong(NumeroVou.Text)
    objOcr.sSerie = SerieVou.Text
    objOcr.sTipoDoc = TipoVou.Text
    objOcr.dValorOCRBrutoVou = StrParaDbl(ValorBrutoVouOCR.Text)
    objOcr.dValorOCRCMAVou = StrParaDbl(ValorCMAVouOCR.Text)
    ...
    For iLinha = 1 To objGridDet.iLinhasExistentes
        ...
        Set objTRPOcrDet = New ClassTRPOcorrenciaDet

        objTRPOcrDet.iTipo = Codigo_Extrai(GridDet.TextMatrix(iLinha, iGrid_Tipo_Col))
        objTRPOcrDet.iSeq = iLinha
        objTRPOcrDet.dValor = StrParaDbl(GridDet.TextMatrix(iLinha, iGrid_Valor_Col))
        
        objOcr.colDetalhamento.Add objTRPOcrDet
        
    Next
    
    If objOcr.iOrigem = INATIVACAO_AUTOMATICA_CODIGO Then
        If objVou.iStatus <> STATUS_TRP_VOU_CANCELADO Then gError 198092
    End If
...
On Error GoTo Erro_Tela_Preenche
    ...
    objOcr.lCodigo = colCampoValor.Item("Codigo").vValor

    If objOcr.lCodigo <> 0 Then
...
On Error GoTo Erro_Gravar_Registro
    ...
    'Preenche o objOcr
    lErro = Move_Tela_Memoria(objOcr)
    If lErro <> SUCESSO Then gError 190187
    
    If objOcr.colDetalhamento.Count = 0 Then gError 190181
    ...
    iLinha = 0
    For Each objTRPOcrDet In objOcr.colDetalhamento
        iLinha = iLinha + 1
        If objTRPOcrDet.iTipo = 0 Then gError 190182
        If objTRPOcrDet.dValor = 0 Then gError 190183
    Next

    lErro = Trata_Alteracao(objOcr, objOcr.lCodigo)
    If lErro <> SUCESSO Then gError 190184

    'Grava o/a TRPOcorrencias no Banco de Dados
    lErro = CF("TRPOcorrencias_Grava", objOcr)
...
Erro_Gravar_Registro:
    ...
    Select Case gErr
        ...
        Case 190177 'Origem
            Call Rotina_Erro(vbOKOnly, "ERRO_ORIGEM_NAO_PREENCHIDA_TRP", gErr)
            Origem.SetFocus
        ...
        Case 198086
            Call Rotina_Erro(vbOKOnly, "ERRO_TRPTIPOOCR_NAO_ACEITA_VLR_POSITIVO", gErr)

        Case 198087
            Call Rotina_Erro(vbOKOnly, "ERRO_TRPTIPOOCR_NAO_ACEITA_VLR_NEGATIVO", gErr)
...
Function Limpa_Tela_TRPOcorrencias() As Long

Dim lErro As Long

On Error GoTo Erro_Limpa_Tela_TRPOcorrencias
    ...
    Limpa_Tela_TRPOcorrencias = SUCESSO

    Exit Function

Erro_Limpa_Tela_TRPOcorrencias:

    Limpa_Tela_TRPOcorrencias = gErr
...
Function Traz_TRPOcorrencias_Tela(ByVal objOcr As ClassTRPOcorrencias) As Long
...
On Error GoTo Erro_Traz_TRPOcorrencias_Tela

    Call Limpa_Tela_TRPOcorrencias

    If objOcr.lCodigo <> 0 Then
        Codigo.PromptInclude = False
        Codigo.Text = CStr(objOcr.lCodigo)
        Codigo.PromptInclude = True
    End If

    If objOcr.dtDataEmissao <> DATA_NULA Then
        DataEmissao.PromptInclude = False
        DataEmissao.Text = Format(objOcr.dtDataEmissao, "dd/mm/yy")
        DataEmissao.PromptInclude = True
    End If
        
    NumeroVou.PromptInclude = False
    NumeroVou.Text = CStr(objOcr.lNumVou)
    NumeroVou.PromptInclude = True
    
    SerieVou.Text = objOcr.sSerie
    TipoVou.Text = objOcr.sTipoDoc
    
    If objOcr.lNumVou <> 0 Then Call TrazerVou_Click(False)
        
    'Lê o TRPOcorrencias que está sendo Passado
    lErro = CF("TRPOcorrencias_Le", objOcr)
    ...
    If lErro = SUCESSO Then
        ...
        Observacao.Text = objOcr.sObservacao
        
        Select Case objOcr.iStatus
        
            Case STATUS_TRP_OCR_BLOQUEADO
                Status.Caption = STATUS_TRP_OCR_BLOQUEADO_TEXTO
            
            Case STATUS_TRP_OCR_CANCELADO
                Status.Caption = STATUS_TRP_OCR_CANCELADO_TEXTO
        
            Case STATUS_TRP_OCR_FATURADO
                Status.Caption = STATUS_TRP_OCR_FATURADO_TEXTO
        
            Case STATUS_TRP_OCR_LIBERADO
                Status.Caption = STATUS_TRP_OCR_LIBERADO_TEXTO
        
        End Select
        
        Call Combo_Seleciona_ItemData(FormaPagto, objOcr.iFormaPagto)
...
'        objVoucher.sTipoDoc = TRP_TIPODOC_VOU_TEXTO
...
'        ClienteVou.Caption = Cliente.Text
'
        If objOcr.lCliente <> 0 Then Cliente.Text = CStr(objOcr.lCliente)
        Call Cliente_Validate(bSGECancelDummy)
'
'        ValorVou.Caption = Format(objVoucher.dvalor, "STANDARD")
'        DataEmissaoVou.Caption = Format(objVoucher.dtdata, "dd/mm/yyyy")
        
        If objOcr.iOrigem <> 0 Then Call Combo_Seleciona_ItemData(Origem, objOcr.iOrigem)

        Historico.Text = objOcr.sHistorico
        
        NumDocDestino.Caption = objOcr.lNumDocDestino
        ...
        For Each objTRPOcrDet In objOcr.colDetalhamento
            ...
            Call Combo_Seleciona_ItemData(Tipo, objTRPOcrDet.iTipo)
            
            GridDet.TextMatrix(iLinha, iGrid_Tipo_Col) = Tipo.Text
            GridDet.TextMatrix(iLinha, iGrid_Valor_Col) = Format(objTRPOcrDet.dValor, "STANDARD")
            
        Next
        
        objGridDet.iLinhasExistentes = objOcr.colDetalhamento.Count
    ...
    Traz_TRPOcorrencias_Tela = SUCESSO

    Exit Function

Erro_Traz_TRPOcorrencias_Tela:

    Traz_TRPOcorrencias_Tela = gErr
...
On Error GoTo Erro_BotaoExcluir_Click
    ...
    vbMsgRes = Rotina_Aviso(vbYesNo, "AVISO_CONFIRMA_EXCLUSAO_TRPOCORRENCIAS", objOcr.lCodigo)

    If vbMsgRes = vbYes Then

        'Exclui a requisição de consumo
        lErro = CF("TRPOcorrencias_Exclui", objOcr)
...
On Error GoTo Erro_Historico_Validate
    ...
    If Len(Trim(Historico.Text)) <> 0 Then
       ...
       If Len(Historico.Text) > STRING_TRP_OCR_HISTORICO Then gError 190222
...
Erro_Historico_Validate:
    ...
    Select Case gErr
        ...
        Case 190222
            Call Rotina_Erro(vbOKOnly, "ERRO_TAMANHO_HISTORICO", gErr, STRING_TRP_OCR_HISTORICO, Len(Historico.Text))
...
On Error GoTo Erro_objEventoCodigo_evSelecao
    ...
    'Mostra os dados do TRPOcorrencias na tela
    lErro = Traz_TRPOcorrencias_Tela(objOcr)
...
On Error GoTo Erro_LabelCodigo_Click
    ...
    If Len(Trim(Codigo.Text)) <> 0 Then
        ...
        objOcr.lCodigo = Codigo.Text

    End If

    Call Chama_Tela("TRPOcorrenciaLista", colSelecao, objOcr, objEventoCodigo)
...
On Error GoTo Erro_BotaoProxNum_Click
    ...
    lErro = CF("Config_ObterAutomatico", "FATConfig", "NUM_PROX_TRPOCORRENCIAS", "TRPOcorrencias", "Codigo", lCodigo)
...
On Error GoTo Erro_BotaoAbrirDoc_Click
    ...
    If Len(Trim(NumDocDestino.Caption)) <> 0 Then
        ...
        lErro = CF("Verifica_Existencia_Doc_TRP", objOcr.lNumIntDocDestino, objOcr.iTipoDocDestino, bExisteDestino, lNumTitulo, sDoc)
        If lErro <> SUCESSO Then gError 192871
        
        Select Case objOcr.iTipoDocDestino
        ...
        If Not (objObjeto Is Nothing) Then
            ...
            objObjeto.lNumIntDoc = objOcr.lNumIntDocDestino
...
Dim objInfo As ClassTRPVoucherInfo
Dim objVou As New ClassTRPVouchers
...
On Error GoTo Erro_OCR_Ajusta_Resumo
    ...
    If lErro = SUCESSO Then
        ...
        For Each objInfo In objVou.colTRPVoucherInfo
            If objInfo.sTipoDoc = TRP_TIPODOC_BRUTO_TEXTO Then
                dValorB = dValorB + objInfo.dValor
            End If
            If objInfo.sTipoDoc = TRP_TIPODOC_CMA_TEXTO Then
    ...
    Else
        ...
        If objTipo.iCodigo <> 0 Then
            ...
            dFator = 0
            If objTipo.iIncideSobre <> TRP_TIPO_OCR_INCIDE_CMA And objVou.dValorBruto > 0 Then
