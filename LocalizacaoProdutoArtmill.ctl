...
Begin VB.UserControl LocalizacaoProduto 
   ClientHeight    =   5625
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   6570
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   75
         Picture         =   "LocalizacaoProdutoArtmill.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   4
         ToolTipText     =   "Gravar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   570
         Picture         =   "LocalizacaoProdutoArtmill.ctx":015A
         Style           =   1  'Graphical
         TabIndex        =   3
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1065
         Picture         =   "LocalizacaoProdutoArtmill.ctx":068C
         Style           =   1  'Graphical
         TabIndex        =   2
         ToolTipText     =   "Fechar"
         Top             =   75
   ...
   End
End
Attribute VB_Name = "LocalizacaoProduto"
...
Erro_BotaoLimpar_Click:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error, 177311)
...
On Error GoTo Erro_BotaoSubstituir_Click
    ...
    If giCodigo = DOCINFO_NFISPC Or giCodigo = DOCINFO_NFFISPC Then
    ...
    ElseIf giCodigo = DOCINFO_NFISRMB3PV Then 'Incluido por Leo em 11/01/02
...
Erro_Form_Load:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 177312)
...
Erro_Item_Click:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 177313)
...
On Error GoTo Erro_Item_Click
    ...
    For Each objEstoqueProduto In colEstoqueProduto
        ...
        Select Case giCodigo
            ...
            Case DOCINFO_NFISBF, DOCINFO_NFISFBF, DOCINFO_NFISRMB3PV 'Por Leo em 15/01/02
...
Erro_Item_Click:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 177314)
...
Dim iIndice As Integer
    ...
    ElseIf giCodigo = DOCINFO_NFISRMB3PV Then 'inserido por Leo em 15/01/02
...
Erro_Trata_Parametros:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 177315)
...
Erro_Preenche_Tela:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 177316)
...
Erro_Saida_Celula:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 177317)
...
On Error GoTo Erro_Saida_Celula_QuantAlocada
    ...
    If Len(Trim(QuantAlocada.ClipText)) > 0 Then
        ...
        If dTotalAlocado > dQuantAlocar Then Error 39383
...
Erro_Saida_Celula_QuantAlocada:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 177318)
...
Erro_BotaoGravar_Click:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, 177319)
...
Erro_Gravar_Registro:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 177320)
...
On Error GoTo Erro_Move_Tela_Memoria
    ...
    Else
        ...
        Set objItemNF.colItensRomaneioGrade(Item.ListIndex + 1).colLocalizacao = New Collection
        ...
        If dQuantAlocada > 0 Then
            ...
            Else
                ...
                If giFilialEmpresa = 52 Then
                    objReservaItem.iFilialEmpresa = 51
                Else
...
Erro_Move_Tela_Memoria:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 177321)
    End Select
