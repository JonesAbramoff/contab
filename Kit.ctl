...
Private Sub PesoFator5_Validate(Cancel As Boolean)
    Call objCT.PesoFator5_Validate(Cancel)
End Sub

Private Sub PesoFator6_Validate(Cancel As Boolean)
    Call objCT.PesoFator6_Validate(Cancel)
End Sub

Private Sub Agua_Validate(Cancel As Boolean)
    Call objCT.Agua_Validate(Cancel)
End Sub

Private Sub BPF_Validate(Cancel As Boolean)
    Call objCT.BPF_Validate(Cancel)
End Sub

Private Sub Energia_Validate(Cancel As Boolean)
    Call objCT.Energia_Validate(Cancel)
End Sub

Private Sub MaoDeObra_Validate(Cancel As Boolean)
    Call objCT.MaoDeObra_Validate(Cancel)
End Sub
...
Private Sub PesoFator5_Change()
     Call objCT.PesoFator5_Change
End Sub

Private Sub PesoFator5_GotFocus()
     Call objCT.PesoFator5_GotFocus
End Sub

Private Sub PesoFator6_Change()
     Call objCT.PesoFator6_Change
End Sub

Private Sub PesoFator6_GotFocus()
     Call objCT.PesoFator6_GotFocus
End Sub
