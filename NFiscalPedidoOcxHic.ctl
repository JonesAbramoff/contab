...
Begin VB.UserControl NFiscalPedido 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton BotaoLimparNF 
            Height          =   300
            Left            =   5265
            Picture         =   "NFiscalPedidoOcxHic.ctx":0000
            Style           =   1  'Graphical
            TabIndex        =   4
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox ProdutoRastro 
            Height          =   315
            ItemData        =   "NFiscalPedidoOcxHic.ctx":0532
            Left            =   0
            List            =   "NFiscalPedidoOcxHic.ctx":053F
            Style           =   2  'Dropdown List
            TabIndex        =   174
            Top             =   0
            Width           =   1740
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Height          =   315
            ItemData        =   "NFiscalPedidoOcxHic.ctx":055E
            Left            =   3690
            List            =   "NFiscalPedidoOcxHic.ctx":056B
            Style           =   2  'Dropdown List
            TabIndex        =   142
            Top             =   270
            Width           =   1215
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame NFiscalOcx 
         ...
         Begin VB.CommandButton BotaoVendedores 
            ...
            Height          =   540
            Left            =   7680
            Picture         =   "NFiscalPedidoOcxHic.ctx":058A
            Style           =   1  'Graphical
            TabIndex        =   166
            Top             =   3285
            Width           =   1305
         ...
         Begin VB.ComboBox DiretoIndireto 
            Height          =   315
            ItemData        =   "NFiscalPedidoOcxHic.ctx":0B34
            Left            =   7080
            List            =   "NFiscalPedidoOcxHic.ctx":0B3E
            Style           =   2  'Dropdown List
            TabIndex        =   160
            Top             =   1560
            Width           =   1335
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   330
         Left            =   1349
         Picture         =   "NFiscalPedidoOcxHic.ctx":0B54
         Style           =   1  'Graphical
         TabIndex        =   158
         ToolTipText     =   "Excluir"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   330
         Left            =   2265
         Picture         =   "NFiscalPedidoOcxHic.ctx":0CDE
         Style           =   1  'Graphical
         TabIndex        =   157
         ToolTipText     =   "Fechar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   330
         Left            =   1806
         Picture         =   "NFiscalPedidoOcxHic.ctx":0E5C
         Style           =   1  'Graphical
         TabIndex        =   156
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   330
         Left            =   892
         Picture         =   "NFiscalPedidoOcxHic.ctx":138E
         Style           =   1  'Graphical
         TabIndex        =   155
         ToolTipText     =   "Gravar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoConsultaTitRec 
         ...
         Height          =   330
         Left            =   60
         Picture         =   "NFiscalPedidoOcxHic.ctx":14E8
         Style           =   1  'Graphical
         TabIndex        =   154
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.CommandButton BotaoPedido 
         Height          =   360
         Left            =   3810
         Picture         =   "NFiscalPedidoOcxHic.ctx":1D6A
         Style           =   1  'Graphical
         TabIndex        =   238
      ...
      Begin VB.CommandButton BotaoVerPedido 
         Height          =   360
         Left            =   4200
         Picture         =   "NFiscalPedidoOcxHic.ctx":213C
         Style           =   1  'Graphical
         TabIndex        =   237
