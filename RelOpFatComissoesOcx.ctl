...
Begin VB.UserControl RelOpFatComissoesOcx 
   ClientHeight    =   3630
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   8070
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "RelOpFatComissoesOcx.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   10
         ToolTipText     =   "Gravar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "RelOpFatComissoesOcx.ctx":015A
         Style           =   1  'Graphical
         TabIndex        =   11
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "RelOpFatComissoesOcx.ctx":02E4
         Style           =   1  'Graphical
         TabIndex        =   12
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "RelOpFatComissoesOcx.ctx":0816
         Style           =   1  'Graphical
         TabIndex        =   13
         ToolTipText     =   "Fechar"
         Top             =   90
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   600
      Left            =   5895
      Picture         =   "RelOpFatComissoesOcx.ctx":0994
      Style           =   1  'Graphical
      TabIndex        =   8
      Top             =   870
      Width           =   1815
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   315
      ItemData        =   "RelOpFatComissoesOcx.ctx":0A96
      Left            =   1485
      List            =   "RelOpFatComissoesOcx.ctx":0A98
      Sorted          =   -1  'True
      TabIndex        =   0
      Top             =   255
      Width           =   2730
   ...
   End
End
Attribute VB_Name = "RelOpFatComissoesOcx"
   ...
   If sVend_F <> "" Then
    ...
    If OpConsidera(0).Value = True Then
        ...
        If Trim(DataInicial.ClipText) <> "" Then
            ...
            If sExpressao <> "" Then sExpressao = sExpressao & " E "
            sExpressao = sExpressao & "(DataGeracao = DataNula OU DataGeracao >= " & Forprint_ConvData(CDate(DataInicial.Text)) & ")"
    ...
    If OpConsidera(2).Value = True Then
        ...
        If Trim(DataInicial.ClipText) <> "" Then
            ...
            If sExpressao <> "" Then sExpressao = sExpressao & " E "
            sExpressao = sExpressao & " ( DataBaixa >= " & Forprint_ConvData(CDate(DataInicial.Text)) & " OU (DataGeracao = DataNula OU DataGeracao >= " & Forprint_ConvData(CDate(DataInicial.Text)) & " )) "
        ...
        If Trim(DataFinal.ClipText) <> "" Then
            ...
            If sExpressao <> "" Then sExpressao = sExpressao & " E "
            sExpressao = sExpressao & " ( (DataBaixa <> DataNula E DataBaixa <= " & Forprint_ConvData(CDate(DataFinal.Text)) & ") OU ( DataGeracao <> DataNula E DataGeracao <= " & Forprint_ConvData(CDate(DataFinal.Text)) & " )) "
