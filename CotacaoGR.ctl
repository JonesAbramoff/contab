...
Begin VB.UserControl Cotacao 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox ComboJustificativa 
            Height          =   315
            ItemData        =   "CotacaoGR.ctx":0000
            Left            =   6120
            List            =   "CotacaoGR.ctx":0002
         ...
         Begin VB.ComboBox ComboSituacaoResultado 
            Height          =   315
            ItemData        =   "CotacaoGR.ctx":0004
            Left            =   1860
            List            =   "CotacaoGR.ctx":0011
            Style           =   2  'Dropdown List
            TabIndex        =   44
            Top             =   225
            Width           =   1740
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox ComboCarga 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "CotacaoGR.ctx":0030
         Left            =   2265
         List            =   "CotacaoGR.ctx":003A
         Style           =   2  'Dropdown List
         TabIndex        =   85
         Top             =   600
         Width           =   1620
      ...
      Begin VB.ComboBox ComboOva 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "CotacaoGR.ctx":0062
         Left            =   2265
         List            =   "CotacaoGR.ctx":006C
         Style           =   2  'Dropdown List
         TabIndex        =   84
         Top             =   1050
         Width           =   1620
      ...
      Begin VB.Frame FrameTipoConteiner 
         ...
         Begin VB.ComboBox ComboTipoContainer 
            Height          =   315
            ItemData        =   "CotacaoGR.ctx":0094
            Left            =   645
            List            =   "CotacaoGR.ctx":0096
            Style           =   2  'Dropdown List
            TabIndex        =   89
            Top             =   735
            Width           =   4590
      ...
      Begin VB.ComboBox ComboDesova 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "CotacaoGR.ctx":0098
         Left            =   6375
         List            =   "CotacaoGR.ctx":00A2
         Style           =   2  'Dropdown List
         TabIndex        =   28
         Top             =   1050
         Width           =   1605
      ...
      Begin VB.ComboBox ComboDescarga 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "CotacaoGR.ctx":00CA
         Left            =   6375
         List            =   "CotacaoGR.ctx":00D4
         Style           =   2  'Dropdown List
         TabIndex        =   27
         Top             =   600
         Width           =   1605
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.Frame Frame2 
            ...
            Begin VB.ComboBox ComboEnvioCotacao 
               Height          =   315
               ItemData        =   "CotacaoGR.ctx":00FC
               Left            =   840
               List            =   "CotacaoGR.ctx":010C
               Sorted          =   -1  'True
               Style           =   2  'Dropdown List
               TabIndex        =   12
               Top             =   270
      ...
      Begin VB.ComboBox ComboTipoOperacao 
         Height          =   315
         ItemData        =   "CotacaoGR.ctx":012E
         Left            =   5280
         List            =   "CotacaoGR.ctx":013B
         Style           =   2  'Dropdown List
         TabIndex        =   4
         Top             =   120
         Width           =   1560
...
On Error GoTo Erro_Form_Load
    ...
    For iIndiceFrame = TAB_Servico To TAB_CondComerciais
...
On Error GoTo TP_OrigemDestino_Le
    ...
    Case TIPO_STRING
        ...
        If Len(Trim(sUF)) <> 0 And Len(Trim(sOrigemDestino)) = 0 Then
        
            objOrigemDestino.sUF = sUF
            
            lErro = CF("OrigemDestino_Le_UF", objOrigemDestino)
            If lErro <> SUCESSO And lErro <> 99277 Then gError 99272
            
            'Não existe UF
            If lErro = 99277 Then gError 99273
                        
        ElseIf Len(Trim(sUF)) <> 0 Then
...
TP_OrigemDestino_Le:
    ...
    Select Case gErr
        ...
        Case 99230, 99232, 99253, 99255, 99272 'Tratados nas rotinas chamadas
        ...
        Case 99256
            ...
            lErro = Rotina_Aviso(vbYesNo, "AVISO_CRIAR_ORIGEMDESTINO_UF", objOrigemDestino.iCodigo, objOrigemDestino.sUF)
                ...
                End If
        Case 99273
            lErro = Rotina_Erro(vbOKOnly, "ERRO_ORIGEMDESTINO_UF", gErr, objOrigemDestino.sUF)
...
On Error GoTo Erro_Gravar_Registro
    ...
    'Verifica se a origem e o destino são compatíveis
    For iIndex = 1 To objGridServicos.iLinhasExistentes
        If Len(Trim(GridServicos.TextMatrix(iIndex, iGrid_OrigemServ_Col))) <> 0 Or Len(Trim(GridServicos.TextMatrix(iIndex, iGrid_UFOrigemServ_Col))) <> 0 Then
            lErro = TP_OrigemDestino_Le(objOrigemDestino, GridServicos.TextMatrix(iIndex, iGrid_OrigemServ_Col), GridServicos.TextMatrix(iIndex, iGrid_UFOrigemServ_Col))
            If lErro <> SUCESSO Then gError 99268
        End If
        If Len(Trim(GridServicos.TextMatrix(iIndex, iGrid_DestinoServ_Col))) <> 0 Or Len(Trim(GridServicos.TextMatrix(iIndex, iGrid_UFDestinoServ_Col))) <> 0 Then
            lErro = TP_OrigemDestino_Le(objOrigemDestino, GridServicos.TextMatrix(iIndex, iGrid_DestinoServ_Col), GridServicos.TextMatrix(iIndex, iGrid_UFDestinoServ_Col))
            If lErro <> SUCESSO Then gError 99269
        End If
    Next
...
Erro_Gravar_Registro:
    ...
    Select Case gErr
        ...
        Case 97211, 97216, 98754, 99268, 99269
...
On Error GoTo Erro_BotaoImprimir_Click
    ...
    'Verifica se Codigo foi preenchido
    If Len(Trim(MaskCodigo.ClipText)) = 0 Then gError 99299

    'Capturando a chave primaria
    objCotacao.lCodigo = MaskCodigo.ClipText
    objCotacao.iFilialEmpresa = giFilialEmpresa

    'Le a cotacao com a chave capturada anteriormente
    lErro = CF("Cotacao_LeGR", objCotacao)
    If lErro <> SUCESSO And lErro <> 97170 Then gError 97375

    If lErro <> SUCESSO Then gError 97376

    lErro = objRelatorio.ExecutarDireto("Proposta de Cotação", "", 1, "", "NCODCOTACAO", objCotacao.lCodigo)
    If lErro <> SUCESSO Then gError 97377
...
On Error GoTo Erro_Saida_Celula_UFOrigemServ
    ...
    If Len(Trim(UFOrigem.Text)) > 0 And Len(Trim(GridServicos.TextMatrix(GridServicos.Row, iGrid_OrigemServ_Col))) > 0 Then
    ...
    ElseIf Len(Trim(UFOrigem.Text)) > 0 Then
        lErro = TP_OrigemDestino_Le(objOrigemDestino, GridServicos.TextMatrix(GridServicos.Row, iGrid_OrigemServ_Col), UFOrigem.Text)
        If lErro <> SUCESSO Then gError 99271
    End If
...
On Error GoTo Erro_Saida_Celula_UFDestinoServ
    ...
    If Len(Trim(UFDestino.Text)) > 0 And Len(Trim(GridServicos.TextMatrix(GridServicos.Row, iGrid_DestinoServ_Col))) > 0 Then
    ...
    ElseIf Len(Trim(UFDestino.Text)) > 0 Then
        lErro = TP_OrigemDestino_Le(objOrigemDestino, GridServicos.TextMatrix(GridServicos.Row, iGrid_DestinoServ_Col), UFDestino.Text)
        If lErro <> SUCESSO Then gError 99270
    End If
...
On Error GoTo Erro_objEventoDestino_evSelecao
    ...
    If Me.ActiveControl Is Destino Then
        Destino.Text = objOrigemDestino.sOrigemDestino
    Else
        GridServicos.TextMatrix(GridServicos.Row, iGrid_DestinoServ_Col) = objOrigemDestino.sOrigemDestino
    End If
    GridServicos.TextMatrix(GridServicos.Row, iGrid_UFDestinoServ_Col) = objOrigemDestino.sUF
...
On Error GoTo Erro_objEventoOrigem_evSelecao
    ...
    If Me.ActiveControl Is Origem Then
        Origem.Text = objOrigemDestino.sOrigemDestino
    Else
        GridServicos.TextMatrix(GridServicos.Row, iGrid_OrigemServ_Col) = objOrigemDestino.sOrigemDestino
    End If
    GridServicos.TextMatrix(GridServicos.Row, iGrid_UFOrigemServ_Col) = objOrigemDestino.sUF
