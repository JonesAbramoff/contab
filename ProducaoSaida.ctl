...
Begin VB.UserControl ProducaoSaida 
   ClientHeight    =   6000
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9525
   ...
   Begin VB.Frame Frame1 
      ...
      Top             =   795
      Width           =   9375
      Begin VB.CommandButton BotaoRatear 
         Caption         =   "Ratear"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
      ...
      Begin VB.ComboBox Benef 
         Height          =   315
         ItemData        =   "ProducaoSaida.ctx":0000
         Left            =   4905
         List            =   "ProducaoSaida.ctx":000D
      ...
      Begin VB.Frame Frame2 
         Caption         =   "Geração Automática de Requisições"
         Height          =   945
         Left            =   45
         TabIndex        =   13
         Top             =   1005
         Width           =   9285
         Begin VB.CommandButton BotaoGerarReqRateio 
            Caption         =   "Gerar p/ Rateio"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
         ...
         Begin VB.CommandButton BotaoGeraReq 
            ...
            Width           =   1200
         End
         Begin VB.CheckBox IgnorarReqProdAnt 
            Caption         =   "Ignorar as requisições de produção já cadastradas no cálculo de necessidade"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
      ...
      Begin VB.CommandButton BotaoProxNum 
         Height          =   285
         Left            =   2595
         Picture         =   "ProducaoSaida.ctx":0032
         Style           =   1  'Graphical
         TabIndex        =   3
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "ProducaoSaida.ctx":011C
         Style           =   1  'Graphical
         TabIndex        =   99
         ToolTipText     =   "Excluir"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "ProducaoSaida.ctx":02A6
         Style           =   1  'Graphical
         TabIndex        =   98
         ToolTipText     =   "Fechar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "ProducaoSaida.ctx":0424
         Style           =   1  'Graphical
         TabIndex        =   97
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "ProducaoSaida.ctx":0956
         Style           =   1  'Graphical
         TabIndex        =   96
         ToolTipText     =   "Gravar"
         Top             =   75
   ...
   End
End
Attribute VB_Name = "ProducaoSaida"
...
Private WithEvents objCT As CTProducaoSaida
Attribute objCT.VB_VarHelpID = -1

Private Sub UserControl_Initialize()
    Set objCT = New CTProducaoSaida
...
Private Sub BotaoRatear_Click()
     Call objCT.BotaoRatear_Click
End Sub

Private Sub BotaoGerarReqRateio_Click()
     Call objCT.BotaoGerarReqRateio_Click
End Sub
