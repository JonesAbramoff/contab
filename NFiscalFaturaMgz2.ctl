...
Begin VB.UserControl NFiscalFatura 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox TabPrecoItemNF 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "NFiscalFaturaMgz2.ctx":0000
            Left            =   3810
            List            =   "NFiscalFaturaMgz2.ctx":0002
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame4 
         ...
         Begin VB.CommandButton BotaoDataReferenciaDown 
            Height          =   150
            Left            =   3000
            Picture         =   "NFiscalFaturaMgz2.ctx":0004
            Style           =   1  'Graphical
            TabIndex        =   200
            TabStop         =   0   'False
            Top             =   780
         ...
         Begin VB.ComboBox Desconto1Codigo 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "NFiscalFaturaMgz2.ctx":005E
            Left            =   3120
            List            =   "NFiscalFaturaMgz2.ctx":0060
            TabIndex        =   197
            Top             =   1140
            Width           =   1860
         End
         Begin VB.CommandButton BotaoDataReferenciaUp 
            Height          =   150
            Left            =   3000
            Picture         =   "NFiscalFaturaMgz2.ctx":0062
            Style           =   1  'Graphical
            TabIndex        =   196
            TabStop         =   0   'False
            Top             =   630
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   21
         Left            =   3315
         Picture         =   "NFiscalFaturaMgz2.ctx":00BC
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   22
         Left            =   3690
         Picture         =   "NFiscalFaturaMgz2.ctx":048E
         Style           =   1  'Graphical
         TabIndex        =   7
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox TipoNFiscal 
            Height          =   315
            ItemData        =   "NFiscalFaturaMgz2.ctx":07A0
            Left            =   1995
            List            =   "NFiscalFaturaMgz2.ctx":07A2
            TabIndex        =   11
            Top             =   150
            Width           =   2835
         End
         Begin VB.CommandButton Botao 
            ...
            Index           =   20
            Left            =   5070
            Picture         =   "NFiscalFaturaMgz2.ctx":07A4
            Style           =   1  'Graphical
            TabIndex        =   78
   ...
   Begin VB.Frame Frame1 
      ...
      Visible         =   0   'False
      Width           =   9225
      Begin TelasFATMgz.TabTributacaoFat TabTrib 
         Height          =   4545
         Left            =   60
         TabIndex        =   263
         Top             =   60
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Height          =   315
            ItemData        =   "NFiscalFaturaMgz2.ctx":0CD6
            Left            =   3690
            List            =   "NFiscalFaturaMgz2.ctx":0CE3
            Style           =   2  'Dropdown List
            TabIndex        =   181
            Top             =   255
            Width           =   1215
         ...
         Begin VB.ComboBox ProdutoRastro 
            Height          =   315
            ItemData        =   "NFiscalFaturaMgz2.ctx":0D02
            Left            =   1740
            List            =   "NFiscalFaturaMgz2.ctx":0D0F
            Style           =   2  'Dropdown List
            TabIndex        =   180
            Top             =   1320
            Width           =   1740
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame4 
         ...
         Begin VB.CommandButton BotaoVendedores 
            ...
            Height          =   615
            Left            =   6960
            Picture         =   "NFiscalFaturaMgz2.ctx":0D2E
            Style           =   1  'Graphical
            TabIndex        =   219
            Top             =   3300
            Width           =   1815
         ...
         Begin VB.ComboBox DiretoIndireto 
            Height          =   315
            ItemData        =   "NFiscalFaturaMgz2.ctx":12D8
            Left            =   6360
            List            =   "NFiscalFaturaMgz2.ctx":12E2
            Style           =   2  'Dropdown List
            TabIndex        =   218
            Top             =   1320
            Width           =   1335
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   0
         Left            =   3915
         Picture         =   "NFiscalFaturaMgz2.ctx":12F8
         Style           =   1  'Graphical
         TabIndex        =   2
         ToolTipText     =   "Trazer Dados"
         Top             =   210
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   1
         Left            =   4305
         Picture         =   "NFiscalFaturaMgz2.ctx":16CA
         Style           =   1  'Graphical
         TabIndex        =   3
         ToolTipText     =   "Trazer a tela de cadastro"
         Top             =   210
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   4
         Left            =   1380
         Picture         =   "NFiscalFaturaMgz2.ctx":19DC
         Style           =   1  'Graphical
         TabIndex        =   254
         ToolTipText     =   "Excluir"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   6
         Left            =   2310
         Picture         =   "NFiscalFaturaMgz2.ctx":1B66
         Style           =   1  'Graphical
         TabIndex        =   253
         ToolTipText     =   "Fechar"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   5
         Left            =   1845
         Picture         =   "NFiscalFaturaMgz2.ctx":1CE4
         Style           =   1  'Graphical
         TabIndex        =   252
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   3
         Left            =   915
         Picture         =   "NFiscalFaturaMgz2.ctx":2216
         Style           =   1  'Graphical
         TabIndex        =   251
         ToolTipText     =   "Gravar"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   2
         Left            =   75
         Picture         =   "NFiscalFaturaMgz2.ctx":2370
         Style           =   1  'Graphical
         TabIndex        =   250
