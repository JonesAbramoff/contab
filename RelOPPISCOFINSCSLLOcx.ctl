...
Begin VB.UserControl RelOPPISCOFINSCSLLOcx 
   ClientHeight    =   1560
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   6630
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   600
      Left            =   4470
      Picture         =   "RelOPPISCOFINSCSLLOcx.ctx":0000
      Style           =   1  'Graphical
      TabIndex        =   13
      Top             =   780
      Width           =   1815
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   315
      ItemData        =   "RelOPPISCOFINSCSLLOcx.ctx":0102
      Left            =   975
      List            =   "RelOPPISCOFINSCSLLOcx.ctx":0104
      Sorted          =   -1  'True
      TabIndex        =   12
      Top             =   150
      Width           =   2730
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "RelOPPISCOFINSCSLLOcx.ctx":0106
         Style           =   1  'Graphical
         TabIndex        =   4
         ToolTipText     =   "Fechar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "RelOPPISCOFINSCSLLOcx.ctx":0284
         Style           =   1  'Graphical
         TabIndex        =   3
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "RelOPPISCOFINSCSLLOcx.ctx":07B6
         Style           =   1  'Graphical
         TabIndex        =   2
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "RelOPPISCOFINSCSLLOcx.ctx":0940
         Style           =   1  'Graphical
         TabIndex        =   1
         ToolTipText     =   "Gravar"
         Top             =   90
   ...
   End
End
Attribute VB_Name = "RelOPPISCOFINSCSLLOcx"
...
Erro_Form_Load:
   ...
   lErro_Chama_Tela = Err
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 171152)
...
On Error GoTo Erro_Define_Padrao
    ...
    If Day(gdtDataAtual) > 15 Then
    
        dtDataInicial = StrParaDate("01/" & Format(Month(gdtDataAtual), "00") & "/" & Format(Year(gdtDataAtual), "0000"))
        dtDataFinal = dtDataInicial + 14
        
    Else
    
        If Month(gdtDataAtual) = 1 Then
            dtDataInicial = StrParaDate("16/12/" & Year(gdtDataAtual))
            dtDataFinal = dtDataInicial + 15
        Else
            dtDataFinal = StrParaDate("01/" & Format(Month(gdtDataAtual), "00") & "/" & Format(Year(gdtDataAtual), "0000")) - 1
            dtDataInicial = StrParaDate("16/" & Format(Month(gdtDataAtual) - 1, "00") & "/" & Year(gdtDataAtual))
        End If
...
Erro_Define_Padrao:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 171153)
...
Erro_Trata_Parametros:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 171154)
...
Erro_BotaoLimpar_Click:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 171155)
...
Erro_BotaoGravar_Click:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 171156)
...
Erro_BotaoExcluir_Click:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 171157)
...
Erro_BotaoExecutar_Click:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 171158)
...
Erro_PreencherRelOp:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 171159)
...
Erro_Formata_E_Critica_Parametros:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 171160)
...
Erro_Monta_Expressao_Selecao:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 171161)
...
Erro_PreencherParametrosNaTela:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 171162)
...
Erro_DataFinal_Validate:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 171163)
...
Erro_DataInicial_Validate:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 171164)
...
Erro_AteUpDown_DownClick:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 171165)
...
Erro_AteUpDown_UpClick:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 171166)
...
Erro_DeUpDown_DownClick:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 171167)
...
Erro_DeUpDown_UpClick:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 171168)
...
Public Function Form_Load_Ocx() As Object
    ...
    Caption = "Relatório para Recolhimento de PIS,COFINS,CSLL"
    Call Form_Load
