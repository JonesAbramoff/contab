...
Begin VB.UserControl ChequePagAvulso3Ocx 
   ClientHeight    =   3450
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   5700
   ...
   Begin VB.PictureBox Picture7 
      ...
      Begin VB.CommandButton BotaoVoltar 
         Height          =   345
         Left            =   90
         Picture         =   "ChequePagAvulso3Ocx.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   90
         Width           =   930
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   345
         Left            =   2115
         Picture         =   "ChequePagAvulso3Ocx.ctx":075E
         Style           =   1  'Graphical
         TabIndex        =   6
         ToolTipText     =   "Fechar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoSeguir 
         Height          =   345
         Left            =   1102
         Picture         =   "ChequePagAvulso3Ocx.ctx":08DC
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   90
         Width           =   930
   ...
   Begin VB.CommandButton ConfigurarImpressao 
      ...
      Height          =   720
      Left            =   473
      Picture         =   "ChequePagAvulso3Ocx.ctx":106E
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   1980
      Width           =   2280
   ...
   Begin VB.CommandButton Imprimir 
      ...
      Height          =   720
      Left            =   2948
      Picture         =   "ChequePagAvulso3Ocx.ctx":1C10
      Style           =   1  'Graphical
      TabIndex        =   8
      Top             =   1980
      Width           =   2280
   ...
   End
End
Attribute VB_Name = "ChequePagAvulso3Ocx"
