...
Begin VB.UserControl RelOpMotivoDifPrecoOcx 
   ClientHeight    =   2595
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   8025
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   315
      ItemData        =   "RelOpMotivoDifPrecoOcx.ctx":0000
      Left            =   1455
      List            =   "RelOpMotivoDifPrecoOcx.ctx":0002
      Sorted          =   -1  'True
      TabIndex        =   18
      Top             =   135
      Width           =   2730
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   600
      Left            =   5865
      Picture         =   "RelOpMotivoDifPrecoOcx.ctx":0004
      Style           =   1  'Graphical
      TabIndex        =   17
      Top             =   750
      Width           =   1815
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "RelOpMotivoDifPrecoOcx.ctx":0106
         Style           =   1  'Graphical
         TabIndex        =   4
         ToolTipText     =   "Fechar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "RelOpMotivoDifPrecoOcx.ctx":0284
         Style           =   1  'Graphical
         TabIndex        =   3
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "RelOpMotivoDifPrecoOcx.ctx":07B6
         Style           =   1  'Graphical
         TabIndex        =   2
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "RelOpMotivoDifPrecoOcx.ctx":0940
         Style           =   1  'Graphical
         TabIndex        =   1
         ToolTipText     =   "Gravar"
         Top             =   90
   ...
   End
End
Attribute VB_Name = "RelOpMotivoDifPrecoOcx"
...
Public Function Form_Load_Ocx() As Object
    ...
    Caption = "Motivo Diferença de Preço"
    Call Form_Load
