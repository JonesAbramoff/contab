...
' Outputs:  None
'----------------------------------------------------------------------
Private Sub ctlFocus_Validate(Cancel As Boolean)
    'draw a focus rect where the last focus area was
    'drawing a focus rect twice removes it
    DrawFocusRect UserControl.hdc, mrcFocusArea
End Sub 'ctlFocus_Validate(Cancel As Boolean)
...
Private Sub txtYear_Validate(Cancel As Boolean)
    ...
    End If
End Sub 'txtYear_Validate(Cancel As Boolean)
