VERSION 5.00
Begin VB.UserControl RelOpBalPatrPerOcx 
   ClientHeight    =   2280
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   6255
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "RelOpBalPatrPerOcx.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   7
         ToolTipText     =   "Gravar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "RelOpBalPatrPerOcx.ctx":015A
         Style           =   1  'Graphical
         TabIndex        =   8
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "RelOpBalPatrPerOcx.ctx":02E4
         Style           =   1  'Graphical
         TabIndex        =   9
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "RelOpBalPatrPerOcx.ctx":0816
         Style           =   1  'Graphical
         TabIndex        =   10
         ToolTipText     =   "Fechar"
         Top             =   90
   ...
   Begin VB.ComboBox ComboPeriodo 
      Height          =   315
      ItemData        =   "RelOpBalPatrPerOcx.ctx":0994
      Left            =   1035
      List            =   "RelOpBalPatrPerOcx.ctx":0996
   ...
   Begin VB.ComboBox ComboExercicio 
      Height          =   315
      ItemData        =   "RelOpBalPatrPerOcx.ctx":0998
      Left            =   1035
      List            =   "RelOpBalPatrPerOcx.ctx":099A
      Style           =   2  'Dropdown List
      TabIndex        =   1
      Top             =   765
      Width           =   1860
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   315
      ItemData        =   "RelOpBalPatrPerOcx.ctx":099C
      Left            =   1035
      List            =   "RelOpBalPatrPerOcx.ctx":099E
      Sorted          =   -1  'True
      TabIndex        =   0
      Top             =   240
      Width           =   2655
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   600
      Left            =   4035
      Picture         =   "RelOpBalPatrPerOcx.ctx":09A0
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   900
      Width           =   1815
   ...
   End
End
Attribute VB_Name = "RelOpBalPatrPerOcx"
...
Public Function Form_Load_Ocx() As Object
    ...
    Caption = "Balanço Patrimonial no Periodo"
    Call Form_Load
