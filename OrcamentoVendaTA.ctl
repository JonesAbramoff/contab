...
Begin VB.UserControl OrcamentoVenda 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox Moeda 
            Height          =   315
            ItemData        =   "OrcamentoVendaTA.ctx":0000
            Left            =   1230
            List            =   "OrcamentoVendaTA.ctx":0002
         ...
         Begin VB.ComboBox StatusComercial 
            Height          =   315
            ItemData        =   "OrcamentoVendaTA.ctx":0004
            Left            =   7035
            List            =   "OrcamentoVendaTA.ctx":0017
            TabIndex        =   9
            Top             =   165
            Width           =   2295
         End
         Begin VB.ComboBox Idioma 
            Height          =   315
            ItemData        =   "OrcamentoVendaTA.ctx":004F
            Left            =   3750
            List            =   "OrcamentoVendaTA.ctx":0051
            Style           =   2  'Dropdown List
            TabIndex        =   11
            Top             =   525
            Width           =   1935
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton BotaoProxNum 
            Height          =   285
            Left            =   2190
            Picture         =   "OrcamentoVendaTA.ctx":0053
            Style           =   1  'Graphical
            TabIndex        =   75
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.ComboBox Status 
            Height          =   315
            ItemData        =   "OrcamentoVendaTA.ctx":013D
            Left            =   1245
            List            =   "OrcamentoVendaTA.ctx":013F
            Style           =   2  'Dropdown List
            TabIndex        =   17
            Top             =   465
            Width           =   3255
         ...
         Begin MSMask.MaskEdBox DataProxContato 
            ...
            PromptChar      =   " "
         End
         Begin MSMask.MaskEdBox PercParticVend2 
            Height          =   315
            Left            =   6345
            TabIndex        =   15
            Top             =   150
      ...
      Begin VB.Frame Frame9 
         ...
         Begin VB.Frame FrameDataPrazoEnt 
            ...
            Begin VB.ComboBox PrazoEntVar 
               Height          =   315
               ItemData        =   "OrcamentoVendaTA.ctx":0141
               Left            =   1245
               List            =   "OrcamentoVendaTA.ctx":0151
               Style           =   2  'Dropdown List
               TabIndex        =   26
               Top             =   0
               Width           =   1320
         ...
         Begin VB.Frame FrameDataPrazoEnt 
            ...
            Begin VB.ComboBox PrazoTexto 
               Height          =   315
               ItemData        =   "OrcamentoVendaTA.ctx":0180
               Left            =   555
               List            =   "OrcamentoVendaTA.ctx":0182
               TabIndex        =   29
               Top             =   15
               Width           =   3360
            End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Top             =   -30
         Width           =   9525
         Begin MSMask.MaskEdBox Acrescimo 
            Height          =   225
            Left            =   2115
            TabIndex        =   259
            Top             =   2760
         ...
         Begin VB.CommandButton BotaoSobe 
            Height          =   195
            Left            =   75
            Picture         =   "OrcamentoVendaTA.ctx":0184
            Style           =   1  'Graphical
            TabIndex        =   252
            Top             =   270
            Visible         =   0   'False
         ...
         Begin VB.CommandButton BotaoDesce 
            Height          =   195
            Left            =   270
            Picture         =   "OrcamentoVendaTA.ctx":0346
            Style           =   1  'Graphical
            TabIndex        =   251
            Top             =   270
            Visible         =   0   'False
         ...
         Begin MSMask.MaskEdBox PrecoBase 
            ...
            PromptChar      =   " "
         End
         Begin MSMask.MaskEdBox PercAcresc 
            Height          =   225
            Left            =   735
            TabIndex        =   247
            Top             =   2880
         ...
         Begin VB.ComboBox UnidadeMed 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "OrcamentoVendaTA.ctx":0508
            Left            =   2775
            List            =   "OrcamentoVendaTA.ctx":050A
            Style           =   2  'Dropdown List
            TabIndex        =   132
            Top             =   1875
            Width           =   720
      ...
      Begin VB.Frame Frame2 
         ...
         Top             =   3705
         Width           =   9525
         Begin VB.CommandButton BotaoComparar 
            Caption         =   "Comparar Preços"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
         ...
         Begin MSMask.MaskEdBox ValorDescontoItens 
            ...
            PromptChar      =   " "
         End
         Begin MSMask.MaskEdBox PercAcrescimoItens 
            Height          =   285
            Left            =   4215
            TabIndex        =   93
            ToolTipText     =   "Percentual de acréscimo dos itens"
            Top             =   915
            Width           =   1140
            _ExtentX        =   2011
            _ExtentY        =   503
            ...
            PromptChar      =   " "
         End
         Begin MSMask.MaskEdBox ValorAcrescimoItens 
            Height          =   285
            Left            =   5595
            TabIndex        =   94
            ToolTipText     =   "Soma dos acréscimo dos itens"
            Top             =   915
            Width           =   1140
            _ExtentX        =   2011
            _ExtentY        =   503
         ...
         Begin VB.Label Label1 
            ...
            Width           =   1125
         End
         Begin VB.Label ValorVariacaoItens 
            BorderStyle     =   1  'Fixed Single
            Height          =   285
            Left            =   5610
            TabIndex        =   265
         ...
         Begin VB.Label Label1 
            ...
            Width           =   1125
         End
         Begin VB.Label PercVariacaoItens 
            BorderStyle     =   1  'Fixed Single
            Height          =   285
            Left            =   4200
            TabIndex        =   263
   ...
   Begin VB.Frame Frame1 
      ...
      Visible         =   0   'False
      Width           =   9510
      Begin TelasFATTA.TabTributacaoFat TabTrib 
         Height          =   4590
         Left            =   225
         TabIndex        =   235
         Top             =   45
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoImprimir 
         Height          =   345
         Left            =   579
         Picture         =   "OrcamentoVendaTA.ctx":050C
         Style           =   1  'Graphical
         TabIndex        =   244
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   345
         Left            =   1098
         Picture         =   "OrcamentoVendaTA.ctx":060E
         Style           =   1  'Graphical
         TabIndex        =   243
         ToolTipText     =   "Gravar"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   345
         Left            =   1617
         Picture         =   "OrcamentoVendaTA.ctx":0768
         Style           =   1  'Graphical
         TabIndex        =   242
         ToolTipText     =   "Excluir"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   345
         Left            =   2136
         Picture         =   "OrcamentoVendaTA.ctx":08F2
         Style           =   1  'Graphical
         TabIndex        =   241
         ToolTipText     =   "Limpar"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   345
         Left            =   2655
         Picture         =   "OrcamentoVendaTA.ctx":0E24
         Style           =   1  'Graphical
         TabIndex        =   240
         ToolTipText     =   "Fechar"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoEmail 
         Height          =   345
         Left            =   60
         Picture         =   "OrcamentoVendaTA.ctx":0FA2
         Style           =   1  'Graphical
         TabIndex        =   239
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame6 
         ...
         Begin VB.ComboBox PCUnidMed 
            ...
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "OrcamentoVendaTA.ctx":1944
            Left            =   3315
            List            =   "OrcamentoVendaTA.ctx":1946
            Style           =   2  'Dropdown List
            TabIndex        =   231
            Top             =   360
            Width           =   720
         ...
         Begin VB.ComboBox PCSituacao 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "OrcamentoVendaTA.ctx":1948
            Left            =   6345
            List            =   "OrcamentoVendaTA.ctx":1958
            Style           =   2  'Dropdown List
            TabIndex        =   225
            Top             =   1125
            Width           =   1155
      ...
      Begin VB.Frame Frame7 
         ...
         Begin VB.ComboBox FPSituacao 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "OrcamentoVendaTA.ctx":1979
            Left            =   5880
            List            =   "OrcamentoVendaTA.ctx":1989
            Style           =   2  'Dropdown List
            TabIndex        =   219
            Top             =   1650
            Width           =   1155
         ...
         Begin VB.ComboBox FPUnidMed 
            ...
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "OrcamentoVendaTA.ctx":19AA
            Left            =   645
            List            =   "OrcamentoVendaTA.ctx":19AC
            Style           =   2  'Dropdown List
            TabIndex        =   216
            Top             =   1110
            Width           =   720
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame3 
         ...
         Begin VB.CommandButton BotaoDataReferenciaUp 
            Height          =   150
            Left            =   3045
            Picture         =   "OrcamentoVendaTA.ctx":19AE
            Style           =   1  'Graphical
            TabIndex        =   184
            TabStop         =   0   'False
            Top             =   690
         ...
         Begin VB.CommandButton BotaoDataReferenciaDown 
            Height          =   150
            Left            =   3045
            Picture         =   "OrcamentoVendaTA.ctx":1A08
            Style           =   1  'Graphical
            TabIndex        =   183
            TabStop         =   0   'False
            Top             =   825
...
Private Sub UserControl_Initialize()
    ...
    Set objCT.gobjInfoUsu = New CTOrcVendaVGTA
    Set objCT.gobjInfoUsu.gobjTelaUsu = New CTOrcamentoVendaTA
...
Private Sub PrecoBase_Change()
     Call objCT.gobjInfoUsu.gobjTelaUsu.PrecoBase_Change(objCT)
End Sub

Private Sub PrecoBase_GotFocus()
     Call objCT.gobjInfoUsu.gobjTelaUsu.PrecoBase_GotFocus(objCT)
End Sub

Private Sub PrecoBase_KeyPress(KeyAscii As Integer)
     Call objCT.gobjInfoUsu.gobjTelaUsu.PrecoBase_KeyPress(objCT, KeyAscii)
End Sub

Private Sub PrecoBase_Validate(Cancel As Boolean)
     Call objCT.gobjInfoUsu.gobjTelaUsu.PrecoBase_Validate(objCT, Cancel)
End Sub

Private Sub PercAcresc_Change()
     Call objCT.gobjInfoUsu.gobjTelaUsu.PercAcresc_Change(objCT)
End Sub

Private Sub PercAcresc_GotFocus()
     Call objCT.gobjInfoUsu.gobjTelaUsu.PercAcresc_GotFocus(objCT)
End Sub

Private Sub PercAcresc_KeyPress(KeyAscii As Integer)
     Call objCT.gobjInfoUsu.gobjTelaUsu.PercAcresc_KeyPress(objCT, KeyAscii)
End Sub

Private Sub PercAcresc_Validate(Cancel As Boolean)
     Call objCT.gobjInfoUsu.gobjTelaUsu.PercAcresc_Validate(objCT, Cancel)
End Sub
...
Private Sub ValorAcrescimoItens_Change()
     Call objCT.gobjInfoUsu.gobjTelaUsu.ValorAcrescimoItens_Change(objCT)
End Sub

Private Sub ValorAcrescimoItens_Validate(Cancel As Boolean)
     Call objCT.gobjInfoUsu.gobjTelaUsu.ValorAcrescimoItens_Validate(objCT, Cancel)
End Sub

Private Sub PercAcrescimoItens_Change()
     Call objCT.gobjInfoUsu.gobjTelaUsu.PercAcrescimoItens_Change(objCT)
End Sub

Private Sub PercAcrescimoItens_Validate(Cancel As Boolean)
     Call objCT.gobjInfoUsu.gobjTelaUsu.PercAcrescimoItens_Validate(objCT, Cancel)
End Sub

Private Sub Acrescimo_Change()
     Call objCT.gobjInfoUsu.gobjTelaUsu.Acrescimo_Change(objCT)
End Sub

Private Sub Acrescimo_GotFocus()
     Call objCT.gobjInfoUsu.gobjTelaUsu.Acrescimo_GotFocus(objCT)
End Sub

Private Sub Acrescimo_KeyPress(KeyAscii As Integer)
     Call objCT.gobjInfoUsu.gobjTelaUsu.Acrescimo_KeyPress(objCT, KeyAscii)
End Sub

Private Sub Acrescimo_Validate(Cancel As Boolean)
     Call objCT.gobjInfoUsu.gobjTelaUsu.Acrescimo_Validate(objCT, Cancel)
End Sub
...
Private Sub PercParticVend2_Validate(Cancel As Boolean)
     Call objCT.gobjInfoUsu.gobjTelaUsu.PercParticVend2_Validate(objCT, Cancel)
End Sub
