...
Begin VB.UserControl RelOpSaldoEstoque 
   ClientHeight    =   4905
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   8640
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   600
      Left            =   4575
      Picture         =   "RelOpSaldoEstoqueInpal.ctx":0000
      Style           =   1  'Graphical
      TabIndex        =   26
      Top             =   120
      Width           =   1575
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   315
      ItemData        =   "RelOpSaldoEstoqueInpal.ctx":0102
      Left            =   1425
      List            =   "RelOpSaldoEstoqueInpal.ctx":0104
      Sorted          =   -1  'True
      TabIndex        =   25
      Top             =   255
      Width           =   2916
   ...
   Begin VB.ComboBox ComboTotaliza 
      Height          =   315
      ItemData        =   "RelOpSaldoEstoqueInpal.ctx":0106
      Left            =   1425
      List            =   "RelOpSaldoEstoqueInpal.ctx":0113
   ...
   Begin VB.ListBox Almoxarifados 
      Height          =   3375
      ItemData        =   "RelOpSaldoEstoqueInpal.ctx":0136
      Left            =   5880
      List            =   "RelOpSaldoEstoqueInpal.ctx":0138
      Sorted          =   -1  'True
      TabIndex        =   5
      Top             =   1095
      Width           =   2670
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "RelOpSaldoEstoqueInpal.ctx":013A
         Style           =   1  'Graphical
         TabIndex        =   4
         ToolTipText     =   "Fechar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "RelOpSaldoEstoqueInpal.ctx":02B8
         Style           =   1  'Graphical
         TabIndex        =   3
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "RelOpSaldoEstoqueInpal.ctx":07EA
         Style           =   1  'Graphical
         TabIndex        =   2
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "RelOpSaldoEstoqueInpal.ctx":0974
         Style           =   1  'Graphical
         TabIndex        =   1
         ToolTipText     =   "Gravar"
         Top             =   90
   ...
   End
End
Attribute VB_Name = "RelOpSaldoEstoque"
...
On Error GoTo Erro_PreencherRelOp
    ...
    If ComboTotaliza.ListIndex = 0 Then gobjRelatorio.sNomeTsk = "SdEsAlIn"
    If ComboTotaliza.ListIndex = 1 Then gobjRelatorio.sNomeTsk = "SdEsFlIn"
    If ComboTotaliza.ListIndex = 2 Then
        gobjRelatorio.sNomeTsk = "SdEsEmIn"
