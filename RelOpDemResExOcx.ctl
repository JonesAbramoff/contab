VERSION 5.00
Begin VB.UserControl RelOpDemResExOcx 
   ClientHeight    =   3840
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   6360
   ...
   End
End
Attribute VB_Name = "RelOpDemResExOcx"
...
On Error GoTo Erro_BotaoExecutar_Click
    ...
    lErro = CF("RelDRE_Calcula", ComboModelos.List(ComboModelos.ListIndex), ComboExercicio.ItemData(ComboExercicio.ListIndex), giFilialEmpresa, 0, ComboGrupoEmp.ItemData(ComboGrupoEmp.ListIndex))
...
Public Function Form_Load_Ocx() As Object
    ...
    Caption = "Demonstrativo do Resultado do Exercício"
    Call Form_Load
