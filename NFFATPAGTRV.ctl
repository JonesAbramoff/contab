...
Begin VB.UserControl NFFATPAG 
   ...
   Begin VB.Frame Frame8 
      ...
      Begin VB.ComboBox TipoPagto 
         Height          =   315
         ItemData        =   "NFFATPAGTRV.ctx":03D2
         Left            =   2460
         List            =   "NFFATPAGTRV.ctx":03DC
         Style           =   2  'Dropdown List
         TabIndex        =   133
         Top             =   165
         Width           =   1440
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame6 
         ...
         Begin VB.ComboBox TipoCobranca 
            Height          =   315
            ItemData        =   "NFFATPAGTRV.ctx":04E0
            Left            =   4290
            List            =   "NFFATPAGTRV.ctx":04E2
            TabIndex        =   30
            Top             =   600
            Width           =   1935
         End
...
Private Sub UserControl_Initialize()
    ...
    'TRV
    Set objCT.gobjInfoUsu = New CTNFFATPAGVGTRV
    Set objCT.gobjInfoUsu.gobjTelaUsu = New CTNFFATPAGTRV
End Sub
