...
Begin VB.Form TRPLoginAcesso 
   ...
   Begin VB.CommandButton BotaoCancela 
      ...
      Height          =   555
      Left            =   2445
      Picture         =   "TRPLoginAcesso.frx":014A
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   1905
      Width           =   975
   ...
   Begin VB.CommandButton BotaoOk 
      ...
      Height          =   555
      Left            =   1005
      Picture         =   "TRPLoginAcesso.frx":024C
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   1905
      Width           =   975
   End
End
Attribute VB_Name = "TRPLoginAcesso"
...
Dim gobjUsu As AdmGenerico

Function Trata_Parametros(objFlag As AdmGenerico, objUsu As AdmGenerico) As Long
