...
Begin VB.UserControl RelOpRegInvetReqOcx 
   ClientHeight    =   1590
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   6435
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   570
      Left            =   4500
      Picture         =   "RelOpRegInvetReq.ctx":0000
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   750
      Width           =   1755
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   315
      ItemData        =   "RelOpRegInvetReq.ctx":0102
      Left            =   870
      List            =   "RelOpRegInvetReq.ctx":0104
      Sorted          =   -1  'True
      TabIndex        =   0
      Top             =   165
      Width           =   2760
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "RelOpRegInvetReq.ctx":0106
         Style           =   1  'Graphical
         TabIndex        =   5
         ToolTipText     =   "Fechar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "RelOpRegInvetReq.ctx":0284
         Style           =   1  'Graphical
         TabIndex        =   4
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "RelOpRegInvetReq.ctx":07B6
         Style           =   1  'Graphical
         TabIndex        =   3
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "RelOpRegInvetReq.ctx":0940
         Style           =   1  'Graphical
         TabIndex        =   2
         ToolTipText     =   "Gravar"
         Top             =   75
   ...
   End
End
Attribute VB_Name = "RelOpRegInvetReqOcx"
...
Public Function Form_Load_Ocx() As Object
    ...
    Caption = "Registro de Inventário - Em Processo"
    Call Form_Load
