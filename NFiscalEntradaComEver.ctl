...
Begin VB.UserControl NFiscalEntradaCom 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CommandButton BotaoTrazerNFe 
            Height          =   360
            Left            =   6165
            Picture         =   "NFiscalEntradaComEver.ctx":0000
            Style           =   1  'Graphical
            TabIndex        =   1
      ...
      Begin VB.Frame Frame14 
         ...
         Begin VB.CommandButton BotaoDesmarcarTodos 
            ...
            Index           =   0
            Left            =   7365
            Picture         =   "NFiscalEntradaComEver.ctx":03D2
            Style           =   1  'Graphical
            TabIndex        =   22
            Top             =   480
            Width           =   1395
         ...
         Begin VB.CommandButton BotaoMarcarTodos 
            ...
            Index           =   0
            Left            =   5880
            Picture         =   "NFiscalEntradaComEver.ctx":15B4
            Style           =   1  'Graphical
            TabIndex        =   21
            Top             =   480
            Width           =   1395
      ...
      Begin VB.Frame Frame6 
         ...
         Begin VB.CommandButton BotaoLimparNF 
            Height          =   315
            Left            =   5625
            Picture         =   "NFiscalEntradaComEver.ctx":25CE
            Style           =   1  'Graphical
            TabIndex        =   8
         ...
         Begin VB.ComboBox TipoNFiscal 
            Height          =   315
            ItemData        =   "NFiscalEntradaComEver.ctx":2B00
            Left            =   1470
            List            =   "NFiscalEntradaComEver.ctx":2B02
            TabIndex        =   4
            Top             =   540
            Width           =   4515
         End
         ...
         Begin VB.CommandButton Recebimento 
            Height          =   360
            Left            =   2175
            Picture         =   "NFiscalEntradaComEver.ctx":2B04
            Style           =   1  'Graphical
            TabIndex        =   3
            ToolTipText     =   "Trazer Dados"
            Top             =   150
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton BotaoMarcarTodos 
         ...
         Index           =   1
         Left            =   7620
         Picture         =   "NFiscalEntradaComEver.ctx":2ED6
         Style           =   1  'Graphical
         TabIndex        =   58
         Top             =   120
         Width           =   1380
      ...
      Begin VB.CommandButton BotaoDesmarcarTodos 
         ...
         Index           =   1
         Left            =   7620
         Picture         =   "NFiscalEntradaComEver.ctx":3EF0
         Style           =   1  'Graphical
         TabIndex        =   59
         Top             =   690
         Width           =   1380
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame6 
         ...
         Begin VB.ComboBox ProdutoRastro 
            Height          =   315
            ItemData        =   "NFiscalEntradaComEver.ctx":50D2
            Left            =   0
            List            =   "NFiscalEntradaComEver.ctx":50DF
            Style           =   2  'Dropdown List
            TabIndex        =   195
            Top             =   0
            Width           =   1740
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "NFiscalEntradaComEver.ctx":50FE
            Left            =   3930
            List            =   "NFiscalEntradaComEver.ctx":5108
            Style           =   2  'Dropdown List
            TabIndex        =   164
            Top             =   210
            Visible         =   0   'False
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   330
         Left            =   1341
         Picture         =   "NFiscalEntradaComEver.ctx":5124
         Style           =   1  'Graphical
         TabIndex        =   30
         ToolTipText     =   "Excluir"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoConsultaNFPag 
         ...
         Height          =   330
         Left            =   60
         Picture         =   "NFiscalEntradaComEver.ctx":52AE
         Style           =   1  'Graphical
         TabIndex        =   28
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   330
         Left            =   888
         Picture         =   "NFiscalEntradaComEver.ctx":5B30
         Style           =   1  'Graphical
         TabIndex        =   29
         ToolTipText     =   "Gravar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   330
         Left            =   1794
         Picture         =   "NFiscalEntradaComEver.ctx":5C8A
         Style           =   1  'Graphical
         TabIndex        =   31
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   330
         Left            =   2250
         Picture         =   "NFiscalEntradaComEver.ctx":61BC
         Style           =   1  'Graphical
         TabIndex        =   32
         ToolTipText     =   "Fechar"
         Top             =   75
