...
Begin VB.UserControl NFiscalEntrada 
   ClientHeight    =   5730
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9435
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame14 
         ...
         Begin MSComCtl2.UpDown UpDownVencimento 
            ...
            Enabled         =   -1  'True
         End
         Begin MSMask.MaskEdBox DtVencimento 
            Height          =   300
            Left            =   4575
            TabIndex        =   12
            Top             =   210
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox TipoNFiscal 
            Height          =   315
            ItemData        =   "NFiscalEntradaHic.ctx":0000
            Left            =   1485
            List            =   "NFiscalEntradaHic.ctx":0002
            TabIndex        =   2
            Top             =   690
            Width           =   4560
         End
         Begin VB.CommandButton BotaoLimparNF 
            Height          =   315
            Left            =   5670
            Picture         =   "NFiscalEntradaHic.ctx":0004
            Style           =   1  'Graphical
            TabIndex        =   6
         ...
         Begin VB.CommandButton Recebimento 
            Height          =   360
            Left            =   2205
            Picture         =   "NFiscalEntradaHic.ctx":0536
            Style           =   1  'Graphical
            TabIndex        =   1
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox ProdutoRastro 
            Height          =   315
            ItemData        =   "NFiscalEntradaHic.ctx":0908
            Left            =   0
            List            =   "NFiscalEntradaHic.ctx":0915
            Style           =   2  'Dropdown List
            TabIndex        =   171
            Top             =   0
            Width           =   1740
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "NFiscalEntradaHic.ctx":0934
            Left            =   3840
            List            =   "NFiscalEntradaHic.ctx":093E
            Style           =   2  'Dropdown List
            TabIndex        =   157
            Top             =   240
            Visible         =   0   'False
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   330
         Left            =   1365
         Picture         =   "NFiscalEntradaHic.ctx":095A
         Style           =   1  'Graphical
         TabIndex        =   24
         ToolTipText     =   "Excluir"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   330
         Left            =   2295
         Picture         =   "NFiscalEntradaHic.ctx":0AE4
         Style           =   1  'Graphical
         TabIndex        =   26
         ToolTipText     =   "Fechar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   330
         Left            =   1830
         Picture         =   "NFiscalEntradaHic.ctx":0C62
         Style           =   1  'Graphical
         TabIndex        =   25
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   330
         Left            =   900
         Picture         =   "NFiscalEntradaHic.ctx":1194
         Style           =   1  'Graphical
         TabIndex        =   23
         ToolTipText     =   "Gravar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoConsultaNFPag 
         ...
         Height          =   330
         Left            =   60
         Picture         =   "NFiscalEntradaHic.ctx":12EE
         Style           =   1  'Graphical
         TabIndex        =   22
   ...
   End
End
Attribute VB_Name = "NFiscalEntrada"
...
Private WithEvents objCT As CTNFiscalEntrada
...
Private Sub UserControl_Initialize()
    Set objCT = New CTNFiscalEntrada
...
Private Sub DtVencimento_GotFocus()
     Call objCT.DtVencimento_GotFocus
End Sub
...
Private Sub DtVencimento_Change()
     Call objCT.DtVencimento_Change
End Sub

Private Sub DtVencimento_Validate(Cancel As Boolean)
     Call objCT.DtVencimento_Validate(Cancel)
End Sub
...
Private Sub FilialFornNFOrigLabel_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
   Call Controle_MouseDown(FilialFornNFOrigLabel, Button, Shift, X, Y)
End Sub

Private Sub FilialCliNFOrigLabel_DragDrop(Source As Control, X As Single, Y As Single)
   Call Controle_DragDrop(FilialCliNFOrigLabel, Source, X, Y)
End Sub

Private Sub FilialCliNFOrigLabel_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
   Call Controle_MouseDown(FilialCliNFOrigLabel, Button, Shift, X, Y)
End Sub
...
Private Sub FornNFOrigLabel_DragDrop(Source As Control, X As Single, Y As Single)
   Call Controle_DragDrop(FornNFOrigLabel, Source, X, Y)
End Sub

Private Sub FornNFOrigLabel_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
   Call Controle_MouseDown(FornNFOrigLabel, Button, Shift, X, Y)
End Sub

Private Sub ClienteNFOrigLabel_DragDrop(Source As Control, X As Single, Y As Single)
   Call Controle_DragDrop(ClienteNFOrigLabel, Source, X, Y)
End Sub

Private Sub ClienteNFOrigLabel_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
   Call Controle_MouseDown(ClienteNFOrigLabel, Button, Shift, X, Y)
End Sub
