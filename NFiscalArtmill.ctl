...
Begin VB.UserControl NFiscal 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CommandButton BotaoLimparNF 
            Height          =   300
            Left            =   4860
            Picture         =   "NFiscalArtmill.ctx":0000
            Style           =   1  'Graphical
            TabIndex        =   13
         ...
         Begin VB.ComboBox TipoNFiscal 
            Height          =   315
            ItemData        =   "NFiscalArtmill.ctx":0532
            Left            =   1995
            List            =   "NFiscalArtmill.ctx":0534
            TabIndex        =   5
            Top             =   270
            Width           =   2835
         End
   ...
   Begin VB.Frame FrameCliInt 
      ...
      Visible         =   0   'False
      Width           =   585
      Begin VB.ComboBox FilialCliIntermediario 
         Height          =   315
         Left            =   4425
         TabIndex        =   249
         Top             =   0
         Width           =   1860
      End
      Begin MSMask.MaskEdBox CliIntermediario 
         Height          =   300
         Left            =   1215
         TabIndex        =   250
         Top             =   0
         ...
         PromptChar      =   " "
      End
      Begin VB.Label LabelCliTomador 
         AutoSize        =   -1  'True
         Caption         =   "Tomador:"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox TabPrecoItemNF 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "NFiscalArtmill.ctx":0536
            Left            =   4830
            List            =   "NFiscalArtmill.ctx":0538
            Style           =   2  'Dropdown List
            TabIndex        =   247
            Top             =   1935
            Width           =   1800
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox ProdutoRastro 
            Height          =   315
            ItemData        =   "NFiscalArtmill.ctx":053A
            Left            =   1350
            List            =   "NFiscalArtmill.ctx":0547
            Style           =   2  'Dropdown List
            TabIndex        =   177
            Top             =   1170
            Width           =   1740
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Height          =   315
            ItemData        =   "NFiscalArtmill.ctx":0566
            Left            =   3690
            List            =   "NFiscalArtmill.ctx":0573
            Style           =   2  'Dropdown List
            TabIndex        =   155
            Top             =   285
            Width           =   1215
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.CommandButton BotaoOrcamento 
         Height          =   360
         Left            =   3825
         Picture         =   "NFiscalArtmill.ctx":0592
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      Begin VB.CommandButton BotaoVerOrcamento 
         Height          =   360
         Left            =   4215
         Picture         =   "NFiscalArtmill.ctx":0964
         Style           =   1  'Graphical
         TabIndex        =   3
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame4 
         ...
         Begin VB.CommandButton BotaoVendedores 
            ...
            Height          =   555
            Left            =   7250
            Picture         =   "NFiscalArtmill.ctx":0C76
            Style           =   1  'Graphical
            TabIndex        =   170
            Top             =   3361
            Width           =   1650
         ...
         Begin VB.ComboBox DiretoIndireto 
            Height          =   315
            ItemData        =   "NFiscalArtmill.ctx":1220
            Left            =   6240
            List            =   "NFiscalArtmill.ctx":122A
            Style           =   2  'Dropdown List
            TabIndex        =   164
            Top             =   1560
            Width           =   1335
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   330
         Left            =   1357
         Picture         =   "NFiscalArtmill.ctx":1240
         Style           =   1  'Graphical
         TabIndex        =   160
         ToolTipText     =   "Excluir"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoConsultaTitRec 
         ...
         Height          =   330
         Left            =   60
         Picture         =   "NFiscalArtmill.ctx":13CA
         Style           =   1  'Graphical
         TabIndex        =   158
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   330
         Left            =   896
         Picture         =   "NFiscalArtmill.ctx":1C4C
         Style           =   1  'Graphical
         TabIndex        =   159
         ToolTipText     =   "Gravar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   330
         Left            =   1818
         Picture         =   "NFiscalArtmill.ctx":1DA6
         Style           =   1  'Graphical
         TabIndex        =   161
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   330
         Left            =   2280
         Picture         =   "NFiscalArtmill.ctx":22D8
         Style           =   1  'Graphical
         TabIndex        =   162
         ToolTipText     =   "Fechar"
         Top             =   75
...
Private Sub UserControl_Initialize()
    ...
    Set objCT.gobjInfoUsu = New CTNfiscalVGArt
    Set objCT.gobjInfoUsu.gobjTelaUsu = New CTNFiscalArt
End Sub
...
Private Sub FilialCliIntermediario_Change()
     Call objCT.FilialCliIntermediario_Change
End Sub

Private Sub FilialCliIntermediario_Click()
     Call objCT.FilialCliIntermediario_Change
End Sub

Private Sub FilialCliIntermediario_Validate(Cancel As Boolean)
     Call objCT.FilialCliIntermediario_Validate(Cancel)
End Sub

Private Sub CliIntermediario_Change()
     Call objCT.CliIntermediario_Change
End Sub

Private Sub CliIntermediario_Validate(Cancel As Boolean)
     Call objCT.CliIntermediario_Validate(Cancel)
End Sub

Private Sub LabelCliInt_Click()
     Call objCT.LabelCliInt_Click
End Sub

Private Sub LabelCliTomador_Click()
     Call objCT.LabelCliTomador_Click
End Sub
