...
Begin VB.UserControl RelOpReqComprasAbertoOcx 
   ClientHeight    =   5670
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   8250
   ...
   Begin VB.ComboBox ComboOrdenacao 
      Height          =   315
      ItemData        =   "RelOpReqComprasAbertoOcx.ctx":0000
      Left            =   1515
      List            =   "RelOpReqComprasAbertoOcx.ctx":000D
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "RelOpReqComprasAbertoOcx.ctx":0043
         Style           =   1  'Graphical
         TabIndex        =   21
         ToolTipText     =   "Gravar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "RelOpReqComprasAbertoOcx.ctx":019D
         Style           =   1  'Graphical
         TabIndex        =   22
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "RelOpReqComprasAbertoOcx.ctx":0327
         Style           =   1  'Graphical
         TabIndex        =   23
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "RelOpReqComprasAbertoOcx.ctx":0859
         Style           =   1  'Graphical
         TabIndex        =   24
         ToolTipText     =   "Fechar"
         Top             =   90
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   600
      Left            =   4230
      Picture         =   "RelOpReqComprasAbertoOcx.ctx":09D7
      Style           =   1  'Graphical
      TabIndex        =   20
      Top             =   135
      Width           =   1515
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   315
      ItemData        =   "RelOpReqComprasAbertoOcx.ctx":0AD9
      Left            =   960
      List            =   "RelOpReqComprasAbertoOcx.ctx":0ADB
      Sorted          =   -1  'True
      TabIndex        =   0
      Top             =   120
      Width           =   3045
   ...
   End
End
Attribute VB_Name = "RelOpReqComprasAbertoOcx"
...
On Error GoTo Erro_Trata_Parametros
    ...
    If Not (gobjRelatorio Is Nothing) Then gError 72743
    
    Set gobjRelatorio = objRelatorio
    Set gobjRelOpcoes = objRelOpcoes

    lErro = RelOpcoes_ComboOpcoes_Preenche(objRelatorio, ComboOpcoes, objRelOpcoes, Me)
    If lErro <> SUCESSO Then gError 72744
...
Erro_Trata_Parametros:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172637)
...
On Error GoTo Erro_Limpa_Tela_Rel
    ...
    If lErro <> SUCESSO Then gError 72745
...
Erro_Limpa_Tela_Rel:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172638)
...
On Error GoTo Erro_Form_Load
    ...
    If lErro <> SUCESSO Then gError 72746
...
Erro_Form_Load:
   ...
   lErro_Chama_Tela = gErr
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172639)
...
Erro_LabelCodRequisitanteAte_Click:
    ...
    Select Case gErr
         ...
         Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172640)
...
On Error GoTo Erro_DataEnvioDe_Validate
    ...
    If lErro <> SUCESSO Then gError 72747
...
Erro_DataEnvioDe_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172641)
...
On Error GoTo Erro_DataEnvioAte_Validate
    ...
    If lErro <> SUCESSO Then gError 72748
...
Erro_DataEnvioAte_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172642)
...
On Error GoTo Erro_DataLimiteAte_Validate
    ...
    If lErro <> SUCESSO Then gError 72749
...
Erro_DataLimiteAte_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172643)
...
On Error GoTo Erro_UpDownDataEnvioDe_DownClick
    ...
    If lErro <> SUCESSO Then gError 72750
...
Erro_UpDownDataEnvioDe_DownClick:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, 172644)
...
On Error GoTo Erro_UpDownDataEnvioDe_UpClick
    ...
    If lErro <> SUCESSO Then gError 72751
...
Erro_UpDownDataEnvioDe_UpClick:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, 172645)
...
On Error GoTo Erro_UpDownDataEnvioAte_DownClick
    ...
    If lErro <> SUCESSO Then gError 72752
...
Erro_UpDownDataEnvioAte_DownClick:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, 172646)
...
On Error GoTo Erro_UpDownDataEnvioAte_UpClick
    ...
    If lErro <> SUCESSO Then gError 72753
...
Erro_UpDownDataEnvioAte_UpClick:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, 172647)
...
On Error GoTo Erro_UpDownDataLimiteAte_DownClick
    ...
    If lErro <> SUCESSO Then gError 72754
...
Erro_UpDownDataLimiteAte_DownClick:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, 172648)
...
On Error GoTo Erro_UpDownDataLimiteAte_UpClick
    ...
    If lErro <> SUCESSO Then gError 72755
...
Erro_UpDownDataLimiteAte_UpClick:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, 172649)
...
On Error GoTo Erro_UpDownDataLimiteDe_DownClick
    ...
    If lErro <> SUCESSO Then gError 72756
...
Erro_UpDownDataLimiteDe_DownClick:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, 172650)
...
On Error GoTo Erro_UpDownDataLimiteDe_UpClick
    ...
    If lErro <> SUCESSO Then gError 72757
...
Erro_UpDownDataLimiteDe_UpClick:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, 172651)
...
On Error GoTo Erro_DataLimiteDe_Validate
    ...
    If lErro <> SUCESSO Then gError 72758
...
Erro_DataLimiteDe_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172652)
...
Erro_LabelCodigoDe_Click:
    ...
    Select Case gErr
         ...
         Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172653)
...
Erro_LabelCodigoAte_Click:
    ...
    Select Case gErr
         ...
         Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172654)
...
Erro_LabelCodRequisicaoAte_Click:
    ...
    Select Case gErr
         ...
         Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172655)
...
Erro_LabelCodRequisicaoDe_Click:
    ...
    Select Case gErr
         ...
         Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172656)
...
Erro_LabelCodRequisitanteDe_Click:
    ...
    Select Case gErr
         ...
         Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172657)
...
On Error GoTo Erro_LabelCclAte_Click
    ...
    If Len(Trim(CclAte.Text)) > 0 Then
        ...
        If lErro <> SUCESSO Then gError 72759
...
Erro_LabelCclAte_Click:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172658)
...
On Error GoTo Erro_LabelCclDe_Click
    ...
    If Len(Trim(CclDe.Text)) > 0 Then
        ...
        If lErro <> SUCESSO Then gError 72760
...
Erro_LabelCclDe_Click:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172659)
...
Erro_LabelNomeDe_Click:
    ...
    Select Case gErr
         ...
         Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172660)
...
Erro_LabelNomeAte_Click:
    ...
    Select Case gErr
         ...
         Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172661)
...
Erro_LabelNomeReqDe_Click:
    ...
    Select Case gErr
         ...
         Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172662)
...
Erro_LabelNomeReqAte_Click:
    ...
    Select Case gErr
         ...
         Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172663)
...
On Error GoTo Erro_objEventoCclDe_evSelecao
    ...
    If lErro <> SUCESSO Then gError 72761
...
Erro_objEventoCclDe_evSelecao:
    ...
    Select Case gErr
        ...
        Case Else
             lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172664)
...
On Error GoTo Erro_objEventoCclAte_evSelecao
    ...
    lErro = Mascara_MascararCcl(objCcl.sCcl, sCclMascarado)
    If lErro <> SUCESSO Then gError 72762
...
Erro_objEventoCclAte_evSelecao:
    ...
    Select Case gErr
        ...
        Case Else
             lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172665)
...
On Error GoTo Erro_BotaoGravar_Click
    ...
    If ComboOpcoes.Text = "" Then gError 72763

    lErro = PreencherRelOp(gobjRelOpcoes)
    If lErro <> SUCESSO Then gError 72764

    gobjRelOpcoes.sNome = ComboOpcoes.Text

    lErro = CF("RelOpcoes_Grava", gobjRelOpcoes, iResultado)
    If lErro <> SUCESSO Then gError 72765
    
    lErro = RelOpcoes_Testa_Combo(ComboOpcoes, gobjRelOpcoes.sNome)
    If lErro <> SUCESSO Then gError 72766
...
Erro_BotaoGravar_Click:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 172666)
...
On Error GoTo Erro_BotaoExcluir_Click
    ...
    If ComboOpcoes.ListIndex = -1 Then gError 72767
    ...
    If vbMsgRes = vbYes Then
        ...
        If lErro <> SUCESSO Then gError 72768
...
Erro_BotaoExcluir_Click:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172667)
...
On Error GoTo Erro_BotaoExecutar_Click
    ...
    lErro = PreencherRelOp(gobjRelOpcoes)
    If lErro <> SUCESSO Then gError 72769
...
Erro_BotaoExecutar_Click:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172668)
...
On Error GoTo Erro_PreencherRelOp
    ...
    End If
    If lErro <> AD_BOOL_TRUE Then gError 72778
    ...
    End If
    If lErro <> AD_BOOL_TRUE Then gError 72786
    ...
    End If
    If lErro <> AD_BOOL_TRUE Then gError 72787
    ...
    If lErro <> AD_BOOL_TRUE Then gError 72789
   
    sOrd = ComboOrdenacao.ListIndex
    lErro = objRelOpcoes.IncluirParametro("NORDENACAO", sOrd)
    If lErro <> AD_BOOL_TRUE Then gError 72790
       
    If CheckItens.Value = 0 Then
        gobjRelatorio.sNomeTsk = "rcaberto"
        sCheck = "N"
    Else
        gobjRelatorio.sNomeTsk = "rcaberit"
        sCheck = "S"
    End If
    
    lErro = objRelOpcoes.IncluirParametro("TITENS", sCheck)
    If lErro <> AD_BOOL_TRUE Then gError 72791
    ...
    If lErro <> SUCESSO Then gError 72792
...
Erro_PreencherRelOp:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172669)
...
On Error GoTo Erro_Formata_E_Critica_Parametros
    ...
    If sCodRequisitante_I <> "" And sCodRequisitante_F <> "" Then
        ...
        If StrParaLong(sCodRequisitante_I) > StrParaLong(sCodRequisitante_F) Then gError 72793
    ...
    If sNomeReq_I <> "" And sNomeReq_F <> "" Then
        If sNomeReq_I > sNomeReq_F Then gError 72794
    End If
    
    'critica Ccl Inicial e Final
    If CclDe.ClipText <> "" Then
        lErro = CF("Ccl_Formata", CclDe.Text, sCclFormata, iCclPreenchida)
        If lErro <> SUCESSO Then gError 72795
    ...
    If CclAte.ClipText <> "" Then
        lErro = CF("Ccl_Formata", CclAte.Text, sCclFormata, iCclPreenchida)
        If lErro <> SUCESSO Then gError 72796
    ...
    If sCcl_I <> "" And sCcl_F <> "" Then
        ...
        If sCcl_I > sCcl_F Then gError 72797
    ...
    If sCodFilial_I <> "" And sCodFilial_F <> "" Then
        ...
        If StrParaInt(sCodFilial_I) > StrParaInt(sCodFilial_F) Then gError 72798
    ...
    If sNomeFilial_I <> "" And sNomeFilial_F <> "" Then
        If sNomeFilial_I > sNomeFilial_F Then gError 72799
    End If
    ...
    If sCodRequisicao_I <> "" And sCodRequisicao_F <> "" Then
        ...
        If StrParaLong(sCodRequisicao_I) > StrParaLong(sCodRequisicao_F) Then gError 72800
    ...
    If Trim(DataEnvioDe.ClipText) <> "" And Trim(DataEnvioAte.ClipText) <> "" Then
         ...
         If CDate(DataEnvioDe.Text) > CDate(DataEnvioAte.Text) Then gError 72801
    ...
    If Trim(DataLimiteDe.ClipText) <> "" And Trim(DataLimiteAte.ClipText) <> "" Then
         ...
         If CDate(DataLimiteDe.Text) > CDate(DataLimiteAte.Text) Then gError 72802
...
Erro_Formata_E_Critica_Parametros:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172670)
...
Erro_Monta_Expressao_Selecao:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172671)
...
On Error GoTo Erro_PreencherParametrosNaTela
    ...
    If lErro <> SUCESSO Then gError 72805
    ...
    If lErro <> SUCESSO Then gError 72806
    ...
    If lErro <> SUCESSO Then gError 72807
    ...
    If lErro <> SUCESSO Then gError 72810
                   
    If Len(Trim(sParam)) > 0 Then
    
        lErro = Mascara_MascararCcl(sParam, sCclMascarado)
        If lErro <> SUCESSO Then gError 72811
    ...
    If lErro <> SUCESSO Then gError 72812
    ...
    If lErro <> SUCESSO Then gError 72813
    ...
    If lErro <> SUCESSO Then gError 72814
    ...
    If lErro <> SUCESSO Then gError 72815
    ...
    If lErro <> SUCESSO Then gError 72819
    ...
    If lErro <> SUCESSO Then gError 72820
    ...
    If lErro <> SUCESSO Then gError 72823
...
Erro_PreencherParametrosNaTela:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172672)
...
On Error GoTo Erro_CodigoFilialDe_Validate
    ...
    If Len(Trim(CodigoFilialDe.Text)) > 0 Then
        ...
        If lErro <> SUCESSO And lErro <> 27378 Then gError 72825
        
        'Se não encontrou a Filial ==> erro
        If lErro = 27378 Then gError 72826
...
Erro_CodigoFilialDe_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 172673)
...
On Error GoTo Erro_CodigoFilialAte_Validate
    ...
    If Len(Trim(CodigoFilialAte.Text)) > 0 Then
        ...
        'Lê o código informado
        lErro = CF("FilialEmpresa_Le", objFilialEmpresa)
        If lErro <> SUCESSO And lErro <> 27378 Then gError 72827
        
        'Se não encontrou a Filial ==> erro
        If lErro = 27378 Then gError 72828
...
Erro_CodigoFilialAte_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 172674)
...
On Error GoTo Erro_CodRequisitanteDe_Validate
    ...
    If Len(Trim(CodRequisitanteDe.Text)) > 0 Then
        ...
        If lErro <> SUCESSO And lErro <> 49084 Then gError 72829

        'Se não encontrou o Requisitante ==> erro
        If lErro = 49084 Then gError 72830
...
Erro_CodRequisitanteDe_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 172675)
...
On Error GoTo Erro_CodRequisitanteAte_Validate
    ...
    If Len(Trim(CodRequisitanteAte.Text)) > 0 Then
        ...
        'Lê o código informado
        lErro = CF("Requisitante_Le", objRequisitante)
        If lErro <> SUCESSO And lErro <> 49084 Then gError 72831

        'Se não encontrou o Requisitante ==> erro
        If lErro = 49084 Then gError 72832
...
Erro_CodRequisitanteAte_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 172676)
...
On Error GoTo Erro_NomeFilialDe_Validate
    ...
    If Len(Trim(NomeFilialDe.Text)) > 0 Then
        ...
        If lErro <> SUCESSO Then gError 72833
        ...
        If bAchou = False Then gError 72834
...
Erro_NomeFilialDe_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 172677)
...
On Error GoTo Erro_NomeFilialAte_Validate
    ...
    If Len(Trim(NomeFilialAte.Text)) > 0 Then
        ...
        lErro = CF("FiliaisEmpresas_Le_Empresa", glEmpresa, colFiliais)
        If lErro <> SUCESSO Then gError 72835
        ...
        'Se não encontrou Filial com o Nome informado ==> erro
        If bAchou = False Then gError 72836
...
Erro_NomeFilialAte_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 172678)
...
On Error GoTo Erro_NomeReqDe_Validate
    ...
    If Len(Trim(NomeReqDe.Text)) > 0 Then
        ...
        If lErro <> SUCESSO And lErro <> 51152 Then gError 72837

        'Se não encontrou o Requisitante ==> erro
        If lErro = 51152 Then gError 72838
...
Erro_NomeReqDe_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 172679)
...
On Error GoTo Erro_NomeReqAte_Validate
    ...
    If Len(Trim(NomeReqAte.Text)) > 0 Then
        ...
        'Lê o Requisitante informado
        lErro = CF("Requisitante_Le_NomeReduzido", objRequisitante)
        If lErro <> SUCESSO And lErro <> 51152 Then gError 72839

        'Se não encontrou o Requisitante ==> erro
        If lErro = 51152 Then gError 72840
...
Erro_NomeReqAte_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 172680)
...
On Error GoTo Erro_CclDe_Validate
    ...
    If Len(Trim(CclDe.ClipText)) > 0 Then
        ...
        lErro = CF("Ccl_Formata", CclDe.Text, sCclFormata, iCclPreenchida)
        If lErro <> SUCESSO Then gError 72841
        
        objCcl.sCcl = sCclFormata
        
        'Lê o Ccl informado
        lErro = CF("Ccl_Le", objCcl)
        If lErro <> SUCESSO And lErro <> 5599 Then gError 72842

        'Se não encontrou o Ccl ==> erro
        If lErro = 5599 Then gError 72843
...
Erro_CclDe_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 172681)
...
On Error GoTo Erro_CclAte_Validate
    ...
    If Len(Trim(CclAte.ClipText)) > 0 Then
        ...
        'Coloca Ccl no formato do BD
        lErro = CF("Ccl_Formata", CclAte.Text, sCclFormata, iCclPreenchida)
        If lErro <> SUCESSO Then gError 72844
        
        objCcl.sCcl = sCclFormata
        
        'Lê o Ccl informado
        lErro = CF("Ccl_Le", objCcl)
        If lErro <> SUCESSO And lErro <> 5599 Then gError 72845

        'Se não encontrou o Ccl ==> erro
        If lErro = 5599 Then gError 72846
...
Erro_CclAte_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 172682)
