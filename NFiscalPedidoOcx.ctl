...
Begin VB.UserControl NFiscalPedidoOcx 
   ClientHeight    =   5790
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9510
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame6 
         ...
         Begin VB.ComboBox TabPrecoItemNF 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "NFiscalPedidoOcx.ctx":0000
            Left            =   3030
            List            =   "NFiscalPedidoOcx.ctx":0002
            Style           =   2  'Dropdown List
            TabIndex        =   238
            Top             =   1470
            Width           =   1800
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton BotaoLimparNF 
            Height          =   300
            Left            =   5940
            Picture         =   "NFiscalPedidoOcx.ctx":0004
            Style           =   1  'Graphical
            TabIndex        =   17
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox ProdutoRastro 
            Height          =   315
            ItemData        =   "NFiscalPedidoOcx.ctx":0536
            Left            =   0
            List            =   "NFiscalPedidoOcx.ctx":0543
            Style           =   2  'Dropdown List
            TabIndex        =   195
            Top             =   0
            Width           =   1740
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Height          =   315
            ItemData        =   "NFiscalPedidoOcx.ctx":0562
            Left            =   3690
            List            =   "NFiscalPedidoOcx.ctx":056F
            Style           =   2  'Dropdown List
            TabIndex        =   169
            Top             =   270
            Width           =   1215
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame NFiscalOcx 
         ...
         Begin VB.CommandButton BotaoVendedores 
            ...
            Height          =   540
            Left            =   7680
            Picture         =   "NFiscalPedidoOcx.ctx":058E
            Style           =   1  'Graphical
            TabIndex        =   187
            Top             =   3285
            Width           =   1305
         ...
         Begin VB.ComboBox DiretoIndireto 
            Height          =   315
            ItemData        =   "NFiscalPedidoOcx.ctx":0B38
            Left            =   7080
            List            =   "NFiscalPedidoOcx.ctx":0B42
            Style           =   2  'Dropdown List
            TabIndex        =   181
            Top             =   1560
            Width           =   1335
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   330
         Left            =   1349
         Picture         =   "NFiscalPedidoOcx.ctx":0B58
         Style           =   1  'Graphical
         TabIndex        =   27
         ToolTipText     =   "Excluir"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   330
         Left            =   2265
         Picture         =   "NFiscalPedidoOcx.ctx":0CE2
         Style           =   1  'Graphical
         TabIndex        =   29
         ToolTipText     =   "Fechar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   330
         Left            =   1806
         Picture         =   "NFiscalPedidoOcx.ctx":0E60
         Style           =   1  'Graphical
         TabIndex        =   28
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   330
         Left            =   892
         Picture         =   "NFiscalPedidoOcx.ctx":1392
         Style           =   1  'Graphical
         TabIndex        =   26
         ToolTipText     =   "Gravar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoConsultaTitRec 
         ...
         Height          =   330
         Left            =   60
         Picture         =   "NFiscalPedidoOcx.ctx":14EC
         Style           =   1  'Graphical
         TabIndex        =   25
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.CommandButton BotaoVerPedido 
         Height          =   360
         Left            =   4230
         Picture         =   "NFiscalPedidoOcx.ctx":1D6E
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      Begin VB.CommandButton BotaoPedido 
         Height          =   360
         Left            =   3840
         Picture         =   "NFiscalPedidoOcx.ctx":2080
         Style           =   1  'Graphical
         TabIndex        =   2
   ...
   End
End
Attribute VB_Name = "NFiscalPedidoOcx"
