...
Begin VB.UserControl EstoqueInicial 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   540
         Left            =   1890
         Picture         =   "EstoqueInicial.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   72
         ToolTipText     =   "Excluir"
         Top             =   30
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   540
         Left            =   1380
         Picture         =   "EstoqueInicial.ctx":018A
         Style           =   1  'Graphical
         TabIndex        =   71
         ToolTipText     =   "Gravar"
         Top             =   30
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   540
         Left            =   2400
         Picture         =   "EstoqueInicial.ctx":02E4
         Style           =   1  'Graphical
         TabIndex        =   70
         Top             =   30
         Width           =   405
      ...
      Begin VB.CommandButton BotaoConsultar 
         Height          =   540
         Left            =   45
         Picture         =   "EstoqueInicial.ctx":0816
         Style           =   1  'Graphical
         TabIndex        =   69
         Top             =   30
         Width           =   1245
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   540
         Left            =   2895
         Picture         =   "EstoqueInicial.ctx":25D8
         Style           =   1  'Graphical
         TabIndex        =   68
         ToolTipText     =   "Fechar"
         Top             =   30
