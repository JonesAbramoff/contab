...
''Public Declare Function Bematech_FI_VerificaIndiceAliquotasIss Lib "BEMAFI32.DLL" (ByVal AliquotasIss As String) As Integer
''
...
''
''Public Declare Function Bematech_FIR_AbreBilhetePassagem Lib "BEMAFI32.DLL" (ByVal ImprimeValorFinal As String, ByVal ImprimeEnfatizado As String, ByVal LocalEmbarque As String, ByVal Destino As String, ByVal Linha As String, ByVal Prefixo As String, ByVal Agente As String, ByVal Agencia As String, ByVal Data As String, ByVal HORA As String, ByVal Poltrona As String, ByVal Plataforma As String) As Integer
''
''' Funções de TEF
''
...
''Public Declare Function Bematech_FITEF_ConfiguraDiretorioTef Lib "BEMAFI32.DLL" (ByVal PathREQ As String, ByVal PathRESP As String) As Integer
''
''Public Declare Function Bematech_FITEF_ApagaResiduos Lib "BEMAFI32.DLL" () As Integer
''Public Declare Function Bematech_FITEF_VendaCheque Lib "BEMAFI32.DLL" (ByVal Identificacao As String, ByVal ValorCompra As String) As Integer
''
''' Outras funções
''
...
''Public Declare Function Bematech_FI_InfoBalanca Lib "BEMAFI32.DLL" (ByVal sPorta As String, ByVal iModelo As Integer, sPeso As String, sPrecoKilo As String, sPrecoTotal As String) As Integer
''Public Declare Function Bematech_FI_ModeloImpressora Lib "BEMAFI32.DLL" (ByVal sModelo As String) As Integer'Public Declare Function Bematech_FI_ModeloImpressora Lib "BEMAFI32.DLL" (ByVal sModelo As String) As Integer
''
''
''
'''REGISTRO TIPO E
...
''
''
''Public Declare Function Bematech_FI_DataHoraGravacaoUsuarioSWBasicoMFAdicional Lib "BEMAMFD2.DLL" (ByVal sDataUsuario As String, ByVal sDataSWBasico As String, ByVal sMFAdicional As String) As Integer
'
'
'
'' Funções de Inicialização
...
'
'
'Public Declare Function Bematech_FI_DataHoraGravacaoUsuarioSWBasicoMFAdicional Lib "BEMAFI32.DLL" (ByVal dataUsuario As String, ByVal dataSWBasico As String, ByVal MFAdicional As String) As Integer
'
'Public Declare Function Bematech_FI_VerificaIndiceAliquotasIss Lib "BEMAFI32.DLL" (ByVal AliquotasIss As String) As Integer
'
'
...
Public Declare Function Bematech_FI_DataHoraGravacaoUsuarioSWBasicoMFAdicional Lib "BEMAFI32.DLL" (ByVal ArquivoMFD As String, ByVal ArquivoDestino As String, ByVal FormatoDestino As String) As Integer
...
Public Declare Function setLibType Lib "sign_bema.dll" (iTipo As Integer) As Integer
...
Public Const SECAO_SISTEMA = "Sistema"
Public Const BEMATECH_INI_32 = "BemaFI32.ini"
Public Const BEMATECH_INI_64 = "BemaFI64.ini"

Public Declare Function Bematech_FI_VendaBruta Lib "BEMAFI32.DLL" (ByVal Valor As String) As Integer
Public Declare Function Bematech_FI_VerificaZPendente Lib "BEMAFI32.DLL" (ByVal Valor As String) As Integer


Public Function Bematech_AjustaTextoImpressora(sTexto As String, Optional iColunas As Integer = 48) As String

Dim sTextoFormatado As String, sTextoAux As String
Dim iTam As Integer, sTextoFinal As String

    sTextoFormatado = Replace(Replace(sTexto, vbCr, ""), vbLf, "")
    
    sTextoFormatado = DesacentuaTexto(sTextoFormatado)
    
    Do While True
    
        sTextoAux = Mid(sTextoFormatado, 1, 48)
        iTam = Len(sTextoAux)
        If iTam < iColunas Then sTextoAux = sTextoAux & Space(iColunas - iTam)
        sTextoAux = sTextoAux & vbLf
        sTextoFinal = sTextoFinal & sTextoAux
        sTextoFormatado = Mid(sTextoFormatado, 49)
        If Len(sTextoFormatado) = 0 Then Exit Do
    
    Loop
        
    Bematech_AjustaTextoImpressora = sTextoFinal
