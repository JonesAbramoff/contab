...
On Error GoTo Erro_Trata_Parametros
    ...
    'Se foi passado um Tipo de Registro de apuração ICMS
    If Not objTipoApuracaoReg Is Nothing Then
    
        'Se o código foi passado
        If objTipoApuracaoReg.iCodigo > 0 Then
        
            'Lê o Tipo de Apuração de Registro ICMS com o código passado
            ...
            If lErro = SUCESSO Then
                ...
                'Traz os dados do Tipo de apuração ICMS para a tela
...
On Error GoTo Erro_BotaoProxNum_Click
    ...
    'Gera código automático para próximo Tipo de Registro de apuração ICMS
...
On Error GoTo Erro_BotaoExcluir_Click
    ...
    'Pede a confirmação da exclusão do tipo de registro de apuração ICMS
...
Public Function Form_Load_Ocx() As Object
    ...
    Caption = "Tipos de Registro para apuração de ICMS"
    Call Form_Load
