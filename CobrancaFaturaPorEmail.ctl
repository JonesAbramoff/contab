...
Begin VB.UserControl CobrancaFaturaPorEmailOcx 
   ClientHeight    =   6495
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9510
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Modelo 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "CobrancaFaturaPorEmail.ctx":0000
         Left            =   2205
         List            =   "CobrancaFaturaPorEmail.ctx":000A
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.CheckBox IgnoraJaEnviados 
            Caption         =   "Ignorar NFs cujo email já tenha sido enviado"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Carta 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "CobrancaFaturaPorEmail.ctx":003F
         Left            =   3090
         List            =   "CobrancaFaturaPorEmail.ctx":0049
         Style           =   2  'Dropdown List
         TabIndex        =   38
         Top             =   420
         Width           =   2235
      ...
      Begin VB.CommandButton BotaoMarcarTodos 
         ...
         Height          =   555
         Left            =   60
         Picture         =   "CobrancaFaturaPorEmail.ctx":007E
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   3450
         Width           =   1725
      ...
      Begin VB.CommandButton BotaoDesmarcarTodos 
         ...
         Height          =   555
         Left            =   45
         Picture         =   "CobrancaFaturaPorEmail.ctx":1098
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   4200
         Width           =   1725
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoEmail 
         Height          =   360
         Left            =   120
         Picture         =   "CobrancaFaturaPorEmail.ctx":227A
         Style           =   1  'Graphical
         TabIndex        =   17
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   645
         Picture         =   "CobrancaFaturaPorEmail.ctx":2C1C
         Style           =   1  'Graphical
         TabIndex        =   18
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1155
         Picture         =   "CobrancaFaturaPorEmail.ctx":314E
         Style           =   1  'Graphical
         TabIndex        =   19
         ToolTipText     =   "Fechar"
         Top             =   75
   ...
   Begin MSComctlLib.TabStrip TabStrip1 
      ...
      BeginProperty Tabs {1EFB6598-857C-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Tab2 {1EFB659A-857C-11D1-B16A-00C0F0283628} 
            Caption         =   "Notas Fiscais Simples sem Fatura"
            ImageVarType    =   2
         EndProperty
      EndProperty
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
   ...
   End
End
Attribute VB_Name = "CobrancaFaturaPorEmailOcx"
