...
Begin VB.UserControl NFiscalRemOcx 
   ClientHeight    =   5745
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9510
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton BotaoLimparNF 
            Height          =   300
            Left            =   6090
            Picture         =   "NFiscalRemOcx.ctx":0000
            Style           =   1  'Graphical
            TabIndex        =   177
         ...
         Begin VB.ComboBox TipoNFiscal 
            Height          =   315
            ItemData        =   "NFiscalRemOcx.ctx":0532
            Left            =   1800
            List            =   "NFiscalRemOcx.ctx":0534
            TabIndex        =   0
            Top             =   255
            Width           =   3030
         End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame18 
         ...
         Begin VB.ComboBox ProdutoRastro 
            Height          =   315
            ItemData        =   "NFiscalRemOcx.ctx":0536
            Left            =   600
            List            =   "NFiscalRemOcx.ctx":0543
            Style           =   2  'Dropdown List
            TabIndex        =   162
            Top             =   645
            Width           =   1740
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "NFiscalRemOcx.ctx":0562
            Left            =   615
            List            =   "NFiscalRemOcx.ctx":056F
            Style           =   2  'Dropdown List
            TabIndex        =   142
            Top             =   2280
            Visible         =   0   'False
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   330
         Left            =   530
         Picture         =   "NFiscalRemOcx.ctx":058E
         Style           =   1  'Graphical
         TabIndex        =   17
         ToolTipText     =   "Excluir"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   330
         Left            =   1440
         Picture         =   "NFiscalRemOcx.ctx":0718
         Style           =   1  'Graphical
         TabIndex        =   19
         ToolTipText     =   "Fechar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   330
         Left            =   985
         Picture         =   "NFiscalRemOcx.ctx":0896
         Style           =   1  'Graphical
         TabIndex        =   18
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   330
         Left            =   75
         Picture         =   "NFiscalRemOcx.ctx":0DC8
         Style           =   1  'Graphical
         TabIndex        =   16
         ToolTipText     =   "Gravar"
         Top             =   75
   ...
   End
End
Attribute VB_Name = "NFiscalRemOcx"
