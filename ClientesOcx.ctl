...
Begin VB.UserControl ClientesOcx 
   ClientHeight    =   5685
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9300
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox TipoFrete 
         Height          =   315
         ItemData        =   "ClientesOcx.ctx":00EA
         Left            =   6255
         List            =   "ClientesOcx.ctx":00F4
         Style           =   2  'Dropdown List
         TabIndex        =   41
         Top             =   1965
         Width           =   1125
      ...
      Begin VB.ComboBox PadraoCobranca 
         Height          =   315
         ItemData        =   "ClientesOcx.ctx":0102
         Left            =   2040
         List            =   "ClientesOcx.ctx":0104
         TabIndex        =   38
         Top             =   1530
         Width           =   1965
      End
