...
Begin VB.UserControl RelOpPosCli 
   ClientHeight    =   1905
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   6945
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   600
      Left            =   3840
      Picture         =   "RelOpPosCliPur.ctx":0000
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   165
      Width           =   1815
   ...
   Begin VB.ComboBox Filial 
      Height          =   315
      ItemData        =   "RelOpPosCliPur.ctx":0102
      Left            =   885
      List            =   "RelOpPosCliPur.ctx":0104
      TabIndex        =   1
      Top             =   735
      Width           =   1815
   End
...
On Error GoTo Erro_PreencherRelOp
    ...
    If lErro <> AD_BOOL_TRUE Then gError 23334
    ...
    If lErro <> SUCESSO Then gError 23337
...
Erro_PreencherRelOp:
    ...
    Select Case gErr
        ...
        Case 23335
            lErro = Rotina_Erro(vbOKOnly, "ERRO_CLIENTE_NAO_INFORMADO", gErr, Error$)
            Cliente.SetFocus

        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 171232)
