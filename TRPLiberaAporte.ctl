...
Begin VB.UserControl TRPLiberaAporte 
   ClientHeight    =   6000
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9510
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Base 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "TRPLiberaAporte.ctx":0000
         Left            =   855
         List            =   "TRPLiberaAporte.ctx":000A
      ...
      Begin VB.ComboBox Forma 
         Height          =   315
         ItemData        =   "TRPLiberaAporte.ctx":0037
         Left            =   2985
         List            =   "TRPLiberaAporte.ctx":0041
         Style           =   2  'Dropdown List
         TabIndex        =   28
         Top             =   240
         Width           =   1245
      ...
      Begin VB.CommandButton BotaoLibera 
         ...
         Height          =   960
         Left            =   15
         Picture         =   "TRPLiberaAporte.ctx":0063
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   4065
         Width           =   1590
      ...
      Begin VB.CommandButton BotaoDesmarcarTodos 
         ...
         Height          =   570
         Left            =   4635
         Picture         =   "TRPLiberaAporte.ctx":04A5
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   4260
         Width           =   1425
      ...
      Begin VB.CommandButton BotaoMarcarTodos 
         ...
         Height          =   570
         Left            =   3000
         Picture         =   "TRPLiberaAporte.ctx":1687
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   4260
         Width           =   1425
   ...
   Begin VB.CommandButton BotaoFechar 
      ...
      Height          =   330
      Left            =   8175
      Picture         =   "TRPLiberaAporte.ctx":26A1
      Style           =   1  'Graphical
      TabIndex        =   11
      ToolTipText     =   "Fechar"
      Top             =   120
   ...
   End
End
Attribute VB_Name = "TRPLiberaAporte"
...
Dim gobjTRPLiberaAporteSel As New ClassTRPLiberaAporteSel
...
Private Function Move_Selecao_Memoria(ByVal objTRPLiberaAporteSel As ClassTRPLiberaAporteSel) As Long

Dim lErro As Long

On Error GoTo Erro_Move_Selecao_Memoria

    objTRPLiberaAporteSel.dtDataPagtoAte = StrParaDate(DataAte.Text)
    objTRPLiberaAporteSel.dtDataPagtoDe = StrParaDate(DataDe.Text)
    objTRPLiberaAporteSel.lCodigoDe = StrParaLong(AporteDe.Text)
    objTRPLiberaAporteSel.lCodigoAte = StrParaLong(AporteAte.Text)
    
    If objTRPLiberaAporteSel.dtDataPagtoAte <> DATA_NULA And objTRPLiberaAporteSel.dtDataPagtoDe <> DATA_NULA Then
        If objTRPLiberaAporteSel.dtDataPagtoAte < objTRPLiberaAporteSel.dtDataPagtoDe Then gError 190761
    End If
...
Dim objTRPLiberaAporteSel As New ClassTRPLiberaAporteSel
...
On Error GoTo Erro_Traz_Bloqueios_Tela
    ...
    lErro = Move_Selecao_Memoria(objTRPLiberaAporteSel)
    If lErro <> SUCESSO Then gError 190763
  
    'Preenche a Coleção de Bloqueios
    lErro = CF("TRPAportes_Le_Bloqueios", objTRPLiberaAporteSel)
    If lErro <> SUCESSO Then gError 190764
    
    If Not bTirandoLiberados Then
        If objTRPLiberaAporteSel.colAportes.Count = 0 Then gError 190765
    End If
    
    Set gobjTRPLiberaAporteSel = objTRPLiberaAporteSel
    
    'Preenche o GridBloqueio
    lErro = Grid_Bloqueio_Preenche(objTRPLiberaAporteSel)
...
On Error GoTo Erro_BotaoAporte_Click
    ...
    objAporte.lNumIntDoc = gobjTRPLiberaAporteSel.colAportes.Item(GridBloqueio.Row).lNumIntDocAporte

    'Chama a tela de Pedidos de Venda
    Call Chama_Tela("TRPAporte", objAporte)
...
Public Sub Form_Unload(Cancel As Integer)
    ...
    Set gobjTRPLiberaAporteSel = Nothing
...
Dim objAporte As New ClassTRPAportes
    ...
    Call Chama_Tela("TRPAportesLista", colSelecao, objAporte, objEventoAporteAte)
...
Dim objAporte As New ClassTRPAportes
    ...
    'Chama Tela PedidoVendaLista
    Call Chama_Tela("TRPAportesLista", colSelecao, objAporte, objEventoAporteDe)
...
Erro_AporteDe_Validate:
    ...
    Select Case gErr
        ...
        Case 190783
            Call Rotina_Erro(vbOKOnly, "ERRO_TRPAPORTES_NAO_CADASTRADO", gErr, objAporte.lCodigo)
...
Function Trata_Parametros(Optional objAporte As ClassTRPAportes) As Long
...
Private Function Grid_Bloqueio_Preenche(ByVal objLiberaAporteSel As ClassTRPLiberaAporteSel) As Long
...
On Error GoTo Erro_Grid_Bloqueio_Preenche
    ...
    For Each objAportePagtoC In objLiberaAporteSel.colAportes
        ...
        dValor = 0
        If objAportePagtoC.iBase = BASE_TRP_APORTE_REAL Then
...
On Error GoTo Erro_Gravar_Registro
    ...
    lErro = CF("TRPAportes_Libera", colAportes)
...
On Error GoTo Erro_Move_Tela_Memoria
    ...
    For iIndice = 1 To objGridBloqueio.iLinhasExistentes
        ...
        If GridBloqueio.TextMatrix(iIndice, iGrid_Libera_Col) = GRID_CHECKBOX_ATIVO Then
            ...
            Set objAportePagto = gobjTRPLiberaAporteSel.colAportes.Item(iIndice)
