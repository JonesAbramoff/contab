...
Begin VB.UserControl RelOpBordCobrDuplOcx 
   ClientHeight    =   1155
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   5175
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   615
      Left            =   3450
      Picture         =   "RelOpBordCobrDupl.ctx":0000
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   150
      Width           =   1575
   ...
   End
End
Attribute VB_Name = "RelOpBordCobrDuplOcx"
...
Dim lErro As Long
Dim sSigla As String, sSigla1 As String
...
On Error GoTo Erro_PreencherRelOp
    ...
    lErro = objRelOpcoes.IncluirParametro("NDUPLINIC", "0")
    If lErro <> AD_BOOL_TRUE Then gError 38194

    lErro = objRelOpcoes.IncluirParametro("NDUPLFIM", "0")
    If lErro <> AD_BOOL_TRUE Then gError 38195
   
    lErro = objRelOpcoes.IncluirParametro("NPARCINIC", "0")
    If lErro <> AD_BOOL_TRUE Then gError 54900

    lErro = objRelOpcoes.IncluirParametro("NPARCFIM", "0")
    ...
    objRelOpcoes.sSelecao = "NumBordero = " & Forprint_ConvLong(StrParaLong(NumBordero.Text))
...
Public Function Form_Load_Ocx() As Object
    ...
    Caption = "Emissão de NF por Borderô de Cobrança"
    Call Form_Load
