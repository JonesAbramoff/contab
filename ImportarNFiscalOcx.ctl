...
Begin VB.UserControl ImportarNFiscalOcx 
   ClientHeight    =   2340
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   5385
   ...
   Begin VB.CommandButton BotaoOK 
      ...
      Height          =   540
      Left            =   1800
      Picture         =   "ImportarNFiscalOcx.ctx":0000
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   1590
      Width           =   855
   ...
   Begin VB.CommandButton BotaoCancela 
      ...
      Height          =   540
      Left            =   2730
      Picture         =   "ImportarNFiscalOcx.ctx":015A
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   1590
      Width           =   855
   ...
   End
End
Attribute VB_Name = "ImportarNFiscalOcx"
...
On Error GoTo Erro_BotaoOK_Click
    ...
    If Len(Trim(NomeArquivo.Text)) = 0 Then gError 62295
    
    lErro = CF("NFiscais_Importar", NomeArquivo.Text)
...
Erro_BotaoOK_Click:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 161828)
...
Erro_Form_Load:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 161829)
