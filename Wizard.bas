...
Function AddToAddInCommandBar(VBInst As Object, sCaption As String, oBitmap As Object) As Object   'Office.CommandBarControl
    ...
    Set cbMenu = VBInst.CommandBars(1).Controls(9)
    ...
    Set cbMenuCommandBar = cbMenu.CommandBar.Controls.Add(1)
    c = cbMenu.CommandBar.Controls.Count - 1
    If cbMenu.CommandBar.Controls(c).BeginGroup And _
        Not cbMenu.CommandBar.Controls(c - 1).BeginGroup Then
...
On Error GoTo Erro_Main
    ...
    If lSistema = 0 Then Error 41615

    '??? para que a equipe de desenvolvimento nao passe pela tela...
...
'''
'''    If objUsuarioEmpresa.iTelaOK = False Then Error 41617

    objUsuarioEmpresa.sCodUsuario = "dudu"
    objUsuarioEmpresa.sSenha = "pwd_dudu"
    objUsuarioEmpresa.sNomeEmpresa = "Forprint Informatica Ltda"
    ...
    If lErro <> AD_BOOL_TRUE Then Error 41618
    
    'seleciona a Empresa e filial
    lErro = Sistema_DefEmpresa(objUsuarioEmpresa.sNomeEmpresa, objUsuarioEmpresa.lCodEmpresa, objUsuarioEmpresa.sNomeFilial, objUsuarioEmpresa.iCodFilial)
...
Erro_Main:
    ...
    Select Case Err
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, 175746)
