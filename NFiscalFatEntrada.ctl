...
Begin VB.UserControl NFiscalFatEntrada 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton BotaoAnexos 
         Height          =   465
         Left            =   8340
         Picture         =   "NFiscalFatEntrada.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   258
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CommandButton BotaoTrazerNFe 
            Height          =   360
            Left            =   6165
            Picture         =   "NFiscalFatEntrada.ctx":0196
            Style           =   1  'Graphical
            TabIndex        =   4
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton Recebimento 
            Height          =   360
            Left            =   2670
            Picture         =   "NFiscalFatEntrada.ctx":0568
            Style           =   1  'Graphical
            TabIndex        =   6
            ToolTipText     =   "Trazer Dados"
            Top             =   225
         ...
         Begin VB.CommandButton BotaoLimparNF 
            Height          =   315
            Left            =   5790
            Picture         =   "NFiscalFatEntrada.ctx":093A
            Style           =   1  'Graphical
            TabIndex        =   11
         ...
         Begin VB.ComboBox TipoNFiscal 
            Height          =   315
            ItemData        =   "NFiscalFatEntrada.ctx":0E6C
            Left            =   1455
            List            =   "NFiscalFatEntrada.ctx":0E6E
            TabIndex        =   7
            Top             =   675
            Width           =   4695
         End
   ...
   Begin VB.Frame Frame2 
      ...
      Top             =   45
      Width           =   3660
      Begin VB.CommandButton BotaoVerContrato 
         Height          =   360
         Left            =   3120
         Picture         =   "NFiscalFatEntrada.ctx":0E70
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      Begin VB.CommandButton BotaoContrato 
         Height          =   360
         Left            =   2745
         Picture         =   "NFiscalFatEntrada.ctx":1182
         Style           =   1  'Graphical
         TabIndex        =   1
         ToolTipText     =   "Trazer Dados"
         Top             =   150
         Width           =   360
      End
      Begin MSMask.MaskEdBox ContratoPag 
         Height          =   315
         Left            =   1305
         TabIndex        =   0
         Top             =   180
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox ProdutoRastro 
            Height          =   315
            ItemData        =   "NFiscalFatEntrada.ctx":1554
            Left            =   0
            List            =   "NFiscalFatEntrada.ctx":1561
            Style           =   2  'Dropdown List
            TabIndex        =   205
            Top             =   0
            Width           =   1740
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "NFiscalFatEntrada.ctx":1580
            Left            =   3870
            List            =   "NFiscalFatEntrada.ctx":158A
            Style           =   2  'Dropdown List
            TabIndex        =   184
            Top             =   165
            Visible         =   0   'False
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   330
         Left            =   1357
         Picture         =   "NFiscalFatEntrada.ctx":15A6
         Style           =   1  'Graphical
         TabIndex        =   26
         ToolTipText     =   "Excluir"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoConsultaTitPag 
         ...
         Height          =   330
         Left            =   60
         Picture         =   "NFiscalFatEntrada.ctx":1730
         Style           =   1  'Graphical
         TabIndex        =   24
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   330
         Left            =   896
         Picture         =   "NFiscalFatEntrada.ctx":1FB2
         Style           =   1  'Graphical
         TabIndex        =   25
         ToolTipText     =   "Gravar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   330
         Left            =   1818
         Picture         =   "NFiscalFatEntrada.ctx":210C
         Style           =   1  'Graphical
         TabIndex        =   27
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   330
         Left            =   2280
         Picture         =   "NFiscalFatEntrada.ctx":263E
         Style           =   1  'Graphical
         TabIndex        =   28
         ToolTipText     =   "Fechar"
         Top             =   75
...
Private Sub ContratoPag_Change()
    Call objCT.ContratoPag_Change
End Sub

Private Sub ContratoPag_GotFocus()
    Call objCT.ContratoPag_GotFocus
End Sub
...
Private Sub BotaoVerContrato_Click()
    Call objCT.BotaoVerContrato_Click
End Sub
