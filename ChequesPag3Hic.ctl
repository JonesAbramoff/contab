...
Begin VB.UserControl ChequesPag3 
   ...
   Begin VB.CommandButton BotaoReter 
      ...
      Height          =   525
      Left            =   465
      Picture         =   "ChequesPag3Hic.ctx":0000
      Style           =   1  'Graphical
      TabIndex        =   21
      Top             =   5040
      Width           =   2310
   ...
   Begin VB.PictureBox Picture7 
      ...
      Begin VB.CommandButton BotaoVoltar 
         Height          =   345
         Left            =   75
         Picture         =   "ChequesPag3Hic.ctx":0432
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   90
         Width           =   930
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   345
         Left            =   2115
         Picture         =   "ChequesPag3Hic.ctx":0B90
         Style           =   1  'Graphical
         TabIndex        =   13
         ToolTipText     =   "Fechar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoSeguir 
         Height          =   345
         Left            =   1125
         Picture         =   "ChequesPag3Hic.ctx":0D0E
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   90
         Width           =   930
...
Private Sub UserControl_Initialize()
    ...
    'hicare
    Set objCT.gobjInfoUsu = New CTChequesPag3VGHic
    Set objCT.gobjInfoUsu.gobjTelaUsu = New CTChequesPag3Hic
    '################################################
...
Private Sub Observacao_GotFocus()
     Call objCT.gobjInfoUsu.gobjTelaUsu.Observacao_GotFocus(objCT)
End Sub

Private Sub Observacao_KeyPress(KeyAscii As Integer)
     Call objCT.gobjInfoUsu.gobjTelaUsu.Observacao_KeyPress(objCT, KeyAscii)
End Sub

Private Sub Observacao_Validate(Cancel As Boolean)
     Call objCT.gobjInfoUsu.gobjTelaUsu.Observacao_Validate(objCT, Cancel)
End Sub
