...
Begin VB.UserControl ContratoSrvOcx 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin MSMask.MaskEdBox CliContrato 
         ...
         PromptChar      =   "_"
      End
      Begin MSMask.MaskEdBox FilCliContrato 
         Height          =   315
         Left            =   5265
         TabIndex        =   33
         Top             =   1125
...
Erro_objEventoTipo_evSelecao:
    ...
    Select Case gErr
        ...
        Case 195534
            Call Rotina_Erro(vbOKOnly, "ERRO_TIPOGARANTIA_NAO_ENCONTRADA", gErr, objTipoGarantia.lCodigo)
...
On Error GoTo Erro_Traz_Contrato_Tela
    ...
    CliContrato.Text = objcliente.sNomeReduzido
    ...
    FilCliContrato.Text = objFilialCliente.sNome
...
On Error GoTo Erro_Exibe_Dados_TipoGarantia
    ...
    For iIndice = 1 To objTipoGarantia.colTipoGarantiaProduto.Count
        ...
        GridServicos.TextMatrix(iIndice, iGrid_Servico_Col) = objTipoGarantia.colTipoGarantiaProduto.Item(iIndice).sProduto
...
'    ??? Parent.HelpContextID = IDH_
    ...
    Caption = "Item de Contrato de Serviço"
    Call Form_Load
End Function
