...
Begin VB.UserControl FluxoSintRevOcx 
   ClientHeight    =   3900
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9480
   ScaleHeight     =   3900
   ScaleWidth      =   9480
   Begin VB.CommandButton Botao_GraficoReal 
      Caption         =   "Gráfico Real"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
      ...
      Height          =   615
      Left            =   6360
      Picture         =   "FluxoSintRevOcx.ctx":0000
      Style           =   1  'Graphical
      TabIndex        =   23
      Top             =   120
      Width           =   1590
   ...
   Begin VB.CommandButton Botao_GraficoAjustado 
      ...
      Height          =   615
      Left            =   4350
      Picture         =   "FluxoSintRevOcx.ctx":0432
      Style           =   1  'Graphical
      TabIndex        =   22
      Top             =   120
      Width           =   1590
   End
   Begin MSMask.MaskEdBox SaldoAcumuladoPercentual 
      Height          =   225
      Left            =   6870
      TabIndex        =   21
      Top             =   1890
      ...
      PromptChar      =   " "
   End
   Begin MSMask.MaskEdBox SaldoAcumuladoReal 
      Height          =   225
      Left            =   5610
      TabIndex        =   20
      Top             =   1890
      ...
      PromptChar      =   " "
   End
   Begin MSMask.MaskEdBox SaldoAcumuladoAjust 
      Height          =   225
      Left            =   4380
      TabIndex        =   19
      Top             =   1890
   ...
   Begin VB.PictureBox Picture5 
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "FluxoSintRevOcx.ctx":0864
         Style           =   1  'Graphical
         TabIndex        =   17
         ToolTipText     =   "Gravar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   600
         Picture         =   "FluxoSintRevOcx.ctx":09BE
         Style           =   1  'Graphical
         TabIndex        =   18
         ToolTipText     =   "Fechar"
         Top             =   90
   ...
   Begin VB.CommandButton Botao_ImprimeFluxo 
      ...
      Height          =   615
      Left            =   2340
      Picture         =   "FluxoSintRevOcx.ctx":0B3C
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   120
      Width           =   1590
   ...
   Begin VB.CommandButton Botao_ExibeFluxo 
      ...
      Height          =   615
      Left            =   330
      Picture         =   "FluxoSintRevOcx.ctx":0C3E
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   120
      Width           =   1590
   End
   Begin MSMask.MaskEdBox ValorRealRec 
      Height          =   225
      Left            =   2550
      TabIndex        =   10
      Top             =   3525
   ...
   Begin MSMask.MaskEdBox PercentualRec 
      ...
      PromptChar      =   " "
   End
   Begin MSMask.MaskEdBox ValorRealPag 
      Height          =   225
      Left            =   4995
      TabIndex        =   13
      Top             =   3540
   ...
   Begin MSMask.MaskEdBox PercentualPag 
      ...
      PromptChar      =   " "
   End
   Begin MSMask.MaskEdBox ValorRealTes 
      Height          =   225
      Left            =   5325
      TabIndex        =   3
      Top             =   795
   ...
   End
End
Attribute VB_Name = "FluxoSintRevOcx"
...
Const GRAFICO_REAL = 2

'Colunas do Grid
Const GRID_DATA_COL = 1
Const GRID_VALOR_AJUSTADO_RECEBER_COL = 2
Const GRID_VALOR_REAL_RECEBER_COL = 3
Const GRID_VALOR_PERCENTUAL_RECEBER_COL = 4
Const GRID_VALOR_AJUSTADO_PAGAMENTO_COL = 5
Const GRID_VALOR_REAL_PAGAMENTO_COL = 6
Const GRID_VALOR_PERCENTUAL_PAGAMENTO_COL = 7
Const GRID_VALOR_AJUSTADO_TESOURARIA_COL = 8
Const GRID_VALOR_REAL_TESOURARIA_COL = 9
Const GRID_VALOR_PERCENTUAL_TESOURARIA_COL = 10
Const GRID_SALDO_AJUSTADO_COL = 11
Const GRID_SALDO_REAL_COL = 12
Const GRID_SALDO_PERCENTUAL_COL = 13
Const GRID_SALDO_ACUMULADO_AJUSTADO_COL = 14
Const GRID_SALDO_ACUMULADO_REAL_COL = 15
...
On Error GoTo Erro_Botao_ExibeFluxo_Click
    ...
    If lErro <> SUCESSO Then Error 55928

    lErro = ExibeFluxoSint()
    If lErro <> SUCESSO Then Error 21107
...
Erro_Botao_ExibeFluxo_Click:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 160477)
...
On Error GoTo Erro_Botao_GraficoAjustado_Click
    ...
    If lErro <> SUCESSO Then gError 79968
...
Erro_Botao_GraficoAjustado_Click:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 160478)
...
Private Sub Botao_GraficoReal_Click()
'Dispara a geração de gráfico

Dim lErro As Long
Dim iGrafico As Integer

On Error GoTo Erro_Botao_GraficoReal_Click
    
    'Define que o gráfico será gerado em cima dos valores ajustados
    iGrafico = GRAFICO_REAL
    
    'Gera os dados que serão utilizados na montagem do gráfico
    lErro = Gera_Grafico(iGrafico)
    If lErro <> SUCESSO Then gError 79969
    
    Exit Sub
    
Erro_Botao_GraficoReal_Click:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 160479)
...
On Error GoTo Erro_Form_Load
    ...
    If lErro <> SUCESSO Then Error 21108
...
Erro_Form_Load:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 160480)
...
On Error GoTo Erro_Trata_Parametros
    ...
    If (objFluxo Is Nothing) Then Error 21109

    Set objFluxo1 = objFluxo

    lErro = ExibeFluxoSint()
    If lErro <> SUCESSO Then Error 21110

    Parent.Caption = "Fluxo Sintético " & objFluxo.sFluxo & " - Revisado"
...
Erro_Trata_Parametros:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error, 160481)
...
Dim dColunaSomaValorRealRec As Double
Dim dColunaSomaValorAjustadoPag As Double
Dim dColunaSomaValorRealPag As Double
Dim dColunaSomaValorAjustadoTes As Double
Dim dColunaSomaValorRealTes As Double
...
On Error GoTo Erro_Preenche_GridFCaixa
    ...
    For Each objFluxoSldIni In colFluxoSldIni
        ...
        dSaldoInicialReal = dSaldoInicialReal + objFluxoSldIni.dSaldoReal
    Next
    
    dSaldoAcumuladoAjust = dSaldoInicialAjust
    dSaldoAcumuladoReal = dSaldoInicialReal
    ...
    GridFCaixa.TextMatrix(1, GRID_SALDO_REAL_COL) = Format(dSaldoInicialReal, "Standard")
    GridFCaixa.TextMatrix(1, GRID_SALDO_ACUMULADO_AJUSTADO_COL) = Format(dSaldoInicialAjust, "Standard") 'Coluna Acumul.Ajust.
    GridFCaixa.TextMatrix(1, GRID_SALDO_ACUMULADO_REAL_COL) = Format(dSaldoInicialReal, "Standard") 'Coluna Acumul.Sist.
    ...
    For iIndice = 1 To colFluxoSint.Count
        ...
        GridFCaixa.TextMatrix(iIndice, GRID_VALOR_REAL_RECEBER_COL) = Format(objFluxoSint.dRecValorReal, "Standard")
        ...
        If objFluxoSint.dRecValorReal <> 0 Then
            dPercRec = (objFluxoSint.dRecValorAjustado / objFluxoSint.dRecValorReal)
            GridFCaixa.TextMatrix(iIndice, GRID_VALOR_PERCENTUAL_RECEBER_COL) = Format(dPercRec, "Percent")
        End If
        
        GridFCaixa.TextMatrix(iIndice, GRID_VALOR_REAL_PAGAMENTO_COL) = Format(objFluxoSint.dPagValorReal, "Standard")
        ...
        If objFluxoSint.dPagValorReal <> 0 Then
            dPercPag = (objFluxoSint.dPagValorAjustado / objFluxoSint.dPagValorReal)
            GridFCaixa.TextMatrix(iIndice, GRID_VALOR_PERCENTUAL_PAGAMENTO_COL) = Format(dPercPag, "Percent")
        End If
        
        GridFCaixa.TextMatrix(iIndice, GRID_VALOR_REAL_TESOURARIA_COL) = Format(objFluxoSint.dTesValorReal, "Standard")
        ...
        If objFluxoSint.dTesValorReal <> 0 Then
            dPercTes = (objFluxoSint.dTesValorAjustado / objFluxoSint.dTesValorReal)
            GridFCaixa.TextMatrix(iIndice, GRID_VALOR_PERCENTUAL_TESOURARIA_COL) = Format(dPercTes, "Percent")
        End If
        
        GridFCaixa.TextMatrix(iIndice, GRID_SALDO_REAL_COL) = Format((objFluxoSint.dRecValorReal + objFluxoSint.dTesValorReal - objFluxoSint.dPagValorReal), "Standard")
        ...
        If (objFluxoSint.dSaldoValorReal) <> 0 Then
            dPercSaldo = (objFluxoSint.dRecValorAjustado + objFluxoSint.dTesValorAjustado - objFluxoSint.dPagValorAjustado) / objFluxoSint.dSaldoValorReal
        ...
        dSaldoAcumuladoReal = dSaldoAcumuladoReal + objFluxoSint.dRecValorReal + objFluxoSint.dTesValorReal - objFluxoSint.dPagValorReal
        ...
        GridFCaixa.TextMatrix(iIndice, GRID_SALDO_ACUMULADO_REAL_COL) = Format(dSaldoAcumuladoReal, "Standard")
        ...
        If dSaldoAcumuladoReal <> 0 Then
            dPercSaldoAcumulado = dSaldoAcumuladoAjust / dSaldoAcumuladoReal
        ...
        dColunaSomaValorRealRec = dColunaSomaValorRealRec + objFluxoSint.dRecValorReal
        dColunaSomaValorAjustadoPag = dColunaSomaValorAjustadoPag + objFluxoSint.dPagValorAjustado
        dColunaSomaValorRealPag = dColunaSomaValorRealPag + objFluxoSint.dPagValorReal
        dColunaSomaValorAjustadoTes = dColunaSomaValorAjustadoTes + objFluxoSint.dTesValorAjustado
        dColunaSomaValorRealTes = dColunaSomaValorRealTes + objFluxoSint.dTesValorReal
    ...
    GridFCaixa.TextMatrix(iIndice, GRID_DATA_COL) = "Totais:"
    
    GridFCaixa.TextMatrix(iIndice, GRID_VALOR_REAL_RECEBER_COL) = Format(dColunaSomaValorRealRec, "Standard")
    GridFCaixa.TextMatrix(iIndice, GRID_VALOR_AJUSTADO_RECEBER_COL) = Format(dColunaSomaValorAjustadoRec, "Standard")
    GridFCaixa.TextMatrix(iIndice, GRID_VALOR_PERCENTUAL_RECEBER_COL) = Format(0, "Percent")
    If dColunaSomaValorRealRec <> 0 Then
        dColunaSomaPercRec = dColunaSomaValorAjustadoRec / dColunaSomaValorRealRec
        GridFCaixa.TextMatrix(iIndice, GRID_VALOR_PERCENTUAL_RECEBER_COL) = Format(dColunaSomaPercRec, "Percent")
    End If
    
    GridFCaixa.TextMatrix(iIndice, GRID_VALOR_REAL_PAGAMENTO_COL) = Format(dColunaSomaValorRealPag, "Standard")
    GridFCaixa.TextMatrix(iIndice, GRID_VALOR_AJUSTADO_PAGAMENTO_COL) = Format(dColunaSomaValorAjustadoPag, "Standard")
    GridFCaixa.TextMatrix(iIndice, GRID_VALOR_PERCENTUAL_PAGAMENTO_COL) = Format(0, "Percent")
    If dColunaSomaValorRealPag <> 0 Then
        dColunaSomaPercPag = dColunaSomaValorAjustadoPag / dColunaSomaValorRealPag
        GridFCaixa.TextMatrix(iIndice, GRID_VALOR_PERCENTUAL_PAGAMENTO_COL) = Format(dColunaSomaPercPag, "Percent")
    End If
    
    GridFCaixa.TextMatrix(iIndice, GRID_VALOR_REAL_TESOURARIA_COL) = Format(dColunaSomaValorRealTes, "Standard")
    GridFCaixa.TextMatrix(iIndice, GRID_VALOR_AJUSTADO_TESOURARIA_COL) = Format(dColunaSomaValorAjustadoTes, "Standard")
    GridFCaixa.TextMatrix(iIndice, GRID_VALOR_PERCENTUAL_TESOURARIA_COL) = Format(0, "Percent")
    If dColunaSomaValorRealTes <> 0 Then
        dColunaSomaPercTes = dColunaSomaValorAjustadoTes / dColunaSomaValorRealTes
        GridFCaixa.TextMatrix(iIndice, GRID_VALOR_PERCENTUAL_TESOURARIA_COL) = Format(dColunaSomaPercTes, "Percent")
    End If
    
    GridFCaixa.TextMatrix(iIndice, GRID_SALDO_REAL_COL) = Format(dSaldoInicialReal + dColunaSomaValorRealRec + dColunaSomaValorRealTes - dColunaSomaValorRealPag, "Standard")
    ...
    GridFCaixa.TextMatrix(iIndice, GRID_SALDO_PERCENTUAL_COL) = Format(0, "Percent")
    If (dSaldoInicialReal + dColunaSomaValorRealRec + dColunaSomaValorRealTes - dColunaSomaValorRealPag) <> 0 Then
        dColunaSomaPercSaldo = (dSaldoInicialAjust + dColunaSomaValorAjustadoRec + dColunaSomaValorAjustadoTes - dColunaSomaValorAjustadoPag) / (dSaldoInicialReal + dColunaSomaValorRealRec + dColunaSomaValorRealTes - dColunaSomaValorRealPag)
...
Erro_Preenche_GridFCaixa:
    ...
    Select Case Err
        ...
        Case Else
             lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 160482)
...
On Error GoTo Erro_Saida_Celula
    ...
    If lErro = SUCESSO Then
        ...
        If GridFCaixa.Col = GRID_VALOR_AJUSTADO_TESOURARIA_COL Then
            ...
            If lErro <> SUCESSO Then Error 21112

        End If

        lErro = Grid_Finaliza_Saida_Celula(objGridInt)
        If lErro <> SUCESSO Then Error 21113
...
Erro_Saida_Celula:
    ...
    Select Case Err
        ...
        Case Else
             lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 160483)
...
Dim dColunaSomaSaldoReal As Double
Dim objFluxoSint As ClassFluxoSint
Dim dSaldoValorReal As Double
...
On Error GoTo Erro_Saida_Celula_ValorAjustadoTes
    ...
    If objGrid1.iLinhasExistentes <> GridFCaixa.Row And GridFCaixa.Row > 1 Then
        ...
        If Len(ValorAjustadoTes.Text) > 0 Then
            lErro = Valor_Critica(ValorAjustadoTes.Text)
            If lErro <> SUCESSO Then Error 21114
        ...
        objFluxoSint.dTesValorReal = CDbl(GridFCaixa.TextMatrix(GridFCaixa.Row, GRID_VALOR_REAL_TESOURARIA_COL))
        ...
        If objFluxoSint.dTesValorReal <> 0 Then
            GridFCaixa.TextMatrix(GridFCaixa.Row, GRID_VALOR_PERCENTUAL_TESOURARIA_COL) = Format(objFluxoSint.dTesValorAjustado / objFluxoSint.dTesValorReal, "Percent")
        Else
        ...
        objFluxoSint.dSaldoValorReal = CDbl(GridFCaixa.TextMatrix(GridFCaixa.Row, GRID_SALDO_REAL_COL))
        
        If objFluxoSint.dSaldoValorReal <> 0 Then
            GridFCaixa.TextMatrix(GridFCaixa.Row, GRID_SALDO_PERCENTUAL_COL) = Format(objFluxoSint.dSaldoValorAjustado / objFluxoSint.dSaldoValorReal, "Percent")
        Else
        ...
        dSaldoValorReal = CDbl(GridFCaixa.TextMatrix(iIndice, GRID_VALOR_REAL_TESOURARIA_COL))
        
        If dSaldoValorReal <> 0 Then
            GridFCaixa.TextMatrix(iIndice, GRID_VALOR_PERCENTUAL_TESOURARIA_COL) = Format(dColunaSomaSaldoAjustado / dSaldoValorReal, "Percent")
        Else
            GridFCaixa.TextMatrix(iIndice, GRID_VALOR_PERCENTUAL_TESOURARIA_COL) = Format(0, "Percent")
        End If
        ...
        dColunaSomaSaldoReal = CDbl(GridFCaixa.TextMatrix(iIndice, GRID_SALDO_REAL_COL))

        GridFCaixa.TextMatrix(iIndice, GRID_VALOR_AJUSTADO_TESOURARIA_COL) = Format(dColunaSomaValorAjustadoTes, "Standard")
        GridFCaixa.TextMatrix(iIndice, GRID_SALDO_AJUSTADO_COL) = Format(dColunaSomaSaldoAjustado, "Standard")

        If dColunaSomaSaldoReal <> 0 Then
            GridFCaixa.TextMatrix(iIndice, GRID_SALDO_PERCENTUAL_COL) = Format(dColunaSomaSaldoAjustado / dColunaSomaSaldoReal, "Percent")
        Else
            GridFCaixa.TextMatrix(iIndice, GRID_SALDO_PERCENTUAL_COL) = Format(0, "Percent")
        End If
    ...
    If lErro <> SUCESSO Then Error 21115
...
Erro_Saida_Celula_ValorAjustadoTes:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 160484)
...
On Error GoTo Erro_ExibeFluxoSint
    ...
    lErro = CF("FluxoSintetico_Le", colFluxoSint, objFluxo1.lFluxoId, FLUXOSINT_REV)
    If lErro <> SUCESSO And lErro <> 21089 Then gError 21116
...
Erro_ExibeFluxoSint:
    ...
    Select Case gErr
        ...
        Case 21116, 21117, 83796

        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 160485)
...
On Error GoTo Erro_BotaoGravar_Click
    ...
    If lErro <> SUCESSO Then Error 21118
...
Erro_BotaoGravar_Click:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 160486)
...
On Error GoTo Erro_Gravar_Registro
    ...
    If lErro <> SUCESSO Then Error 21119
...
Erro_Gravar_Registro:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 160487)
...
On Error GoTo Erro_Botao_ImprimeFluxo_Click
    ...
    lErro = objRelTela.Iniciar("REL_FLUXOSINTREV_CPR")
    If lErro <> SUCESSO Then Error 47926
    
    lErro = Grid_FCaixa_Obter(colFluxoSint)
    If lErro <> SUCESSO Then Error 47927
    
    If objGrid1.iLinhasExistentes <> 0 Then
        dSaldoInicialAjust = StrParaDbl(GridFCaixa.TextMatrix(1, GRID_SALDO_AJUSTADO_COL))
        dSaldoInicialReal = StrParaDbl(GridFCaixa.TextMatrix(1, GRID_SALDO_REAL_COL))
    End If
    ...
    For iIndice1 = 1 To colFluxoSint.Count
        ...
        Call colTemp.Add(objFluxoSint.dRecValorReal)
        ...
        Call colTemp.Add(objFluxoSint.dPagValorReal)
...
Erro_Botao_ImprimeFluxo_Click:
    ...
    Select Case Err
        ...
        Case 47926, 47927, 47928, 47929
        
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error, 160488)
...
On Error GoTo Erro_Grid_FCaixa_Obter
    ...
    For iLinha = 1 To objGrid1.iLinhasExistentes - 1
        ...
        objFluxoSint.dRecValorReal = StrParaDbl(GridFCaixa.TextMatrix(iLinha, GRID_VALOR_REAL_RECEBER_COL))
        
        objFluxoSint.dPagValorAjustado = StrParaDbl(GridFCaixa.TextMatrix(iLinha, GRID_VALOR_AJUSTADO_PAGAMENTO_COL))
        objFluxoSint.dPagValorReal = StrParaDbl(GridFCaixa.TextMatrix(iLinha, GRID_VALOR_REAL_PAGAMENTO_COL))
         
        objFluxoSint.dTesValorAjustado = StrParaDbl(GridFCaixa.TextMatrix(iLinha, GRID_VALOR_AJUSTADO_TESOURARIA_COL))
        objFluxoSint.dTesValorReal = StrParaDbl(GridFCaixa.TextMatrix(iLinha, GRID_VALOR_REAL_TESOURARIA_COL))
                
        objFluxoSint.dSaldoValorAjustado = StrParaDbl(GridFCaixa.TextMatrix(iLinha, GRID_SALDO_AJUSTADO_COL))
        objFluxoSint.dSaldoValorReal = StrParaDbl(GridFCaixa.TextMatrix(iLinha, GRID_SALDO_REAL_COL))
...
Erro_Grid_FCaixa_Obter:
    ...
    Grid_FCaixa_Obter = Err
        ...
        Select Case Err
            ...
            Case Else
                lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 160489)
...
On Error GoTo Erro_Gera_Grafico
    ...
    'Se o gráfico não é sobre os valores ajustados nem sobre os valores do reais = > erro
    If iGrafico <> GRAFICO_AJUSTADO And iGrafico <> GRAFICO_REAL Then gError 79970
    ...
    For iColuna = 1 To objGrid1.colColuna.Count - 1
        ...
        For iLinha = 0 To objGrid1.iLinhasExistentes
            ...
            Select Case iColuna
                ...
                'Se for moeda
                Case GRID_VALOR_REAL_RECEBER_COL, GRID_VALOR_AJUSTADO_RECEBER_COL, GRID_VALOR_REAL_PAGAMENTO_COL, GRID_VALOR_AJUSTADO_PAGAMENTO_COL, GRID_VALOR_REAL_TESOURARIA_COL, GRID_VALOR_AJUSTADO_TESOURARIA_COL, GRID_SALDO_REAL_COL, GRID_SALDO_AJUSTADO_COL, GRID_SALDO_ACUMULADO_REAL_COL, GRID_SALDO_ACUMULADO_AJUSTADO_COL
        ...
        Select Case iColuna
            ...
            'Se for a coluna de saldo ajustado ou saldo real
            Case GRID_SALDO_AJUSTADO_COL, GRID_SALDO_REAL_COL
                ...
                'Se o gráfico é sobre os valores reais e a coluna é a dos valores reais
                If iGrafico = GRAFICO_REAL And iColuna = GRID_SALDO_REAL_COL Then
                    'Informa ao excel que a coluna faz parte do gráfico no eixo Y
                    objColunas.iParticipaGrafico = EXCEL_PARTICIPA_GRAFICO_Y
                    'Informa ao excel o tipo de gráfico que será utilizado para exibir os dados da série
                    objColunas.lTipoGraficoColuna = EXCEL_GRAFICO_COLUMN_CLUSTERED
            ...
            'Se for a coluna de saldo acumulado ajustado ou saldo acumulado real
            Case GRID_SALDO_ACUMULADO_AJUSTADO_COL, GRID_SALDO_ACUMULADO_REAL_COL
                ...
                'Se o gráfico é sobre os valores Reais e a coluna é a dos valores Reais
                If iGrafico = GRAFICO_REAL And iColuna = GRID_SALDO_ACUMULADO_REAL_COL Then
                    'Faz parte do gráfico no eixo X
                    objColunas.iParticipaGrafico = EXCEL_PARTICIPA_GRAFICO_Y
                    'Informa o tipo de gráfico que será utilizado para exibir os dados da série
                    objColunas.lTipoGraficoColuna = EXCEL_GRAFICO_LINE_MARKERS
    ...
    ElseIf iGrafico = GRAFICO_REAL Then
    
        'Informa ao excel o nome do gráfico e o nome da planilha gerada com os dados reais
        objPlanilha.sNomeGrafico = "Gráfico - Fluxo Real"
        objPlanilha.sNomePlanilha = "Planilha - Fluxo Real"
    End If
...
Erro_Gera_Grafico:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 160490)
...
Public Function Form_Load_Ocx() As Object
    ...
    Parent.HelpContextID = IDH_FLUXO_SINTETICO_REVISADO
    Set Form_Load_Ocx = Me
    Caption = "Fluxo Sintético - Revisado"
    Call Form_Load
