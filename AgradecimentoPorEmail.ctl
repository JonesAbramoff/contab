...
Begin VB.UserControl AgradecimentoPorEmailOcx 
   ClientHeight    =   6495
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9510
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Modelo 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "AgradecimentoPorEmail.ctx":0000
         Left            =   2205
         List            =   "AgradecimentoPorEmail.ctx":000A
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.Frame Frame2 
            ...
            Begin VB.ComboBox TipoDocSeleciona 
               Enabled         =   0   'False
               Height          =   315
               ItemData        =   "AgradecimentoPorEmail.ctx":003F
               Left            =   1410
               List            =   "AgradecimentoPorEmail.ctx":0041
               Style           =   2  'Dropdown List
               TabIndex        =   9
               Top             =   780
               Width           =   2820
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Carta 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "AgradecimentoPorEmail.ctx":0043
         Left            =   3090
         List            =   "AgradecimentoPorEmail.ctx":004D
         Style           =   2  'Dropdown List
         TabIndex        =   46
         Top             =   420
         Width           =   2235
      ...
      Begin VB.CommandButton BotaoMarcarTodos 
         ...
         Height          =   555
         Left            =   60
         Picture         =   "AgradecimentoPorEmail.ctx":0082
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   3450
         Width           =   1725
      ...
      Begin VB.CommandButton BotaoDesmarcarTodos 
         ...
         Height          =   555
         Left            =   45
         Picture         =   "AgradecimentoPorEmail.ctx":109C
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   4200
         Width           =   1725
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoEmail 
         Height          =   360
         Left            =   120
         Picture         =   "AgradecimentoPorEmail.ctx":227E
         Style           =   1  'Graphical
         TabIndex        =   22
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   645
         Picture         =   "AgradecimentoPorEmail.ctx":2C20
         Style           =   1  'Graphical
         TabIndex        =   23
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1155
         Picture         =   "AgradecimentoPorEmail.ctx":3152
         Style           =   1  'Graphical
         TabIndex        =   24
         ToolTipText     =   "Fechar"
         Top             =   75
   ...
   End
End
Attribute VB_Name = "AgradecimentoPorEmailOcx"
...
Function Trata_Parametros() As Long
     Trata_Parametros = objCT.Trata_Parametros(TIPOTELA_EMAIL_AGRADECIMENTO)
End Function
...
Public Function Form_Load_Ocx() As Object
    ...
    objCT.Trata_Parametros (TIPOTELA_EMAIL_AGRADECIMENTO)
