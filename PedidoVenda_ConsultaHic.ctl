...
Begin VB.UserControl PedidoVenda_Consulta 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame12 
         ...
         Begin VB.ComboBox UnidadeMed 
            ...
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "PedidoVenda_ConsultaHic.ctx":0000
            Left            =   1500
            List            =   "PedidoVenda_ConsultaHic.ctx":0002
            Style           =   2  'Dropdown List
            TabIndex        =   8
            Top             =   390
            Width           =   720
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox ComboOrdenacao 
         Height          =   315
         ItemData        =   "PedidoVenda_ConsultaHic.ctx":0004
         Left            =   2580
         List            =   "PedidoVenda_ConsultaHic.ctx":000E
         Style           =   2  'Dropdown List
         TabIndex        =   68
         Top             =   105
         Width           =   2475
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame1 
         ...
         Begin VB.ComboBox TipoBloqueio 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "PedidoVenda_ConsultaHic.ctx":0032
            Left            =   180
            List            =   "PedidoVenda_ConsultaHic.ctx":0034
            TabIndex        =   51
            Top             =   360
            Width           =   1605
         End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame4 
         ...
         Begin VB.ComboBox DiretoIndireto 
            Height          =   315
            ItemData        =   "PedidoVenda_ConsultaHic.ctx":0036
            Left            =   6120
            List            =   "PedidoVenda_ConsultaHic.ctx":0040
            Style           =   2  'Dropdown List
            TabIndex        =   181
            Top             =   960
            Width           =   1335
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoConsulta 
         ...
         Height          =   735
         Left            =   60
         Picture         =   "PedidoVenda_ConsultaHic.ctx":0056
         Style           =   1  'Graphical
         TabIndex        =   83
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   735
         Left            =   1725
         Picture         =   "PedidoVenda_ConsultaHic.ctx":0B24
         Style           =   1  'Graphical
         TabIndex        =   85
         ToolTipText     =   "Limpar"
         Top             =   30
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   735
         Left            =   2265
         Picture         =   "PedidoVenda_ConsultaHic.ctx":1056
         Style           =   1  'Graphical
         TabIndex        =   86
         ToolTipText     =   "Fechar"
         Top             =   30
      ...
      Begin VB.CommandButton BotaoEditar 
         ...
         Height          =   735
         Left            =   945
         Picture         =   "PedidoVenda_ConsultaHic.ctx":11D4
         Style           =   1  'Graphical
         TabIndex        =   84
         ToolTipText     =   "Editar"
         Top             =   30
...
Private Sub UserControl_Initialize()
    ...
    'hicare
    Set objCT.gobjInfoUsu = New CTPV_ConsultaVGHic
    Set objCT.gobjInfoUsu.gobjTelaUsu = New CTPV_ConsultaHic
