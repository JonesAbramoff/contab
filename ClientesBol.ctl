...
Begin VB.UserControl Clientes 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame FrameRotas 
         ...
         Begin VB.Frame Frame5 
            ...
            Top             =   210
            Width           =   3300
            Begin VB.ComboBox RotaFilialLista 
               Height          =   315
               Left            =   1020
               ...
               Width           =   2190
            End
            Begin VB.CheckBox RotaTodasFiliais 
            ...
            End
         End
         Begin MSMask.MaskEdBox RotaFilial 
            Height          =   225
            Left            =   405
            TabIndex        =   163
            Top             =   2190
            ...
            PromptChar      =   " "
         End
         Begin VB.CommandButton BotaoNovaRota 
            Caption         =   "Criar Rota"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   8.25
            ...
            Width           =   1305
         End
         Begin VB.CommandButton BotaoRotaEditar 
            Caption         =   "Editar Rota"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   8.25
            ...
            Width           =   1305
         End
         Begin MSFlexGridLib.MSFlexGrid GridRotas 
            Height          =   1560
            Left            =   30
            TabIndex        =   12
            Top             =   1230
            ...
            HighLight       =   0
         End
         Begin MSMask.MaskEdBox RotaChave 
            Height          =   225
            Left            =   1170
            TabIndex        =   164
            Top             =   1875
            ...
            PromptChar      =   " "
         End
         Begin MSMask.MaskEdBox RotaCodigo 
            Height          =   225
            Left            =   2265
            TabIndex        =   165
            Top             =   2175
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Visible         =   0   'False
         Width           =   8595
         Begin TelasFATBol.TabEndereco TabEnd 
            Height          =   3315
            Index           =   2
            Left            =   0
            TabIndex        =   188
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox TipoFrete 
         Height          =   315
         ItemData        =   "ClientesBol.ctx":00EA
         Left            =   6255
         List            =   "ClientesBol.ctx":00F4
         Style           =   2  'Dropdown List
         TabIndex        =   40
         Top             =   1965
         Width           =   1125
      ...
      Begin VB.ComboBox PadraoCobranca 
         Height          =   315
         ItemData        =   "ClientesBol.ctx":0102
         Left            =   2040
         List            =   "ClientesBol.ctx":0104
         TabIndex        =   37
         Top             =   1530
         Width           =   1965
      End
...
Private Sub UserControl_Initialize()
    ...
    Set objCT.gobjInfoUsu = New CTClientesVGBol
    Set objCT.gobjInfoUsu.gobjTelaUsu = New CTClientesBol
End Sub
...
Private Sub BotaoNovaRota_Click()
    objCT.BotaoNovaRota_Click
End Sub

Private Sub BotaoRotaEditar_Click()
    objCT.BotaoRotaEditar_Click
End Sub

Private Sub GridRotas_Click()
     Call objCT.GridRotas_Click
End Sub

Private Sub GridRotas_EnterCell()
     Call objCT.GridRotas_EnterCell
End Sub

Private Sub GridRotas_GotFocus()
     Call objCT.GridRotas_GotFocus
End Sub

Private Sub GridRotas_KeyDown(KeyCode As Integer, Shift As Integer)
     Call objCT.GridRotas_KeyDown(KeyCode, Shift)
End Sub

Private Sub GridRotas_KeyPress(KeyAscii As Integer)
     Call objCT.GridRotas_KeyPress(KeyAscii)
End Sub

Private Sub GridRotas_LeaveCell()
     Call objCT.GridRotas_LeaveCell
End Sub

Private Sub GridRotas_Validate(Cancel As Boolean)
     Call objCT.GridRotas_Validate(Cancel)
End Sub

Private Sub GridRotas_RowColChange()
     Call objCT.GridRotas_RowColChange
End Sub

Private Sub GridRotas_Scroll()
     Call objCT.GridRotas_Scroll
End Sub

Private Sub RotaFilialLista_Click()
     Call objCT.RotaFilialLista_Click
End Sub

Private Sub RotaTodasFiliais_Click()
     Call objCT.RotaTodasFiliais_Click
End Sub
