...
On Error GoTo Erro_TipoPlanilha_Click
    ...
    'preenche Objeto com dados que estão na tela
    lErro = Move_Tela_Memoria(objMnemonicoFPlanilha)
    If lErro <> SUCESSO Then gError 116814
        
    'chama função de Browser, que vai buscar Mnemonicos no BD e preenche-los na tela
...
'    Parent.HelpContextID = IDH_PLANO_CONTAS
    ...
    Caption = "Mnemônicos para Planilhas de Formação de Preços"
    Call Form_Load
