...
Begin VB.UserControl NFiscal 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CommandButton BotaoLimparNF 
            Height          =   300
            Left            =   4950
            Picture         =   "NFiscalOcxHic.ctx":0000
            Style           =   1  'Graphical
            TabIndex        =   4
         ...
         Begin VB.ComboBox TipoNFiscal 
            Height          =   315
            ItemData        =   "NFiscalOcxHic.ctx":0532
            Left            =   1995
            List            =   "NFiscalOcxHic.ctx":0534
            TabIndex        =   1
            Top             =   210
            Width           =   3330
         End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox ProdutoRastro 
            Height          =   315
            ItemData        =   "NFiscalOcxHic.ctx":0536
            Left            =   0
            List            =   "NFiscalOcxHic.ctx":0543
            Style           =   2  'Dropdown List
            TabIndex        =   180
            Top             =   0
            Width           =   1740
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Height          =   315
            ItemData        =   "NFiscalOcxHic.ctx":0562
            Left            =   3690
            List            =   "NFiscalOcxHic.ctx":056F
            Style           =   2  'Dropdown List
            TabIndex        =   150
            Top             =   285
            Width           =   1215
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.CommandButton BotaoOrcamento 
         Height          =   360
         Left            =   3810
         Picture         =   "NFiscalOcxHic.ctx":058E
         Style           =   1  'Graphical
         TabIndex        =   170
      ...
      Begin VB.CommandButton BotaoVerOrcamento 
         Height          =   360
         Left            =   4200
         Picture         =   "NFiscalOcxHic.ctx":0960
         Style           =   1  'Graphical
         TabIndex        =   171
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame4 
         ...
         Begin VB.CommandButton BotaoVendedores 
            ...
            Height          =   555
            Left            =   7250
            Picture         =   "NFiscalOcxHic.ctx":0C72
            Style           =   1  'Graphical
            TabIndex        =   165
            Top             =   3361
            Width           =   1650
         ...
         Begin VB.ComboBox DiretoIndireto 
            Height          =   315
            ItemData        =   "NFiscalOcxHic.ctx":121C
            Left            =   6240
            List            =   "NFiscalOcxHic.ctx":1226
            Style           =   2  'Dropdown List
            TabIndex        =   159
            Top             =   1560
            Width           =   1335
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   330
         Left            =   1357
         Picture         =   "NFiscalOcxHic.ctx":123C
         Style           =   1  'Graphical
         TabIndex        =   157
         ToolTipText     =   "Excluir"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoConsultaTitRec 
         ...
         Height          =   330
         Left            =   60
         Picture         =   "NFiscalOcxHic.ctx":13C6
         Style           =   1  'Graphical
         TabIndex        =   156
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   330
         Left            =   896
         Picture         =   "NFiscalOcxHic.ctx":1C48
         Style           =   1  'Graphical
         TabIndex        =   154
         ToolTipText     =   "Gravar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   330
         Left            =   1818
         Picture         =   "NFiscalOcxHic.ctx":1DA2
         Style           =   1  'Graphical
         TabIndex        =   153
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   330
         Left            =   2280
         Picture         =   "NFiscalOcxHic.ctx":22D4
         Style           =   1  'Graphical
         TabIndex        =   152
         ToolTipText     =   "Fechar"
         Top             =   75
