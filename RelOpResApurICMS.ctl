...
Begin VB.UserControl RelOpResApurICMSOcx 
   ClientHeight    =   4230
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   7095
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   480
      Left            =   5190
      Picture         =   "RelOpResApurICMS.ctx":0000
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   750
      Width           =   1755
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "RelOpResApurICMS.ctx":0102
         Style           =   1  'Graphical
         TabIndex        =   11
         ToolTipText     =   "Fechar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "RelOpResApurICMS.ctx":0280
         Style           =   1  'Graphical
         TabIndex        =   10
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "RelOpResApurICMS.ctx":07B2
         Style           =   1  'Graphical
         TabIndex        =   9
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "RelOpResApurICMS.ctx":093C
         Style           =   1  'Graphical
         TabIndex        =   8
         ToolTipText     =   "Gravar"
         Top             =   90
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   315
      ItemData        =   "RelOpResApurICMS.ctx":0A96
      Left            =   1260
      List            =   "RelOpResApurICMS.ctx":0A98
      Sorted          =   -1  'True
      TabIndex        =   0
      Top             =   240
      Width           =   2916
   ...
   End
End
Attribute VB_Name = "RelOpResApurICMSOcx"
...
On Error GoTo Erro_Form_Load
    ...
    If lErro <> SUCESSO Then gError 75383
...
Erro_Form_Load:
   ...
   lErro_Chama_Tela = gErr
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172968)
...
On Error GoTo Erro_Traz_LivroFiscal_Tela
    ...
    If lErro <> SUCESSO And lErro <> 67992 Then gError 70803
    ...
    If lErro = 67992 Then
        ...
        If lErro <> SUCESSO And lErro <> 70231 Then gError 70804
...
Erro_Traz_LivroFiscal_Tela:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172969)
...
On Error GoTo Erro_PreencherParametrosNaTela
    ...
    If lErro <> SUCESSO Then gError 70809
    
    lErro = objRelOpcoes.ObterParametro("TOBSERVACAO", sParam)
    If lErro Then gError 70808
    
    Observacao.Text = sParam
...
Erro_PreencherParametrosNaTela:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172970)
...
On Error GoTo Erro_Trata_Parametros
    ...
    If Not (gobjRelatorio Is Nothing) Then gError 70811
    ...
    If lErro <> SUCESSO Then gError 70810
...
Erro_Trata_Parametros:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172971)
...
On Error GoTo Erro_Formata_E_Critica_Parametros
    ...
    If Len(Trim(DataInicial.ClipText)) = 0 Then gError 70812
    
    'Se a data Final não está preenchida, erro
    If Len(Trim(DataFinal.ClipText)) = 0 Then gError 70813
    
    'Data inicial não pode ser maior que a data final
    If Trim(DataInicial.ClipText) <> "" And Trim(DataFinal.ClipText) <> "" Then
         If CDate(DataInicial.Text) > CDate(DataFinal.Text) Then gError 70815
        ...
        If OptionTipo(0).Value = True Then
            ...
            If lErro <> SUCESSO Then gError 70814
...
Erro_Formata_E_Critica_Parametros:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172972)
...
On Error GoTo Erro_LivroFiscal_Data_Critica
    ...
    If lErro <> SUCESSO And lErro <> 70599 Then gError 70816
    ...
    If lErro = 70599 Then
        ...
        If lErro <> SUCESSO And lErro <> 70595 Then gError 70817
        
        'Se não encontrou o Livro de Registro de Entrada Fechado, erro
        If lErro = 70595 Then gError 70818
...
'    If lErro <> SUCESSO And lErro <> 70675 Then gError 70820
'
'    'Se não encontrou Apuração ICMS, erro
'    If lErro = 70675 Then gError 70819
...
Erro_LivroFiscal_Data_Critica:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172973)
...
Erro_objEventoLivrosFechados_evSelecao:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 172974)
...
On Error GoTo Erro_PreencherRelOp
    ...
    If lErro <> SUCESSO Then gError 70822
    
    lErro = objRelOpcoes.Limpar
    If lErro <> AD_BOOL_TRUE Then gError 70823
    ...
    End If
    If lErro <> AD_BOOL_TRUE Then gError 70824
    ...
    End If
    If lErro <> AD_BOOL_TRUE Then gError 70825
    ...
    If lErro <> AD_BOOL_TRUE Then gError 70826
        
    lErro = objRelOpcoes.IncluirParametro("NFOLHA", sFolha)
    If lErro <> AD_BOOL_TRUE Then gError 70827
    
'Alteração Daniel em 18/09/2002
    'Tenta encontrar a filial empresa corrente
    For Each objFilEmp In gcolFiliais
        If objFilEmp.iCodFilial = giFilialEmpresa Then Exit For
    Next

    'Le os dados da Filial Empresa
    lErro = CF("FilialEmpresa_Le", objFilEmp)
    If lErro <> SUCESSO Then gError 108690
    
    lErro = objRelOpcoes.IncluirParametro("TINSCEST", objFilEmp.sInscricaoEstadual)
    If lErro <> AD_BOOL_TRUE Then gError 70826
        
    lErro = objRelOpcoes.IncluirParametro("TCGC", objFilEmp.sCgc)
    If lErro <> AD_BOOL_TRUE Then gError 70827
'Fim da Alteração Daniel em 18/09/2002
            
    lErro = objRelOpcoes.IncluirParametro("TOBSERVACAO", Observacao.Text)
    If lErro <> AD_BOOL_TRUE Then gError 70827
...
Erro_PreencherRelOp:
    ...
    Select Case gErr
        ...
        Case 108690
            Call Rotina_Erro(vbOKOnly, "ERRO_LEITURA_FILIAISEMPRESAS", gErr)

        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172975)
...
On Error GoTo Erro_BotaoExcluir_Click
    ...
    If ComboOpcoes.ListIndex = -1 Then gError 70828
    ...
    If vbMsgRes = vbYes Then
        ...
        If lErro <> SUCESSO Then gError 70829
...
Erro_BotaoExcluir_Click:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172976)
...
On Error GoTo Erro_BotaoExecutar_Click
    ...
    If lErro <> SUCESSO Then gError 70830

    lErro = gobjRelatorio.Executar_Prossegue2(Me)
    If lErro <> SUCESSO And lErro <> 7072 Then gError 70894
    
    'Se cancelou o Relatório
    If lErro = 7072 Then gError 70895
    ...
    If OptionTipo(0).Value = True Then
        ...
        If lErro <> SUCESSO Then gError 70831
...
Erro_BotaoExecutar_Click:
    ...
    Select Case gErr
        ...
        Case 70830, 70831, 70894
        
        Case 70895
            Unload Me
            
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172977)
...
On Error GoTo Erro_BotaoGravar_Click
    ...
    If ComboOpcoes.Text = "" Then gError 70832

    lErro = PreencherRelOp(gobjRelOpcoes)
    If lErro Then gError 70833

    gobjRelOpcoes.sNome = ComboOpcoes.Text

    lErro = CF("RelOpcoes_Grava", gobjRelOpcoes, iResultado)
    If lErro <> SUCESSO Then gError 70834
...
Erro_BotaoGravar_Click:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172978)
...
On Error GoTo Erro_BotaoLivroAberto_Click
    ...
    objLivrosFilial.iFilialEmpresa = giFilialEmpresa
    lErro = CF("LivrosFilial_Le", objLivrosFilial)
    If lErro <> SUCESSO And lErro <> 67992 Then gError 70835
               
    'Se não encontrou o Livro de Registro de Entrada Aberto
    If lErro = 67992 Then gError 70836
...
Erro_BotaoLivroAberto_Click:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172979)
...
On Error GoTo Erro_DataFinal_Validate
    ...
    If Len(DataFinal.ClipText) > 0 Then
        ...
        If lErro <> SUCESSO Then gError 70837
...
Erro_DataFinal_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172980)
...
On Error GoTo Erro_DataInicial_Validate
    ...
    If Len(DataInicial.ClipText) > 0 Then
        ...
        If lErro <> SUCESSO Then gError 70838
...
Erro_DataInicial_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172981)
...
On Error GoTo Erro_UpDown1_DownClick
    ...
    If lErro <> SUCESSO Then gError 70839
...
Erro_UpDown1_DownClick:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172982)
...
On Error GoTo Erro_UpDown1_UpClick
    ...
    If lErro <> SUCESSO Then gError 70840
...
Erro_UpDown1_UpClick:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172983)
...
On Error GoTo Erro_UpDown2_DownClick
    ...
    If lErro <> SUCESSO Then gError 70841
...
Erro_UpDown2_DownClick:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172984)
...
On Error GoTo Erro_UpDown2_UpClick
    ...
    If lErro <> SUCESSO Then gError 70842
...
Erro_UpDown2_UpClick:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 172985)
...
Public Function Form_Load_Ocx() As Object
    ...
    Caption = "Resumo da Apuração ICMS"
    Call Form_Load
