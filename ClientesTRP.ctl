...
Begin VB.UserControl Clientes 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame5 
         ...
         Begin VB.ComboBox TipoFrete 
            Height          =   315
            ItemData        =   "ClientesTRP.ctx":0000
            Left            =   1695
            List            =   "ClientesTRP.ctx":000A
      ...
      Begin VB.Frame Frame4 
         ...
         Begin VB.ComboBox PadraoCobranca 
            Height          =   315
            ItemData        =   "ClientesTRP.ctx":0018
            Left            =   1695
            List            =   "ClientesTRP.ctx":001A
            TabIndex        =   53
            Top             =   150
            Width           =   2520
         End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame18 
         Caption         =   "Opções de Pagamento (Comissão\Reembolso)"
         Height          =   720
         Left            =   90
         TabIndex        =   164
         Top             =   4155
      ...
      Begin VB.ComboBox FilialEmpresaFat 
         Height          =   315
         ItemData        =   "ClientesTRP.ctx":001C
         Left            =   6360
         List            =   "ClientesTRP.ctx":001E
         TabIndex        =   11
         Text            =   "FilialEmpresa"
         Top             =   1560
         Width           =   2640
      ...
      Begin VB.ComboBox FilialEmpresa 
         Height          =   315
         ItemData        =   "ClientesTRP.ctx":0020
         Left            =   6360
         List            =   "ClientesTRP.ctx":0022
         TabIndex        =   7
         Text            =   "FilialEmpresa"
         Top             =   810
         Width           =   2640
      ...
      Begin VB.ComboBox FilialEmpresaNF 
         Height          =   315
         ItemData        =   "ClientesTRP.ctx":0024
         Left            =   6360
         List            =   "ClientesTRP.ctx":0026
         TabIndex        =   9
         Text            =   "FilialEmpresa"
         Top             =   1185
         Width           =   2640
...
Private Sub UserControl_Initialize()
    ...
    Set objCT.gobjInfoUsu = New CTClientesVGTRP
    Set objCT.gobjInfoUsu.gobjTelaUsu = New CTClientesTRP
...
Private Sub Agencia_Change()
     Call objCT.gobjInfoUsu.gobjTelaUsu.Agencia_Change(objCT)
End Sub

Private Sub Banco_Change()
     Call objCT.gobjInfoUsu.gobjTelaUsu.Banco_Change(objCT)
End Sub

Private Sub Banco_GotFocus()
     Call objCT.gobjInfoUsu.gobjTelaUsu.Banco_GotFocus(objCT)
End Sub

Private Sub Banco_Validate(Cancel As Boolean)
     Call objCT.gobjInfoUsu.gobjTelaUsu.Banco_Validate(objCT, Cancel)
End Sub

Private Sub ContaCorrente_Change()
     Call objCT.gobjInfoUsu.gobjTelaUsu.ContaCorrente_Change(objCT)
End Sub
...
Private Sub BotaoWebAcesso_Click()
     Call objCT.gobjInfoUsu.gobjTelaUsu.BotaoWebAcesso_Click(objCT)
End Sub
