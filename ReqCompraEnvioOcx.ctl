...
Begin VB.UserControl ReqCompraEnvioOcx 
   ClientHeight    =   9195
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   16995
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame7 
         ...
         Begin VB.CommandButton BotaoDesmarcarTodosReq 
            ...
            Height          =   555
            Left            =   1680
            Picture         =   "ReqCompraEnvioOcx.ctx":0000
            Style           =   1  'Graphical
            TabIndex        =   10
            Top             =   3870
            Width           =   1425
         ...
         Begin VB.CommandButton BotaoMarcarTodosReq 
            ...
            Height          =   555
            Left            =   60
            Picture         =   "ReqCompraEnvioOcx.ctx":11E2
            Style           =   1  'Graphical
            TabIndex        =   9
            Top             =   3870
            Width           =   1425
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   45
         Picture         =   "ReqCompraEnvioOcx.ctx":21FC
         Style           =   1  'Graphical
         TabIndex        =   13
         ToolTipText     =   "Gravar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   570
         Picture         =   "ReqCompraEnvioOcx.ctx":2356
         Style           =   1  'Graphical
         TabIndex        =   14
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1080
         Picture         =   "ReqCompraEnvioOcx.ctx":2888
         Style           =   1  'Graphical
         TabIndex        =   15
         ToolTipText     =   "Fechar"
         Top             =   75
   ...
   End
End
Attribute VB_Name = "ReqCompraEnvioOcx"
...
On Error GoTo Erro_Inicializa_Grid_Requisicoes
    ...
    'titulos do grid
    objGridInt.colColuna.Add (" ")
    objGridInt.colColuna.Add ("Enviar")
...
Public Function Form_Load_Ocx() As Object
    ...
    Caption = "Envio de Requisição para Compras"
    Call Form_Load
...
On Error GoTo Erro_Gravar_Registro
    ...
    lErro = CF("ReqCompraEnvio_Grava", gobjReqCompraEnvio)
    If lErro <> SUCESSO Then gError ERRO_SEM_MENSAGEM
