Attribute VB_Name = "GlobalFATEver"
Option Explicit
...
'        bClonar = False
        ...
        Else 'se for nf externa
            ...
            If objTipoDocInfo.iOrigem = DOCINFO_ORIGEM_FORNECEDOR And objNFiscal.sSerie = "2" Then
...
'            .dValorDesconto = Round(objNFiscalOriginal.dValorDesconto * dFatorValor, 2)
            .dValorFrete = Round(objNFiscalOriginal.dValorFrete * 1, 2)
            .dValorSeguro = Round(objNFiscalOriginal.dValorSeguro * 1, 2)
            .dValorOutrasDespesas = Round(objNFiscalOriginal.dValorOutrasDespesas * 1, 2)
            .dValorDesconto = Round(objNFiscalOriginal.dValorDesconto * 1, 2)
