...
Begin VB.UserControl RelOpESPRJ 
   ClientHeight    =   4140
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   6285
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   315
      ItemData        =   "RelOpESPRJ.ctx":0000
      Left            =   840
      List            =   "RelOpESPRJ.ctx":0002
      Sorted          =   -1  'True
      TabIndex        =   0
      Top             =   255
      Width           =   2916
...
On Error GoTo Erro_Monta_Expressao_Selecao
    ...
    If glNumIntPRJ <> 0 Then

        If sExpressao <> "" Then sExpressao = sExpressao & " E "
        sExpressao = sExpressao & "Projeto = " & Forprint_ConvLong(glNumIntPRJ)

    End If

    If glNumIntPRJEtapa <> 0 Then

        If sExpressao <> "" Then sExpressao = sExpressao & " E "
        sExpressao = sExpressao & "Etapa = " & Forprint_ConvLong(glNumIntPRJEtapa)
...
On Error GoTo Erro_PreencherRelOp
    ...
    If lErro <> SUCESSO Then gError 194335
...
Public Function Form_Load_Ocx() As Object
    ...
    Caption = "Entradas e Saídas por Projeto"
    Call Form_Load
