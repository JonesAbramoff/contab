...
Begin VB.UserControl NFPag_Consulta 
   ClientHeight    =   5820
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9270
   ...
   Begin VB.Frame Frame 
      ...
      Begin VB.CommandButton BotaoDocOriginal 
         ...
         Height          =   675
         Left            =   6600
         Picture         =   "NFPag_ConsultaTRV.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   5
   ...
   Begin VB.Frame Frame 
      ...
      Begin MSMask.MaskEdBox CTBConta 
         Bindings        =   "NFPag_ConsultaTRV.ctx":2F16
         Height          =   225
         Left            =   60
         TabIndex        =   10
         Top             =   1230
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   675
         Left            =   1425
         Picture         =   "NFPag_ConsultaTRV.ctx":2F21
         Style           =   1  'Graphical
         TabIndex        =   20
         ToolTipText     =   "Excluir"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoConsulta 
         Height          =   675
         Left            =   90
         Picture         =   "NFPag_ConsultaTRV.ctx":30AB
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   60
         Width           =   1275
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   675
         Left            =   1870
         Picture         =   "NFPag_ConsultaTRV.ctx":4E6D
         Style           =   1  'Graphical
         TabIndex        =   21
         ToolTipText     =   "Limpar"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   675
         Left            =   2310
         Picture         =   "NFPag_ConsultaTRV.ctx":539F
         Style           =   1  'Graphical
         TabIndex        =   22
         ToolTipText     =   "Fechar"
         Top             =   60
   ...
   End
End
Attribute VB_Name = "NFPag_Consulta"
...
Private Sub UserControl_Initialize()
    ...
    'TRV
    Set objCT.gobjInfoUsu = New CTNFPagConVGTRV
    Set objCT.gobjInfoUsu.gobjTelaUsu = New CTNFPagConTRV
End Sub
