...
Begin VB.UserControl NFiscalFatura 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox TabPrecoItemNF 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "NFiscalFaturaArtmill.ctx":0000
            Left            =   4920
            List            =   "NFiscalFaturaArtmill.ctx":0002
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame4 
         ...
         Begin VB.CommandButton BotaoDataReferenciaUp 
            Height          =   150
            Left            =   3120
            Picture         =   "NFiscalFaturaArtmill.ctx":0004
            Style           =   1  'Graphical
            TabIndex        =   124
            TabStop         =   0   'False
            Top             =   645
         ...
         Begin VB.ComboBox Desconto1Codigo 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "NFiscalFaturaArtmill.ctx":005E
            Left            =   3120
            List            =   "NFiscalFaturaArtmill.ctx":0060
            TabIndex        =   67
            Top             =   1140
            Width           =   1860
         End
         ...
         Begin VB.CommandButton BotaoDataReferenciaDown 
            Height          =   150
            Left            =   3120
            Picture         =   "NFiscalFaturaArtmill.ctx":0062
            Style           =   1  'Graphical
            TabIndex        =   125
            TabStop         =   0   'False
            Top             =   795
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CommandButton Botao 
            ...
            Index           =   20
            Left            =   4920
            Picture         =   "NFiscalFaturaArtmill.ctx":00BC
            Style           =   1  'Graphical
            TabIndex        =   13
         ...
         Begin VB.ComboBox TipoNFiscal 
            Height          =   315
            ItemData        =   "NFiscalFaturaArtmill.ctx":05EE
            Left            =   1995
            List            =   "NFiscalFaturaArtmill.ctx":05F0
            TabIndex        =   5
            Top             =   210
            Width           =   2835
         End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox ProdutoRastro 
            Height          =   315
            ItemData        =   "NFiscalFaturaArtmill.ctx":05F2
            Left            =   1740
            List            =   "NFiscalFaturaArtmill.ctx":05FF
            Style           =   2  'Dropdown List
            TabIndex        =   214
            Top             =   1320
            Width           =   1740
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Height          =   315
            ItemData        =   "NFiscalFaturaArtmill.ctx":061E
            Left            =   3690
            List            =   "NFiscalFaturaArtmill.ctx":062B
            Style           =   2  'Dropdown List
            TabIndex        =   163
            Top             =   255
            Width           =   1215
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame4 
         ...
         Begin VB.ComboBox DiretoIndireto 
            Height          =   315
            ItemData        =   "NFiscalFaturaArtmill.ctx":064A
            Left            =   6360
            List            =   "NFiscalFaturaArtmill.ctx":0654
            Style           =   2  'Dropdown List
            TabIndex        =   190
            Top             =   1320
            Width           =   1335
         ...
         Begin VB.CommandButton BotaoVendedores 
            ...
            Height          =   615
            Left            =   6960
            Picture         =   "NFiscalFaturaArtmill.ctx":066A
            Style           =   1  'Graphical
            TabIndex        =   189
            Top             =   3300
            Width           =   1815
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   2
         Left            =   75
         Picture         =   "NFiscalFaturaArtmill.ctx":0C14
         Style           =   1  'Graphical
         TabIndex        =   206
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   3
         Left            =   915
         Picture         =   "NFiscalFaturaArtmill.ctx":1496
         Style           =   1  'Graphical
         TabIndex        =   204
         ToolTipText     =   "Gravar"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   5
         Left            =   1845
         Picture         =   "NFiscalFaturaArtmill.ctx":15F0
         Style           =   1  'Graphical
         TabIndex        =   203
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   6
         Left            =   2310
         Picture         =   "NFiscalFaturaArtmill.ctx":1B22
         Style           =   1  'Graphical
         TabIndex        =   202
         ToolTipText     =   "Fechar"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   4
         Left            =   1380
         Picture         =   "NFiscalFaturaArtmill.ctx":1CA0
         Style           =   1  'Graphical
         TabIndex        =   201
         ToolTipText     =   "Excluir"
         Top             =   75
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   22
         Left            =   3675
         Picture         =   "NFiscalFaturaArtmill.ctx":1E2A
         Style           =   1  'Graphical
         TabIndex        =   226
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   21
         Left            =   3300
         Picture         =   "NFiscalFaturaArtmill.ctx":213C
         Style           =   1  'Graphical
         TabIndex        =   225
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   1
         Left            =   4305
         Picture         =   "NFiscalFaturaArtmill.ctx":250E
         Style           =   1  'Graphical
         TabIndex        =   224
         ToolTipText     =   "Trazer a tela de cadastro"
         Top             =   210
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   0
         Left            =   3915
         Picture         =   "NFiscalFaturaArtmill.ctx":2820
         Style           =   1  'Graphical
         TabIndex        =   223
         ToolTipText     =   "Trazer Dados"
         Top             =   210
...
Private Sub UserControl_Initialize()
    ...
    Set objCT.gobjInfoUsu = New CTNFiscalFaturaVGArt
    Set objCT.gobjInfoUsu.gobjTelaUsu = New CTNFiscalFaturaArt
End Sub
...
Private Sub Botao_Click(iIndice As Integer)
    If iIndice = 990 Then
        Call BotaoContratoOrcamento_Click
    Else
