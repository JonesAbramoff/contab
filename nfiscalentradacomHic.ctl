...
Begin VB.UserControl NFiscalEntradaCom 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton BotaoMarcarTodos 
         ...
         Index           =   1
         Left            =   7620
         Picture         =   "nfiscalentradacomHic.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   54
         Top             =   120
         Width           =   1380
      ...
      Begin VB.CommandButton BotaoDesmarcarTodos 
         ...
         Index           =   1
         Left            =   7620
         Picture         =   "nfiscalentradacomHic.ctx":101A
         Style           =   1  'Graphical
         TabIndex        =   55
         Top             =   690
         Width           =   1380
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame14 
         ...
         Begin VB.CommandButton BotaoDesmarcarTodos 
            ...
            Index           =   0
            Left            =   7410
            Picture         =   "nfiscalentradacomHic.ctx":21FC
            Style           =   1  'Graphical
            TabIndex        =   20
            Top             =   465
            Width           =   1395
         ...
         Begin VB.CommandButton BotaoMarcarTodos 
            ...
            Index           =   0
            Left            =   5925
            Picture         =   "nfiscalentradacomHic.ctx":33DE
            Style           =   1  'Graphical
            TabIndex        =   19
            Top             =   465
            Width           =   1395
      ...
      Begin VB.Frame Frame6 
         ...
         Begin VB.CommandButton BotaoLimparNF 
            Height          =   315
            Left            =   5625
            Picture         =   "nfiscalentradacomHic.ctx":43F8
            Style           =   1  'Graphical
            TabIndex        =   6
         ...
         Begin VB.ComboBox TipoNFiscal 
            Height          =   315
            ItemData        =   "nfiscalentradacomHic.ctx":492A
            Left            =   1470
            List            =   "nfiscalentradacomHic.ctx":492C
            TabIndex        =   2
            Top             =   480
            Width           =   4515
         End
         ...
         Begin VB.CommandButton Recebimento 
            Height          =   360
            Left            =   2175
            Picture         =   "nfiscalentradacomHic.ctx":492E
            Style           =   1  'Graphical
            TabIndex        =   1
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame6 
         ...
         Begin VB.ComboBox ProdutoRastro 
            Height          =   315
            ItemData        =   "nfiscalentradacomHic.ctx":4D00
            Left            =   0
            List            =   "nfiscalentradacomHic.ctx":4D0D
            Style           =   2  'Dropdown List
            TabIndex        =   209
            Top             =   -15
            Width           =   1740
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "nfiscalentradacomHic.ctx":4D2C
            Left            =   3930
            List            =   "nfiscalentradacomHic.ctx":4D36
            Style           =   2  'Dropdown List
            TabIndex        =   178
            Top             =   210
            Visible         =   0   'False
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   330
         Left            =   1341
         Picture         =   "nfiscalentradacomHic.ctx":4D52
         Style           =   1  'Graphical
         TabIndex        =   28
         ToolTipText     =   "Excluir"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoConsultaNFPag 
         ...
         Height          =   330
         Left            =   60
         Picture         =   "nfiscalentradacomHic.ctx":4EDC
         Style           =   1  'Graphical
         TabIndex        =   26
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   330
         Left            =   888
         Picture         =   "nfiscalentradacomHic.ctx":575E
         Style           =   1  'Graphical
         TabIndex        =   27
         ToolTipText     =   "Gravar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   330
         Left            =   1794
         Picture         =   "nfiscalentradacomHic.ctx":58B8
         Style           =   1  'Graphical
         TabIndex        =   29
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   330
         Left            =   2250
         Picture         =   "nfiscalentradacomHic.ctx":5DEA
         Style           =   1  'Graphical
         TabIndex        =   30
         ToolTipText     =   "Fechar"
         Top             =   75
