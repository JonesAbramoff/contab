...
Begin VB.MDIForm PrincipalNovo 
   ...
   ClientTop       =   1395
   ClientWidth     =   11760
   Icon            =   "principalnovoimport.frx":0000
   LinkTopic       =   "MDIForm1"
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoFacebook 
         Height          =   360
         Left            =   11490
         Picture         =   "principalnovoimport.frx":000C
         Style           =   1  'Graphical
         TabIndex        =   18
      ...
      Begin VB.CommandButton SuporteOnline 
         Height          =   315
         Left            =   9975
         Picture         =   "principalnovoimport.frx":046D
         Style           =   1  'Graphical
         TabIndex        =   15
      ...
      Begin VB.CommandButton BotaoBrowseCria 
         Height          =   315
         Left            =   13275
         Picture         =   "principalnovoimport.frx":0B00
         Style           =   1  'Graphical
         TabIndex        =   16
      ...
      Begin VB.CommandButton BotaoAnotacao 
         Height          =   315
         Left            =   4710
         Picture         =   "principalnovoimport.frx":103A
         Style           =   1  'Graphical
         TabIndex        =   13
      ...
      Begin VB.CommandButton BotaoConsulta 
         Height          =   360
         Left            =   907
         Picture         =   "principalnovoimport.frx":1574
         Style           =   1  'Graphical
         TabIndex        =   12
      ...
      Begin VB.CommandButton Ultimo 
         Height          =   360
         Left            =   1740
         Picture         =   "principalnovoimport.frx":1886
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      Begin VB.CommandButton Proximo 
         Height          =   360
         Left            =   1323
         Picture         =   "principalnovoimport.frx":1B98
         Style           =   1  'Graphical
         TabIndex        =   10
      ...
      Begin VB.CommandButton Anterior 
         Height          =   360
         Left            =   491
         Picture         =   "principalnovoimport.frx":1D42
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      Begin VB.CommandButton Primeiro 
         Height          =   360
         Left            =   75
         Picture         =   "principalnovoimport.frx":1EEC
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton BotaoTestaInt 
         Height          =   315
         Left            =   12450
         Picture         =   "principalnovoimport.frx":21FE
         Style           =   1  'Graphical
         TabIndex        =   7
         ToolTipText     =   "NAO USE"
         Top             =   105
      ...
      Begin VB.CommandButton BotaoGeraCodigoLight 
         Height          =   315
         Left            =   12870
         Picture         =   "principalnovoimport.frx":2738
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.ComboBox ComboModulo 
         Height          =   315
         ItemData        =   "principalnovoimport.frx":28C2
         Left            =   5730
         List            =   "principalnovoimport.frx":28C4
   ...
   Begin VB.Menu mnuRotinas 
      ...
      End
      Begin VB.Menu mnuESTRot 
         Caption         =   "Importação de xmls de NFe"
         Index           =   14
      End
   End
   Begin VB.Menu mnuRotinas 
...
Dim colItensPaiVisiveis As New Collection
...
Private Sub mnuCOMConPedCompra_Click(Index As Integer)
    Select Case Index
        ...
        Case 6
            Call Chama_Tela("UltPCPorProdLista")
        Case 7
...
'    End If
    ...
    If MsgBox("Deseja importar as Cidades", vbYesNo) = vbYes Then Call Importa_Cidades
    If MsgBox("Deseja importar os Vendedores", vbYesNo) = vbYes Then Call Importa_Vendedores
    If MsgBox("Deseja importar os Clientes", vbYesNo) = vbYes Then Call Importa_Clientes
    If MsgBox("Deseja importar os Fornecedores", vbYesNo) = vbYes Then Call Importa_Fornecedores
    If MsgBox("Deseja importar os Produtos", vbYesNo) = vbYes Then Call Importa_Produtos
    If MsgBox("Deseja importar as Condições de Pagamento", vbYesNo) = vbYes Then Call Importa_CondPagto
