...
Begin VB.UserControl TituloPagar_Consulta 
   ClientHeight    =   6000
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9405
   ...
   Begin VB.Frame Frame 
      ...
      Begin MSMask.MaskEdBox CTBConta 
         Bindings        =   "TituloPagar_ConsultaMiguez.ctx":0000
         Height          =   225
         Left            =   60
         TabIndex        =   26
         Top             =   1230
   ...
   Begin VB.Frame Frame 
      ...
      Begin VB.Frame Frame8 
         ...
         Begin VB.CheckBox Cobrar 
            ...
            Width           =   1095
         End
         Begin VB.ComboBox ItemHistorico 
            Height          =   315
            Left            =   1980
            TabIndex        =   189
            Top             =   960
   ...
   Begin VB.Frame Frame 
      ...
      Begin VB.CommandButton BotaoDocOriginal 
         ...
         Height          =   705
         Left            =   7110
         Picture         =   "TituloPagar_ConsultaMiguez.ctx":000B
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   90
         Width           =   1665
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   675
         Left            =   2025
         Picture         =   "TituloPagar_ConsultaMiguez.ctx":2F21
         Style           =   1  'Graphical
         TabIndex        =   37
         ToolTipText     =   "Fechar"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   675
         Left            =   1455
         Picture         =   "TituloPagar_ConsultaMiguez.ctx":309F
         Style           =   1  'Graphical
         TabIndex        =   36
         ToolTipText     =   "Limpar"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoConsulta 
         Height          =   675
         Left            =   90
         Picture         =   "TituloPagar_ConsultaMiguez.ctx":35D1
         Style           =   1  'Graphical
         TabIndex        =   35
         Top             =   60
         Width           =   1275
   ...
   End
End
Attribute VB_Name = "TituloPagar_Consulta"
...
Private Sub UserControl_Initialize()
    ...
    'Alterado por Wagner
    'Miguez
    Set objCT.gobjInfoUsu = New CTTitPag_CVGMgz
    Set objCT.gobjInfoUsu.gobjTelaUsu = New CTTitPag_CMgz
    '#################################
...
Private Sub ItemHistorico_Change()
     Call objCT.gobjInfoUsu.gobjTelaUsu.ItemHistorico_Change(objCT)
End Sub

Private Sub ItemHistorico_GotFocus()
     Call objCT.gobjInfoUsu.gobjTelaUsu.ItemHistorico_GotFocus(objCT)
End Sub

Private Sub ItemHistorico_KeyPress(KeyAscii As Integer)
     Call objCT.gobjInfoUsu.gobjTelaUsu.ItemHistorico_KeyPress(objCT, KeyAscii)
End Sub

Private Sub ItemHistorico_Validate(Cancel As Boolean)
     Call objCT.gobjInfoUsu.gobjTelaUsu.ItemHistorico_Validate(objCT, Cancel)
End Sub
...
Private Sub BotaoGravar_Click()
    Call objCT.gobjInfoUsu.gobjTelaUsu.BotaoGravar_Click(objCT)
End Sub
