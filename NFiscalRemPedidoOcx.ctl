...
Begin VB.UserControl NFiscalRemPedidoOcx 
   ClientHeight    =   5790
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9510
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame6 
         ...
         Begin VB.ComboBox TabPrecoItemNF 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "NFiscalRemPedidoOcx.ctx":0000
            Left            =   3990
            List            =   "NFiscalRemPedidoOcx.ctx":0002
            Style           =   2  'Dropdown List
            TabIndex        =   219
            Top             =   1320
            Width           =   1800
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox TipoNFiscal 
            Height          =   315
            ItemData        =   "NFiscalRemPedidoOcx.ctx":0004
            Left            =   1935
            List            =   "NFiscalRemPedidoOcx.ctx":0006
            TabIndex        =   4
            Top             =   270
            Width           =   2835
         End
         Begin VB.CommandButton BotaoLimparNF 
            Height          =   300
            Left            =   6165
            Picture         =   "NFiscalRemPedidoOcx.ctx":0008
            Style           =   1  'Graphical
            TabIndex        =   24
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame18 
         ...
         Begin VB.ComboBox ProdutoRastro 
            Height          =   315
            ItemData        =   "NFiscalRemPedidoOcx.ctx":053A
            Left            =   885
            List            =   "NFiscalRemPedidoOcx.ctx":0547
            Style           =   2  'Dropdown List
            TabIndex        =   174
            Top             =   960
            Width           =   1740
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "NFiscalRemPedidoOcx.ctx":0566
            Left            =   3705
            List            =   "NFiscalRemPedidoOcx.ctx":0573
            Style           =   2  'Dropdown List
            TabIndex        =   154
            Top             =   270
            Visible         =   0   'False
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   330
         Left            =   75
         Picture         =   "NFiscalRemPedidoOcx.ctx":0592
         Style           =   1  'Graphical
         TabIndex        =   19
         ToolTipText     =   "Gravar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   330
         Left            =   985
         Picture         =   "NFiscalRemPedidoOcx.ctx":06EC
         Style           =   1  'Graphical
         TabIndex        =   21
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   330
         Left            =   1440
         Picture         =   "NFiscalRemPedidoOcx.ctx":0C1E
         Style           =   1  'Graphical
         TabIndex        =   22
         ToolTipText     =   "Fechar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   330
         Left            =   530
         Picture         =   "NFiscalRemPedidoOcx.ctx":0D9C
         Style           =   1  'Graphical
         TabIndex        =   20
         ToolTipText     =   "Excluir"
         Top             =   75
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.CommandButton BotaoVerPedido 
         Height          =   360
         Left            =   4215
         Picture         =   "NFiscalRemPedidoOcx.ctx":0F26
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      Begin VB.CommandButton BotaoPedido 
         Height          =   360
         Left            =   3795
         Picture         =   "NFiscalRemPedidoOcx.ctx":1238
         Style           =   1  'Graphical
         TabIndex        =   2
   ...
   End
End
Attribute VB_Name = "NFiscalRemPedidoOcx"
...
Private Sub GridItens_LeaveCell()
    Call objCT1.GridItens_LeaveCell
End Sub
...
Private Sub GridItens_KeyDown(KeyCode As Integer, Shift As Integer)
    Call objCT1.GridItens_KeyDown(KeyCode, Shift)
End Sub
...
Private Sub BotaoLocalizacao_Click()
     Call objCT1.BotaoLocalizacao_Click
End Sub
...
Private Sub Cliente_Formata(lCliente As Long)
     Call objCT1.Cliente_Formata(lCliente)
End Sub
...
Private Sub Filial_Validate(Cancel As Boolean)
     Call objCT2.Filial_Validate(Cancel)
End Sub
