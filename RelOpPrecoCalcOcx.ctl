...
Begin VB.UserControl RelOpPrecoCalcOcx 
   ClientHeight    =   2520
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   3630
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   600
      Left            =   810
      Picture         =   "RelOpPrecoCalcOcx.ctx":0000
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   1785
      Width           =   1815
   ...
   End
End
Attribute VB_Name = "RelOpPrecoCalcOcx"
...
On Error GoTo Erro_PreencherRelOp
    ...
    If bExecutar Then
        ...
        lErro = CF("RelListaPrecoCalc_Prepara", lNumIntRel, giFilialEmpresa, MaskedParaDate(DataFinal), MaskedParaDate(DataInicial), "", "")
