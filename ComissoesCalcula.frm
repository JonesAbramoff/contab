...
Begin VB.Form ComissoesCalcula 
   Caption         =   "Form1"
   ClientHeight    =   5355
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame4 
         ...
         Begin VB.CommandButton BotaoVendedores 
            ...
            Height          =   645
            Left            =   7440
            Picture         =   "ComissoesCalcula.frx":0000
            Style           =   1  'Graphical
            TabIndex        =   70
            Top             =   3300
            Width           =   1500
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox UnidadeMed 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "ComissoesCalcula.frx":05AA
            Left            =   1575
            List            =   "ComissoesCalcula.frx":05AC
            Style           =   2  'Dropdown List
            TabIndex        =   30
            Top             =   240
            Width           =   720
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.Frame Frame2 
            ...
            Begin VB.ComboBox FilialFaturamento 
               Height          =   315
               ItemData        =   "ComissoesCalcula.frx":05AE
               Left            =   5475
               List            =   "ComissoesCalcula.frx":05B0
               TabIndex        =   17
               Top             =   780
               Width           =   2145
            End
            Begin VB.CommandButton BotaoProxNum 
               Height          =   285
               Left            =   2940
               Picture         =   "ComissoesCalcula.frx":05B2
               Style           =   1  'Graphical
               TabIndex        =   16
   ...
   End
End
Attribute VB_Name = "ComissoesCalcula"
