...
Begin VB.UserControl RelOpDiarioSintOcx 
   ClientHeight    =   3810
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   6285
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   600
      Left            =   4140
      Picture         =   "RelOpDiarioSintOcx.ctx":0000
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   975
      Width           =   1815
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   315
      ItemData        =   "RelOpDiarioSintOcx.ctx":0102
      Left            =   1275
      List            =   "RelOpDiarioSintOcx.ctx":0104
      Sorted          =   -1  'True
      TabIndex        =   5
      Top             =   375
      Width           =   2325
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "RelOpDiarioSintOcx.ctx":0106
         Style           =   1  'Graphical
         TabIndex        =   4
         ToolTipText     =   "Fechar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "RelOpDiarioSintOcx.ctx":0284
         Style           =   1  'Graphical
         TabIndex        =   3
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "RelOpDiarioSintOcx.ctx":07B6
         Style           =   1  'Graphical
         TabIndex        =   2
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "RelOpDiarioSintOcx.ctx":0940
         Style           =   1  'Graphical
         TabIndex        =   1
         ToolTipText     =   "Gravar"
         Top             =   90
   ...
   End
End
Attribute VB_Name = "RelOpDiarioSintOcx"
...
Dim sCtaIni As String
Dim sCtaFim As String
...
On Error GoTo Erro_PreencherRelOp
    ...
    sDataIni = DataInicial.Text
    sDataFim = DataFinal.Text

    If bGeraArqTemp Then
    
        lErro = CF("RelLcto_Prepara_1", giFilialEmpresa, lNumIntRel, sCtaIni, sCtaFim, sDataIni, sDataFim)
        If lErro <> SUCESSO Then gError 54964
    
        lErro = objRelOpcoes.IncluirParametro("NNUMINTREL", CStr(lNumIntRel))
        If lErro <> AD_BOOL_TRUE Then Error 54966
...
Erro_PreencherRelOp:
    ...
    Select Case Err
        ...
        Case 13182, 13183, 13184, 54964, 54966
