...
Begin VB.UserControl ContratoMedicaoPag 
   ClientHeight    =   6030
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9570
   ...
   Begin VB.Frame Frame2 
      ...
      Top             =   1395
      Width           =   9225
      Begin VB.ComboBox FilFornContrato 
         BackColor       =   &H80000004&
         Enabled         =   0   'False
         Height          =   315
         Left            =   6705
      ...
      Begin MSMask.MaskEdBox Contrato 
         ...
         PromptChar      =   " "
      End
      Begin MSMask.MaskEdBox FornContrato 
         Height          =   315
         Left            =   1665
         TabIndex        =   32
         Top             =   690
         ...
         PromptChar      =   "_"
      End
      Begin VB.Label FilFornContratoLabel 
         AutoSize        =   -1  'True
         Caption         =   "Filial:"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
         ...
         Width           =   465
      End
      Begin VB.Label FornContratoLabel 
         AutoSize        =   -1  'True
         Caption         =   "Fornecedor:"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton BotaoProxNum 
         Height          =   285
         Left            =   2505
         Picture         =   "ContratoMedicaoPagOcx.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   21
   ...
   Begin VB.PictureBox Picture 
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "ContratoMedicaoPagOcx.ctx":00EA
         Style           =   1  'Graphical
         TabIndex        =   19
         ToolTipText     =   "Gravar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "ContratoMedicaoPagOcx.ctx":0244
         Style           =   1  'Graphical
         TabIndex        =   18
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "ContratoMedicaoPagOcx.ctx":03CE
         Style           =   1  'Graphical
         TabIndex        =   17
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "ContratoMedicaoPagOcx.ctx":0900
         Style           =   1  'Graphical
         TabIndex        =   16
         ToolTipText     =   "Fechar"
         Top             =   90
   ...
   Begin VB.Frame Frame1 
      ...
      Begin MSMask.MaskEdBox Item 
         ...
         PromptChar      =   " "
      End
      Begin VB.CommandButton BotaoPag 
         Caption         =   "Pagamento"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
         ...
         Left            =   7590
         TabIndex        =   3
         ToolTipText     =   "Abre a Tela de Nota Fiscal que pagou o item selecionado."
         Top             =   2820
         Width           =   1485
      End
   ...
   End
End
Attribute VB_Name = "ContratoMedicaoPag"
...
Erro_Limpa_Tela_Medicao:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 155118)
...
Erro_Move_GridItens_Memoria:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 155119)
...
Erro_Move_Tela_Memoria:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 155120)
...
Erro_Form_Load:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 155121)
...
On Error GoTo Erro_BotaoPag_Click
    ...
    If bAchou Then
        ...
        If objContrato.iTipo <> CONTRATOS_PAGAR Then gError 132905
    ...
    If Not bAchou Then gError 136035
...
Erro_BotaoPag_Click:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 155122)
...
Erro_BotaoProxNum_Click:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 155123)
...
Erro_BotaoTrazer_Click:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 155124)
...
On Error GoTo Erro_Codigo_Validate
    ...
    If iCodigoAlterado <> REGISTRO_ALTERADO Then Exit Sub

    objMedicaoContrato.lCodigo = StrParaLong(Codigo.ClipText)

    If objMedicaoContrato.lCodigo = 0 Then Exit Sub
...
Erro_Codigo_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 155125)
...
Dim colSelecao As New Collection
    ...
    Call Chama_Tela("MedicaoContratosPagLista", colSelecao, objMedicaoContrato, objEventoCodigo)
...
Erro_Contrato_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 155126)
...
On Error GoTo Erro_Traz_Contrato_Tela
    ...
    If objContrato.iTipo <> CONTRATOS_PAGAR Then gError 132906
   
    With objContrato
            
        If .lFornecedor <> 0 Then
            Call Fornecedor_Formata(.lFornecedor)
            Call Filial_Formata(FilFornContrato, .iFilForn)
        Else
            FornContrato.Text = ""
            FilFornContrato.Text = ""
        End If
...
Erro_Traz_Contrato_Tela:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 155127)
...
On Error GoTo Erro_Traz_Contrato_Tela2
    ...
    If objContrato.iTipo <> CONTRATOS_PAGAR Then gError 132907
...
Erro_Traz_Contrato_Tela2:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 155128)
...
On Error GoTo Erro_Traz_GridItens_Tela
    ...
    If lErro = SUCESSO And objContrato.iTipo <> CONTRATOS_PAGAR Then gError 132913
...
Erro_Traz_GridItens_Tela:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 155129)
...
Erro_Traz_Medicao_Tela:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 155130)
...
On Error GoTo Erro_Fornecedor_Formata
    ...
    FornContrato.Text = lFornecedor

    'Busca o Fornecedor no BD
    lErro = TP_Fornecedor_Le(FornContrato, objFornecedor, iCodFilial)
    ...
    Call CF("Filial_Preenche", FilFornContrato, colCodigoNome)
...
Erro_Fornecedor_Formata:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 155131)
...
Erro_Filial_Formata:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 155132)
...
Dim iIndice As Integer
    ...
    objGridInt.colColuna.Add ("Valor Pagar")
    objGridInt.colColuna.Add ("Dt Pagamento")
    ...
    iGrid_ValorCobrar_Col = 9
    iGrid_DataCobranca_Col = 10
    iGrid_DataRefIni_Col = 11
    iGrid_DataRefFim_Col = 12
    iGrid_Status_Col = 13
...
Erro_Trata_Parametros:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 155133)
...
Erro_Gravar_Registro:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 155134)
...
Public Function Form_Load_Ocx() As Object
    ...
    Caption = "Medição de Contrato a Pagar"
    Call Form_Load
...
Erro_Data_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 155135)
...
Erro_UpDown_DownClick:
    ...
    Select Case gErr
        ...
        Case Else
             Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 155136)
...
Erro_UpDown_UpClick:
    ...
    Select Case gErr
        ...
        Case Else
             Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 155137)
...
Erro_Tela_Preenche:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 155138)
...
Erro_Tela_Extrai:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 155139)
...
Erro_Saida_Celula:
    ...
    Select Case gErr
        ...
        Case Else
             Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 155140)
...
Erro_Saida_Celula_Quantidade:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, 155141)
...
Erro_Saida_Celula_QtdContratada:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, 155142)
...
Erro_Saida_Celula_Valor:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 155143)
...
Erro_Saida_Celula_ValorCobrar:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 155144)
...
Erro_Saida_Celula_Cobrar:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 155145)
...
Erro_Saida_Celula_Descricao:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, 155146)
...
Erro_Saida_Celula_UM:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, 155147)
...
Erro_Saida_Celula_Item:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, 155148)
...
Erro_Saida_Celula_Status:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, 155149)
...
Erro_Saida_Celula_Produto:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, 155150)
...
Erro_Saida_Celula_DataRefIni:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 155151)
...
Erro_Saida_Celula_DataRefFim:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 155152)
...
Erro_Saida_Celula_DataCobranca:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 155153)
...
Erro_BotaoGravar_Click:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, 155154)
...
Erro_BotaoLimpar_Click:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 155155)
...
Erro_BotaoExcluir_Click:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 155156)
...
Erro_Valida_Grid_Itens:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 155157)
...
Erro_Rotina_Grid_Enable:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 155158)
...
Erro_Carrega_GridItens_Contratos:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 155159)
...
Erro_Traz_ItemDeContrato:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 155160)
...
Erro_Carrega_GridItens:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 155161)
...
Erro_Carrega_ComboStatus:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 155162)
...
Private Sub FornContratoLabel_DragDrop(Source As Control, X As Single, Y As Single)
   Call Controle_DragDrop(FornContratoLabel, Source, X, Y)
End Sub

Private Sub FornContratoLabel_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
   Call Controle_MouseDown(FornContratoLabel, Button, Shift, X, Y)
End Sub

Private Sub FornContrato_DragDrop(Source As Control, X As Single, Y As Single)
   Call Controle_DragDrop(FornContrato, Source, X, Y)
End Sub

Private Sub FilFornContratoLabel_DragDrop(Source As Control, X As Single, Y As Single)
   Call Controle_DragDrop(FilFornContratoLabel, Source, X, Y)
End Sub

Private Sub FilFornContratoLabel_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
   Call Controle_MouseDown(FilFornContratoLabel, Button, Shift, X, Y)
End Sub

Private Sub FilFornContrato_DragDrop(Source As Control, X As Single, Y As Single)
   Call Controle_DragDrop(FilFornContrato, Source, X, Y)
End Sub
'#######################################################################
