...
Begin VB.UserControl NFiscalFaturaOcx 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CommandButton Botao 
            ...
            Index           =   20
            Left            =   6540
            Picture         =   "NFiscalFaturaOcxTeste.ctx":0000
            Style           =   1  'Graphical
            TabIndex        =   7
         ...
         Begin VB.ComboBox TipoNFiscal 
            Height          =   288
            ItemData        =   "NFiscalFaturaOcxTeste.ctx":0532
            Left            =   1995
            List            =   "NFiscalFaturaOcxTeste.ctx":0534
            TabIndex        =   4
            Top             =   210
            Width           =   2835
         End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox ProdutoRastro 
            Height          =   288
            ItemData        =   "NFiscalFaturaOcxTeste.ctx":0536
            Left            =   1740
            List            =   "NFiscalFaturaOcxTeste.ctx":0543
            Style           =   2  'Dropdown List
            TabIndex        =   364
            Top             =   1320
            Width           =   1740
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Height          =   288
            ItemData        =   "NFiscalFaturaOcxTeste.ctx":0562
            Left            =   3690
            List            =   "NFiscalFaturaOcxTeste.ctx":056F
            Style           =   2  'Dropdown List
            TabIndex        =   281
            Top             =   255
            Width           =   1215
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame4 
         ...
         Begin VB.CommandButton BotaoDataReferenciaUp 
            Height          =   150
            Left            =   3345
            Picture         =   "NFiscalFaturaOcxTeste.ctx":058E
            Style           =   1  'Graphical
            TabIndex        =   174
            TabStop         =   0   'False
            Top             =   345
         ...
         Begin VB.ComboBox Desconto1Codigo 
            Appearance      =   0  'Flat
            Height          =   288
            ItemData        =   "NFiscalFaturaOcxTeste.ctx":05E8
            Left            =   3120
            List            =   "NFiscalFaturaOcxTeste.ctx":05EA
            TabIndex        =   62
            Top             =   1140
            Width           =   1860
         End
         ...
         Begin VB.CommandButton BotaoDataReferenciaDown 
            Height          =   150
            Left            =   3345
            Picture         =   "NFiscalFaturaOcxTeste.ctx":05EC
            Style           =   1  'Graphical
            TabIndex        =   175
            TabStop         =   0   'False
            Top             =   495
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame4 
         ...
         Begin VB.ComboBox DiretoIndireto 
            Height          =   288
            ItemData        =   "NFiscalFaturaOcxTeste.ctx":0646
            Left            =   6360
            List            =   "NFiscalFaturaOcxTeste.ctx":0650
            Style           =   2  'Dropdown List
            TabIndex        =   310
            Top             =   1320
            Width           =   1335
         ...
         Begin VB.CommandButton BotaoVendedores 
            ...
            Height          =   615
            Left            =   6960
            Picture         =   "NFiscalFaturaOcxTeste.ctx":0666
            Style           =   1  'Graphical
            TabIndex        =   309
            Top             =   3300
            Width           =   1815
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   2
         Left            =   75
         Picture         =   "NFiscalFaturaOcxTeste.ctx":0C10
         Style           =   1  'Graphical
         TabIndex        =   325
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   3
         Left            =   915
         Picture         =   "NFiscalFaturaOcxTeste.ctx":1492
         Style           =   1  'Graphical
         TabIndex        =   324
         ToolTipText     =   "Gravar"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   5
         Left            =   1845
         Picture         =   "NFiscalFaturaOcxTeste.ctx":15EC
         Style           =   1  'Graphical
         TabIndex        =   323
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   6
         Left            =   2310
         Picture         =   "NFiscalFaturaOcxTeste.ctx":1B1E
         Style           =   1  'Graphical
         TabIndex        =   322
         ToolTipText     =   "Fechar"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   4
         Left            =   1380
         Picture         =   "NFiscalFaturaOcxTeste.ctx":1C9C
         Style           =   1  'Graphical
         TabIndex        =   321
         ToolTipText     =   "Excluir"
         Top             =   75
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   22
         Left            =   3690
         Picture         =   "NFiscalFaturaOcxTeste.ctx":1E26
         Style           =   1  'Graphical
         TabIndex        =   389
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   21
         Left            =   3315
         Picture         =   "NFiscalFaturaOcxTeste.ctx":2138
         Style           =   1  'Graphical
         TabIndex        =   388
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   1
         Left            =   4305
         Picture         =   "NFiscalFaturaOcxTeste.ctx":250A
         Style           =   1  'Graphical
         TabIndex        =   387
         ToolTipText     =   "Trazer a tela de cadastro"
         Top             =   210
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   0
         Left            =   3915
         Picture         =   "NFiscalFaturaOcxTeste.ctx":281C
         Style           =   1  'Graphical
         TabIndex        =   386
         ToolTipText     =   "Trazer Dados"
         Top             =   210
