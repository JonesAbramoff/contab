...
Begin VB.UserControl RelOpFatProdVendOcx 
   ClientHeight    =   5565
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   7770
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.ComboBox Layout 
         Height          =   315
         ItemData        =   "RelOpFatProdVend.ctx":0000
         Left            =   1095
         List            =   "RelOpFatProdVend.ctx":0010
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "RelOpFatProdVend.ctx":0060
         Style           =   1  'Graphical
         TabIndex        =   20
         ToolTipText     =   "Fechar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1095
         Picture         =   "RelOpFatProdVend.ctx":01DE
         Style           =   1  'Graphical
         TabIndex        =   18
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   585
         Picture         =   "RelOpFatProdVend.ctx":0710
         Style           =   1  'Graphical
         TabIndex        =   17
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "RelOpFatProdVend.ctx":089A
         Style           =   1  'Graphical
         TabIndex        =   16
         ToolTipText     =   "Gravar"
         Top             =   90
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   315
      ItemData        =   "RelOpFatProdVend.ctx":09F4
      Left            =   870
      List            =   "RelOpFatProdVend.ctx":09F6
      Sorted          =   -1  'True
      TabIndex        =   0
      Top             =   375
      Width           =   2916
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   600
      Left            =   3825
      Picture         =   "RelOpFatProdVend.ctx":09F8
      Style           =   1  'Graphical
      TabIndex        =   15
      Top             =   165
      Width           =   1575
   ...
   End
End
Attribute VB_Name = "RelOpFatProdVendOcx"
...
Private Function Formata_E_Critica_Produtos(sProd_I As String, sProd_F As String, iTipoVend As Integer) As Long
...
On Error GoTo Erro_PreencherRelOp
    ...
    lErro = Formata_E_Critica_Produtos(sProd_I, sProd_F, iTipoVend)
