...
Begin VB.UserControl NFiscalFatEntradaCom 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton BotaoAnexos 
         Height          =   465
         Left            =   8460
         Picture         =   "NFiscalFatEntradaCom.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   291
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CommandButton BotaoTrazerNFe 
            Height          =   360
            Left            =   6165
            Picture         =   "NFiscalFatEntradaCom.ctx":0196
            Style           =   1  'Graphical
            TabIndex        =   1
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CommandButton Recebimento 
            Height          =   360
            Left            =   2685
            Picture         =   "NFiscalFatEntradaCom.ctx":0568
            Style           =   1  'Graphical
            TabIndex        =   3
            ToolTipText     =   "Trazer Dados"
            Top             =   135
         ...
         Begin VB.ComboBox TipoNFiscal 
            Height          =   315
            ItemData        =   "NFiscalFatEntradaCom.ctx":093A
            Left            =   1485
            List            =   "NFiscalFatEntradaCom.ctx":093C
            TabIndex        =   4
            Top             =   525
            Width           =   4725
         End
         Begin VB.CommandButton Botao 
            ...
            Index           =   5
            Left            =   5850
            Picture         =   "NFiscalFatEntradaCom.ctx":093E
            Style           =   1  'Graphical
            TabIndex        =   8
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CommandButton Botao 
            ...
            Index           =   8
            Left            =   7350
            Picture         =   "NFiscalFatEntradaCom.ctx":0E70
            Style           =   1  'Graphical
            TabIndex        =   20
            Top             =   465
            Width           =   1425
         ...
         Begin VB.CommandButton Botao 
            ...
            Index           =   7
            Left            =   5790
            Picture         =   "NFiscalFatEntradaCom.ctx":2052
            Style           =   1  'Graphical
            TabIndex        =   19
            Top             =   450
            Width           =   1425
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "NFiscalFatEntradaCom.ctx":306C
            Left            =   3735
            List            =   "NFiscalFatEntradaCom.ctx":3076
            Style           =   2  'Dropdown List
            TabIndex        =   209
            Top             =   195
            Visible         =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   12
         Left            =   7224
         Picture         =   "NFiscalFatEntradaCom.ctx":3092
         Style           =   1  'Graphical
         TabIndex        =   75
         Top             =   690
         Width           =   1776
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   11
         Left            =   7224
         Picture         =   "NFiscalFatEntradaCom.ctx":4274
         Style           =   1  'Graphical
         TabIndex        =   74
         Top             =   84
         Width           =   1776
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   2
         Left            =   1341
         Picture         =   "NFiscalFatEntradaCom.ctx":528E
         Style           =   1  'Graphical
         TabIndex        =   27
         ToolTipText     =   "Excluir"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   4
         Left            =   2250
         Picture         =   "NFiscalFatEntradaCom.ctx":5418
         Style           =   1  'Graphical
         TabIndex        =   29
         ToolTipText     =   "Fechar"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   3
         Left            =   1794
         Picture         =   "NFiscalFatEntradaCom.ctx":5596
         Style           =   1  'Graphical
         TabIndex        =   28
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   1
         Left            =   888
         Picture         =   "NFiscalFatEntradaCom.ctx":5AC8
         Style           =   1  'Graphical
         TabIndex        =   26
         ToolTipText     =   "Gravar"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   0
         Left            =   60
         Picture         =   "NFiscalFatEntradaCom.ctx":5C22
         Style           =   1  'Graphical
         TabIndex        =   25
...
Public WithEvents objCT As CTNFiscalFatEntradaCom
