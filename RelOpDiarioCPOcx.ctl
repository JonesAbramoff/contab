...
Begin VB.UserControl RelOpDiarioCPOcx 
   ClientHeight    =   2190
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   6270
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "RelOpDiarioCPOcx.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   6
         ToolTipText     =   "Gravar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "RelOpDiarioCPOcx.ctx":015A
         Style           =   1  'Graphical
         TabIndex        =   7
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "RelOpDiarioCPOcx.ctx":02E4
         Style           =   1  'Graphical
         TabIndex        =   8
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "RelOpDiarioCPOcx.ctx":0816
         Style           =   1  'Graphical
         TabIndex        =   9
         ToolTipText     =   "Fechar"
         Top             =   90
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   315
      ItemData        =   "RelOpDiarioCPOcx.ctx":0994
      Left            =   810
      List            =   "RelOpDiarioCPOcx.ctx":0996
      Sorted          =   -1  'True
      TabIndex        =   0
      Top             =   225
      Width           =   2895
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   600
      Left            =   4110
      Picture         =   "RelOpDiarioCPOcx.ctx":0998
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   840
      Width           =   1815
   ...
   End
End
Attribute VB_Name = "RelOpDiarioCPOcx"
...
Erro_Trata_Parametros:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168287)
...
Erro_Critica_Datas_RelOpDiario:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168288)
...
Dim lNumIntRel As Long, bGeraArqTemp As Boolean

On Error GoTo Erro_PreencherRelOp

    bGeraArqTemp = True '??? passar como optional na chamada, só nao fiz p/manter a compat binaria
    
    lErro = Critica_Datas_RelOpDiario(iExercicio)
    If lErro <> SUCESSO Then gError 23122

    lErro = objRelOpcoes.Limpar
    If lErro <> AD_BOOL_TRUE Then gError 23123

    lErro = objRelOpcoes.IncluirParametro("NFILIAL", CStr(giFilialEmpresa))
    If lErro <> AD_BOOL_TRUE Then gError 7229

    lErro = objRelOpcoes.IncluirParametro("TNOMEFILIAL", CStr(gsNomeFilialEmpresa))
    If lErro <> AD_BOOL_TRUE Then gError 7230

    lErro = objRelOpcoes.IncluirParametro("NEXERCICIO", CStr(iExercicio))
    If lErro <> AD_BOOL_TRUE Then gError 7231

    lErro = objRelOpcoes.IncluirParametro("NPAGRELINI", IIf(Trim(PrimeiraFolha.Text) = 0, "1", Trim(PrimeiraFolha.Text)))
    If lErro <> AD_BOOL_TRUE Then gError 23124

    lErro = objRelOpcoes.IncluirParametro("DINIC", DataInicial.Text)
    If lErro <> AD_BOOL_TRUE Then gError 23125

    lErro = objRelOpcoes.IncluirParametro("DFIM", DataFinal.Text)
    If lErro <> AD_BOOL_TRUE Then gError 23126
    ...
    If lErro <> AD_BOOL_TRUE Then gError 56808
    ...
    If bGeraArqTemp Then
        ...
        If lErro <> SUCESSO Then gError 111779
        
        'tulio110203
        lErro = objRelOpcoes.IncluirParametro("NNUMINTREL", CStr(lNumIntRel))
        If lErro <> AD_BOOL_TRUE Then gError 111770
...
Erro_PreencherRelOp:
    ...
    Select Case gErr
        ...
        Case 23122, 23123, 23124, 23125, 23126, 56808, 56809, 111770, 111779

        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 168289)
...
Erro_PreencherParametrosNaTela:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168290)
...
Erro_PreencheComboOpcoes:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168291)
...
Erro_BotaoExcluir_Click:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168292)
...
Erro_BotaoExecutar_Click:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168293)
...
On Error GoTo Erro_BotaoGravar_Click
    ...
    If lErro <> SUCESSO Then Error 59497
...
Erro_BotaoGravar_Click:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168294)
...
Erro_ComboOpcoes_Click:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168295)
...
Erro_DataFinal_Validate:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168296)
...
Erro_DataInicial_Validate:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168297)
...
Erro_OpcoesRel_Form_Load:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168298)
...
Erro_UpDown1_DownClick:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168299)
...
Erro_UpDown1_UpClick:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168300)
...
Erro_UpDown2_DownClick:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168301)
...
Erro_UpDown2_UpClick:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168302)
...
Erro_Monta_Expressao_Selecao:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168303)
...
Public Function Form_Load_Ocx() As Object
    ...
    '??? Parent.HelpContextID = IDH_RELOP_DIARIOCP
    Set Form_Load_Ocx = Me
    Caption = "Diario Auxiliar de Contas a Pagar"
    Call Form_Load
