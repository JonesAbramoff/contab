...
Dim iIndice As Integer
    ...
    'Carregar os arrays de ordenação das Requisicoes
    ...
    asOrdenacaoReqString(0) = "Número"
    asOrdenacaoReqString(1) = "Data Limite"
    asOrdenacaoReqString(2) = "Data da Requisição"
    ...
    'Seleciona a opção FilialEmpresa + Codigo de seleção
...
Dim iIndice As Integer
    ...
    'Carregar os arrays de ordenação das Cotacoes
...
On Error GoTo Erro_TabStrip1_Click
    ...
    If iFrameAtual <> TAB_Selecao And iFrameSelecaoAlterado = REGISTRO_ALTERADO Then
        ...
        'Busca no BD todas as Requisicoes de Compra com as características definidas no Tab Selecao
...
On Error GoTo Erro_Traz_Requisicoes_Tela
    ...
    'Lê os Itens das requisição de compra selcionadas
    ...
    'Para cada Requisição de compra lida
    For Each objReqCompra In gobjGeracaoPedCompraReq.colRequisicao
        'Para cada item de requisição lido
        For Each objItemRC In objReqCompra.colItens
            'Inclui ou altera um item de concorrência incluindo os
            'dados do itemRC sem ler as cotações
...
'Faz a saida de célula de EscolhidoProduto
...
'Faz a saida de célula de EscolhidoCot
...
'Faz a saida de célula de EscolhidoItem
...
'Atualiza o Grid de Cotações (quantComprar e itens selecionados)
...
Dim iIndice As Integer
    ...
    'Procura no GridCotações o mesmo Produto
        ...
        If sProduto = GridCotacoes.TextMatrix(iIndice, iGrid_ProdutoCot_Col) And _
           ...
           iFilial = Codigo_Extrai(GridCotacoes.TextMatrix(iIndice, iGrid_FilialFornCot_Col)) Then
            ...
            If dQuantDiferenca > 0 Then
                ...
                'Se a quantidade atual mais a quantidade que aumentou for menor ou igual a máxima a comprar
                ...
                Else
                    ...
                    'Guarda nova diferença de quantidade
            ...
            Else
                ...
                If StrParaDbl(GridCotacoes.TextMatrix(iIndice, iGrid_QuantComprarCot_Col)) + dQuantDiferenca >= 0 Then
                    ...
                    If StrParaDbl(GridCotacoes.TextMatrix(iIndice, iGrid_QuantComprarCot_Col)) = 0 Then
                        ...
                        'desmarca linha do GridCotações
...
Public Function Form_Load_Ocx() As Object
    ...
    Caption = "Geração de Pedidos de Compra por Requisições"
    Call Form_Load
