...
Begin VB.UserControl NFiscal 
   ...
   Begin VB.Frame Frame1 
      ...
      Visible         =   0   'False
      Width           =   9195
      Begin TelasFATGR.TabTributacaoFat TabTrib 
         Height          =   4530
         Left            =   105
         TabIndex        =   209
         Top             =   120
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CommandButton BotaoLimparNF 
            Height          =   300
            Left            =   4830
            Picture         =   "NFiscalRochaLog.ctx":0000
            Style           =   1  'Graphical
            TabIndex        =   4
         ...
         Begin VB.ComboBox TipoNFiscal 
            Height          =   315
            ItemData        =   "NFiscalRochaLog.ctx":0532
            Left            =   1995
            List            =   "NFiscalRochaLog.ctx":0534
            TabIndex        =   1
            Top             =   270
            Width           =   2835
         End
         Begin MSMask.MaskEdBox Projeto 
            ...
            PromptChar      =   " "
         End
         Begin MSMask.MaskEdBox NFiscalAux 
            Height          =   315
            Left            =   3600
            TabIndex        =   3
            Top             =   1125
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox ProdutoRastro 
            Height          =   315
            ItemData        =   "NFiscalRochaLog.ctx":0536
            Left            =   1350
            List            =   "NFiscalRochaLog.ctx":0543
            Style           =   2  'Dropdown List
            TabIndex        =   175
            Top             =   1170
            Width           =   1740
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Height          =   315
            ItemData        =   "NFiscalRochaLog.ctx":0562
            Left            =   3690
            List            =   "NFiscalRochaLog.ctx":056F
            Style           =   2  'Dropdown List
            TabIndex        =   149
            Top             =   285
            Width           =   1215
   ...
   Begin VB.Frame Frame10 
      ...
      Begin VB.CommandButton BotaoOrcamento 
         Height          =   360
         Left            =   3810
         Picture         =   "NFiscalRochaLog.ctx":058E
         Style           =   1  'Graphical
         TabIndex        =   169
      ...
      Begin VB.CommandButton BotaoVerOrcamento 
         Height          =   360
         Left            =   4200
         Picture         =   "NFiscalRochaLog.ctx":0960
         Style           =   1  'Graphical
         TabIndex        =   170
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame10 
         ...
         Begin VB.CommandButton BotaoVendedores 
            ...
            Height          =   555
            Left            =   7250
            Picture         =   "NFiscalRochaLog.ctx":0C72
            Style           =   1  'Graphical
            TabIndex        =   164
            Top             =   3361
            Width           =   1650
         ...
         Begin VB.ComboBox DiretoIndireto 
            Height          =   315
            ItemData        =   "NFiscalRochaLog.ctx":121C
            Left            =   6240
            List            =   "NFiscalRochaLog.ctx":1226
            Style           =   2  'Dropdown List
            TabIndex        =   158
            Top             =   1560
            Width           =   1335
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   330
         Left            =   1357
         Picture         =   "NFiscalRochaLog.ctx":123C
         Style           =   1  'Graphical
         TabIndex        =   156
         ToolTipText     =   "Excluir"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoConsultaTitRec 
         ...
         Height          =   330
         Left            =   60
         Picture         =   "NFiscalRochaLog.ctx":13C6
         Style           =   1  'Graphical
         TabIndex        =   155
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   330
         Left            =   896
         Picture         =   "NFiscalRochaLog.ctx":1C48
         Style           =   1  'Graphical
         TabIndex        =   154
         ToolTipText     =   "Gravar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   330
         Left            =   1818
         Picture         =   "NFiscalRochaLog.ctx":1DA2
         Style           =   1  'Graphical
         TabIndex        =   152
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   330
         Left            =   2280
         Picture         =   "NFiscalRochaLog.ctx":22D4
         Style           =   1  'Graphical
         TabIndex        =   151
         ToolTipText     =   "Fechar"
         Top             =   75
...
Private Sub UserControl_Initialize()
    ...
    Set objCT.gobjInfoUsu = New CTNFiscalVGGR
    Set objCT.gobjInfoUsu.gobjTelaUsu = New CTNFiscalGR
...
'**** adaptacao RochaLog / GrandeRio *****
Private Sub BotaoComprovante_Click()
    Call objCT.gobjInfoUsu.gobjTelaUsu.BotaoComprovante_Click(objCT)
End Sub

Private Sub ComprovServCon_Change()
    Call objCT.gobjInfoUsu.gobjTelaUsu.ComprovServCon_Change(objCT)
End Sub

Private Sub ComprovServCon_GotFocus()
    Call objCT.gobjInfoUsu.gobjTelaUsu.ComprovServCon_GotFocus(objCT)
End Sub

Private Sub ComprovServCon_KeyPress(KeyAscii As Integer)
    Call objCT.gobjInfoUsu.gobjTelaUsu.ComprovServCon_KeyPress(objCT, KeyAscii)
End Sub

Private Sub ComprovServCon_Validate(Cancel As Boolean)
    Call objCT.gobjInfoUsu.gobjTelaUsu.ComprovServCon_Validate(objCT, Cancel)
End Sub

Private Sub GridComprovServ_Click()
    Call objCT.gobjInfoUsu.gobjTelaUsu.GridComprovServ_Click(objCT)
End Sub

Private Sub GridComprovServ_EnterCell()
    Call objCT.gobjInfoUsu.gobjTelaUsu.GridComprovServ_EnterCell(objCT)
End Sub

Private Sub GridComprovServ_GotFocus()
    Call objCT.gobjInfoUsu.gobjTelaUsu.GridComprovServ_GotFocus(objCT)
End Sub

Private Sub GridComprovServ_KeyDown(KeyCode As Integer, Shift As Integer)
    Call objCT.gobjInfoUsu.gobjTelaUsu.GridComprovServ_KeyDown(objCT, KeyCode, Shift)
End Sub

Private Sub GridComprovServ_KeyPress(KeyAscii As Integer)
    Call objCT.gobjInfoUsu.gobjTelaUsu.GridComprovServ_KeyPress(objCT, KeyAscii)
End Sub

Private Sub GridComprovServ_LeaveCell()
    Call objCT.gobjInfoUsu.gobjTelaUsu.GridComprovServ_LeaveCell(objCT)
End Sub

Private Sub GridComprovServ_Scroll()
    Call objCT.gobjInfoUsu.gobjTelaUsu.GridComprovServ_Scroll(objCT)
End Sub

Private Sub GridComprovServ_RowColChange()
    Call objCT.gobjInfoUsu.gobjTelaUsu.GridComprovServ_RowColChange(objCT)
End Sub

Private Sub GridComprovServ_Validate(Cancel As Boolean)
    Call objCT.gobjInfoUsu.gobjTelaUsu.GridComprovServ_Validate(objCT, Cancel)
End Sub

Private Sub ValorContainer_Change()
    Call objCT.gobjInfoUsu.gobjTelaUsu.ValorContainer_Change(objCT)
End Sub

Private Sub ValorMercadoria_Change()
    Call objCT.gobjInfoUsu.gobjTelaUsu.ValorMercadoria_Change(objCT)
End Sub

Private Sub Destino_Change()
    Call objCT.gobjInfoUsu.gobjTelaUsu.Destino_Change(objCT)
End Sub

Private Sub Origem_Change()
    Call objCT.gobjInfoUsu.gobjTelaUsu.Origem_Change(objCT)
End Sub

'**** fim da adaptacao RochaLog / GrandeRio *****

Private Sub NFiscalAux_Change()
     Call objCT.NFiscalAux_Change
End Sub

Private Sub NFiscalAux_GotFocus()
     Call objCT.NFiscalAux_GotFocus
End Sub
