...
Begin VB.UserControl PreAutorizacao 
   ClientHeight    =   1275
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   3480
   ...
   End
End
Attribute VB_Name = "PreAutorizacao"
...
On Error GoTo Erro_Valor_Validate
    ...
    If StrParaDbl(Valor.Text) > 0 Then
        ...
        If lErro <> SUCESSO Then gError 133830
...
Erro_Valor_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 165098)
...
On Error GoTo Erro_BotaoOk_Click
    ...
    If Not AFRAC_ImpressoraCFe(giCodModeloECF) Then
        ...
        If lErro <> SUCESSO Then gError 207994

    End If

    If StrParaDbl(Valor.Text) = 0 Then gError 133832

    Set objTela = Me
    Set objFormMsg = MsgTEF
    
    lErro = CF_ECF("TEF_PreAutorizacao", StrParaDbl(Valor.Text), objFormMsg, objTela)
    If lErro <> SUCESSO Then gError 133831
...
Erro_BotaoOk_Click:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error, 165099)
