...
Begin VB.UserControl RelOPEstPerTRV 
   ClientHeight    =   2295
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4635
   ScaleHeight     =   2295
   ScaleWidth      =   4635
   Begin VB.CheckBox ExibirCidades 
      Caption         =   "Exibir dados por cidade"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   600
         Picture         =   "RelOPEstPerTRV.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   3
         ToolTipText     =   "Fechar"
         Top             =   96
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   96
         Picture         =   "RelOPEstPerTRV.ctx":017E
         Style           =   1  'Graphical
         TabIndex        =   2
         ToolTipText     =   "Limpar"
         Top             =   96
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   600
      Left            =   2952
      Picture         =   "RelOPEstPerTRV.ctx":06B0
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   900
      Width           =   1575
   ...
   End
End
Attribute VB_Name = "RelOPEstPerTRV"
...
Dim lErro As Long
Dim objSel As New ClassRelTRVEstPeriodoSel
...
On Error GoTo Erro_PreencherRelOp
    ...
    If ExibirCidades.Value = vbChecked Then
        objSel.iExibirCidades = MARCADO
    Else
        objSel.iExibirCidades = DESMARCADO
    End If
    
    GL_objMDIForm.MousePointer = vbHourglass
    
    lErro = CF("RelTRVEstPeriodo_Prepara", objSel)
    ...
    lErro = objRelOpcoes.IncluirParametro("NEXIBIRCIDADE", CStr(objSel.iExibirCidades))
    If lErro <> AD_BOOL_TRUE Then gError ERRO_SEM_MENSAGEM
...
Public Function Form_Load_Ocx() As Object
    ...
    Caption = "Estatísticas por Período"
    Call Form_Load
