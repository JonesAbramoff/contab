...
Begin VB.UserControl PedidoVenda 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox TabPrecoItemPV 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "PedidoVendaInpal.ctx":0000
            Left            =   -20000
            List            =   "PedidoVendaInpal.ctx":0002
         ...
         Begin VB.ComboBox RecebForaFaixa 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "PedidoVendaInpal.ctx":0004
            Left            =   5055
            List            =   "PedidoVendaInpal.ctx":000E
            Style           =   2  'Dropdown List
            TabIndex        =   224
            Top             =   1335
            Width           =   2235
         ...
         Begin VB.ComboBox UnidadeMed 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "PedidoVendaInpal.ctx":0043
            Left            =   1575
            List            =   "PedidoVendaInpal.ctx":0045
            Style           =   2  'Dropdown List
            TabIndex        =   40
            Top             =   240
            Width           =   720
   ...
   Begin VB.Frame Frame1 
      ...
      Top             =   1170
      Width           =   9195
      Begin VB.CheckBox Programacao 
         Caption         =   "Programação de Pedidos"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton BotaoProxNum 
            Height          =   285
            Left            =   2910
            Picture         =   "PedidoVendaInpal.ctx":0047
            Style           =   1  'Graphical
            TabIndex        =   12
         ...
         Begin VB.ComboBox FilialFaturamento 
            Height          =   315
            ItemData        =   "PedidoVendaInpal.ctx":0131
            Left            =   5190
            List            =   "PedidoVendaInpal.ctx":0133
            TabIndex        =   17
            Top             =   765
            Width           =   2145
         End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton BotaoImprimirConf 
         Height          =   345
         Left            =   5460
         Picture         =   "PedidoVendaInpal.ctx":0135
         Style           =   1  'Graphical
         TabIndex        =   270
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame3 
         ...
         Begin VB.CommandButton BotaoDataRefFluxoUp 
            Height          =   150
            Left            =   8940
            Picture         =   "PedidoVendaInpal.ctx":0237
            Style           =   1  'Graphical
            TabIndex        =   221
            TabStop         =   0   'False
            Top             =   615
         ...
         Begin VB.CommandButton BotaoDataRefFluxoDown 
            Height          =   150
            Left            =   8940
            Picture         =   "PedidoVendaInpal.ctx":0291
            Style           =   1  'Graphical
            TabIndex        =   220
            TabStop         =   0   'False
            Top             =   765
         ...
         Begin VB.ComboBox TipoPagto 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "PedidoVendaInpal.ctx":02EB
            Left            =   3045
            List            =   "PedidoVendaInpal.ctx":02FB
            TabIndex        =   217
            Top             =   2310
            Width           =   1965
         End
         Begin VB.CommandButton BotaoDataReferenciaDown 
            Height          =   150
            Left            =   3075
            Picture         =   "PedidoVendaInpal.ctx":0338
            Style           =   1  'Graphical
            TabIndex        =   132
            TabStop         =   0   'False
            Top             =   780
         ...
         Begin VB.CommandButton BotaoDataReferenciaUp 
            Height          =   150
            Left            =   3075
            Picture         =   "PedidoVendaInpal.ctx":0392
            Style           =   1  'Graphical
            TabIndex        =   133
            TabStop         =   0   'False
            Top             =   630
   ...
   Begin VB.Frame Frame1 
      ...
      Visible         =   0   'False
      Width           =   9270
      Begin TelasFATInpal.TabTributacaoFat TabTrib 
         Height          =   4560
         Left            =   150
         TabIndex        =   232
         Top             =   45
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame4 
         ...
         Begin VB.ComboBox DiretoIndireto 
            Height          =   315
            ItemData        =   "PedidoVendaInpal.ctx":03EC
            Left            =   5070
            List            =   "PedidoVendaInpal.ctx":03F6
            Style           =   2  'Dropdown List
            TabIndex        =   182
            Top             =   915
            Width           =   1335
         ...
         Begin VB.CommandButton BotaoVendedores 
            ...
            Height          =   645
            Left            =   7440
            Picture         =   "PedidoVendaInpal.ctx":040C
            Style           =   1  'Graphical
            TabIndex        =   179
            Top             =   3300
            Width           =   1500
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton BotaoLiberaBloqueio 
         ...
         Height          =   600
         Left            =   6825
         Picture         =   "PedidoVendaInpal.ctx":09B6
         Style           =   1  'Graphical
         TabIndex        =   103
         Top             =   3840
         Width           =   1650
      ...
      Begin VB.Frame SSFrame1 
         ...
         Begin VB.ComboBox TipoBloqueio 
            Height          =   315
            ItemData        =   "PedidoVendaInpal.ctx":2FB0
            Left            =   555
            List            =   "PedidoVendaInpal.ctx":2FB2
            TabIndex        =   96
            Top             =   330
            Width           =   1605
         End
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.CommandButton BotaoVerOrcamento 
         Height          =   360
         Left            =   4185
         Picture         =   "PedidoVendaInpal.ctx":2FB4
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton BotaoOrcamento 
         Height          =   360
         Left            =   3795
         Picture         =   "PedidoVendaInpal.ctx":32C6
         Style           =   1  'Graphical
         TabIndex        =   5
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoEmail 
         Height          =   345
         Left            =   0
         Picture         =   "PedidoVendaInpal.ctx":3698
         Style           =   1  'Graphical
         TabIndex        =   118
      ...
      Begin VB.CommandButton BotaoImprimir 
         Height          =   345
         Left            =   495
         Picture         =   "PedidoVendaInpal.ctx":403A
         Style           =   1  'Graphical
         TabIndex        =   119
         ToolTipText     =   "Imprimir"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   345
         Left            =   975
         Picture         =   "PedidoVendaInpal.ctx":413C
         Style           =   1  'Graphical
         TabIndex        =   120
         ToolTipText     =   "Gravar"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   345
         Left            =   1470
         Picture         =   "PedidoVendaInpal.ctx":4296
         Style           =   1  'Graphical
         TabIndex        =   121
         ToolTipText     =   "Excluir"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   345
         Left            =   1965
         Picture         =   "PedidoVendaInpal.ctx":4420
         Style           =   1  'Graphical
         TabIndex        =   122
         ToolTipText     =   "Limpar"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   345
         Left            =   2460
         Picture         =   "PedidoVendaInpal.ctx":4952
         Style           =   1  'Graphical
         TabIndex        =   123
         ToolTipText     =   "Fechar"
         Top             =   60
...
Private Sub UserControl_Initialize()
    ...
    'Inpal
    Set objCT.gobjInfoUsu = New CTPVVGInpal
    Set objCT.gobjInfoUsu.gobjTelaUsu = New CTPVInpal
...
Private Sub Programacao_Click()
    Call objCT.gobjInfoUsu.gobjTelaUsu.Programacao_Click(objCT)
End Sub

Private Sub PercAcrescFin_Validate(Cancel As Boolean)
     Call objCT.gobjInfoUsu.gobjTelaUsu.PercAcrescFin_Validate(objCT, Cancel)
End Sub
