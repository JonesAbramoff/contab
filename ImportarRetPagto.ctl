...
Begin VB.UserControl ImportarRetPagtoOcx 
   ClientHeight    =   2400
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   6975
   ...
   Begin VB.CommandButton BotaoOK 
      ...
      Height          =   540
      Left            =   2595
      Picture         =   "ImportarRetPagto.ctx":0000
      Style           =   1  'Graphical
      TabIndex        =   3
      Top             =   1605
      Width           =   855
   ...
   Begin VB.CommandButton BotaoCancela 
      ...
      Height          =   540
      Left            =   3525
      Picture         =   "ImportarRetPagto.ctx":015A
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   1605
      Width           =   855
   ...
   End
End
Attribute VB_Name = "ImportarRetPagtoOcx"
...
'    Parent.HelpContextID = IDH_PROCESSA_ARQRETCOBRANCA
    ...
    Caption = "Importar Arquivo de Retorno de Pagamento"
    Call Form_Load
...
On Error GoTo Erro_BotaoOK_Click
    ...
    lErro = CF("RetPagto_Importa", sNomeDir, sNomeArq)
