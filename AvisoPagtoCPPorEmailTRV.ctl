...
Begin VB.UserControl AvisoPagtoCPPorEmail 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Modelo 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "AvisoPagtoCPPorEmailTRV.ctx":0000
         Left            =   1740
         List            =   "AvisoPagtoCPPorEmailTRV.ctx":000A
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.Frame Frame5 
            ...
            Begin VB.ListBox TipoDoc 
               Columns         =   3
               Height          =   1410
               ItemData        =   "AvisoPagtoCPPorEmailTRV.ctx":003F
               Left            =   90
               List            =   "AvisoPagtoCPPorEmailTRV.ctx":0058
               Style           =   1  'Checkbox
               TabIndex        =   9
               Top             =   330
               Width           =   3255
         ...
         Begin VB.Frame Frame2 
            ...
            Begin VB.ComboBox TipoDocSeleciona 
               Enabled         =   0   'False
               Height          =   315
               ItemData        =   "AvisoPagtoCPPorEmailTRV.ctx":0084
               Left            =   1410
               List            =   "AvisoPagtoCPPorEmailTRV.ctx":0086
               Style           =   2  'Dropdown List
               TabIndex        =   12
               Top             =   915
               Width           =   2820
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Carta 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "AvisoPagtoCPPorEmailTRV.ctx":0088
         Left            =   3090
         List            =   "AvisoPagtoCPPorEmailTRV.ctx":0092
         Style           =   2  'Dropdown List
         TabIndex        =   47
         Top             =   420
         Width           =   2235
      ...
      Begin VB.CommandButton BotaoMarcarTodos 
         ...
         Height          =   555
         Left            =   60
         Picture         =   "AvisoPagtoCPPorEmailTRV.ctx":00C7
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   3450
         Width           =   1725
      ...
      Begin VB.CommandButton BotaoDesmarcarTodos 
         ...
         Height          =   555
         Left            =   45
         Picture         =   "AvisoPagtoCPPorEmailTRV.ctx":10E1
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   4200
         Width           =   1725
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoEmail 
         Height          =   360
         Left            =   120
         Picture         =   "AvisoPagtoCPPorEmailTRV.ctx":22C3
         Style           =   1  'Graphical
         TabIndex        =   23
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   645
         Picture         =   "AvisoPagtoCPPorEmailTRV.ctx":2C65
         Style           =   1  'Graphical
         TabIndex        =   24
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1155
         Picture         =   "AvisoPagtoCPPorEmailTRV.ctx":3197
         Style           =   1  'Graphical
         TabIndex        =   25
         ToolTipText     =   "Fechar"
         Top             =   75
