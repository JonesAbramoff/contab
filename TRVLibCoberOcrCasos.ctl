...
Begin VB.UserControl TRVLibCoberOcrCasos 
   ClientHeight    =   6240
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   10515
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.Frame Frame3 
            Caption         =   "Data Programação Financeiro"
            Height          =   1125
            Left            =   795
            TabIndex        =   33
            Top             =   2685
            Width           =   5505
            Begin MSComCtl2.UpDown UpDownProgDe 
               Height          =   300
               Left            =   1920
               TabIndex        =   7
               TabStop         =   0   'False
               ...
               Enabled         =   -1  'True
            End
            Begin MSMask.MaskEdBox DataProgDe 
               Height          =   300
               Left            =   795
               TabIndex        =   6
               Top             =   480
               ...
               PromptChar      =   " "
            End
            Begin MSMask.MaskEdBox DataProgAte 
               Height          =   300
               Left            =   3390
               TabIndex        =   8
               Top             =   480
               ...
               PromptChar      =   " "
            End
            Begin MSComCtl2.UpDown UpDownProgAte 
               Height          =   300
               Left            =   4545
               TabIndex        =   9
               TabStop         =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin MSMask.MaskEdBox Ccl 
         ...
         PromptChar      =   " "
      End
      Begin MSMask.MaskEdBox ValorSeg 
         Height          =   285
         Left            =   3780
         TabIndex        =   38
         Top             =   1395
         ...
         PromptChar      =   "_"
      End
      Begin MSMask.MaskEdBox ValorAssist 
         Height          =   285
         Left            =   3990
         TabIndex        =   37
         Top             =   2085
         ...
         PromptChar      =   "_"
      End
      Begin MSMask.MaskEdBox DataProg 
         Height          =   285
         Left            =   2355
         TabIndex        =   36
         Top             =   1185
      ...
      Begin VB.CommandButton BotaoLibera 
         ...
         Height          =   960
         Left            =   165
         Picture         =   "TRVLibCoberOcrCasos.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   4770
         Width           =   1590
      ...
      Begin VB.CommandButton BotaoDesmarcarTodos 
         ...
         Height          =   570
         Left            =   5340
         Picture         =   "TRVLibCoberOcrCasos.ctx":0442
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   4965
         Width           =   1425
      ...
      Begin VB.CommandButton BotaoMarcarTodos 
         ...
         Height          =   570
         Left            =   3720
         Picture         =   "TRVLibCoberOcrCasos.ctx":1624
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   4965
         Width           =   1425
   ...
   Begin VB.CommandButton BotaoFechar 
      ...
      Height          =   330
      Left            =   9270
      Picture         =   "TRVLibCoberOcrCasos.ctx":263E
      Style           =   1  'Graphical
      TabIndex        =   15
      ToolTipText     =   "Fechar"
      Top             =   30
   ...
   End
End
Attribute VB_Name = "TRVLibCoberOcrCasos"
...
Dim iGrid_DataProg_Col As Integer
Dim iGrid_ValorAssist_Col As Integer
Dim iGrid_ValorSeg_Col As Integer
...
On Error GoTo Erro_Move_Selecao_Memoria
    ...
    objLibOcr.iTipo = TRV_OCRCASOS_LIB_COBERTURA

    objLibOcr.dtDataProgAte = StrParaDate(DataProgAte.Text)
    objLibOcr.dtDataProgDe = StrParaDate(DataProgDe.Text)
    ...
    If objLibOcr.dtDataProgAte <> DATA_NULA And objLibOcr.dtDataProgDe <> DATA_NULA Then
        If objLibOcr.dtDataProgAte < objLibOcr.dtDataProgDe Then gError 208706
    End If
...
Private Sub DataProgAte_GotFocus()
    Call MaskEdBox_TrataGotFocus(DataProgAte, iAlterado)
End Sub

Private Sub DataProgAte_Validate(Cancel As Boolean)
'Critica a Data

Dim lErro As Long

On Error GoTo Erro_DataProgAte_Validate

    'Se a DataProgAte está preenchida
    If Len(DataProgAte.ClipText) > 0 Then

        'Verifica se a DataProgAte é válida
        lErro = Data_Critica(DataProgAte.Text)
        If lErro <> SUCESSO Then gError ERRO_SEM_MENSAGEM
...
Erro_DataProgAte_Validate:
    ...
    Select Case gErr
        ...
        Case Else
             Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 208715)
...
Private Sub DataProgDe_GotFocus()
    
    Call MaskEdBox_TrataGotFocus(DataProgDe, iAlterado)

End Sub

Private Sub DataProgDe_Validate(Cancel As Boolean)
'Critica a Data

Dim lErro As Long

On Error GoTo Erro_DataProgDe_Validate

    'Se a DataProgDe está preenchida
    If Len(DataProgDe.ClipText) > 0 Then

        'Verifica se a DataProgDe é válida
        lErro = Data_Critica(DataProgDe.Text)
        If lErro <> SUCESSO Then gError ERRO_SEM_MENSAGEM
...
Erro_DataProgDe_Validate:
    ...
    Select Case gErr
        ...
        Case Else
             Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 208716)
...
Private Sub UpDownProgAte_DownClick()

Dim lErro As Long

On Error GoTo Erro_UpDownProgAte_DownClick

    'Diminui a DataProgAte em 1 dia
    lErro = Data_Up_Down_Click(DataProgAte, DIMINUI_DATA)
    If lErro <> SUCESSO Then gError ERRO_SEM_MENSAGEM

    Exit Sub

Erro_UpDownProgAte_DownClick:
    ...
    Select Case gErr
        ...
        Case Else
             Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 208731)
...
Private Sub UpDownProgAte_UpClick()

Dim lErro As Long

On Error GoTo Erro_UpDownProgAte_UpClick

    'Aumenta a DataProgAte em 1 dia
    lErro = Data_Up_Down_Click(DataProgAte, AUMENTA_DATA)
    If lErro <> SUCESSO Then gError ERRO_SEM_MENSAGEM

    Exit Sub

Erro_UpDownProgAte_UpClick:
    ...
    Select Case gErr
        ...
        Case Else
             Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 208732)
...
Private Sub UpDownProgDe_DownClick()

Dim lErro As Long

On Error GoTo Erro_UpDownProgDe_DownClick

    'Diminui a DataProgDe em 1 dia
    lErro = Data_Up_Down_Click(DataProgDe, DIMINUI_DATA)
    If lErro <> SUCESSO Then gError ERRO_SEM_MENSAGEM

    Exit Sub

Erro_UpDownProgDe_DownClick:
    ...
    Select Case gErr
        ...
        Case Else
             Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 208733)
...
Private Sub UpDownProgDe_UpClick()

Dim lErro As Long

On Error GoTo Erro_UpDownProgDe_UpClick

    'Aumenta a DataProgDe em 1 dia
    lErro = Data_Up_Down_Click(DataProgDe, AUMENTA_DATA)
    If lErro <> SUCESSO Then gError ERRO_SEM_MENSAGEM

    Exit Sub

Erro_UpDownProgDe_UpClick:
    ...
    Select Case gErr
        ...
        Case Else
             Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 208734)
...
On Error GoTo Erro_Grid_Itens_Preenche
    ...
    For Each objOcorrencia In objLiberaOcrSel.colOcorrenciais
        ...
        If objOcorrencia.dtDataLimite <> DATA_NULA Then GridItens.TextMatrix(iLinha, iGrid_Data_Col) = Format(objOcorrencia.dtDataLimite, "dd/mm/yyyy")
        If objOcorrencia.dtDataProgFinanc <> DATA_NULA Then GridItens.TextMatrix(iLinha, iGrid_DataProg_Col) = Format(objOcorrencia.dtDataProgFinanc, "dd/mm/yyyy")
        GridItens.TextMatrix(iLinha, iGrid_ValorAssist_Col) = Format(objOcorrencia.dValorAutorizadoAssistRS, "STANDARD")
        If objOcorrencia.iAnteciparPagtoSeguro = MARCADO Then
            GridItens.TextMatrix(iLinha, iGrid_ValorSeg_Col) = Format(objOcorrencia.dValorAutorizadoSeguroRS, "STANDARD")
        Else
            GridItens.TextMatrix(iLinha, iGrid_ValorSeg_Col) = Format(objOcorrencia.dValorAutoSegRespTrvRS, "STANDARD")
        End If
...
'Executa a Inicialização do grid Bloqueio
    ...
    objGridInt.colColuna.Add ("Programação")
    objGridInt.colColuna.Add ("Assitência")
    objGridInt.colColuna.Add ("Seg. Travel.")
   ...
   'campos de edição do grid
    ...
    objGridInt.colCampo.Add (DataProg.Name)
    objGridInt.colCampo.Add (ValorAssist.Name)
    objGridInt.colCampo.Add (ValorSeg.Name)
    ...
    iGrid_Data_Col = 4
    iGrid_DataProg_Col = 5
    iGrid_ValorAssist_Col = 6
    iGrid_ValorSeg_Col = 7
    iGrid_Ccl_Col = 8
    iGrid_Tipo_Col = 9
    iGrid_Serie_Col = 10
    iGrid_Voucher_Col = 11
...
On Error GoTo Erro_Gravar_Registro
    ...
    lErro = CF("TRVLibOcrCasos_Libera", TRV_OCRCASOS_LIB_COBERTURA, colOcorrencias)
    If lErro <> SUCESSO Then gError ERRO_SEM_MENSAGEM
...
Public Function Form_Load_Ocx() As Object
    ...
    Caption = "Liberação de ocorrências de cobertura"
    Call Form_Load
