...
Begin VB.UserControl NFiscalFaturaPedido 
   ClientHeight    =   5970
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9570
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox TabPrecoItemNF 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "NFiscalFaturaPedidoPhar.ctx":0000
            Left            =   -20000
            List            =   "NFiscalFaturaPedidoPhar.ctx":0002
         ...
         Begin MSMask.MaskEdBox ProdutoKit 
            ...
            PromptChar      =   " "
         End
         Begin MSMask.MaskEdBox QuantKit 
            Height          =   225
            Left            =   540
            TabIndex        =   203
            Top             =   705
   ...
   Begin VB.Frame Frame1 
      ...
      End
      Begin VB.CommandButton Botao 
         Caption         =   "Refazer automaticamente"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CommandButton Botao 
            ...
            Index           =   8
            Left            =   5085
            Picture         =   "NFiscalFaturaPedidoPhar.ctx":0004
            Style           =   1  'Graphical
            TabIndex        =   24
         ...
         Begin VB.ComboBox TipoNFiscal 
            Height          =   315
            ItemData        =   "NFiscalFaturaPedidoPhar.ctx":0536
            Left            =   2085
            List            =   "NFiscalFaturaPedidoPhar.ctx":0538
            TabIndex        =   23
            Top             =   180
            Width           =   3360
         End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame3 
         ...
         Begin VB.ComboBox Desconto1Codigo 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "NFiscalFaturaPedidoPhar.ctx":053A
            Left            =   3120
            List            =   "NFiscalFaturaPedidoPhar.ctx":053C
            TabIndex        =   111
            Top             =   1140
            Width           =   1950
         End
         Begin VB.CommandButton BotaoDataReferenciaUp 
            Height          =   150
            Left            =   3000
            Picture         =   "NFiscalFaturaPedidoPhar.ctx":053E
            Style           =   1  'Graphical
            TabIndex        =   110
            TabStop         =   0   'False
            Top             =   645
         ...
         Begin VB.CommandButton BotaoDataReferenciaDown 
            Height          =   150
            Left            =   3000
            Picture         =   "NFiscalFaturaPedidoPhar.ctx":0598
            Style           =   1  'Graphical
            TabIndex        =   107
            TabStop         =   0   'False
            Top             =   795
         ...
         Begin VB.ComboBox TipoPagto 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "NFiscalFaturaPedidoPhar.ctx":05F2
            Left            =   2940
            List            =   "NFiscalFaturaPedidoPhar.ctx":0602
            TabIndex        =   105
            Top             =   2265
            Width           =   1965
         End
   ...
   Begin VB.Frame Frame1 
      BorderStyle     =   0  'None
      Caption         =   $"NFiscalFaturaPedidoPhar.ctx":063F
      Height          =   4650
      Index           =   7
      Left            =   135
      TabIndex        =   127
      ...
      Visible         =   0   'False
      Width           =   9240
      Begin TelasFATPhar.TabTributacaoFat TabTrib 
         Height          =   4530
         Left            =   135
         TabIndex        =   216
         Top             =   90
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   0
         Left            =   3630
         Picture         =   "NFiscalFaturaPedidoPhar.ctx":06D2
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   1
         Left            =   4020
         Picture         =   "NFiscalFaturaPedidoPhar.ctx":0AA4
         Style           =   1  'Graphical
         TabIndex        =   3
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   7
         Left            =   2685
         Picture         =   "NFiscalFaturaPedidoPhar.ctx":0DB6
         Style           =   1  'Graphical
         TabIndex        =   188
         ToolTipText     =   "Fechar"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   6
         Left            =   2232
         Picture         =   "NFiscalFaturaPedidoPhar.ctx":0F34
         Style           =   1  'Graphical
         TabIndex        =   187
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   4
         Left            =   1326
         Picture         =   "NFiscalFaturaPedidoPhar.ctx":1466
         Style           =   1  'Graphical
         TabIndex        =   186
         ToolTipText     =   "Gravar"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   3
         Left            =   498
         Picture         =   "NFiscalFaturaPedidoPhar.ctx":15C0
         Style           =   1  'Graphical
         TabIndex        =   185
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   5
         Left            =   1779
         Picture         =   "NFiscalFaturaPedidoPhar.ctx":1E42
         Style           =   1  'Graphical
         TabIndex        =   184
         ToolTipText     =   "Excluir"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   2
         Left            =   45
         Picture         =   "NFiscalFaturaPedidoPhar.ctx":1FCC
         Style           =   1  'Graphical
         TabIndex        =   183
   ...
   Begin VB.ComboBox DiretoIndireto 
      Height          =   315
      ItemData        =   "NFiscalFaturaPedidoPhar.ctx":20CE
      Left            =   7335
      List            =   "NFiscalFaturaPedidoPhar.ctx":20D8
      Style           =   2  'Dropdown List
      TabIndex        =   180
      Top             =   2370
      Width           =   1215
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame4 
         ...
         Begin VB.CommandButton BotaoVendedores 
            ...
            Height          =   615
            Left            =   7560
            Picture         =   "NFiscalFaturaPedidoPhar.ctx":20EE
            Style           =   1  'Graphical
            TabIndex        =   163
            Top             =   3300
            Width           =   1380
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Height          =   315
            ItemData        =   "NFiscalFaturaPedidoPhar.ctx":2698
            Left            =   3690
            List            =   "NFiscalFaturaPedidoPhar.ctx":26A5
            Style           =   2  'Dropdown List
            TabIndex        =   88
            Top             =   270
            Width           =   1215
         ...
         Begin VB.ComboBox ProdutoRastro 
            Height          =   315
            ItemData        =   "NFiscalFaturaPedidoPhar.ctx":26C4
            Left            =   2400
            List            =   "NFiscalFaturaPedidoPhar.ctx":26D1
            Style           =   2  'Dropdown List
            TabIndex        =   87
            Top             =   1905
            Width           =   1740
   ...
   End
End
Attribute VB_Name = "NFiscalFaturaPedido"
...
Public WithEvents objCT As CTNFiscalFaturaPedido
...
Private Sub UserControl_Initialize()
    Set objCT = New CTNFiscalFaturaPedido
    Set objCT.objUserControl = Me

    Set objCT.gobjInfoUsu = New CTNFFatPedVGPhar
    Set objCT.gobjInfoUsu.gobjTelaUsu = New CTNFFatPedPhar
...
Private Sub FornEntTercLabel_Click()
     Call objCT.FornEntTercLabel_Click
End Sub

Private Sub FornEntTerc_Change()
     Call objCT.FornEntTerc_Change
End Sub

Private Sub FornEntTerc_Validate(Cancel As Boolean)
     Call objCT.FornEntTerc_Validate(Cancel)
End Sub

Private Sub FilialFornEntTerc_Change()
     Call objCT.FilialFornEntTerc_Change
End Sub

Private Sub FilialFornEntTerc_Click()
     Call objCT.FilialFornEntTerc_Click
End Sub

Private Sub FilialFornEntTerc_Validate(Cancel As Boolean)
     Call objCT.FilialFornEntTerc_Validate(Cancel)
End Sub
