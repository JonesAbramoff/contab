...
Begin VB.UserControl FaturasPag 
   ClientHeight    =   6000
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9510
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame1 
         ...
         Begin MSMask.MaskEdBox FornGrid 
            ...
            PromptChar      =   "_"
         End
         Begin VB.CommandButton BotaoNFRegistrarDif 
            Caption         =   "Cadastrar NF da diferença"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "FaturasPagTRV.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   27
         ToolTipText     =   "Gravar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "FaturasPagTRV.ctx":015A
         Style           =   1  'Graphical
         TabIndex        =   28
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "FaturasPagTRV.ctx":02E4
         Style           =   1  'Graphical
         TabIndex        =   29
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "FaturasPagTRV.ctx":0816
         Style           =   1  'Graphical
         TabIndex        =   30
         ToolTipText     =   "Fechar"
         Top             =   90
...
Private Sub UserControl_Initialize()
    ...
    'TRV
    Set objCT.gobjInfoUsu = New CTFatPagVGTRV
    Set objCT.gobjInfoUsu.gobjTelaUsu = New CTFatPagTRV
End Sub
...
Private Sub BotaoNFRegistrarDif_Click()
     Call objCT.gobjInfoUsu.gobjTelaUsu.BotaoNFRegistrarDif_Click(objCT)
End Sub
