...
Begin VB.UserControl Produto 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame Frame28 
         ...
         Begin VB.ComboBox ProdutoEspecifico 
            Height          =   315
            ItemData        =   "produto2.ctx":0000
            Left            =   2190
            List            =   "produto2.ctx":0014
            Sorted          =   -1  'True
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox ProdEmEscalaRelev 
         Height          =   315
         ItemData        =   "produto2.ctx":0059
         Left            =   2385
         List            =   "produto2.ctx":0067
         TabIndex        =   228
         Text            =   "Combo1"
         Top             =   3705
         Width           =   1755
      ...
      Begin VB.ComboBox OrigemMercadoria 
         Height          =   315
         ItemData        =   "produto2.ctx":0078
         Left            =   4500
         List            =   "produto2.ctx":0097
         Style           =   2  'Dropdown List
         TabIndex        =   213
         Top             =   435
         Width           =   4515
      ...
      Begin VB.Frame Frame18 
         ...
         Begin VB.ComboBox comboAliquota 
            Height          =   315
            ItemData        =   "produto2.ctx":03FE
            Left            =   1980
            List            =   "produto2.ctx":0400
            Style           =   2  'Dropdown List
            TabIndex        =   76
            Top             =   720
            Width           =   1500
   ...
   Begin VB.Frame Frame2 
      ...
      Top             =   1200
      Width           =   9195
      Begin VB.CommandButton BotaoDescSimilar 
         Height          =   360
         Left            =   5505
         Picture         =   "produto2.ctx":0402
         Style           =   1  'Graphical
         TabIndex        =   219
      ...
      Begin VB.ComboBox NaturezaProduto 
         Height          =   315
         ItemData        =   "produto2.ctx":0714
         Left            =   1470
         List            =   "produto2.ctx":0743
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   8
         Top             =   2715
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame Frame26 
         ...
         Begin VB.ComboBox Rastro 
            Height          =   315
            ItemData        =   "produto2.ctx":0920
            Left            =   1470
            List            =   "produto2.ctx":0930
            Style           =   2  'Dropdown List
            TabIndex        =   39
            Top             =   180
            Width           =   2430
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.ComboBox ApropriacaoComp 
            Height          =   315
            ItemData        =   "produto2.ctx":0A43
            Left            =   2130
            List            =   "produto2.ctx":0A4A
            Style           =   2  'Dropdown List
            TabIndex        =   46
            Top             =   195
            Width           =   2610
         ...
         Begin VB.ComboBox ApropriacaoProd 
            Height          =   315
            ItemData        =   "produto2.ctx":0A5B
            Left            =   2130
            List            =   "produto2.ctx":0A65
            Style           =   2  'Dropdown List
            TabIndex        =   124
            Top             =   195
            Visible         =   0   'False
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame Frame5 
         ...
         Begin VB.ListBox ListaCaracteristicas 
            Height          =   1185
            ItemData        =   "produto2.ctx":0A91
            Left            =   255
            List            =   "produto2.ctx":0AA4
            Style           =   1  'Checkbox
            TabIndex        =   31
            Top             =   195
            Width           =   3885
...
Private Sub LabelFCI_DragDrop(Source As Control, X As Single, Y As Single)
   Call Controle_DragDrop(LabelFCI, Source, X, Y)
End Sub

Private Sub LabelFCI_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
   Call Controle_MouseDown(LabelFCI, Button, Shift, X, Y)
End Sub

Private Sub BotaoDescSimilar_Click()
     Call objCT.BotaoDescSimilar_Click
End Sub
