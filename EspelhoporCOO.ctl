...
Begin VB.UserControl EspelhoporCOO 
   ClientHeight    =   2280
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4560
   ...
   Begin VB.CommandButton BotaoArquivo 
      ...
      Height          =   615
      Left            =   1305
      Picture         =   "EspelhoporCOO.ctx":0000
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   1545
      Width           =   1935
   End
End
Attribute VB_Name = "EspelhoporCOO"
...
On Error GoTo Erro_COODe_Validate
    ...
    If lErro <> SUCESSO Then gError 204461
...
Erro_COODe_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 204462)
...
On Error GoTo Erro_COOAte_Validate
    ...
    If lErro <> SUCESSO Then gError 204463
...
Erro_COOAte_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 204464)
...
On Error GoTo Erro_BotaoArquivo_Click
    ...
    If lErro <> SUCESSO Then gError 204465
...
Erro_BotaoArquivo_Click:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 204466)
...
Erro_COOAte_GotFocus:
     ...
     Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 204467)
...
Erro_COODe_GotFocus:
     ...
     Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 204468)
...
Erro_UserControl_KeyDown:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 210066)
