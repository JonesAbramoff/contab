...
Begin VB.UserControl RelOpTitRec 
   ClientHeight    =   7410
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   7830
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "RelOpTitRecPur.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   21
         ToolTipText     =   "Gravar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "RelOpTitRecPur.ctx":015A
         Style           =   1  'Graphical
         TabIndex        =   22
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "RelOpTitRecPur.ctx":02E4
         Style           =   1  'Graphical
         TabIndex        =   23
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "RelOpTitRecPur.ctx":0816
         Style           =   1  'Graphical
         TabIndex        =   24
         ToolTipText     =   "Fechar"
         Top             =   90
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   600
      Left            =   5670
      Picture         =   "RelOpTitRecPur.ctx":0994
      Style           =   1  'Graphical
      TabIndex        =   19
      Top             =   825
      Width           =   1815
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   315
      ItemData        =   "RelOpTitRecPur.ctx":0A96
      Left            =   1320
      List            =   "RelOpTitRecPur.ctx":0A98
      Sorted          =   -1  'True
      TabIndex        =   0
      Top             =   255
      Width           =   2730
...
''    If Len(DataRef.ClipText) = 0 Then Error 59631
    ...
    lErro = Formata_E_Critica_Parametros(sCliente_I, sCliente_F, sCheckTipo, sClienteTipo, sCheckCobrador, sCobrador, iVendedor, sProd_I, sProd_F)
...
'    If lErro <> AD_BOOL_TRUE Then gError 47765
    ...
    If bExecutando Then
        ...
        lErro = CF("RelFiltroNumDoc_Prepara_TitRec", giFilialEmpresa, StrParaInt(sClienteTipo), StrParaLong(sCliente_I), StrParaLong(sCliente_F), StrParaDate(EmissaoDe.Text), StrParaDate(EmissaoAte.Text), iTipoVend, Codigo_Extrai(Vendedor.Text), sProd_I, sProd_F, lNumIntRel)
        If lErro <> SUCESSO Then gError ERRO_SEM_MENSAGEM
...
Private Function Formata_E_Critica_Parametros(sCliente_I As String, sCliente_F As String, sCheckTipo As String, sClienteTipo As String, sCheckCobrador As String, sCobrador As String, iVendedor As Integer, sProd_I As String, sProd_F As String) As Long
