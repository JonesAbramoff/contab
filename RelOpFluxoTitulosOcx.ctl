...
Begin VB.UserControl RelOpFluxoTitulosOcx 
   ClientHeight    =   1470
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4815
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   600
      Left            =   3570
      Picture         =   "RelOpFluxoTitulosOcx.ctx":0000
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   750
      Width           =   1140
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   585
         Picture         =   "RelOpFluxoTitulosOcx.ctx":0102
         Style           =   1  'Graphical
         TabIndex        =   4
         ToolTipText     =   "Fechar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   75
         Picture         =   "RelOpFluxoTitulosOcx.ctx":0280
         Style           =   1  'Graphical
         TabIndex        =   3
         ToolTipText     =   "Limpar"
         Top             =   75
   ...
   End
End
Attribute VB_Name = "RelOpFluxoTitulosOcx"
...
Dim lErro As Long
    ...
    If lErro <> SUCESSO Then gError 87895

    lErro = objRelOpcoes.Limpar
    If lErro <> AD_BOOL_TRUE Then gError 87896

    'Preenche a data inicio de emissão
    If Trim(EmissaoDe.ClipText) <> "" Then
        lErro = objRelOpcoes.IncluirParametro("DINIC", EmissaoDe.Text)
    Else
        lErro = objRelOpcoes.IncluirParametro("DINIC", CStr(DATA_NULA))
    End If
    If lErro <> AD_BOOL_TRUE Then gError 87897
    ...
    End If
    If lErro <> AD_BOOL_TRUE Then gError 87898

    'Faz a selecao
    lErro = Monta_Expressao_Selecao(objRelOpcoes)
    If lErro <> SUCESSO Then gError 87899
...
Erro_PreencherRelOp:
    ...
    Select Case gErr
        ...
        Case 87895, 87896, 87897, 87898, 87899

        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 169198)
...
On Error GoTo Erro_Trata_Parametros
    ...
    If Not (gobjRelatorio Is Nothing) Then gError 87916
...
Erro_Trata_Parametros:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 169199)
...
On Error GoTo Erro_BotaoExecutar_Click
    ...
    If lErro <> SUCESSO Then gError 87917
...
Erro_BotaoExecutar_Click:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 169200)
...
On Error GoTo Erro_EmissaoDe_Validate
    ...
    If lErro <> SUCESSO Then gError 87918

    'Verifica se a data informada é maoir que a data atual
    If StrParaDate(EmissaoDe.Text) > gdtDataAtual Then gError 87919
...
Erro_EmissaoDe_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 169201)
...
On Error GoTo Erro_EmissaoAte_Validate
    ...
    If lErro <> SUCESSO Then gError 87920

    'Verifica se a data informada é maoir que a data atual
    If StrParaDate(EmissaoAte.Text) > gdtDataAtual Then gError 87921
...
Erro_EmissaoAte_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 169202)
...
On Error GoTo Erro_UpDownEmissaoDe_DownClick
    ...
    If lErro <> SUCESSO Then gError 87922
...
Erro_UpDownEmissaoDe_DownClick:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 169203)
...
On Error GoTo Erro_UpDownEmissaoDe_UpClick
    ...
    If lErro <> SUCESSO Then gError 87923
...
Erro_UpDownEmissaoDe_UpClick:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 169204)
...
On Error GoTo Erro_UpDownEmissaoAte_DownClick
    ...
    If lErro <> SUCESSO Then gError 87924
...
Erro_UpDownEmissaoAte_DownClick:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 169205)
...
On Error GoTo Erro_UpDownEmissaoAte_UpClick
    ...
    If lErro <> SUCESSO Then gError 87925
...
Erro_UpDownEmissaoAte_UpClick:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 169206)
...
On Error GoTo Erro_Formata_E_Critica_Parametros
    ...
    If Trim(EmissaoDe.ClipText) <> "" And Trim(EmissaoAte.ClipText) <> "" Then
         ...
         If CDate(EmissaoDe.Text) > CDate(EmissaoAte.Text) Then gError 87926
...
Erro_Formata_E_Critica_Parametros:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 169207)
...
Erro_Monta_Expressao_Selecao:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 169208)
