...
Begin VB.UserControl NFiscalRemPedido 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame6 
         ...
         Begin VB.ComboBox TabPrecoItemNF 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "NFiscalRemPedidoPhar.ctx":0000
            Left            =   -20000
            List            =   "NFiscalRemPedidoPhar.ctx":0002
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton BotaoLimparNF 
            Height          =   300
            Left            =   5160
            Picture         =   "NFiscalRemPedidoPhar.ctx":0004
            Style           =   1  'Graphical
            TabIndex        =   14
         ...
         Begin VB.ComboBox TipoNFiscal 
            Height          =   315
            ItemData        =   "NFiscalRemPedidoPhar.ctx":0536
            Left            =   2340
            List            =   "NFiscalRemPedidoPhar.ctx":0538
            TabIndex        =   13
            Top             =   210
            Width           =   3180
         End
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.CommandButton BotaoPedido 
         Height          =   360
         Left            =   3855
         Picture         =   "NFiscalRemPedidoPhar.ctx":053A
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      Begin VB.CommandButton BotaoVerPedido 
         Height          =   360
         Left            =   4275
         Picture         =   "NFiscalRemPedidoPhar.ctx":090C
         Style           =   1  'Graphical
         TabIndex        =   3
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   330
         Left            =   530
         Picture         =   "NFiscalRemPedidoPhar.ctx":0C1E
         Style           =   1  'Graphical
         TabIndex        =   156
         ToolTipText     =   "Excluir"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   330
         Left            =   1440
         Picture         =   "NFiscalRemPedidoPhar.ctx":0DA8
         Style           =   1  'Graphical
         TabIndex        =   155
         ToolTipText     =   "Fechar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   330
         Left            =   985
         Picture         =   "NFiscalRemPedidoPhar.ctx":0F26
         Style           =   1  'Graphical
         TabIndex        =   154
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   330
         Left            =   75
         Picture         =   "NFiscalRemPedidoPhar.ctx":1458
         Style           =   1  'Graphical
         TabIndex        =   153
         ToolTipText     =   "Gravar"
         Top             =   75
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame18 
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "NFiscalRemPedidoPhar.ctx":15B2
            Left            =   3705
            List            =   "NFiscalRemPedidoPhar.ctx":15BF
            Style           =   2  'Dropdown List
            TabIndex        =   113
            Top             =   270
            Visible         =   0   'False
         ...
         Begin VB.ComboBox ProdutoRastro 
            Height          =   315
            ItemData        =   "NFiscalRemPedidoPhar.ctx":15DE
            Left            =   885
            List            =   "NFiscalRemPedidoPhar.ctx":15EB
            Style           =   2  'Dropdown List
            TabIndex        =   112
            Top             =   960
            Width           =   1740
