...
Begin VB.UserControl EspelhoPorData1 
   ClientHeight    =   2370
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4740
   ...
   Begin VB.CommandButton BotaoArquivo 
      ...
      Height          =   615
      Left            =   1380
      Picture         =   "EspelhoPorData1.ctx":0000
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   1575
      Width           =   1935
   End
End
Attribute VB_Name = "EspelhoPorData1"
...
Erro_DataDe_GotFocus:
     ...
     Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 204469)
...
On Error GoTo Erro_DataDe_Validate
    ...
    If lErro <> SUCESSO Then gError 204470
...
Erro_DataDe_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 204471)
...
Erro_DataAte_GotFocus:
     ...
     Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 204472)
...
On Error GoTo Erro_DataAte_Validate
    ...
    If lErro <> SUCESSO Then gError 204473
...
Erro_DataAte_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 204474)
...
On Error GoTo Erro_BotaoArquivo_Click
    ...
    If Len(Trim(DataDe.ClipText)) = 0 Or Len(Trim(DataAte.ClipText)) = 0 Then gError 204476
    
    If Len(Trim(DataDe.ClipText)) > 0 Then sDe = DataDe.Text
    If Len(Trim(DataAte.ClipText)) > 0 Then sAte = DataAte.Text

    If CDate(sDe) > CDate(sAte) Then gError 204477


    'Função que Vai Chamar Função da Afrac que Vai Executar a Leitura da Memoria Fiscal
    lErro = CF_ECF("EspelhoMFD_Executa", iTipoLeitura, sDe, sAte)
    If lErro <> SUCESSO Then gError 204478
...
Erro_BotaoArquivo_Click:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 204479)
...
On Error GoTo Erro_UpDownDataDe_DownClick
    ...
    If lErro <> SUCESSO Then gError 204800
...
Erro_UpDownDataDe_DownClick:
    ...
    Select Case gErr
        ...
        Case Else
             lErro = Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error, 204801)
...
On Error GoTo Erro_UpDownDataDe_UpClick
    ...
    If lErro <> SUCESSO Then gError 204802
...
Erro_UpDownDataDe_UpClick:
    ...
    Select Case gErr
        ...
        Case Else
             lErro = Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error, 204803)
...
On Error GoTo Erro_UpDownDataAte_DownClick
    ...
    If lErro <> SUCESSO Then gError 204804
...
Erro_UpDownDataAte_DownClick:
    ...
    Select Case gErr
        ...
        Case Else
             lErro = Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error, 204805)
...
On Error GoTo Erro_UpDownDataAte_UpClick
    ...
    If lErro <> SUCESSO Then gError 204806
...
Erro_UpDownDataAte_UpClick:
    ...
    Select Case gErr
        ...
        Case Else
             lErro = Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error, 204807)
...
Erro_UserControl_KeyDown:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 210067)
