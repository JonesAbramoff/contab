      ...
      Begin VB.Frame Frame9 
         ...
         Begin VB.Frame Frame3 
            ...
            Begin VB.ComboBox TipoDocSeleciona 
               Enabled         =   0   'False
               Height          =   315
               ItemData        =   "BaixaRecTRV.ctx":0000
               Left            =   1155
               List            =   "BaixaRecTRV.ctx":0002
               Style           =   2  'Dropdown List
               TabIndex        =   24
               Top             =   930
               Width           =   1755
         ...
         Begin VB.Frame Frame15 
            ...
            Begin VB.ComboBox ContaCorrenteSeleciona 
               Enabled         =   0   'False
               Height          =   315
               ItemData        =   "BaixaRecTRV.ctx":0004
               Left            =   1170
               List            =   "BaixaRecTRV.ctx":0006
               TabIndex        =   21
               Top             =   930
               Width           =   1935
            End
         ...
         Begin VB.Frame Frame7 
            ...
            Top             =   1935
            Width           =   2340
            Begin VB.CheckBox optSemAdiant 
               Caption         =   "Não trazer"
               BeginProperty Font 
                  Name            =   "MS Sans Serif"
                  Size            =   8.25
...
Private Sub UserControl_Initialize()
    ...
    Set objCT.gobjInfoUsu = New CTBaixaRecVGTRV
    Set objCT.gobjInfoUsu.gobjTelaUsu = New CTBaixaRecTRV
...
Private Sub optSemAdiant_Click()
     Call objCT.gobjInfoUsu.gobjTelaUsu.ValorAte_Change(objCT)
End Sub
'################################################################
