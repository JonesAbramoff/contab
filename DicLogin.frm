...
Erro_Trata_Parametros:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 159061)
...
Erro_BotaoOk_Click:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, 159062)
...
On Error GoTo Erro_Form_Load
    ...
    For Each objUsuarios In colUsuarios
        If StrComp(objUsuarios.sCodGrupo, GRUPO_SUP, 1) = 0 Then
            If objUsuarios.dtDataValidade = DATA_NULA Or objUsuarios.dtDataValidade >= Date Then ComboUsuario.AddItem objUsuarios.sCodUsuario
        End If
    Next
...
Erro_Form_Load:
    ...
    Select Case Err
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, 159063)
