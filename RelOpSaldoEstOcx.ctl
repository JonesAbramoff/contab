...
Begin VB.UserControl RelOpSaldoEstOcx 
   ClientHeight    =   5040
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   8835
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   600
      Left            =   4632
      Picture         =   "RelOpSaldoEstOcx.ctx":0000
      Style           =   1  'Graphical
      TabIndex        =   25
      Top             =   120
      Width           =   1575
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   288
      ItemData        =   "RelOpSaldoEstOcx.ctx":0102
      Left            =   1488
      List            =   "RelOpSaldoEstOcx.ctx":0104
      Sorted          =   -1  'True
      TabIndex        =   24
      Top             =   252
      Width           =   2916
   ...
   Begin VB.ListBox Almoxarifados 
      Height          =   3180
      ItemData        =   "RelOpSaldoEstOcx.ctx":0106
      Left            =   5940
      List            =   "RelOpSaldoEstOcx.ctx":0108
      Sorted          =   -1  'True
      TabIndex        =   5
      Top             =   1092
      Width           =   2670
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "RelOpSaldoEstOcx.ctx":010A
         Style           =   1  'Graphical
         TabIndex        =   4
         ToolTipText     =   "Fechar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "RelOpSaldoEstOcx.ctx":0288
         Style           =   1  'Graphical
         TabIndex        =   3
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "RelOpSaldoEstOcx.ctx":07BA
         Style           =   1  'Graphical
         TabIndex        =   2
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "RelOpSaldoEstOcx.ctx":0944
         Style           =   1  'Graphical
         TabIndex        =   1
         ToolTipText     =   "Gravar"
         Top             =   90
   ...
   End
End
Attribute VB_Name = "RelOpSaldoEstOcx"
