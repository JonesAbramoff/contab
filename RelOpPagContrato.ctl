...
Begin VB.UserControl RelOpPagContratoOcx 
   ClientHeight    =   5280
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   7485
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   600
      Left            =   5700
      Picture         =   "RelOpPagContrato.ctx":0000
      Style           =   1  'Graphical
      TabIndex        =   16
      Top             =   795
      Width           =   1575
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   315
      ItemData        =   "RelOpPagContrato.ctx":0102
      Left            =   885
      List            =   "RelOpPagContrato.ctx":0104
      Sorted          =   -1  'True
      TabIndex        =   1
      Top             =   270
      Width           =   2916
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1620
         Picture         =   "RelOpPagContrato.ctx":0106
         Style           =   1  'Graphical
         TabIndex        =   15
         ToolTipText     =   "Fechar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1080
         Picture         =   "RelOpPagContrato.ctx":0284
         Style           =   1  'Graphical
         TabIndex        =   14
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "RelOpPagContrato.ctx":07B6
         Style           =   1  'Graphical
         TabIndex        =   13
         ToolTipText     =   "Excluir"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "RelOpPagContrato.ctx":0940
         Style           =   1  'Graphical
         TabIndex        =   12
         ToolTipText     =   "Gravar"
         Top             =   90
   ...
   End
End
Attribute VB_Name = "RelOpPagContratoOcx"
...
On Error GoTo Erro_PreencherRelOp
    ...
    lErro = Formata_E_Critica_Parametros(sProd_I, sProd_F, sFornecedor_I, sFornecedor_F, sContrato_I, sContrato_F)
    ...
    lErro = Monta_Expressao_Selecao(objRelOpcoes, sProd_I, sProd_F, sFornecedor_I, sFornecedor_F, sContrato_I, sContrato_F)
...
Function Monta_Expressao_Selecao(objRelOpcoes As AdmRelOpcoes, sProd_I As String, sProd_F As String, sFornecedor_I As String, sFornecedor_F As String, sContrato_I As String, sContrato_F As String) As Long
...
On Error GoTo Erro_Monta_Expressao_Selecao
    ...
    If sFornecedor_I <> "" Then
        ...
        If sExpressao <> "" Then sExpressao = sExpressao & " E "
        sExpressao = sExpressao & "Fornecedor >= " & Forprint_ConvLong(CLng(sFornecedor_I))
...
Private Function Formata_E_Critica_Parametros(sProd_I As String, sProd_F As String, sFornecedor_I As String, sFornecedor_F As String, sContrato_I As String, sContrato_F As String) As Long
...
Public Function Form_Load_Ocx() As Object
    ...
    Caption = "Pagamento de Contratos"
    Call Form_Load
...
Erro_ContratoFim_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 170548)
...
Erro_ContratoIni_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 170549)
...
Dim colSelecao As New Collection
    ...
    Call Chama_Tela("ContratosPagLista", colSelecao, objContrato, objEventoContratoIni)
...
Dim colSelecao As New Collection
    ...
    Call Chama_Tela("ContratosPagLista", colSelecao, objContrato, objEventoContratoFim)
...
On Error GoTo Erro_Traz_ContratoIni_Tela
    ...
    If objContrato.iTipo <> CONTRATOS_PAGAR Then gError 136150
...
Erro_Traz_ContratoIni_Tela:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 170550)
...
On Error GoTo Erro_Traz_ContratoFim_Tela
    ...
    If objContrato.iTipo <> CONTRATOS_PAGAR Then gError 136152
...
Erro_Traz_ContratoFim_Tela:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 170551)
