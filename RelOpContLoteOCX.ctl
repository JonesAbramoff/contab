...
Begin VB.UserControl RelOpContLoteOCX 
   ClientHeight    =   2145
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   7365
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "RelOpContLoteOCX.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   3
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1110
         Picture         =   "RelOpContLoteOCX.ctx":018A
         Style           =   1  'Graphical
         TabIndex        =   4
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "RelOpContLoteOCX.ctx":06BC
         Style           =   1  'Graphical
         TabIndex        =   5
         ToolTipText     =   "Fechar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "RelOpContLoteOCX.ctx":083A
         Style           =   1  'Graphical
         TabIndex        =   2
         ToolTipText     =   "Gravar"
         Top             =   90
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   600
      Left            =   3360
      Picture         =   "RelOpContLoteOCX.ctx":0994
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   150
      Width           =   1575
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   315
      ItemData        =   "RelOpContLoteOCX.ctx":0A96
      Left            =   885
      List            =   "RelOpContLoteOCX.ctx":0A98
      Sorted          =   -1  'True
      TabIndex        =   0
      Top             =   300
      Width           =   2310
   ...
   End
End
Attribute VB_Name = "RelOpContLoteOCX"
...
Const STRING_RASTREAMENTOLOTE_PRODUTO = 20
...
Erro_Form_Load:
   ...
   lErro_Chama_Tela = gErr
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 167881)
...
Erro_PreencherParametrosNaTela:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 167882)
...
Erro_Trata_Parametros:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 167883)
...
Erro_Formata_E_Critica_Parametros:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 167884)
...
Erro_BotaoLimpar_Click:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 167885)
...
Erro_LabelProduto_Click:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 167886)
...
Erro_objEventoCodigo_evSelecao:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 167887)
...
Erro_objEventoProduto_evSelecao:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 167888)
...
On Error GoTo Erro_PreencherRelOp
    ...
    If lErro <> SUCESSO Then gError 85449
    
    lErro = objRelOpcoes.Limpar
    If lErro <> AD_BOOL_TRUE Then gError 85450
         
    lErro = objRelOpcoes.IncluirParametro("TPRODUTO", sProd_I)
    If lErro <> AD_BOOL_TRUE Then gError 85451

    lErro = objRelOpcoes.IncluirParametro("TLOTE", Lote.Text)
    If lErro <> AD_BOOL_TRUE Then gError 85452
             
    lErro = Existe_Produto_Lote_RastreamentoLote(sProd_I, Lote.Text)
    If lErro <> SUCESSO Then gError 85445
    
    lErro = Monta_Expressao_Selecao(objRelOpcoes, sProd_I)
    If lErro <> SUCESSO Then gError 85453
...
Erro_PreencherRelOp:
    ...
    Select Case gErr
        ...
        Case 85449 To 85453, 85445

        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 167889)
...
Erro_BotaoExcluir_Click:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 167890)
...
On Error GoTo Erro_BotaoExecutar_Click
    ...
    Call objRelatorio.ExecutarDireto("Seção de Envazamento", "", 1, "SCEnvaza", "TPRODUTO", sProd_I, "TLOTE", Lote.Text)
...
Erro_BotaoExecutar_Click:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 167891)
...
Erro_BotaoGravar_Click:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 167892)
...
Erro_Produto_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 167893)
...
Function Monta_Expressao_Selecao(objRelOpcoes As AdmRelOpcoes, sProd_I As String) As Long
...
'        sExpressao = sExpressao & "Lote:  " & Forprint_ConvTexto(Lote.Text)
'
'    End If
...
Erro_Monta_Expressao_Selecao:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 167894)
...
On Error GoTo Erro_Existe__Produto_Lote_RastreamentoLote
    ...
    sProd = String(STRING_RASTREAMENTOLOTE_PRODUTO, 0)
...
Erro_Existe__Produto_Lote_RastreamentoLote:
    ...
    Select Case gErr
        ...
        Case 85447
            lErro = Rotina_Erro(vbOKOnly, "ERRO_PRODUTO_E_LOTE_INEXISTENTES", gErr, sProduto, sLote)
            
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 167895)
