...
Begin VB.UserControl TRPImpRateioOff 
   ClientHeight    =   3255
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   5265
   ...
   End
End
Attribute VB_Name = "TRPImpRateioOff"
...
On Error GoTo Erro_Timer1_Timer
    ...
    If Len(sArq) > 0 Then
        ...
        lErro = CF("RateioOff_Gera_TRPRateio", colRateioOff, giExcluiRateio)
