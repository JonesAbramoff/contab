...
Begin VB.UserControl TipoDeBloqueioOcx 
   ClientHeight    =   4020
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   5610
   ...
   Begin VB.CommandButton BotaoProxNum 
      Height          =   285
      Left            =   2130
      Picture         =   "TipoDeBloqueioOcx.ctx":0000
      Style           =   1  'Graphical
      TabIndex        =   1
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "TipoDeBloqueioOcx.ctx":00EA
         Style           =   1  'Graphical
         TabIndex        =   6
         ToolTipText     =   "Gravar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "TipoDeBloqueioOcx.ctx":0244
         Style           =   1  'Graphical
         TabIndex        =   7
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "TipoDeBloqueioOcx.ctx":03CE
         Style           =   1  'Graphical
         TabIndex        =   8
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "TipoDeBloqueioOcx.ctx":0900
         Style           =   1  'Graphical
         TabIndex        =   9
         ToolTipText     =   "Fechar"
         Top             =   90
   ...
   Begin VB.ListBox TiposDeBloqueioList 
      Height          =   1620
      ItemData        =   "TipoDeBloqueioOcx.ctx":0A7E
      Left            =   150
      List            =   "TipoDeBloqueioOcx.ctx":0A80
      Sorted          =   -1  'True
      TabIndex        =   4
      Top             =   2280
      Width           =   5340
   ...
   End
End
Attribute VB_Name = "TipoDeBloqueioOcx"
...
On Error GoTo Erro_BotaoProxNum_Click
    ...
    lErro = CF("TipoDeBloqueio_Automatico",iCodigo)
    If lErro <> SUCESSO Then Error 57538
...
Erro_BotaoProxNum_Click:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 174760)
...
Sub Traz_Tipo_Tela(objTipo As ClassTipoDeBloqueio)
...
On Error GoTo Erro_NomeReduzido_Validate
    ...
    If Len(Trim(NomeReduzido.Text)) > 0 Then
        ...
        If Not IniciaLetra(NomeReduzido.Text) Then Error 57824
...
Erro_NomeReduzido_Validate:
    ...
    Select Case Err
        ...
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error, 174761)
...
Dim lErro As Long
Dim objTipo As New ClassTipoDeBloqueio
...
On Error GoTo Erro_TiposdeBloqueioList_DblClick
    ...
    lErro = CF("TipoDeBloqueio_Le",objTipo)
    If lErro <> SUCESSO And lErro <> 23666 Then Error 23645
    
    'Se não achou o Tipo De Bloqueio --> Erro
    If lErro <> SUCESSO Then Error 43660
...
Erro_TiposdeBloqueioList_DblClick:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error, 174762)
...
On Error GoTo Erro_BotaoExcluir_Click
    ...
    If Len(Trim(Codigo.Text)) = 0 Then Error 23646

    objTipo.iCodigo = CInt(Codigo.Text)
    'Lê o Tipo De Bloqueio
    lErro = CF("TipoDeBloqueio_Le",objTipo)
    If lErro <> SUCESSO And lErro <> 23666 Then Error 23647

    'Se não achou o Tipo De Bloqueio --> Erro
    If lErro <> SUCESSO Then Error 19162
    
    If objTipo.iCodigo = BLOQUEIO_TOTAL Or objTipo.iCodigo = BLOQUEIO_PARCIAL Or objTipo.iCodigo = BLOQUEIO_NAO_RESERVA Or objTipo.iCodigo = BLOQUEIO_CREDITO Then Error 19163
    ...
    If vbMsgRes = vbYes Then
        ...
        lErro = CF("TipoDeBloqueio_Exclui",objTipo)
        If lErro <> SUCESSO Then Error 23648

        'Exclui da ListBox
        Call TiposdeBloqueioList_Remove(objTipo)
       
        lErro = Limpa_Tela_Tipo
        If lErro <> SUCESSO Then Error 23649
...
Erro_BotaoExcluir_Click:
    ...
    Select Case Err
        ...
        Case 19163
            lErro = Rotina_Erro(vbOKOnly, "ERRO_TIPODEBLOQUEIO_EXCLUSAO", Err, objTipo.iCodigo)
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error, 174763)
...
On Error GoTo Erro_Codigo_Validate
    ...
    If Len(Trim(Codigo.Text)) > 0 Then
        ...
        If Not IsNumeric(Codigo.Text) Then Error 23650

        'Verifica se codigo é menor que um
        If CInt(Codigo.Text) < 1 Then Error 23651
...
Erro_Codigo_Validate:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error, 174764)
...
On Error GoTo Erro_BotaoGravar_Click
    ...
    If lErro <> SUCESSO Then Error 23652

    lErro = Limpa_Tela_Tipo
    If lErro <> SUCESSO Then Error 23653
...
Erro_BotaoGravar_Click:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error, 174765)
...
On Error GoTo Erro_BotaoLimpar_Click
    ...
    If lErro <> SUCESSO Then Error 23654

    lErro = Limpa_Tela_Tipo
    If lErro <> SUCESSO Then Error 23655
...
Erro_BotaoLimpar_Click:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error, 174766)
...
On Error GoTo Erro_Form_Load
    ...
    'Preenche a listbox Tipos de Bloqueio
    'Le cada codigo e Nome Reduzido da tabela TiposdeBloqueio
    lErro = CF("Cod_Nomes_Le","TiposdeBloqueio", "Codigo", "NomeReduzido", STRING_TIPO_BLOQUEIO_NOME_REDUZIDO, colCodigoDescricao)
    If lErro <> SUCESSO Then Error 23656

    'preenche a listbox TiposdeBloqueio com os objetos da colecao colCodigoDescricao
    For Each objCodigoDescricao In colCodigoDescricao

        TiposDeBloqueioList.AddItem objCodigoDescricao.iCodigo & SEPARADOR & objCodigoDescricao.sNome
        TiposDeBloqueioList.ItemData(TiposDeBloqueioList.NewIndex) = objCodigoDescricao.iCodigo
...
Erro_Form_Load:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error, 174767)
...
On Error GoTo Erro_Trata_Parametros
    ...
    If Not (objTipo Is Nothing) Then
        ...
        lErro = CF("TipoDeBloqueio_Le",objTipo)
        If lErro <> SUCESSO And lErro <> 23666 Then Error 23657
    ...
    Else
        ...
        lErro = Limpa_Tela_Tipo
        If lErro <> SUCESSO Then Error 23658
...
Erro_Trata_Parametros:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error, 174768)
...
On Error GoTo Erro_Gravar_Registro
    ...
    'verifica preenchimento do codigo
    If Len(Trim(Codigo.Text)) = 0 Then Error 23659

    'verifica preenchimento do nome
    If Len(Trim(Descricao.Text)) = 0 Then Error 23660

    'verifica preenchimento do nome reduzido
    If Len(Trim(NomeReduzido.Text)) = 0 Then Error 23661
    ...
    If lErro <> SUCESSO Then Error 32328

    lErro = CF("TipoDeBloqueio_Grava",objTipo)
    If lErro <> SUCESSO Then Error 23662
...
Erro_Gravar_Registro:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error, 174769)
...
Erro_Limpa_Tela_Tipo:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 174770)
...
Private Sub TiposdeBloqueioList_Adiciona(objTipo As ClassTipoDeBloqueio)
...
Private Sub TiposdeBloqueioList_Remove(objTipo As ClassTipoDeBloqueio)
...
Dim iIndice As Integer
    ...
    For iIndice = 0 To TiposDeBloqueioList.ListCount - 1
        ...
        If TiposDeBloqueioList.ItemData(iIndice) = CInt(Codigo.Text) Then
            TiposDeBloqueioList.ListIndex = iIndice
            Exit For
        End If
...
Dim iCodigo As Integer
    ...
    colCampoValor.Add "Descricao", Descricao.Text, STRING_TIPO_BLOQUEIO_DESCRICAO, "Descricao"
    colCampoValor.Add "NomeReduzido", NomeReduzido.Text, STRING_TIPO_BLOQUEIO_NOME_REDUZIDO, "NomeReduzido"
