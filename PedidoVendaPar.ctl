...
Begin VB.UserControl PedidoVenda 
   ...
   Begin VB.Frame Frame1 
      ...
      Visible         =   0   'False
      Width           =   9270
      Begin TelasFATPar.TabTributacaoFat TabTrib 
         Height          =   4545
         Left            =   75
         TabIndex        =   239
         Top             =   60
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox RecebForaFaixa 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "PedidoVendaPar.ctx":0000
            Left            =   5055
            List            =   "PedidoVendaPar.ctx":000A
         ...
         Begin VB.ComboBox UnidadeMed 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "PedidoVendaPar.ctx":003F
            Left            =   1575
            List            =   "PedidoVendaPar.ctx":0041
            Style           =   2  'Dropdown List
            TabIndex        =   39
            Top             =   240
            Width           =   720
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton BotaoProxNum 
            Height          =   285
            Left            =   2910
            Picture         =   "PedidoVendaPar.ctx":0043
            Style           =   1  'Graphical
            TabIndex        =   12
         ...
         Begin VB.ComboBox FilialFaturamento 
            Height          =   315
            ItemData        =   "PedidoVendaPar.ctx":012D
            Left            =   5190
            List            =   "PedidoVendaPar.ctx":012F
            TabIndex        =   17
            Top             =   765
            Width           =   2145
         End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame3 
         ...
         Begin VB.CommandButton BotaoDataRefFluxoUp 
            Height          =   150
            Left            =   8475
            Picture         =   "PedidoVendaPar.ctx":0131
            Style           =   1  'Graphical
            TabIndex        =   228
            TabStop         =   0   'False
            Top             =   225
         ...
         Begin VB.CommandButton BotaoDataRefFluxoDown 
            Height          =   150
            Left            =   8475
            Picture         =   "PedidoVendaPar.ctx":018B
            Style           =   1  'Graphical
            TabIndex        =   227
            TabStop         =   0   'False
            Top             =   375
         ...
         Begin VB.ComboBox TipoPagto 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "PedidoVendaPar.ctx":01E5
            Left            =   3045
            List            =   "PedidoVendaPar.ctx":01F5
            TabIndex        =   224
            Top             =   2310
            Width           =   1965
         End
         Begin VB.CommandButton BotaoDataReferenciaDown 
            Height          =   150
            Left            =   3945
            Picture         =   "PedidoVendaPar.ctx":0232
            Style           =   1  'Graphical
            TabIndex        =   139
            TabStop         =   0   'False
            Top             =   390
         ...
         Begin VB.CommandButton BotaoDataReferenciaUp 
            Height          =   150
            Left            =   3945
            Picture         =   "PedidoVendaPar.ctx":028C
            Style           =   1  'Graphical
            TabIndex        =   140
            TabStop         =   0   'False
            Top             =   240
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame4 
         ...
         Begin VB.ComboBox DiretoIndireto 
            Height          =   315
            ItemData        =   "PedidoVendaPar.ctx":02E6
            Left            =   5070
            List            =   "PedidoVendaPar.ctx":02F0
            Style           =   2  'Dropdown List
            TabIndex        =   189
            Top             =   915
            Width           =   1335
         ...
         Begin VB.CommandButton BotaoVendedores 
            ...
            Height          =   645
            Left            =   7440
            Picture         =   "PedidoVendaPar.ctx":0306
            Style           =   1  'Graphical
            TabIndex        =   186
            Top             =   3300
            Width           =   1500
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton BotaoLiberaBloqueio 
         ...
         Height          =   600
         Left            =   6825
         Picture         =   "PedidoVendaPar.ctx":08B0
         Style           =   1  'Graphical
         TabIndex        =   112
         Top             =   3840
         Width           =   1650
      ...
      Begin VB.Frame SSFrame1 
         ...
         Begin VB.ComboBox TipoBloqueio 
            Height          =   315
            ItemData        =   "PedidoVendaPar.ctx":2EAA
            Left            =   555
            List            =   "PedidoVendaPar.ctx":2EAC
            TabIndex        =   105
            Top             =   330
            Width           =   1605
         End
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoImprimir 
         Height          =   345
         Left            =   90
         Picture         =   "PedidoVendaPar.ctx":2EAE
         Style           =   1  'Graphical
         TabIndex        =   152
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   345
         Left            =   600
         Picture         =   "PedidoVendaPar.ctx":2FB0
         Style           =   1  'Graphical
         TabIndex        =   127
         ToolTipText     =   "Gravar"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   345
         Left            =   1095
         Picture         =   "PedidoVendaPar.ctx":310A
         Style           =   1  'Graphical
         TabIndex        =   128
         ToolTipText     =   "Excluir"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   345
         Left            =   1590
         Picture         =   "PedidoVendaPar.ctx":3294
         Style           =   1  'Graphical
         TabIndex        =   129
         ToolTipText     =   "Limpar"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   345
         Left            =   2100
         Picture         =   "PedidoVendaPar.ctx":37C6
         Style           =   1  'Graphical
         TabIndex        =   130
         ToolTipText     =   "Fechar"
         Top             =   60
...
Private Sub UserControl_Initialize()
    ...
    Set objCT.gobjInfoUsu = New CTPedidovendaVGPar
    Set objCT.gobjInfoUsu.gobjTelaUsu = New CTPedidoVendaPar
End Sub
...
Private Sub BotaoEntrega_Click()
    Call objCT.gobjInfoUsu.gobjTelaUsu.BotaoEntrega_Click(objCT)
End Sub
