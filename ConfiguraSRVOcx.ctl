VERSION 5.00
Begin VB.UserControl ConfiguraSRVOcx 
   ClientHeight    =   2010
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   6045
   ...
   Begin VB.ListBox ListaConfigura 
      Height          =   1635
      ItemData        =   "ConfiguraSRVOcx.ctx":0000
      Left            =   135
      List            =   "ConfiguraSRVOcx.ctx":0019
      Style           =   1  'Checkbox
      TabIndex        =   3
      Top             =   120
      Width           =   4320
   ...
   Begin VB.PictureBox Picture5 
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   600
         Picture         =   "ConfiguraSRVOcx.ctx":0162
         Style           =   1  'Graphical
         TabIndex        =   2
         ToolTipText     =   "Fechar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "ConfiguraSRVOcx.ctx":02E0
         Style           =   1  'Graphical
         TabIndex        =   1
         ToolTipText     =   "Gravar"
         Top             =   75
   ...
   End
End
Attribute VB_Name = "ConfiguraSRVOcx"
...
On Error GoTo Erro_Form_Load
    ...
    'Checa Solicitacao Automatica de Garantia
    If gobjSRV.iGarantiaAutoSolic = GARANTIA_AUTOMATICA_SOLICITACAO Then
        ListaConfigura.Selected(SRVCONFIG_GARANTIA_AUTOMATICA_SOLICITACAO) = True
    Else
        ListaConfigura.Selected(SRVCONFIG_GARANTIA_AUTOMATICA_SOLICITACAO) = False
    End If
            
    'Checa Solicitacao Automatica de Contrato
    If gobjSRV.iContratoAutoSolic = CONTRATO_AUTOMATICO_SOLICITACAO Then
        ListaConfigura.Selected(SRVCONFIG_CONTRATO_AUTOMATICO_SOLICITACAO) = True
    Else
        ListaConfigura.Selected(SRVCONFIG_CONTRATO_AUTOMATICO_SOLICITACAO) = False
    End If
...
On Error GoTo Erro_Gravar_Registro
    ...
    If ListaConfigura.Selected(SRVCONFIG_VERIFICA_LOTE) = True Then
        gobjSRV.iVerificaLote = VERIFICA_LOTE
    Else
        gobjSRV.iVerificaLote = NAO_VERIFICA_LOTE
    End If
