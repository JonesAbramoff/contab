VERSION 5.00
Begin VB.UserControl RelOpPrestContasOcx 
   ClientHeight    =   2370
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   6390
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "RelOpPrestContasOcx.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   14
         ToolTipText     =   "Gravar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "RelOpPrestContasOcx.ctx":015A
         Style           =   1  'Graphical
         TabIndex        =   13
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "RelOpPrestContasOcx.ctx":02E4
         Style           =   1  'Graphical
         TabIndex        =   12
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "RelOpPrestContasOcx.ctx":0816
         Style           =   1  'Graphical
         TabIndex        =   11
         ToolTipText     =   "Fechar"
         Top             =   90
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   315
      ItemData        =   "RelOpPrestContasOcx.ctx":0994
      Left            =   1050
      List            =   "RelOpPrestContasOcx.ctx":0996
      Sorted          =   -1  'True
      TabIndex        =   5
      Top             =   240
      Width           =   2775
   ...
   Begin VB.ComboBox ComboExercicio 
      Height          =   315
      ItemData        =   "RelOpPrestContasOcx.ctx":0998
      Left            =   1065
      List            =   "RelOpPrestContasOcx.ctx":099A
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   720
      Left            =   4440
      Picture         =   "RelOpPrestContasOcx.ctx":099C
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   750
      Width           =   1455
   ...
   Begin VB.ComboBox ComboModelos 
      Height          =   315
      ItemData        =   "RelOpPrestContasOcx.ctx":0A9E
      Left            =   1020
      List            =   "RelOpPrestContasOcx.ctx":0AA0
      Sorted          =   -1  'True
      Style           =   2  'Dropdown List
      TabIndex        =   1
      Top             =   1860
   ...
   Begin VB.CommandButton BotaoConfigura 
      ...
      Height          =   720
      Left            =   4440
      Picture         =   "RelOpPrestContasOcx.ctx":0AA2
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   1590
      Width           =   1455
   ...
   End
End
Attribute VB_Name = "RelOpPrestContasOcx"
...
On Error GoTo Erro_PreencherRelOp
    ...
    If ComboExercicio.ListIndex = -1 Then Error 13404

    'período não pode ser vazio
    If ComboPeriodo.ListIndex = -1 Then Error 13405
