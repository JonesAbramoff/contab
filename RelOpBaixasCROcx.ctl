...
Begin VB.UserControl RelOpBaixasCROcx 
   ClientHeight    =   6870
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   6510
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.ComboBox TipoDocSeleciona 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "RelOpBaixasCROcx.ctx":0000
         Left            =   1380
         List            =   "RelOpBaixasCROcx.ctx":0002
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox ComboDias 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "RelOpBaixasCROcx.ctx":0004
         Left            =   1305
         List            =   "RelOpBaixasCROcx.ctx":000E
         Style           =   2  'Dropdown List
         TabIndex        =   32
         Top             =   915
         Width           =   1365
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   315
      ItemData        =   "RelOpBaixasCROcx.ctx":0029
      Left            =   1110
      List            =   "RelOpBaixasCROcx.ctx":002B
      Sorted          =   -1  'True
      TabIndex        =   0
      Top             =   285
      Width           =   2730
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   600
      Left            =   4395
      Picture         =   "RelOpBaixasCROcx.ctx":002D
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   915
      Width           =   1815
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoFechar 
         ...
         HelpContextID   =   1000
         Left            =   1605
         Picture         =   "RelOpBaixasCROcx.ctx":012F
         Style           =   1  'Graphical
         TabIndex        =   10
         ToolTipText     =   "Fechar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "RelOpBaixasCROcx.ctx":02AD
         Style           =   1  'Graphical
         TabIndex        =   9
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "RelOpBaixasCROcx.ctx":07DF
         Style           =   1  'Graphical
         TabIndex        =   8
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "RelOpBaixasCROcx.ctx":0969
         Style           =   1  'Graphical
         TabIndex        =   7
         ToolTipText     =   "Gravar"
         Top             =   90
   ...
   End
End
Attribute VB_Name = "RelOpBaixasCROcx"
...
On Error GoTo Erro_Form_Load
    ...
    'Define os Campos
    lErro = Define_Padrao()
    If lErro <> SUCESSO Then Error 59591
...
Erro_Form_Load:
   ...
   lErro_Chama_Tela = Err
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 167227)
