...
Begin VB.UserControl RelOpRazaoSintOcx 
   ClientHeight    =   3945
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   8280
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   615
      Left            =   4140
      Picture         =   "RelOpRazaoSintOcx.ctx":0000
      Style           =   1  'Graphical
      TabIndex        =   16
      Top             =   105
      Width           =   1575
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   315
      ItemData        =   "RelOpRazaoSintOcx.ctx":0102
      Left            =   1200
      List            =   "RelOpRazaoSintOcx.ctx":0104
      Sorted          =   -1  'True
      TabIndex        =   15
      Top             =   225
      Width           =   2610
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "RelOpRazaoSintOcx.ctx":0106
         Style           =   1  'Graphical
         TabIndex        =   6
         ToolTipText     =   "Fechar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "RelOpRazaoSintOcx.ctx":0284
         Style           =   1  'Graphical
         TabIndex        =   5
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "RelOpRazaoSintOcx.ctx":07B6
         Style           =   1  'Graphical
         TabIndex        =   4
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "RelOpRazaoSintOcx.ctx":0940
         Style           =   1  'Graphical
         TabIndex        =   3
         ToolTipText     =   "Gravar"
         Top             =   90
   ...
   End
End
Attribute VB_Name = "RelOpRazaoSintOcx"
...
On Error GoTo Erro_Obtem_Periodo_Exercicio
    ...
    If lErro <> SUCESSO Then gError 197990

    'pega o período da Data Final
    lErro = CF("Periodo_Le", DataFinal.Text, objPer_F)
    If lErro <> SUCESSO Then gError 197991

    'Data Inicial e Final devem estar num mesmo exercício
    If objPer_I.iExercicio <> objPer_F.iExercicio Then gError 197992
...
Erro_Obtem_Periodo_Exercicio:
    ...
    Select Case gErr
        ...
        Case 197992
            lErro = Rotina_Erro(vbOKOnly, "ERRO_DATAS_COM_EXERCICIOS_DIFERENTES", gErr)

        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 197993)
...
On Error GoTo Erro_Formata_E_Critica_Contas
    ...
    If lErro <> SUCESSO Then gError 197994
    ...
    If lErro <> SUCESSO Then gError 197995
    ...
    If iCtaPreenchida_I = CONTA_PREENCHIDA And iCtaPreenchida_F = CONTA_PREENCHIDA Then
        If sCta_I > sCta_F Then gError 197996
    End If
...
Erro_Formata_E_Critica_Contas:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 197997)
...
On Error GoTo Erro_Traz_Conta_Tela
    ...
    If giFocoInicial Then
        ...
        If lErro <> SUCESSO Then gError 197998

    Else

        lErro = CF("Traz_Conta_MaskEd", sConta, ContaFinal, DescCtaFim)
        If lErro <> SUCESSO Then gError 117999
...
Erro_Traz_Conta_Tela:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 199000)
...
On Error GoTo Erro_Critica_Datas_RelOpRazao
    ...
    If Len(DataInicial.ClipText) = 0 Then gError 199001

    'data final não pode ser vazia
    If Len(DataFinal.ClipText) = 0 Then gError 199002

    'data inicial não pode ser maior que a data final
    If CDate(DataInicial.Text) > CDate(DataFinal.Text) Then gError 199003
...
Erro_Critica_Datas_RelOpRazao:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 199004)
...
On Error GoTo Erro_PreencherParametrosNaTela
    ...
    If lErro <> SUCESSO Then gError 199012
    ...
    If lErro <> SUCESSO Then gError 199013
    ...
    If lErro <> SUCESSO Then gError 199015
...
Erro_PreencherParametrosNaTela:
    ...
    Select Case gErr
        ...
        Case 199005 To 199015

        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 199016)
...
On Error GoTo Erro_PreencherRelOp
    ...
    If bGeraArqTemp Then
        ...
        lErro = CF("RelCtaSaldo_Prepara_1", giFilialEmpresa, lNumIntRel, sCta_I, sCta_F, CDate(DataInicial.Text), CDate(DataFinal.Text))
