...
Begin VB.UserControl LMFCPorReducaoZ 
   ClientHeight    =   2370
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4650
   ...
   Begin VB.CommandButton BotaoAto 
      ...
      Height          =   615
      Left            =   3120
      Picture         =   "LMFCPorReducaoZ.ctx":0000
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   1545
      Visible         =   0   'False
   ...
   Begin VB.CommandButton BotaoRelGer 
      ...
      Height          =   615
      Left            =   60
      Picture         =   "LMFCPorReducaoZ.ctx":3642
      Style           =   1  'Graphical
      TabIndex        =   6
      Top             =   1545
      Width           =   1365
   ...
   Begin VB.CommandButton BotaoArquivo 
      ...
      Height          =   615
      Left            =   1590
      Picture         =   "LMFCPorReducaoZ.ctx":6C84
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   1545
      Visible         =   0   'False
   ...
   End
End
Attribute VB_Name = "LMFCPorReducaoZ"
...
On Error GoTo Erro_ReducaoDe_Validate
    ...
    If lErro <> SUCESSO Then gError 204408
...
Erro_ReducaoDe_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 204409)
...
On Error GoTo Erro_ReducaoAte_Validate
    ...
    If lErro <> SUCESSO Then gError 204410
...
Erro_ReducaoAte_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 204411)
...
On Error GoTo Erro_BotaoRelGer_Click
    ...
    If lErro <> SUCESSO Then gError 204412
...
Erro_BotaoRelGer_Click:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 204413)
...
On Error GoTo Erro_BotaoArquivo_Click
    ...
    'Função que Vai Chamar Função da Afrac que Vai Executar a Leitura da Memoria Fiscal
    lErro = CF_ECF("MemoriaFiscal_Executa_Leitura", iTipoLeitura, sDe, sAte, iTipo, iArquivo)
    If lErro <> SUCESSO Then gError 204436
...
Erro_BotaoArquivo_Click:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 204437)
...
Public Function Form_Load_Ocx() As Object
    ...
    Caption = "Leitura MF Por Redução Z"
    Call Form_Load
...
Erro_UserControl_KeyDown:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 210069)
...
On Error GoTo Erro_BotaoAto_Click
    ...
    'Função que Vai Chamar Função da Afrac que Vai Executar a Leitura da Memoria Fiscal
    lErro = CF_ECF("MemoriaFiscal_Executa_Leitura", iTipoLeitura, sDe, sAte, iTipo, iArquivo)
    If lErro <> SUCESSO Then gError 214029
...
Erro_BotaoAto_Click:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 214030)
