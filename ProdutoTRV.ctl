...
Begin VB.UserControl Produto 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox OrigemMercadoria 
         Height          =   315
         ItemData        =   "ProdutoTRV.ctx":0000
         Left            =   4470
         List            =   "ProdutoTRV.ctx":001F
      ...
      Begin VB.Frame Frame18 
         ...
         Begin VB.ComboBox comboAliquota 
            Height          =   315
            ItemData        =   "ProdutoTRV.ctx":0386
            Left            =   1980
            List            =   "ProdutoTRV.ctx":0388
            Style           =   2  'Dropdown List
            TabIndex        =   76
            Top             =   720
            Width           =   1500
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox NaturezaProduto 
         Height          =   315
         ItemData        =   "ProdutoTRV.ctx":038A
         Left            =   1605
         List            =   "ProdutoTRV.ctx":03B9
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   8
         Top             =   2430
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame Frame28 
         ...
         Begin VB.ComboBox ProdutoEspecifico 
            Height          =   315
            ItemData        =   "ProdutoTRV.ctx":0596
            Left            =   2190
            List            =   "ProdutoTRV.ctx":05AA
            Sorted          =   -1  'True
            Style           =   2  'Dropdown List
            TabIndex        =   72
            Top             =   255
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame Frame5 
         ...
         Begin VB.ListBox ListaCaracteristicas 
            Height          =   1185
            ItemData        =   "ProdutoTRV.ctx":05EF
            Left            =   255
            List            =   "ProdutoTRV.ctx":0602
            Style           =   1  'Checkbox
            TabIndex        =   33
            Top             =   195
            Width           =   3885
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame Frame26 
         ...
         Begin VB.ComboBox Rastro 
            Height          =   315
            ItemData        =   "ProdutoTRV.ctx":0698
            Left            =   1470
            List            =   "ProdutoTRV.ctx":06A8
            Style           =   2  'Dropdown List
            TabIndex        =   41
            Top             =   180
            Width           =   2430
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.ComboBox ApropriacaoComp 
            Height          =   315
            ItemData        =   "ProdutoTRV.ctx":07BB
            Left            =   2130
            List            =   "ProdutoTRV.ctx":07C2
            Style           =   2  'Dropdown List
            TabIndex        =   48
            Top             =   195
            Width           =   2610
         ...
         Begin VB.ComboBox ApropriacaoProd 
            Height          =   315
            ItemData        =   "ProdutoTRV.ctx":07D3
            Left            =   2130
            List            =   "ProdutoTRV.ctx":07DD
            Style           =   2  'Dropdown List
            TabIndex        =   123
            Top             =   195
            Visible         =   0   'False
...
Private Sub UserControl_Initialize()
    ...
    Set objCT.gobjInfoUsu = New CTProdutoVGTRV
    Set objCT.gobjInfoUsu.gobjTelaUsu = New CTProdutoTRV
End Sub
