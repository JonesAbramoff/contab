...
Begin VB.UserControl NfiscalFaturaOcx 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox TabPrecoItemNF 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "NfiscalFaturaOcx2.ctx":0000
            Left            =   3570
            List            =   "NfiscalFaturaOcx2.ctx":0002
            Style           =   2  'Dropdown List
            TabIndex        =   293
            Top             =   1590
            Width           =   1800
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame4 
         ...
         Begin VB.CommandButton BotaoDataReferenciaDown 
            Height          =   150
            Left            =   2985
            Picture         =   "NfiscalFaturaOcx2.ctx":0004
            Style           =   1  'Graphical
            TabIndex        =   195
            TabStop         =   0   'False
            Top             =   765
         ...
         Begin VB.ComboBox Desconto1Codigo 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "NfiscalFaturaOcx2.ctx":005E
            Left            =   3120
            List            =   "NfiscalFaturaOcx2.ctx":0060
            TabIndex        =   192
            Top             =   1140
            Width           =   1860
         End
         Begin VB.CommandButton BotaoDataReferenciaUp 
            Height          =   150
            Left            =   2985
            Picture         =   "NfiscalFaturaOcx2.ctx":0062
            Style           =   1  'Graphical
            TabIndex        =   191
            TabStop         =   0   'False
            Top             =   615
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox TipoNFiscal 
            Height          =   315
            ItemData        =   "NfiscalFaturaOcx2.ctx":00BC
            Left            =   1995
            List            =   "NfiscalFaturaOcx2.ctx":00BE
            TabIndex        =   11
            Top             =   210
            Width           =   2835
         End
         Begin VB.CommandButton Botao 
            ...
            Index           =   20
            Left            =   4980
            Picture         =   "NfiscalFaturaOcx2.ctx":00C0
            Style           =   1  'Graphical
            TabIndex        =   73
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Height          =   315
            ItemData        =   "NfiscalFaturaOcx2.ctx":05F2
            Left            =   3690
            List            =   "NfiscalFaturaOcx2.ctx":05FF
            Style           =   2  'Dropdown List
            TabIndex        =   176
            Top             =   255
            Width           =   1215
         ...
         Begin VB.ComboBox ProdutoRastro 
            Height          =   315
            ItemData        =   "NfiscalFaturaOcx2.ctx":061E
            Left            =   1740
            List            =   "NfiscalFaturaOcx2.ctx":062B
            Style           =   2  'Dropdown List
            TabIndex        =   175
            Top             =   1320
            Width           =   1740
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame4 
         ...
         Begin VB.CommandButton BotaoVendedores 
            ...
            Height          =   615
            Left            =   6960
            Picture         =   "NfiscalFaturaOcx2.ctx":064A
            Style           =   1  'Graphical
            TabIndex        =   214
            Top             =   3300
            Width           =   1815
         ...
         Begin VB.ComboBox DiretoIndireto 
            Height          =   315
            ItemData        =   "NfiscalFaturaOcx2.ctx":0BF4
            Left            =   6360
            List            =   "NfiscalFaturaOcx2.ctx":0BFE
            Style           =   2  'Dropdown List
            TabIndex        =   213
            Top             =   1320
            Width           =   1335
   ...
   Begin VB.Frame FrameOrcVenda 
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   0
         Left            =   3840
         Picture         =   "NfiscalFaturaOcx2.ctx":0C14
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   1
         Left            =   4230
         Picture         =   "NfiscalFaturaOcx2.ctx":0FE6
         Style           =   1  'Graphical
         TabIndex        =   3
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   21
         Left            =   3315
         Picture         =   "NfiscalFaturaOcx2.ctx":12F8
         Style           =   1  'Graphical
         TabIndex        =   6
         ToolTipText     =   "Trazer Dados"
         Top             =   210
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   22
         Left            =   3690
         Picture         =   "NfiscalFaturaOcx2.ctx":16CA
         Style           =   1  'Graphical
         TabIndex        =   7
         ToolTipText     =   "Trazer a tela de cadastro"
         Top             =   210
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   4
         Left            =   1380
         Picture         =   "NfiscalFaturaOcx2.ctx":19DC
         Style           =   1  'Graphical
         TabIndex        =   249
         ToolTipText     =   "Excluir"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   6
         Left            =   2310
         Picture         =   "NfiscalFaturaOcx2.ctx":1B66
         Style           =   1  'Graphical
         TabIndex        =   248
         ToolTipText     =   "Fechar"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   5
         Left            =   1845
         Picture         =   "NfiscalFaturaOcx2.ctx":1CE4
         Style           =   1  'Graphical
         TabIndex        =   247
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   3
         Left            =   915
         Picture         =   "NfiscalFaturaOcx2.ctx":2216
         Style           =   1  'Graphical
         TabIndex        =   246
         ToolTipText     =   "Gravar"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   2
         Left            =   75
         Picture         =   "NfiscalFaturaOcx2.ctx":2370
         Style           =   1  'Graphical
         TabIndex        =   245
