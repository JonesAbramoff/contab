...
'    Set objEFD.colModulo = gcolModulo
    ...
    lErro = CF("DFC_Gera", giFilialEmpresa, sDiretorio, StrParaInt(Ano.Text))
...
On Error GoTo Erro_Form_Load
    ...
    Ano.Text = CStr(Year(gdtDataHoje) - 1)
...
Dim colSelecao As New Collection
    ...
    Call Chama_Tela("DFC_ESLista", colSelecao)
End Sub
