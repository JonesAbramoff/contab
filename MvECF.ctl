...
On Error GoTo Erro_BotaoArquivo_Click
    ...
    'Verificar se o numero serie do ecf esta preenchido
    If Len(Trim(NumSerie.Text)) = 0 Then gError 210811
    
    sNumSerie = NumSerie.Text
    ...
    lErro = CF_ECF("MovimentoPorECF_Grava1", sNumSerie, dtDataDe, dtDataAte)
    If lErro <> SUCESSO Then gError 204592
    
    'Limpa a tela
    Call Limpa_Tela(Me)
    NumSerie.ListIndex = -1
