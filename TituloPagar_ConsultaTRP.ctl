...
Begin VB.UserControl TituloPagar_Consulta 
   ...
   Begin VB.Frame Frame 
      ...
      Begin VB.CommandButton BotaoDocOriginal 
         ...
         Height          =   705
         Left            =   7110
         Picture         =   "TituloPagar_ConsultaTRP.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   90
         Width           =   1665
   ...
   Begin VB.Frame Frame 
      ...
      Begin MSMask.MaskEdBox CTBConta 
         Bindings        =   "TituloPagar_ConsultaTRP.ctx":2F16
         Height          =   225
         Left            =   60
         TabIndex        =   26
         Top             =   1230
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   675
         Left            =   1440
         Picture         =   "TituloPagar_ConsultaTRP.ctx":2F21
         Style           =   1  'Graphical
         TabIndex        =   36
         ToolTipText     =   "Excluir"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   675
         Left            =   2355
         Picture         =   "TituloPagar_ConsultaTRP.ctx":30AB
         Style           =   1  'Graphical
         TabIndex        =   38
         ToolTipText     =   "Fechar"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   675
         Left            =   1880
         Picture         =   "TituloPagar_ConsultaTRP.ctx":3229
         Style           =   1  'Graphical
         TabIndex        =   37
         ToolTipText     =   "Limpar"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoConsulta 
         Height          =   675
         Left            =   90
         Picture         =   "TituloPagar_ConsultaTRP.ctx":375B
         Style           =   1  'Graphical
         TabIndex        =   35
         Top             =   60
         Width           =   1275
...
Private Sub UserControl_Initialize()
    ...
    'TRP
    Set objCT.gobjInfoUsu = New CTTitPagConVGTRP
    Set objCT.gobjInfoUsu.gobjTelaUsu = New CTTitPagConTRP
End Sub
