...
Begin VB.UserControl OrcamentoVenda 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton BotaoProxNum 
            Height          =   285
            Left            =   2190
            Picture         =   "OrcamentoVendaDan.ctx":0000
            Style           =   1  'Graphical
            TabIndex        =   251
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox Moeda 
            Height          =   315
            ItemData        =   "OrcamentoVendaDan.ctx":00EA
            Left            =   1230
            List            =   "OrcamentoVendaDan.ctx":00EC
            Style           =   2  'Dropdown List
            TabIndex        =   216
            Top             =   525
            Width           =   1935
         ...
         Begin VB.ComboBox StatusComercial 
            Height          =   315
            ItemData        =   "OrcamentoVendaDan.ctx":00EE
            Left            =   7035
            List            =   "OrcamentoVendaDan.ctx":0101
            TabIndex        =   215
            Top             =   165
            Width           =   2295
         End
      ...
      Begin VB.Frame Frame9 
         ...
         Begin VB.Frame FrameDataPrazoEnt 
            ...
            Begin VB.ComboBox PrazoEntVar 
               Height          =   315
               ItemData        =   "OrcamentoVendaDan.ctx":0139
               Left            =   1245
               List            =   "OrcamentoVendaDan.ctx":0149
               Style           =   2  'Dropdown List
               TabIndex        =   209
               Top             =   0
               Width           =   1320
         ...
         Begin VB.Frame FrameDataPrazoEnt 
            ...
            Begin VB.ComboBox PrazoTexto 
               Height          =   315
               ItemData        =   "OrcamentoVendaDan.ctx":0178
               Left            =   555
               List            =   "OrcamentoVendaDan.ctx":017A
               TabIndex        =   205
               Top             =   15
               Width           =   3360
            End
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.ComboBox Status 
            Height          =   315
            ItemData        =   "OrcamentoVendaDan.ctx":017C
            Left            =   1245
            List            =   "OrcamentoVendaDan.ctx":017E
            Style           =   2  'Dropdown List
            TabIndex        =   176
            Top             =   465
            Width           =   3255
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         End
      End
      Begin VB.CommandButton Botao_Dan_OS 
         Caption         =   "O.S."
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton BotaoSobe 
            Height          =   195
            Left            =   90
            Picture         =   "OrcamentoVendaDan.ctx":0180
            Style           =   1  'Graphical
            TabIndex        =   169
            Top             =   300
            Visible         =   0   'False
         ...
         Begin VB.CommandButton BotaoDesce 
            Height          =   195
            Left            =   285
            Picture         =   "OrcamentoVendaDan.ctx":0342
            Style           =   1  'Graphical
            TabIndex        =   168
            Top             =   300
            Visible         =   0   'False
         ...
         Begin VB.ComboBox UnidadeMed 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "OrcamentoVendaDan.ctx":0504
            Left            =   1575
            List            =   "OrcamentoVendaDan.ctx":0506
            Style           =   2  'Dropdown List
            TabIndex        =   13
            Top             =   240
            Width           =   720
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame3 
         ...
         Begin VB.CommandButton BotaoDataReferenciaDown 
            Height          =   150
            Left            =   3045
            Picture         =   "OrcamentoVendaDan.ctx":0508
            Style           =   1  'Graphical
            TabIndex        =   36
            TabStop         =   0   'False
            Top             =   810
         ...
         Begin VB.CommandButton BotaoDataReferenciaUp 
            Height          =   150
            Left            =   3045
            Picture         =   "OrcamentoVendaDan.ctx":0562
            Style           =   1  'Graphical
            TabIndex        =   35
            TabStop         =   0   'False
            Top             =   660
   ...
   Begin VB.Frame Frame1 
      ...
      Visible         =   0   'False
      Width           =   9510
      Begin TelasFATDan.TabTributacaoFat TabTrib 
         Height          =   4635
         Left            =   270
         TabIndex        =   91
         Top             =   75
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame7 
         ...
         Begin VB.ComboBox FPUnidMed 
            ...
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "OrcamentoVendaDan.ctx":05BC
            Left            =   645
            List            =   "OrcamentoVendaDan.ctx":05BE
            Style           =   2  'Dropdown List
            TabIndex        =   82
            Top             =   1110
            Width           =   720
         ...
         Begin VB.ComboBox FPSituacao 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "OrcamentoVendaDan.ctx":05C0
            Left            =   5880
            List            =   "OrcamentoVendaDan.ctx":05D0
            Style           =   2  'Dropdown List
            TabIndex        =   76
            Top             =   1650
            Width           =   1155
      ...
      Begin VB.Frame Frame6 
         ...
         Begin VB.ComboBox PCSituacao 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "OrcamentoVendaDan.ctx":05F1
            Left            =   6345
            List            =   "OrcamentoVendaDan.ctx":0601
            Style           =   2  'Dropdown List
            TabIndex        =   74
            Top             =   1125
            Width           =   1155
         ...
         Begin VB.ComboBox PCUnidMed 
            ...
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "OrcamentoVendaDan.ctx":0622
            Left            =   3315
            List            =   "OrcamentoVendaDan.ctx":0624
            Style           =   2  'Dropdown List
            TabIndex        =   68
            Top             =   360
            Width           =   720
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoEmail 
         Height          =   345
         Left            =   60
         Picture         =   "OrcamentoVendaDan.ctx":0626
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   345
         Left            =   2655
         Picture         =   "OrcamentoVendaDan.ctx":0FC8
         Style           =   1  'Graphical
         TabIndex        =   8
         ToolTipText     =   "Fechar"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   345
         Left            =   2136
         Picture         =   "OrcamentoVendaDan.ctx":1146
         Style           =   1  'Graphical
         TabIndex        =   7
         ToolTipText     =   "Limpar"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   345
         Left            =   1617
         Picture         =   "OrcamentoVendaDan.ctx":1678
         Style           =   1  'Graphical
         TabIndex        =   6
         ToolTipText     =   "Excluir"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   345
         Left            =   1098
         Picture         =   "OrcamentoVendaDan.ctx":1802
         Style           =   1  'Graphical
         TabIndex        =   5
         ToolTipText     =   "Gravar"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoImprimir 
         Height          =   345
         Left            =   579
         Picture         =   "OrcamentoVendaDan.ctx":195C
         Style           =   1  'Graphical
         TabIndex        =   4
...
Private Sub UserControl_Initialize()
    ...
    Set objCT.gobjInfoUsu = New CTOrcVendaVGDan
    Set objCT.gobjInfoUsu.gobjTelaUsu = New CTOrcVendaDan
...
'---Dan-Presse
Private Sub Botao_Dan_OS_Click()
    Call objCT.gobjInfoUsu.gobjTelaUsu.Botao_Dan_OS_Click(objCT)
End Sub

Private Sub Dan_OS_Change()
     Call objCT.gobjInfoUsu.gobjTelaUsu.Dan_OS_Change(objCT)
End Sub

Private Sub Dan_OS_GotFocus()
     Call objCT.gobjInfoUsu.gobjTelaUsu.Dan_OS_GotFocus(objCT)
End Sub

Private Sub Dan_OS_KeyPress(KeyAscii As Integer)
     Call objCT.gobjInfoUsu.gobjTelaUsu.Dan_OS_KeyPress(objCT, KeyAscii)
End Sub

Private Sub Dan_OS_Validate(Cancel As Boolean)
     Call objCT.gobjInfoUsu.gobjTelaUsu.Dan_OS_Validate(objCT, Cancel)
End Sub
'---fim Dan-Presse
