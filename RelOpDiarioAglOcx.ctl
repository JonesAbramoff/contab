...
Begin VB.UserControl RelOpDiarioAglOcx 
   ClientHeight    =   3810
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   6525
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   600
      Left            =   4200
      Picture         =   "RelOpDiarioAglOcx.ctx":0000
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   960
      Width           =   1815
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   315
      ItemData        =   "RelOpDiarioAglOcx.ctx":0102
      Left            =   1335
      List            =   "RelOpDiarioAglOcx.ctx":0104
      Sorted          =   -1  'True
      TabIndex        =   5
      Top             =   360
      Width           =   2325
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "RelOpDiarioAglOcx.ctx":0106
         Style           =   1  'Graphical
         TabIndex        =   4
         ToolTipText     =   "Fechar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "RelOpDiarioAglOcx.ctx":0284
         Style           =   1  'Graphical
         TabIndex        =   3
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "RelOpDiarioAglOcx.ctx":07B6
         Style           =   1  'Graphical
         TabIndex        =   2
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "RelOpDiarioAglOcx.ctx":0940
         Style           =   1  'Graphical
         TabIndex        =   1
         ToolTipText     =   "Gravar"
         Top             =   90
   ...
   End
End
Attribute VB_Name = "RelOpDiarioAglOcx"
...
On Error GoTo Erro_Trata_Parametros
    ...
    If Not (gobjRelatorio Is Nothing) Then Error 65398
    ...
    If lErro <> SUCESSO Then Error 65399
...
Erro_Trata_Parametros:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168255)
...
On Error GoTo Erro_Critica_Datas_RelOpDiario
    ...
    If Len(DataInicial.ClipText) = 0 Then Error 65400

    'data final não pode ser vazia
    If Len(DataFinal.ClipText) = 0 Then Error 65402

    'data inicial não pode ser maior que a data final
    If CDate(DataInicial.Text) > CDate(DataFinal.Text) Then Error 65404

    'pega o período da Data Inicial
    lErro = CF("Periodo_Le", DataInicial.Text, objPer_I)
    If lErro <> SUCESSO Then Error 65401

    'pega o período da Data Final
    lErro = CF("Periodo_Le", DataFinal.Text, objPer_F)
    If lErro <> SUCESSO Then Error 65403

    'Data Inicial e Final devem estar num mesmo exercício
    If objPer_I.iExercicio <> objPer_F.iExercicio Then Error 65405
...
Erro_Critica_Datas_RelOpDiario:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168256)
...
On Error GoTo Erro_PreencherRelOp
    ...
    If lErro <> SUCESSO Then Error 65406

    lErro = objRelOpcoes.Limpar
    If lErro <> AD_BOOL_TRUE Then Error 65407

    lErro = objRelOpcoes.IncluirParametro("NEXERCICIO", CStr(iExercicio))
    If lErro <> AD_BOOL_TRUE Then Error 65408

    lErro = objRelOpcoes.IncluirParametro("NPAGRELINI", PrimeiraFolha.Text)
    If lErro <> AD_BOOL_TRUE Then Error 65409

    lErro = objRelOpcoes.IncluirParametro("DINIC", DataInicial.Text)
    If lErro <> AD_BOOL_TRUE Then Error 65410

    lErro = objRelOpcoes.IncluirParametro("DFIM", DataFinal.Text)
    If lErro <> AD_BOOL_TRUE Then Error 65411
    ...
    If lErro <> SUCESSO Then Error 65412
...
Erro_PreencherRelOp:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168257)
...
On Error GoTo Erro_PreencherParametrosNaTela
    ...
    If lErro <> SUCESSO Then Error 65413

    'pega data inicial e exibe
    lErro = objRelOpcoes.ObterParametro("DINIC", sParam)
    If lErro <> SUCESSO Then Error 65414
    ...
    If lErro <> SUCESSO Then Error 65415
    ...
    If lErro <> SUCESSO Then Error 65416
...
Erro_PreencherParametrosNaTela:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168258)
...
On Error GoTo Erro_BotaoExcluir_Click
    ...
    If ComboOpcoes.ListIndex = -1 Then Error 65417
    ...
    If vbMsgRes = vbYes Then
        ...
        If lErro <> SUCESSO Then Error 65418
        ...
        If lErro <> SUCESSO Then Error 65419
...
Erro_BotaoExcluir_Click:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168259)
...
On Error GoTo Erro_BotaoExecutar_Click
    ...
    If lErro <> SUCESSO Then Error 65420
...
Erro_BotaoExecutar_Click:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168260)
...
On Error GoTo Erro_BotaoGravar_Click
    ...
    If ComboOpcoes.Text = "" Then Error 65421

    lErro = PreencherRelOp(gobjRelOpcoes)
    If lErro <> SUCESSO Then Error 65422

    gobjRelOpcoes.sNome = ComboOpcoes.Text

    lErro = CF("RelOpcoes_Grava", gobjRelOpcoes, iResultado)
    If lErro <> SUCESSO Then Error 65423

    lErro = RelOpcoes_Testa_Combo(ComboOpcoes, gobjRelOpcoes.sNome)
    If lErro <> SUCESSO Then Error 65424
...
Erro_BotaoGravar_Click:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168261)
...
On Error GoTo Erro_BotaoLimpar_Click
    ...
    lErro = Limpa_Relatorio(Me)
    If lErro <> SUCESSO Then Error 65425
...
Erro_BotaoLimpar_Click:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168262)
...
On Error GoTo Erro_DataFinal_Validate
    ...
    If Len(DataFinal.ClipText) > 0 Then
        ...
        If lErro <> SUCESSO Then Error 65426
...
Erro_DataFinal_Validate:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168263)
...
On Error GoTo Erro_DataInicial_Validate
    ...
    If Len(DataInicial.ClipText) > 0 Then
        ...
        If lErro <> SUCESSO Then Error 65427
...
Erro_DataInicial_Validate:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168264)
...
Erro_OpcoesRel_Form_Load:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168265)
...
On Error GoTo Erro_UpDown1_DownClick
    ...
    If lErro <> SUCESSO Then Error 65428
...
Erro_UpDown1_DownClick:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168266)
...
On Error GoTo Erro_UpDown1_UpClick
    ...
    If lErro <> SUCESSO Then Error 65429
...
Erro_UpDown1_UpClick:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168267)
...
On Error GoTo Erro_UpDown2_DownClick
    ...
    If lErro <> SUCESSO Then Error 65430
...
Erro_UpDown2_DownClick:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168268)
...
On Error GoTo Erro_UpDown2_UpClick
    ...
    If lErro <> SUCESSO Then Error 65431
...
Erro_UpDown2_UpClick:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168269)
...
Erro_Monta_Expressao_Selecao:
    ...
    Select Case Err
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", Err, Error$, 168270)
