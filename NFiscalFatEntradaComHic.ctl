...
Begin VB.UserControl NFiscalFatEntradaCom 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   12
         Left            =   7224
         Picture         =   "NFiscalFatEntradaComHic.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   97
         Top             =   690
         Width           =   1776
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   11
         Left            =   7224
         Picture         =   "NFiscalFatEntradaComHic.ctx":11E2
         Style           =   1  'Graphical
         TabIndex        =   96
         Top             =   84
         Width           =   1776
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CommandButton Recebimento 
            Height          =   360
            Left            =   2055
            Picture         =   "NFiscalFatEntradaComHic.ctx":21FC
            Style           =   1  'Graphical
            TabIndex        =   1
         ...
         Begin VB.ComboBox TipoNFiscal 
            Height          =   315
            ItemData        =   "NFiscalFatEntradaComHic.ctx":25CE
            Left            =   1350
            List            =   "NFiscalFatEntradaComHic.ctx":25D0
            TabIndex        =   2
            Top             =   570
            Width           =   4650
         End
         Begin VB.CommandButton Botao 
            ...
            Index           =   5
            Left            =   5640
            Picture         =   "NFiscalFatEntradaComHic.ctx":25D2
            Style           =   1  'Graphical
            TabIndex        =   6
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CommandButton Botao 
            ...
            Index           =   8
            Left            =   7335
            Picture         =   "NFiscalFatEntradaComHic.ctx":2B04
            Style           =   1  'Graphical
            TabIndex        =   18
            Top             =   495
            Width           =   1425
         ...
         Begin VB.CommandButton Botao 
            ...
            Index           =   7
            Left            =   5865
            Picture         =   "NFiscalFatEntradaComHic.ctx":3CE6
            Style           =   1  'Graphical
            TabIndex        =   17
            Top             =   480
            Width           =   1425
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "NFiscalFatEntradaComHic.ctx":4D00
            Left            =   3735
            List            =   "NFiscalFatEntradaComHic.ctx":4D0A
            Style           =   2  'Dropdown List
            TabIndex        =   218
            Top             =   195
            Visible         =   0   'False
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   2
         Left            =   1341
         Picture         =   "NFiscalFatEntradaComHic.ctx":4D26
         Style           =   1  'Graphical
         TabIndex        =   28
         ToolTipText     =   "Excluir"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   4
         Left            =   2250
         Picture         =   "NFiscalFatEntradaComHic.ctx":4EB0
         Style           =   1  'Graphical
         TabIndex        =   30
         ToolTipText     =   "Fechar"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   3
         Left            =   1794
         Picture         =   "NFiscalFatEntradaComHic.ctx":502E
         Style           =   1  'Graphical
         TabIndex        =   29
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   1
         Left            =   888
         Picture         =   "NFiscalFatEntradaComHic.ctx":5560
         Style           =   1  'Graphical
         TabIndex        =   27
         ToolTipText     =   "Gravar"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   0
         Left            =   60
         Picture         =   "NFiscalFatEntradaComHic.ctx":56BA
         Style           =   1  'Graphical
         TabIndex        =   26
