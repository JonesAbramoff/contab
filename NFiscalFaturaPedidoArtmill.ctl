...
Begin VB.UserControl NFiscalFaturaPedido 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox TabPrecoItemNF 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "NFiscalFaturaPedidoArtmill.ctx":0000
            Left            =   4590
            List            =   "NFiscalFaturaPedidoArtmill.ctx":0002
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox TipoNFiscal 
            Height          =   315
            ItemData        =   "NFiscalFaturaPedidoArtmill.ctx":0004
            Left            =   2085
            List            =   "NFiscalFaturaPedidoArtmill.ctx":0006
            TabIndex        =   193
            Top             =   165
            Width           =   3420
         End
         Begin VB.CommandButton Botao 
            ...
            Index           =   8
            Left            =   5070
            Picture         =   "NFiscalFaturaPedidoArtmill.ctx":0008
            Style           =   1  'Graphical
            TabIndex        =   7
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame3 
         ...
         Begin VB.ComboBox TipoPagto 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "NFiscalFaturaPedidoArtmill.ctx":053A
            Left            =   2940
            List            =   "NFiscalFaturaPedidoArtmill.ctx":054A
            TabIndex        =   199
            Top             =   2265
            Width           =   1965
         End
         ...
         Begin VB.CommandButton BotaoDataReferenciaDown 
            Height          =   150
            Left            =   3090
            Picture         =   "NFiscalFaturaPedidoArtmill.ctx":0587
            Style           =   1  'Graphical
            TabIndex        =   116
            TabStop         =   0   'False
            Top             =   795
         ...
         Begin VB.CommandButton BotaoDataReferenciaUp 
            Height          =   150
            Left            =   3090
            Picture         =   "NFiscalFaturaPedidoArtmill.ctx":05E1
            Style           =   1  'Graphical
            TabIndex        =   118
            TabStop         =   0   'False
            Top             =   645
         ...
         Begin VB.ComboBox Desconto1Codigo 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "NFiscalFaturaPedidoArtmill.ctx":063B
            Left            =   3120
            List            =   "NFiscalFaturaPedidoArtmill.ctx":063D
            TabIndex        =   69
            Top             =   1140
            Width           =   1950
         End
   ...
   Begin VB.Frame Frame1 
      BorderStyle     =   0  'None
      Caption         =   $"NFiscalFaturaPedidoArtmill.ctx":063F
      Height          =   4650
      Index           =   7
      Left            =   120
      TabIndex        =   93
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox ProdutoRastro 
            Height          =   315
            ItemData        =   "NFiscalFaturaPedidoArtmill.ctx":06D2
            Left            =   2400
            List            =   "NFiscalFaturaPedidoArtmill.ctx":06DF
            Style           =   2  'Dropdown List
            TabIndex        =   195
            Top             =   1905
            Width           =   1740
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Height          =   315
            ItemData        =   "NFiscalFaturaPedidoArtmill.ctx":06FE
            Left            =   3690
            List            =   "NFiscalFaturaPedidoArtmill.ctx":070B
            Style           =   2  'Dropdown List
            TabIndex        =   159
            Top             =   270
            Width           =   1215
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame4 
         ...
         Begin VB.CommandButton BotaoVendedores 
            ...
            Height          =   615
            Left            =   7560
            Picture         =   "NFiscalFaturaPedidoArtmill.ctx":072A
            Style           =   1  'Graphical
            TabIndex        =   189
            Top             =   3300
            Width           =   1380
   ...
   Begin VB.ComboBox DiretoIndireto 
      Height          =   315
      ItemData        =   "NFiscalFaturaPedidoArtmill.ctx":0CD4
      Left            =   7320
      List            =   "NFiscalFaturaPedidoArtmill.ctx":0CDE
      Style           =   2  'Dropdown List
      TabIndex        =   183
      Top             =   2400
      Width           =   1215
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton BotaoImprimirPI 
         Height          =   330
         Left            =   3060
         Picture         =   "NFiscalFaturaPedidoArtmill.ctx":0CF4
         Style           =   1  'Graphical
         TabIndex        =   177
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   2
         Left            =   45
         Picture         =   "NFiscalFaturaPedidoArtmill.ctx":0DF6
         Style           =   1  'Graphical
         TabIndex        =   171
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   5
         Left            =   1740
         Picture         =   "NFiscalFaturaPedidoArtmill.ctx":0EF8
         Style           =   1  'Graphical
         TabIndex        =   174
         ToolTipText     =   "Excluir"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   3
         Left            =   485
         Picture         =   "NFiscalFaturaPedidoArtmill.ctx":1082
         Style           =   1  'Graphical
         TabIndex        =   172
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   4
         Left            =   1300
         Picture         =   "NFiscalFaturaPedidoArtmill.ctx":1904
         Style           =   1  'Graphical
         TabIndex        =   173
         ToolTipText     =   "Gravar"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   6
         Left            =   2180
         Picture         =   "NFiscalFaturaPedidoArtmill.ctx":1A5E
         Style           =   1  'Graphical
         TabIndex        =   175
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   7
         Left            =   2620
         Picture         =   "NFiscalFaturaPedidoArtmill.ctx":1F90
         Style           =   1  'Graphical
         TabIndex        =   176
         ToolTipText     =   "Fechar"
         Top             =   75
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   0
         Left            =   3540
         Picture         =   "NFiscalFaturaPedidoArtmill.ctx":210E
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   1
         Left            =   3930
         Picture         =   "NFiscalFaturaPedidoArtmill.ctx":24E0
         Style           =   1  'Graphical
         TabIndex        =   5
...
Private Sub UserControl_Initialize()
    ...
    Set objCT.gobjInfoUsu = New CTNFiscalFatPedVGArt
    Set objCT.gobjInfoUsu.gobjTelaUsu = New CTNFiscalFatPedArt
End Sub
