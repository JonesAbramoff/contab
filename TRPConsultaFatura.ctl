...
Begin VB.UserControl TRPConsultaFatura 
   ClientHeight    =   6000
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9510
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   45
         Picture         =   "TRPConsultaFatura.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   7
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   555
         Picture         =   "TRPConsultaFatura.ctx":0532
         Style           =   1  'Graphical
         TabIndex        =   8
         ToolTipText     =   "Fechar"
         Top             =   90
   ...
   End
End
Attribute VB_Name = "TRPConsultaFatura"
...
On Error GoTo Erro_Numero_Validate
    ...
    If Len(Trim(Numero.ClipText)) <> 0 Then
        ...
        lErro = CF("TRPFaturas_Le", lNumero, objDestino, iTipoDocDestino, True, True)
        ...
        Select Case iTipoDocDestino
            ...
            Case TRP_TIPO_DOC_DESTINO_TITREC
                ...
                lErro = CF("TitulosRecTRP_Le_NF", objDestino.lNumIntDoc, objNF, iItemNF)
                If lErro <> SUCESSO And lErro <> ERRO_LEITURA_SEM_DADOS Then gError 196765
                
                If lErro = SUCESSO Then
                
                    NumNF.Caption = CStr(objNF.lNumNotaFiscal)
                    NumNFe.Caption = CStr(objNF.lNumNFe)
            ...
            Case TRP_TIPO_DOC_DESTINO_NFSPAG
                ...
                If objFaturaTRP.dtDataPagto <> DATA_NULA Then
                    Status.Caption = "Baixado"
                    SaldoPagto.Caption = Format(0, "STANDARD")
                End If
        ...
        If objFaturaTRP.lClienteVou <> 0 And iTipoDocDestino <> TRP_TIPO_DOC_DESTINO_NFSPAG Then
        
            Set objCliente = New ClassCliente
            
            objCliente.lCodigo = objFaturaTRP.lClienteVou
        ...
        ValorAporte.Caption = Format(objFaturaTRP.dValorAporte, "STANDARD")
        PercAporte.Caption = Format(objFaturaTRP.dPercAporte, "PERCENT")
        UsuarioGerFat.Caption = objFaturaTRP.sUsuarioGerFat
        If objFaturaTRP.dtDataGerFat <> DATA_NULA Then DataGerFat.Caption = Format(objFaturaTRP.dtDataGerFat, "dd/mm/yyyy")
        If objFaturaTRP.dHoraGerFat <> 0 Then HoraGerFat.Caption = Format(objFaturaTRP.dHoraGerFat, "hh:mm:ss")
        If objFaturaTRP.dtDataPagto <> DATA_NULA Then DataPagto.Caption = Format(objFaturaTRP.dtDataPagto, "dd/mm/yyyy")
        If objFaturaTRP.dtDataRegPagto <> DATA_NULA Then DataRegPagto.Caption = Format(objFaturaTRP.dtDataRegPagto, "dd/mm/yyyy")
        If objFaturaTRP.dHoraRegPagto <> 0 Then HoraRegPagto.Caption = Format(objFaturaTRP.dHoraRegPagto, "hh:mm:ss")
        MotivoCanc.Caption = objFaturaTRP.sMotivo
        UsuarioCanc.Caption = objFaturaTRP.sUsuarioCanc
        If objFaturaTRP.dtDataCanc <> DATA_NULA Then DataCanc.Caption = Format(objFaturaTRP.dtDataCanc, "dd/mm/yyyy")
        If objFaturaTRP.dHoraCanc <> 0 Then HoraCanc.Caption = Format(objFaturaTRP.dHoraCanc, "hh:mm:ss")
...
On Error GoTo Erro_BotaoConsultarItens_Click
    ...
    If Not (gobjDestino Is Nothing) Then
        ...
        Call Chama_Tela("TRPDocFaturadosLista", colSelecao, Nothing, Nothing, "TipoDocDestino = ? AND NumIntDocDestino = ?")
...
On Error GoTo Erro_BotaoConsultarAp_Click
    ...
    If Not (gobjDestino Is Nothing) Then
        ...
        Call Chama_Tela("TRPAPortesPagtoFatHistLista", colSelecao, Nothing, Nothing, "NumFat = ?")
...
On Error GoTo Erro_BotaoGerarFat_Click
    ...
    If Not (gobjDestino Is Nothing) Then
        ...
        lErro = CF("TRPConfig_Le", TRPCONFIG_DIRETORIO_MODELO_FAT_HTML, EMPRESA_TODA, sModeloFat)
        If lErro <> SUCESSO Then gError 196771
           
        lErro = CF("TRPFaturas_Regera_Html", gobjDestino.objInfoUsu.lNumFat, gobjDestino.objInfoUsu.lNumFat, sModeloFat, sNomeDiretorio, sSiglaDoc)
...
On Error GoTo Erro_BotaoAbrirFat_Click
    ...
    If Not (gobjDestino Is Nothing) Then
        ...
        sNomeArquivo = sConteudo & gsEmpresaTRP & String(6 - Len(Numero.ClipText), "0") & CStr(Numero.ClipText) & ".html"
...
On Error GoTo Erro_BotaoConsultarContatos_Click
    ...
    If Not (gobjDestino Is Nothing) Then
        ...
        If giTipoDocDestino = TRP_TIPO_DOC_DESTINO_TITREC Then
