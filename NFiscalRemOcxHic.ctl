...
Begin VB.UserControl NFiscalRem 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton BotaoLimparNF 
            Height          =   300
            Left            =   5190
            Picture         =   "NFiscalRemOcxHic.ctx":0000
            Style           =   1  'Graphical
            TabIndex        =   6
         ...
         Begin VB.ComboBox TipoNFiscal 
            Height          =   315
            ItemData        =   "NFiscalRemOcxHic.ctx":0532
            Left            =   2190
            List            =   "NFiscalRemOcxHic.ctx":0534
            TabIndex        =   1
            Top             =   300
            Width           =   2835
         End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame18 
         ...
         Begin VB.ComboBox ProdutoRastro 
            Height          =   315
            ItemData        =   "NFiscalRemOcxHic.ctx":0536
            Left            =   0
            List            =   "NFiscalRemOcxHic.ctx":0543
            Style           =   2  'Dropdown List
            TabIndex        =   149
            Top             =   0
            Width           =   1740
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "NFiscalRemOcxHic.ctx":0562
            Left            =   615
            List            =   "NFiscalRemOcxHic.ctx":056F
            Style           =   2  'Dropdown List
            TabIndex        =   126
            Top             =   2280
            Visible         =   0   'False
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   330
         Left            =   530
         Picture         =   "NFiscalRemOcxHic.ctx":058E
         Style           =   1  'Graphical
         TabIndex        =   131
         ToolTipText     =   "Excluir"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   330
         Left            =   1440
         Picture         =   "NFiscalRemOcxHic.ctx":0718
         Style           =   1  'Graphical
         TabIndex        =   133
         ToolTipText     =   "Fechar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   330
         Left            =   985
         Picture         =   "NFiscalRemOcxHic.ctx":0896
         Style           =   1  'Graphical
         TabIndex        =   132
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   330
         Left            =   75
         Picture         =   "NFiscalRemOcxHic.ctx":0DC8
         Style           =   1  'Graphical
         TabIndex        =   130
         ToolTipText     =   "Gravar"
         Top             =   75
