...
Begin VB.UserControl RelOpPedDataEntregaOcx 
   ClientHeight    =   1710
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   6765
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   315
      ItemData        =   "RelOpPedDataEntrega.ctx":0000
      Left            =   900
      List            =   "RelOpPedDataEntrega.ctx":0002
      Sorted          =   -1  'True
      TabIndex        =   1
      Top             =   195
      Width           =   2916
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   600
      Left            =   4710
      Picture         =   "RelOpPedDataEntrega.ctx":0004
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   855
      Width           =   1575
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "RelOpPedDataEntrega.ctx":0106
         Style           =   1  'Graphical
         TabIndex        =   8
         ToolTipText     =   "Fechar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1110
         Picture         =   "RelOpPedDataEntrega.ctx":0284
         Style           =   1  'Graphical
         TabIndex        =   7
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "RelOpPedDataEntrega.ctx":07B6
         Style           =   1  'Graphical
         TabIndex        =   6
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "RelOpPedDataEntrega.ctx":0940
         Style           =   1  'Graphical
         TabIndex        =   5
         ToolTipText     =   "Gravar"
         Top             =   90
   ...
   End
End
Attribute VB_Name = "RelOpPedDataEntregaOcx"
...
On Error GoTo Erro_Critica_Datas_RelOpLancData
    ...
    If Len(DataInicial.ClipText) <> 0 And Len(DataFinal.ClipText) <> 0 Then
        ...
        If CDate(DataInicial.Text) > CDate(DataFinal.Text) Then gError 75497
...
Erro_Critica_Datas_RelOpLancData:
    ...
    Select Case gErr
        ...
        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 170975)
...
On Error GoTo Erro_PreencherRelOp
    ...
    If lErro <> SUCESSO Then gError 75498

    lErro = objRelOpcoes.Limpar
    If lErro <> AD_BOOL_TRUE Then gError 75499
    ...
    End If
    If lErro <> AD_BOOL_TRUE Then gError 75500
    ...
    End If
    If lErro <> AD_BOOL_TRUE Then gError 75501
    
    lErro = Monta_Expressao_Selecao(objRelOpcoes)
    If lErro <> SUCESSO Then gError 75502
...
Erro_PreencherRelOp:
    ...
    Select Case gErr
        ...
        Case 75498, 75499, 75500, 75501, 75502

        Case Else
            lErro = Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error$, 170976)
...
On Error GoTo Erro_BotaoExecutar_Click
    ...
    If gobjRelatorio.sCodRel = "Pedidos X Data Entrega" Then
    
        If giFilialEmpresa <> EMPRESA_TODA Then gobjRelatorio.sNomeTsk = "pventreg"
        If giFilialEmpresa = EMPRESA_TODA Then gobjRelatorio.sNomeTsk = "pventrET"
    
    End If
    
    If gobjRelatorio.sCodRel = "Programação de Pedidos" Then
    
        If giFilialEmpresa <> EMPRESA_TODA Then gobjRelatorio.sNomeTsk = "ProgPed"
        If giFilialEmpresa = EMPRESA_TODA Then gobjRelatorio.sNomeTsk = "PrPedET"
...
On Error GoTo Erro_Monta_Expressao_Selecao
    ...
    If Trim(DataInicial.ClipText) <> "" Then sExpressao = "DataEntrega >= " & Forprint_ConvData(CDate(DataInicial.Text))
