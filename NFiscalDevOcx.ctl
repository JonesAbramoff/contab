...
Begin VB.UserControl NFiscalDevOcx 
   ClientHeight    =   5880
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9615
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         End
      End
      Begin VB.CommandButton BotaoItensNFOrigAuto 
         Caption         =   "Itens de NFs Orig. Automático"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton BotaoLimparNF 
            Height          =   300
            Left            =   6330
            Picture         =   "NFiscalDevOcx.ctx":0000
            Style           =   1  'Graphical
            TabIndex        =   33
         ...
         Begin VB.ComboBox TipoNFiscal 
            Height          =   315
            ItemData        =   "NFiscalDevOcx.ctx":0532
            Left            =   2040
            List            =   "NFiscalDevOcx.ctx":0534
            TabIndex        =   4
            Top             =   270
            Width           =   3045
         End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame18 
         ...
         Begin VB.ComboBox ProdutoRastro 
            Height          =   315
            ItemData        =   "NFiscalDevOcx.ctx":0536
            Left            =   2130
            List            =   "NFiscalDevOcx.ctx":0543
            Style           =   2  'Dropdown List
            TabIndex        =   175
            Top             =   1845
            Width           =   1740
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "NFiscalDevOcx.ctx":0562
            Left            =   480
            List            =   "NFiscalDevOcx.ctx":056F
            Style           =   2  'Dropdown List
            TabIndex        =   157
            Top             =   2295
            Visible         =   0   'False
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   330
         Left            =   1364
         Picture         =   "NFiscalDevOcx.ctx":058E
         Style           =   1  'Graphical
         TabIndex        =   23
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoConsultaDocCPR 
         ...
         Height          =   330
         Left            =   75
         Picture         =   "NFiscalDevOcx.ctx":0718
         Style           =   1  'Graphical
         TabIndex        =   21
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   330
         Left            =   915
         Picture         =   "NFiscalDevOcx.ctx":0F9A
         Style           =   1  'Graphical
         TabIndex        =   22
         ToolTipText     =   "Gravar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   330
         Left            =   1821
         Picture         =   "NFiscalDevOcx.ctx":10F4
         Style           =   1  'Graphical
         TabIndex        =   24
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   330
         Left            =   2280
         Picture         =   "NFiscalDevOcx.ctx":1626
         Style           =   1  'Graphical
         TabIndex        =   25
         ToolTipText     =   "Fechar"
         Top             =   90
   ...
   End
End
Attribute VB_Name = "NFiscalDevOcx"
...
Private Sub BotaoItensNFOrigAuto_Click()
     Call objCT.BotaoItensNFOrigAuto_Click
End Sub
