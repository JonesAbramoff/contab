...
Begin VB.UserControl CobrancaNFPorEmail 
   ClientHeight    =   6495
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9510
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Modelo 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "CobrancaNFPorEmail.ctx":0000
         Left            =   2205
         List            =   "CobrancaNFPorEmail.ctx":000A
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.Frame Frame2 
            Caption         =   "Documentos que contenham ...."
            Height          =   1575
            Left            =   5025
            TabIndex        =   41
            Top             =   2310
            ...
            Begin VB.ListBox TipoDoc 
               Height          =   960
               ItemData        =   "CobrancaNFPorEmail.ctx":003F
               Left            =   120
               List            =   "CobrancaNFPorEmail.ctx":004C
               Style           =   1  'Checkbox
               TabIndex        =   62
               Top             =   300
               Width           =   2175
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Carta 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "CobrancaNFPorEmail.ctx":0060
         Left            =   3090
         List            =   "CobrancaNFPorEmail.ctx":006A
         Style           =   2  'Dropdown List
         TabIndex        =   36
         Top             =   420
         Width           =   2235
      ...
      Begin VB.CommandButton BotaoMarcarTodos 
         ...
         Height          =   555
         Left            =   60
         Picture         =   "CobrancaNFPorEmail.ctx":009F
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   3450
         Width           =   1725
      ...
      Begin VB.CommandButton BotaoDesmarcarTodos 
         ...
         Height          =   555
         Left            =   45
         Picture         =   "CobrancaNFPorEmail.ctx":10B9
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   4200
         Width           =   1725
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoEmail 
         Height          =   360
         Left            =   120
         Picture         =   "CobrancaNFPorEmail.ctx":229B
         Style           =   1  'Graphical
         TabIndex        =   15
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   645
         Picture         =   "CobrancaNFPorEmail.ctx":2C3D
         Style           =   1  'Graphical
         TabIndex        =   16
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1155
         Picture         =   "CobrancaNFPorEmail.ctx":316F
         Style           =   1  'Graphical
         TabIndex        =   17
         ToolTipText     =   "Fechar"
         Top             =   75
   ...
   End
End
Attribute VB_Name = "CobrancaNFPorEmail"
