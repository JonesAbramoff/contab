...
Begin VB.UserControl NFiscalPedido 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame6 
         ...
         Begin VB.ComboBox TabPrecoItemNF 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "NFiscalPedidoArtmill.ctx":0000
            Left            =   5820
            List            =   "NFiscalPedidoArtmill.ctx":0002
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton BotaoLimparNF 
            Height          =   300
            Left            =   5115
            Picture         =   "NFiscalPedidoArtmill.ctx":0004
            Style           =   1  'Graphical
            TabIndex        =   6
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox ProdutoRastro 
            Height          =   315
            ItemData        =   "NFiscalPedidoArtmill.ctx":0536
            Left            =   0
            List            =   "NFiscalPedidoArtmill.ctx":0543
            Style           =   2  'Dropdown List
            TabIndex        =   176
            Top             =   0
            Width           =   1740
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Height          =   315
            ItemData        =   "NFiscalPedidoArtmill.ctx":0562
            Left            =   3690
            List            =   "NFiscalPedidoArtmill.ctx":056F
            Style           =   2  'Dropdown List
            TabIndex        =   147
            Top             =   270
            Width           =   1215
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame NFiscalOcx 
         ...
         Begin VB.CommandButton BotaoVendedores 
            ...
            Height          =   540
            Left            =   7680
            Picture         =   "NFiscalPedidoArtmill.ctx":058E
            Style           =   1  'Graphical
            TabIndex        =   172
            Top             =   3285
            Width           =   1305
         ...
         Begin VB.ComboBox DiretoIndireto 
            Height          =   315
            ItemData        =   "NFiscalPedidoArtmill.ctx":0B38
            Left            =   7080
            List            =   "NFiscalPedidoArtmill.ctx":0B42
            Style           =   2  'Dropdown List
            TabIndex        =   166
            Top             =   1560
            Width           =   1335
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton BotaoImprimirPI 
         Height          =   345
         Left            =   2715
         Picture         =   "NFiscalPedidoArtmill.ctx":0B58
         Style           =   1  'Graphical
         TabIndex        =   164
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   330
         Left            =   1349
         Picture         =   "NFiscalPedidoArtmill.ctx":0C5A
         Style           =   1  'Graphical
         TabIndex        =   161
         ToolTipText     =   "Excluir"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   330
         Left            =   2265
         Picture         =   "NFiscalPedidoArtmill.ctx":0DE4
         Style           =   1  'Graphical
         TabIndex        =   163
         ToolTipText     =   "Fechar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   330
         Left            =   1806
         Picture         =   "NFiscalPedidoArtmill.ctx":0F62
         Style           =   1  'Graphical
         TabIndex        =   162
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   330
         Left            =   892
         Picture         =   "NFiscalPedidoArtmill.ctx":1494
         Style           =   1  'Graphical
         TabIndex        =   160
         ToolTipText     =   "Gravar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoConsultaTitRec 
         ...
         Height          =   330
         Left            =   60
         Picture         =   "NFiscalPedidoArtmill.ctx":15EE
         Style           =   1  'Graphical
         TabIndex        =   159
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.CommandButton BotaoPedido 
         Height          =   360
         Left            =   3570
         Picture         =   "NFiscalPedidoArtmill.ctx":1E70
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      Begin VB.CommandButton BotaoVerPedido 
         Height          =   360
         Left            =   3960
         Picture         =   "NFiscalPedidoArtmill.ctx":2242
         Style           =   1  'Graphical
         TabIndex        =   3
