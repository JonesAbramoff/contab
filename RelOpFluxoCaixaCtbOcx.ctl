...
Begin VB.UserControl RelOpFluxoCaixaCtbOcx 
   ClientHeight    =   4065
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   8295
   ...
   Begin VB.ComboBox TipoRel 
      Height          =   315
      ItemData        =   "RelOpFluxoCaixaCtbOcx.ctx":0000
      Left            =   1260
      List            =   "RelOpFluxoCaixaCtbOcx.ctx":001C
      TabIndex        =   24
      Text            =   "Combo1"
      Top             =   885
      Width           =   2625
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   615
      Left            =   4125
      Picture         =   "RelOpFluxoCaixaCtbOcx.ctx":00EE
      Style           =   1  'Graphical
      TabIndex        =   14
      Top             =   150
      Width           =   1575
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   315
      ItemData        =   "RelOpFluxoCaixaCtbOcx.ctx":01F0
      Left            =   1275
      List            =   "RelOpFluxoCaixaCtbOcx.ctx":01F2
      Sorted          =   -1  'True
      TabIndex        =   13
      Top             =   270
      Width           =   2610
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "RelOpFluxoCaixaCtbOcx.ctx":01F4
         Style           =   1  'Graphical
         TabIndex        =   4
         ToolTipText     =   "Fechar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "RelOpFluxoCaixaCtbOcx.ctx":0372
         Style           =   1  'Graphical
         TabIndex        =   3
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "RelOpFluxoCaixaCtbOcx.ctx":08A4
         Style           =   1  'Graphical
         TabIndex        =   2
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "RelOpFluxoCaixaCtbOcx.ctx":0A2E
         Style           =   1  'Graphical
         TabIndex        =   1
         ToolTipText     =   "Gravar"
         Top             =   90
   ...
   End
End
Attribute VB_Name = "RelOpFluxoCaixaCtbOcx"
...
Dim sCta_I As String, sCta_F As String, dSaldoInicial As Double
...
'    If lErro <> AD_BOOL_TRUE Then Error 13059
    ...
    If bGeraArqTemp Then
        ...
        lErro = CF("RelFluxoCaixaContabil_Prepara", CDate(DataInicial.Text), CDate(DataFinal.Text), lNumIntRel, dSaldoInicial)
...
On Error GoTo Erro_Monta_Expressao_Selecao
    ...
    If TipoRel.ListIndex = 2 Or TipoRel.ListIndex = 3 Or TipoRel.ListIndex = 7 Then
...
Dim iNumero As Integer
    ...
    gobjRelatorio.sNomeTsk = "flxctb" & (TipoRel.ListIndex + 1)
