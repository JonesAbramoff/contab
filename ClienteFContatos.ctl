...
Begin VB.UserControl ClienteFContatosOcx 
   ClientHeight    =   4965
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   6585
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "ClienteFContatos.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   6
         ToolTipText     =   "Fechar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "ClienteFContatos.ctx":017E
         Style           =   1  'Graphical
         TabIndex        =   5
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "ClienteFContatos.ctx":06B0
         Style           =   1  'Graphical
         TabIndex        =   4
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   105
         Picture         =   "ClienteFContatos.ctx":083A
         Style           =   1  'Graphical
         TabIndex        =   3
         ToolTipText     =   "Gravar"
         Top             =   90
   ...
   End
End
Attribute VB_Name = "ClienteFContatosOcx"
...
On Error GoTo Erro_Traz_ClienteContatos_Tela
    ...
    If lErro <> SUCESSO And lErro <> 181086 Then gError 121178
    ...
    For Each objClienteContatos In colClienteContatos
       ...
       GridContatos.TextMatrix(iLinha, iGrid_Contato_Col) = objClienteContatos.sContato
       GridContatos.TextMatrix(iLinha, iGrid_Setor_Col) = objClienteContatos.sSetor
       GridContatos.TextMatrix(iLinha, iGrid_Email_Col) = objClienteContatos.sEmail
       GridContatos.TextMatrix(iLinha, iGrid_Telefone_Col) = objClienteContatos.sTelefone
       GridContatos.TextMatrix(iLinha, iGrid_Fax_Col) = objClienteContatos.sFax
       GridContatos.TextMatrix(iLinha, iGrid_Cargo_Col) = objClienteContatos.sCargo
       GridContatos.TextMatrix(iLinha, iGrid_Padrao_Col) = objClienteContatos.iPadrao
...
Dim lErro As Long
Dim objCliente As New ClassContatos
...
On Error GoTo Erro_Valida_Cliente
    ...
    If Len(Trim(Cliente.Text)) > 0 Then
        ...
        lErro = TP_Contato_Le(Cliente, objCliente, iCodFilial)
        If lErro <> SUCESSO Then gError 102599

        'Lê coleção de códigos, nomes de Filiais do Cliente
        lErro = CF("FiliaisContatos_Le_Contato", objCliente, colCodigoNome)
...
Dim objFilialCliente As New ClassFilialContato
Dim objClienteContatos As New ClassClienteContatos
...
On Error GoTo Erro_Valida_FilialCliente
    ...
    If lErro = 6730 Then
        ...
        If lErro <> SUCESSO Then gError 102517

        'Passa o Código da Filial que está na tela para o Obj
        objFilialCliente.iCodFilial = iCodigo
        objFilialCliente.lCodContato = objContato.lCodigo

        'Lê Filial no BD a partir do NomeReduzido do Cliente e Código da Filial
        lErro = CF("FilialContato_Le", objFilialCliente)
        If lErro <> SUCESSO And lErro <> 180801 Then gError 102517

        'Se não existe a Filial
        If lErro = 180801 Then gError 102518
    ...
    Select Case gErr
        ...
        Case 102518
            ...
            If vbMsgRes = vbYes Then
                ...
                Call Chama_Tela("FiliaisContatos", objFilialCliente)
            Else
                'Segura o foco
            End If
...
On Error GoTo Erro_Move_Tela_Memoria
    ...
    For iIndice = 1 To objGridContatos.iLinhasExistentes
        ...
        objClienteContatos.iCodigo = iIndice
...
On Error GoTo Erro_Gravar_Registro
    ...
    lErro = CF("ClienteFContatos_Grava", colClienteContatos)
...
On Error GoTo Erro_BotaoExcluir_Click
    ...
    If vbMsgRes = vbYes Then
        ...
        'exclui os contatos
        lErro = CF("ClienteFContatos_Exclui", objClienteContatos)
...
On Error GoTo Erro_LabelCliente_Click
    ...
    Call Chama_Tela("ContatosLista", colSelecao, objCliente, objEventoCliente, "", sOrdenacao)
...
Dim objCliente As ClassContatos
...
On Error GoTo Erro_Tela_Extrai
    ...
    sTabela = "ClienteFContatos_ClientesDistintos"
...
On Error GoTo Erro_Obtem_Cod_Cliente_Filial
    ...
    If Len(Trim(Cliente.Text)) > 0 Then
        ...
        lErro = CF("Contato_Le_NomeReduzido", objCliente)
        If lErro <> SUCESSO And lErro <> 180745 Then gError 102578
        
        'Se não encontrou o cliente => erro
        If lErro = 180745 Then gError 102579
