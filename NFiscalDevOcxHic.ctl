...
Begin VB.UserControl NFiscalDev 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton BotaoLimparNF 
            Height          =   300
            Left            =   5100
            Picture         =   "NFiscalDevOcxHic.ctx":0000
            Style           =   1  'Graphical
            TabIndex        =   17
         ...
         Begin VB.ComboBox TipoNFiscal 
            Height          =   315
            ItemData        =   "NFiscalDevOcxHic.ctx":0532
            Left            =   2040
            List            =   "NFiscalDevOcxHic.ctx":0534
            TabIndex        =   11
            Top             =   195
            Width           =   3450
         End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox ProdutoRastro 
            Height          =   315
            ItemData        =   "NFiscalDevOcxHic.ctx":0536
            Left            =   0
            List            =   "NFiscalDevOcxHic.ctx":0543
            Style           =   2  'Dropdown List
            TabIndex        =   159
            Top             =   0
            Width           =   1740
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "NFiscalDevOcxHic.ctx":0562
            Left            =   480
            List            =   "NFiscalDevOcxHic.ctx":056F
            Style           =   2  'Dropdown List
            TabIndex        =   135
            Top             =   2295
            Visible         =   0   'False
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   330
         Left            =   1364
         Picture         =   "NFiscalDevOcxHic.ctx":058E
         Style           =   1  'Graphical
         TabIndex        =   142
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoConsultaDocCPR 
         ...
         Height          =   330
         Left            =   75
         Picture         =   "NFiscalDevOcxHic.ctx":0718
         Style           =   1  'Graphical
         TabIndex        =   141
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   330
         Left            =   915
         Picture         =   "NFiscalDevOcxHic.ctx":0F9A
         Style           =   1  'Graphical
         TabIndex        =   139
         ToolTipText     =   "Gravar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   330
         Left            =   1821
         Picture         =   "NFiscalDevOcxHic.ctx":10F4
         Style           =   1  'Graphical
         TabIndex        =   138
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   330
         Left            =   2280
         Picture         =   "NFiscalDevOcxHic.ctx":1626
         Style           =   1  'Graphical
         TabIndex        =   137
         ToolTipText     =   "Fechar"
         Top             =   90
