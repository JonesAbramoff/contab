...
Begin VB.UserControl CobrancaPorEmailOcx 
   ClientHeight    =   6495
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9510
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Modelo 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "CobrancaPorEmail.ctx":0000
         Left            =   1860
         List            =   "CobrancaPorEmail.ctx":000A
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.Frame Frame2 
            ...
            Begin VB.ComboBox TipoDocSeleciona 
               Enabled         =   0   'False
               Height          =   315
               ItemData        =   "CobrancaPorEmail.ctx":003F
               Left            =   1230
               List            =   "CobrancaPorEmail.ctx":0041
               Style           =   2  'Dropdown List
               TabIndex        =   14
               Top             =   825
               Width           =   2820
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Carta 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "CobrancaPorEmail.ctx":0043
         Left            =   3090
         List            =   "CobrancaPorEmail.ctx":004D
         Style           =   2  'Dropdown List
         TabIndex        =   54
         Top             =   420
         Width           =   2235
      ...
      Begin VB.CommandButton BotaoMarcarTodos 
         ...
         Height          =   555
         Left            =   60
         Picture         =   "CobrancaPorEmail.ctx":0082
         Style           =   1  'Graphical
         TabIndex        =   22
         Top             =   3450
         Width           =   1725
      ...
      Begin VB.CommandButton BotaoDesmarcarTodos 
         ...
         Height          =   555
         Left            =   45
         Picture         =   "CobrancaPorEmail.ctx":109C
         Style           =   1  'Graphical
         TabIndex        =   23
         Top             =   4200
         Width           =   1725
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoEmail 
         Height          =   360
         Left            =   120
         Picture         =   "CobrancaPorEmail.ctx":227E
         Style           =   1  'Graphical
         TabIndex        =   29
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   645
         Picture         =   "CobrancaPorEmail.ctx":2C20
         Style           =   1  'Graphical
         TabIndex        =   30
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1155
         Picture         =   "CobrancaPorEmail.ctx":3152
         Style           =   1  'Graphical
         TabIndex        =   31
         ToolTipText     =   "Fechar"
         Top             =   75
   ...
   End
End
Attribute VB_Name = "CobrancaPorEmailOcx"
...
Public Function Form_Load_Ocx() As Object
    ...
    objCT.Trata_Parametros (TIPOTELA_EMAIL_COBRANCA)
