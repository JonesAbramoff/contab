...
Begin VB.UserControl TRPRateio 
   ClientHeight    =   6870
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   8190
...
On Error GoTo Erro_BotaGerar_Click
    ...
    Call Chama_Tela_Modal("TRPImpRateioOff", iExcluiRateio)
...
On Error GoTo Erro_Traz_Doc_Tela
    ...
    If colTRPRateio.Count > 0 Then
    
        Set objTRPRateio = colTRPRateio(1)
        
        'mostra o Exercicio
        For iIndice = 0 To Exercicio.ListCount - 1
            If Exercicio.ItemData(iIndice) = objTRPRateio.iExercicio Then
        ...
        For iIndice = 0 To Periodo.ListCount - 1
            If Periodo.ItemData(iIndice) = objTRPRateio.iPeriodo Then
        ...
        For Each objTRPRateio In colTRPRateio
            ...
            lErro = Mascara_RetornaContaEnxuta(objTRPRateio.sConta, sContaMascarada)
            ...
            If objTRPRateio.sCcl <> "" Then
            
                lErro = Mascara_MascararCcl(objTRPRateio.sCcl, sCclMascarado)
            ...
            GridRateio.TextMatrix(iIndice, iGrid_Descricao_Col) = objTRPRateio.sDescricao
...
Erro_Traz_Doc_Tela:
    ...
    Select Case gErr
        ...
        Case 197599
            Call Rotina_Erro(vbOKOnly, "ERRO_MASCARA_RETORNACONTAENXUTA", gErr, objTRPRateio.sConta)
            
        Case 197600
            Call Rotina_Erro(vbOKOnly, "Erro_Mascara_MascararCcl", gErr, objTRPRateio.sCcl)
...
Dim objTRPRateio As New ClassTRPRateio
Dim iContaPreenchida As Integer
Dim iCclPreenchida As Integer
...
On Error GoTo Erro_Gravar_Registro
    ...
    'Preenche a colTRPRateio com as informacoes contidas no Grid
    lErro = Grid_Rateio(colTRPRateio)
    If lErro <> SUCESSO Then gError 197607
           
    lErro = CF("TRPRateio_Grava", colTRPRateio)
...
Private Function Grid_Rateio(colTRPRateio As Collection) As Long
'Armazena os dados do grid em colTRPRateio

Dim iIndice1 As Integer
Dim iIndice2 As Integer
Dim objTRPRateio As ClassTRPRateio
Dim objTRPRateio1 As ClassTRPRateio
Dim sConta As String
Dim sContaFormatada As String
Dim sCcl As String
Dim sCclFormatada As String
...
On Error GoTo Erro_Grid_Rateio
    ...
    For iIndice1 = 1 To objGridRateio.iLinhasExistentes
        ...
        objTRPRateio.iSeq = StrParaInt(GridRateio.TextMatrix(iIndice1, 0))
            
        objTRPRateio.iExercicio = Exercicio.ItemData(Exercicio.ListIndex)
        
        objTRPRateio.iPeriodo = Periodo.ItemData(Periodo.ListIndex)
        ...
        'Armazena a conta
        objTRPRateio.sConta = sContaFormatada
    
        'Armazena a descricao
        objTRPRateio.sDescricao = GridRateio.TextMatrix(iIndice1, iGrid_Descricao_Col)
        
        If Len(objTRPRateio.sDescricao) = 0 Then gError 197612
        ...
        objTRPRateio.sCcl = sCclFormatada
                        
        iIndice2 = 0
        
        For Each objTRPRateio1 In colTRPRateio
        
            iIndice2 = iIndice2 + 1
            
            If objTRPRateio1.sConta = objTRPRateio.sConta And objTRPRateio1.sCcl = objTRPRateio.sCcl Then gError 197615
            
            If objTRPRateio1.sDescricao = objTRPRateio.sDescricao Then gError 197616
