...
Begin VB.UserControl RelacionamentoContatoConsOcx 
   ClientHeight    =   5220
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   8655
      ...
      Begin VB.Frame FrameSelecao 
         ...
         Begin VB.Frame FrameOrigem 
            ...
            Begin VB.ComboBox Origem 
               Height          =   315
               ItemData        =   "RelacionamentoContatosConsOcx.ctx":0000
               Left            =   840
               List            =   "RelacionamentoContatosConsOcx.ctx":000D
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoAtualizar 
         Height          =   360
         Left            =   120
         Picture         =   "RelacionamentoContatosConsOcx.ctx":002A
         Style           =   1  'Graphical
         TabIndex        =   59
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   1080
         Picture         =   "RelacionamentoContatosConsOcx.ctx":07EC
         Style           =   1  'Graphical
         TabIndex        =   55
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   600
         Picture         =   "RelacionamentoContatosConsOcx.ctx":0976
         Style           =   1  'Graphical
         TabIndex        =   54
         ToolTipText     =   "Gravar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1560
         Picture         =   "RelacionamentoContatosConsOcx.ctx":0AD0
         Style           =   1  'Graphical
         TabIndex        =   53
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   2040
         Picture         =   "RelacionamentoContatosConsOcx.ctx":1002
         Style           =   1  'Graphical
         TabIndex        =   52
         ToolTipText     =   "Fechar"
         Top             =   90
   ...
   End
End
Attribute VB_Name = "RelacionamentoContatoConsOcx"
...
'    ??? Parent.HelpContextID = IDH_
    ...
    Caption = "Consulta de Relacionamento com clientes futuros"
    Call Form_Load
End Function

Public Function Name() As String
    Name = "RelacionamentoContatoCons"
End Function
...
On Error GoTo Erro_CodigoDe_Validate
    ...
    If lErro <> SUCESSO And lErro <> 181031 Then gError 102807
    
    'Se não encontrou o relacionamento => erro
    If lErro = 181031 Then gError 102808
...
On Error GoTo Erro_CodigoAte_Validate
    ...
    'Lê o relacionamento no bd
    lErro = CF("RelacionamentoContatos_Le", objRelacionamentoClientes)
    If lErro <> SUCESSO And lErro <> 181031 Then gError 102810
    
    'Se não encontrou o relacionamento => erro
    If lErro = 181031 Then gError 102811
...
On Error GoTo Erro_Inicializa_GridRelacionamentos
    ...
    objGridInt.colColuna.Add ("Cliente Futuro")
...
On Error GoTo Erro_Carrega_Tab_Relacionamentos
    ...
    lErro = CF("RelacionamentoContatosCons_Le", objRelacionamentoClientesCons)
    If lErro <> SUCESSO And lErro <> 181103 Then gError 102873
    
    'Se não encontrou nenhum relacionamento
    If lErro = 181103 Then
...
'Obtém o código do cliente e da filial que estão na tela e guarda-os no objContatoContatos
...
Dim objContato As New ClassContatos
Dim objFilialContato As New ClassFilialContato
Dim objContatoContatos As New ClassClienteContatos
...
On Error GoTo Erro_Carrega_GridRelacionamentos
    ...
    For Each objRelacionamentoClientes In colRelacionamentos
        ...
        objContato.lCodigo = objRelacionamentoClientes.lCliente
        
        'Lê o cliente para obter o nome reduzido
        lErro = CF("Contato_Le", objContato)
        If lErro <> SUCESSO And lErro <> 180548 Then gError 102876
        
        'Se não encontrou o cliente => erro
        If lErro = 180548 Then gError 102879
        
        'Exibe o nome do cliente no grid
        GridRelacionamentos.TextMatrix(iLinha, iGrid_Cliente_Col) = objContato.sNomeReduzido
        '*** CLIENTE - FIM ***
        
        '*** FILIALCLIENTE - INÍCIO ***
        'Guarda o código do cliente e da filial no obj
        objFilialContato.lCodContato = objRelacionamentoClientes.lCliente
        objFilialContato.iCodFilial = objRelacionamentoClientes.iFilialCliente
        
        'Lê a filial do cliente para obter o nome reduzido
        lErro = CF("FilialContato_Le", objFilialContato)
        If lErro <> SUCESSO And lErro <> 180801 Then gError 102877
    
        'Se não existe a filial na tabela FiliaisClientes
        If lErro = 180801 Then gError 102880
        
        'Exibe o nome da filial no grid
        GridRelacionamentos.TextMatrix(iLinha, iGrid_FilialCliente_Col) = objFilialContato.iCodFilial & SEPARADOR & objFilialContato.sNome
        '*** FILIALCLIENTE - FIM ***
        ...
        If objRelacionamentoClientes.iContato > 0 Then
            ...
            objContatoContatos.lCliente = objRelacionamentoClientes.lCliente
            objContatoContatos.iFilialCliente = objRelacionamentoClientes.iFilialCliente
            objContatoContatos.iCodigo = objRelacionamentoClientes.iContato
            
            'Lê o contato para obter o nome e o telefone
            lErro = CF("ClienteFContatos_Le", objContatoContatos)
            ...
            GridRelacionamentos.TextMatrix(iLinha, iGrid_Contato_Col) = objContatoContatos.sContato
           
            'Exibe o telefone no grid
            GridRelacionamentos.TextMatrix(iLinha, iGrid_Telefone_Col) = objContatoContatos.sTelefone
...
Erro_Carrega_GridRelacionamentos:
    ...
    Select Case gErr
        ...
        Case 102881
            Call Rotina_Erro(vbOKOnly, "ERRO_CLIENTECONTATO_NAO_ENCONTRADO", gErr, objRelacionamentoClientes.iContato, objContato.sNomeReduzido, objFilialContato.sNome)
...
Dim objContato As New ClassContatos
    ...
    objContato.lCodigo = gcolRelacionamentos(GridRelacionamentos.Row).lCliente
...
Dim objRelacionamentoClientes As New ClassRelacClientes
    ...
    Call Chama_Tela("RelacionamentoContatos", objRelacionamentoClientes)
