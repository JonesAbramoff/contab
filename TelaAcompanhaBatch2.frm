...
Begin VB.Form TelaAcompanhaBatch2 
   ClientHeight    =   4725
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   8400
   Icon            =   "TelaAcompanhaBatch2.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   4725
   ScaleWidth      =   8400
   ...
   Begin VB.Label Label1 
      AutoSize        =   -1  'True
      Caption         =   "Número de Arquivos Gerados:"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "TelaAcompanhaBatch2"
...
'***
    ...
    lErro = Gerar_DRE_DRP(colModelos, iExercicio, iPeriodo, iFilialEmpresa, sDiretorio, iGrupoEmpresarial)
