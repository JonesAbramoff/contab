...
Begin VB.UserControl CobrancaFaturaPorEmail 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Modelo 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "CobrancaFaturaPorEmailTRP.ctx":0000
         Left            =   2205
         List            =   "CobrancaFaturaPorEmailTRP.ctx":000A
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.Frame Frame2 
            ...
            Begin VB.ListBox TipoDoc 
               Height          =   960
               ItemData        =   "CobrancaFaturaPorEmailTRP.ctx":003F
               Left            =   135
               List            =   "CobrancaFaturaPorEmailTRP.ctx":004F
               Style           =   1  'Checkbox
               TabIndex        =   65
               Top             =   330
               Width           =   1920
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Carta 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "CobrancaFaturaPorEmailTRP.ctx":006B
         Left            =   3090
         List            =   "CobrancaFaturaPorEmailTRP.ctx":0075
         Style           =   2  'Dropdown List
         TabIndex        =   38
         Top             =   420
         Width           =   2235
      ...
      Begin VB.CommandButton BotaoMarcarTodos 
         ...
         Height          =   555
         Left            =   60
         Picture         =   "CobrancaFaturaPorEmailTRP.ctx":00AA
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   3450
         Width           =   1725
      ...
      Begin VB.CommandButton BotaoDesmarcarTodos 
         ...
         Height          =   555
         Left            =   45
         Picture         =   "CobrancaFaturaPorEmailTRP.ctx":10C4
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   4200
         Width           =   1725
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoEmail 
         Height          =   360
         Left            =   120
         Picture         =   "CobrancaFaturaPorEmailTRP.ctx":22A6
         Style           =   1  'Graphical
         TabIndex        =   17
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   645
         Picture         =   "CobrancaFaturaPorEmailTRP.ctx":2C48
         Style           =   1  'Graphical
         TabIndex        =   18
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1155
         Picture         =   "CobrancaFaturaPorEmailTRP.ctx":317A
         Style           =   1  'Graphical
         TabIndex        =   19
         ToolTipText     =   "Fechar"
         Top             =   75
