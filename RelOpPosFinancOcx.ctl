...
Begin VB.UserControl RelOpPosFinancOcx 
   ClientHeight    =   3405
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   6615
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.ComboBox Layout 
         Height          =   315
         ItemData        =   "RelOpPosFinancOcx.ctx":0000
         Left            =   900
         List            =   "RelOpPosFinancOcx.ctx":000A
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "RelOpPosFinancOcx.ctx":0026
         Style           =   1  'Graphical
         TabIndex        =   18
         ToolTipText     =   "Gravar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "RelOpPosFinancOcx.ctx":0180
         Style           =   1  'Graphical
         TabIndex        =   17
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "RelOpPosFinancOcx.ctx":030A
         Style           =   1  'Graphical
         TabIndex        =   16
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "RelOpPosFinancOcx.ctx":083C
         Style           =   1  'Graphical
         TabIndex        =   15
         ToolTipText     =   "Fechar"
         Top             =   90
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   315
      ItemData        =   "RelOpPosFinancOcx.ctx":09BA
      Left            =   945
      List            =   "RelOpPosFinancOcx.ctx":09BC
      Sorted          =   -1  'True
      TabIndex        =   0
      Top             =   255
      Width           =   3060
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   600
      Left            =   4425
      Picture         =   "RelOpPosFinancOcx.ctx":09BE
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   810
      Width           =   1815
   ...
   Begin VB.Label Label14 
      AutoSize        =   -1  'True
      Caption         =   "Detalhar fornecedores com valor acima de:"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "RelOpPosFinancOcx"
...
Dim lNumIntRel As Long, dValFornMin As Double
...
On Error GoTo Erro_PreencherRelOp
    ...
    If bExecutando Then
        ...
        lErro = CF("RelPosFinanc_Prepara", giFilialEmpresa, StrParaDate(DataDe.Text), StrParaDate(DataAte.Text), LCodigo_Extrai(Layout.Text), Codigo_Extrai(sConta), lNumIntRel, dValFornMin)
        If lErro <> SUCESSO Then gError ERRO_SEM_MENSAGEM
...
Public Function Form_Load_Ocx() As Object
    ...
    Caption = "Análise Financeira por Natureza"
    Call Form_Load
