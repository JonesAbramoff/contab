...
Begin VB.UserControl RelOpContEstProdOCX 
   ClientHeight    =   4725
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   7575
   ...
   Begin VB.ComboBox Ano 
      Height          =   315
      ItemData        =   "RelOpContTestProdOCX.ctx":0000
      Left            =   3150
      List            =   "RelOpContTestProdOCX.ctx":004B
   ...
   Begin VB.ComboBox Mes 
      Height          =   315
      ItemData        =   "RelOpContTestProdOCX.ctx":00C8
      Left            =   930
      List            =   "RelOpContTestProdOCX.ctx":00F3
      Style           =   2  'Dropdown List
      TabIndex        =   2
      Top             =   930
      Width           =   1545
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "RelOpContTestProdOCX.ctx":015C
         Style           =   1  'Graphical
         TabIndex        =   6
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "RelOpContTestProdOCX.ctx":02E6
         Style           =   1  'Graphical
         TabIndex        =   7
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1620
         Picture         =   "RelOpContTestProdOCX.ctx":0818
         Style           =   1  'Graphical
         TabIndex        =   8
         ToolTipText     =   "Fechar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "RelOpContTestProdOCX.ctx":0996
         Style           =   1  'Graphical
         TabIndex        =   5
         ToolTipText     =   "Gravar"
         Top             =   90
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   600
      Left            =   3720
      Picture         =   "RelOpContTestProdOCX.ctx":0AF0
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   240
      Width           =   1515
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   315
      ItemData        =   "RelOpContTestProdOCX.ctx":0BF2
      Left            =   945
      List            =   "RelOpContTestProdOCX.ctx":0BF4
      Sorted          =   -1  'True
      TabIndex        =   0
      Top             =   360
      Width           =   2610
   ...
   End
End
Attribute VB_Name = "RelOpContEstProdOCX"
