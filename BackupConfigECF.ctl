...
Begin VB.UserControl BackupConfigECF 
   ClientHeight    =   5595
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4770
   ...
   Begin VB.CommandButton BotaoCancela 
      ...
      Height          =   450
      Left            =   2550
      Picture         =   "BackupConfigECF.ctx":0000
      Style           =   1  'Graphical
      TabIndex        =   47
      Top             =   4620
      Width           =   1380
   ...
   Begin VB.CommandButton BotaoOk 
      ...
      Height          =   450
      Left            =   570
      Picture         =   "BackupConfigECF.ctx":0102
      Style           =   1  'Graphical
      TabIndex        =   46
      Top             =   4620
      Width           =   1380
   ...
   End
End
Attribute VB_Name = "BackupConfigECF"
...
'    giExeBkp = MARCADO
    ...
    Call Rotina_AvisoECF(vbOKOnly, "Backup realizado com sucesso.")
...
'        Case 211710
'            Call Rotina_Erro(vbOKOnly, "Já existe um backup sendo realizado.", gErr)
'
        Case 211712
            Call Rotina_ErroECF(vbOKOnly, "O backup não está ativo", gErr)
    
        Case ERRO_SEM_MENSAGEM
           
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 209001)
...
On Error GoTo Erro_BotaoFTPDownload_Click
    ...
    lErro = CF_ECF("Backup_Trata_Download", DirDownload.Text)
    If lErro <> SUCESSO Then gError ERRO_SEM_MENSAGEM
        
    GL_objMDIForm.MousePointer = vbDefault
        
    Call Rotina_AvisoECF(vbOKOnly, "Download feito com sucesso.")
...
Erro_BotaoFTPDownload_Click:
    ...
    Select Case gErr
        ...
        Case 211968
            Call Rotina_ErroECF(vbOKOnly, "É necessário informar o diretório para download.", gErr)
    
        Case ERRO_SEM_MENSAGEM
           
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 211969)
...
'    lErro = CF_ECF("Backup_Verifica_Habilitado", iBKPAtivo)
'    If lErro <> SUCESSO Then gError ERRO_SEM_MENSAGEM
...
'            Call Rotina_AvisoECF(vbOKOnly, "AVISO_BACKUP_REINICIAR_CORPORATOR")
'        End If
'    End If
...
On Error GoTo Erro_Grava_Registro
    ...
    lErro = CF_ECF("BackupConfig_Le", objBackup)
...
'    If lErro <> SUCESSO Then gError ERRO_SEM_MENSAGEM
'
    lErro = CF_ECF("BackupConfig_Grava", objBackup)
    If lErro <> SUCESSO Then gError ERRO_SEM_MENSAGEM
'
'    If objBackup.dtDataProxBkp <> DATA_NULA Then
'        If iBKPAtivo = DESMARCADO Then
...
Erro_Traz_Config_Tela:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 209002)
...
Erro_NomeDiretorio_Validate:
    ...
    Select Case gErr
        ...
        Case 209003, 76
            Call Rotina_ErroECF(vbOKOnly, "Diretório Inválido", gErr, NomeDiretorio.Text)

        Case Else
            Call Rotina_ErroECF(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 209004)
...
Erro_BotaoProcurar_Click:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 209005)
...
Erro_UpDownData_DownClick:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 209006)
...
Erro_UpDownData_UpClick:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 209007)
...
Erro_Data_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 209008)
...
Erro_Hora_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 209009)
...
On Error GoTo Erro_BotaoFTP_Click
    ...
    If FTPStatus.Caption = "Mensagem completada" Then
        Call Rotina_AvisoECF(vbOKOnly, "Conexão bem sucedida")
    ElseIf FTPStatus.Caption = "Diretorio inexistente" Then
        Call Rotina_AvisoECF(vbOKOnly, "Diretório inexistente", FTPDiretorio.Text)
    Else
        Call Rotina_AvisoECF(vbOKOnly, "Não conseguiu estabelecer conexão")
    End If
'
'        FTPStatus.Caption = ""
'        lTeste = 0
...
Erro_BotaoFTP_Click:
    ...
    Select Case gErr
        ...
        Case 35754
            Call Rotina_ErroECF(vbOKOnly, "Não conseguiu estabelecer conexão", gErr)
    
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 211970)
...
Erro_TabStrip1_Click:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 211971)
...
Erro_DirDownload_Validate:
    ...
    Select Case gErr
        ...
        Case 211972, 76
            Call Rotina_ErroECF(vbOKOnly, "Diretório inválido", gErr, DirDownload.Text)

        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 211973)
...
Erro_BotaoProcurarFTP_Click:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 211974)
...
Public Function Form_Load_Ocx() As Object
    ...
    Caption = "Configurações de Backup"
    Call Form_Load
