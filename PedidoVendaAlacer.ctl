...
Begin VB.UserControl PedidoVenda 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.ComboBox TabPrecoItemPV 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "PedidoVendaAlacer.ctx":0000
            Left            =   2400
            List            =   "PedidoVendaAlacer.ctx":0002
         ...
         Begin VB.ComboBox RecebForaFaixa 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "PedidoVendaAlacer.ctx":0004
            Left            =   5055
            List            =   "PedidoVendaAlacer.ctx":000E
            Style           =   2  'Dropdown List
            TabIndex        =   219
            Top             =   1335
            Width           =   2235
         ...
         Begin VB.ComboBox UnidadeMed 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "PedidoVendaAlacer.ctx":0043
            Left            =   1575
            List            =   "PedidoVendaAlacer.ctx":0045
            Style           =   2  'Dropdown List
            TabIndex        =   40
            Top             =   240
            Width           =   720
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin MSMask.MaskEdBox DataEntregaPV 
            ...
            PromptChar      =   " "
         End
         Begin MSComCtl2.UpDown UpDownEntregaReal 
            Height          =   300
            Left            =   7635
            TabIndex        =   278
            TabStop         =   0   'False
            ...
            Enabled         =   -1  'True
         End
         Begin MSMask.MaskEdBox DataEntregaReal 
            Height          =   300
            Left            =   6510
            TabIndex        =   279
            Top             =   1605
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame4 
         ...
         Begin VB.ComboBox DiretoIndireto 
            Height          =   315
            ItemData        =   "PedidoVendaAlacer.ctx":0047
            Left            =   5070
            List            =   "PedidoVendaAlacer.ctx":0051
            Style           =   2  'Dropdown List
            TabIndex        =   177
            Top             =   915
            Width           =   1335
         ...
         Begin VB.CommandButton BotaoVendedores 
            ...
            Height          =   645
            Left            =   7440
            Picture         =   "PedidoVendaAlacer.ctx":0067
            Style           =   1  'Graphical
            TabIndex        =   174
            Top             =   3300
            Width           =   1500
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton BotaoProxNum 
            Height          =   285
            Left            =   2910
            Picture         =   "PedidoVendaAlacer.ctx":0611
            Style           =   1  'Graphical
            TabIndex        =   13
         ...
         Begin VB.ComboBox FilialFaturamento 
            Height          =   315
            ItemData        =   "PedidoVendaAlacer.ctx":06FB
            Left            =   5190
            List            =   "PedidoVendaAlacer.ctx":06FD
            TabIndex        =   18
            Top             =   765
            Width           =   2145
         End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton BotaoImprimirConf 
         Height          =   345
         Left            =   5460
         Picture         =   "PedidoVendaAlacer.ctx":06FF
         Style           =   1  'Graphical
         TabIndex        =   270
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame3 
         ...
         Begin VB.CommandButton BotaoDataRefFluxoUp 
            Height          =   150
            Left            =   8970
            Picture         =   "PedidoVendaAlacer.ctx":0801
            Style           =   1  'Graphical
            TabIndex        =   216
            TabStop         =   0   'False
            Top             =   675
         ...
         Begin VB.CommandButton BotaoDataRefFluxoDown 
            Height          =   150
            Left            =   8970
            Picture         =   "PedidoVendaAlacer.ctx":085B
            Style           =   1  'Graphical
            TabIndex        =   215
            TabStop         =   0   'False
            Top             =   825
         ...
         Begin VB.ComboBox TipoPagto 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "PedidoVendaAlacer.ctx":08B5
            Left            =   3045
            List            =   "PedidoVendaAlacer.ctx":08C5
            TabIndex        =   212
            Top             =   2310
            Width           =   1965
         End
         Begin VB.CommandButton BotaoDataReferenciaDown 
            Height          =   150
            Left            =   3105
            Picture         =   "PedidoVendaAlacer.ctx":0902
            Style           =   1  'Graphical
            TabIndex        =   128
            TabStop         =   0   'False
            Top             =   855
         ...
         Begin VB.CommandButton BotaoDataReferenciaUp 
            Height          =   150
            Left            =   3105
            Picture         =   "PedidoVendaAlacer.ctx":095C
            Style           =   1  'Graphical
            TabIndex        =   129
            TabStop         =   0   'False
            Top             =   705
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   345
         Left            =   2430
         Picture         =   "PedidoVendaAlacer.ctx":09B6
         Style           =   1  'Graphical
         TabIndex        =   269
         ToolTipText     =   "Fechar"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   345
         Left            =   1950
         Picture         =   "PedidoVendaAlacer.ctx":0B34
         Style           =   1  'Graphical
         TabIndex        =   268
         ToolTipText     =   "Limpar"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   345
         Left            =   1485
         Picture         =   "PedidoVendaAlacer.ctx":1066
         Style           =   1  'Graphical
         TabIndex        =   267
         ToolTipText     =   "Excluir"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   345
         Left            =   1005
         Picture         =   "PedidoVendaAlacer.ctx":11F0
         Style           =   1  'Graphical
         TabIndex        =   266
         ToolTipText     =   "Gravar"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoImprimir 
         Height          =   345
         Left            =   510
         Picture         =   "PedidoVendaAlacer.ctx":134A
         Style           =   1  'Graphical
         TabIndex        =   265
      ...
      Begin VB.CommandButton BotaoEmail 
         Height          =   345
         Left            =   45
         Picture         =   "PedidoVendaAlacer.ctx":144C
         Style           =   1  'Graphical
         TabIndex        =   264
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton BotaoLiberaBloqueio 
         ...
         Height          =   600
         Left            =   6825
         Picture         =   "PedidoVendaAlacer.ctx":1DEE
         Style           =   1  'Graphical
         TabIndex        =   104
         Top             =   3840
         Width           =   1650
      ...
      Begin VB.Frame SSFrame1 
         ...
         Begin VB.ComboBox TipoBloqueio 
            Height          =   315
            ItemData        =   "PedidoVendaAlacer.ctx":43E8
            Left            =   555
            List            =   "PedidoVendaAlacer.ctx":43EA
            TabIndex        =   97
            Top             =   330
            Width           =   1605
         End
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.CommandButton BotaoOrcamento 
         Height          =   360
         Left            =   3795
         Picture         =   "PedidoVendaAlacer.ctx":43EC
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton BotaoVerOrcamento 
         Height          =   360
         Left            =   4185
         Picture         =   "PedidoVendaAlacer.ctx":47BE
         Style           =   1  'Graphical
         TabIndex        =   6
...
Private Sub UserControl_Initialize()
    ...
    Set objCT.gobjInfoUsu = New CTPedidoVendaVGAla
    Set objCT.gobjInfoUsu.gobjTelaUsu = New CTPedidoVendaAla
End Sub
...
Private Sub DataEntregaReal_Change()
    Call objCT.gobjInfoUsu.gobjTelaUsu.DataEntregaReal_Change(objCT)
End Sub

Private Sub DataEntregaReal_GotFocus()
    Call objCT.gobjInfoUsu.gobjTelaUsu.DataEntregaReal_GotFocus(objCT)
End Sub

Private Sub DataEntregaReal_Validate(Cancel As Boolean)
    Call objCT.gobjInfoUsu.gobjTelaUsu.DataEntregaReal_Validate(objCT, Cancel)
End Sub

Private Sub UpDownEntregaReal_DownClick()
    Call objCT.gobjInfoUsu.gobjTelaUsu.UpDownEntregaReal_DownClick(objCT)
End Sub

Private Sub UpDownEntregaReal_UpClick()
    Call objCT.gobjInfoUsu.gobjTelaUsu.UpDownEntregaReal_UpClick(objCT)
End Sub
