...
Begin VB.UserControl PedidoVenda_ConsultaOcx 
   ClientHeight    =   6375
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9540
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame12 
         ...
         Begin VB.ComboBox TabPrecoItemPV 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "PedidoVenda_ConsultaOcx.ctx":0000
            Left            =   5085
            List            =   "PedidoVenda_ConsultaOcx.ctx":0002
         ...
         Begin VB.ComboBox UnidadeMed 
            ...
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "PedidoVenda_ConsultaOcx.ctx":0004
            Left            =   1500
            List            =   "PedidoVenda_ConsultaOcx.ctx":0006
            Style           =   2  'Dropdown List
            TabIndex        =   8
            Top             =   390
            Width           =   720
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame1 
         ...
         Begin VB.ComboBox TipoBloqueio 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "PedidoVenda_ConsultaOcx.ctx":0008
            Left            =   180
            List            =   "PedidoVenda_ConsultaOcx.ctx":000A
            TabIndex        =   51
            Top             =   360
            Width           =   1605
         End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame4 
         ...
         Begin VB.ComboBox DiretoIndireto 
            Height          =   315
            ItemData        =   "PedidoVenda_ConsultaOcx.ctx":000C
            Left            =   6120
            List            =   "PedidoVenda_ConsultaOcx.ctx":0016
            Style           =   2  'Dropdown List
            TabIndex        =   178
            Top             =   960
            Width           =   1335
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox ComboOrdenacao 
         Height          =   315
         ItemData        =   "PedidoVenda_ConsultaOcx.ctx":002C
         Left            =   2580
         List            =   "PedidoVenda_ConsultaOcx.ctx":0036
         Style           =   2  'Dropdown List
         TabIndex        =   68
         Top             =   105
         Width           =   2475
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoConsulta 
         ...
         Height          =   735
         Left            =   60
         Picture         =   "PedidoVenda_ConsultaOcx.ctx":005A
         Style           =   1  'Graphical
         TabIndex        =   83
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   735
         Left            =   1725
         Picture         =   "PedidoVenda_ConsultaOcx.ctx":0B28
         Style           =   1  'Graphical
         TabIndex        =   85
         ToolTipText     =   "Limpar"
         Top             =   30
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   735
         Left            =   2265
         Picture         =   "PedidoVenda_ConsultaOcx.ctx":105A
         Style           =   1  'Graphical
         TabIndex        =   86
         ToolTipText     =   "Fechar"
         Top             =   30
      ...
      Begin VB.CommandButton BotaoEditar 
         ...
         Height          =   735
         Left            =   945
         Picture         =   "PedidoVenda_ConsultaOcx.ctx":11D8
         Style           =   1  'Graphical
         TabIndex        =   84
         ToolTipText     =   "Editar"
         Top             =   30
   ...
   End
End
Attribute VB_Name = "PedidoVenda_ConsultaOcx"
