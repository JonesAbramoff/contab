...
Begin VB.UserControl NFiscalEntDev 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CommandButton BotaoTrazerNFe 
            Height          =   360
            Left            =   6165
            Picture         =   "NFiscalEntDev.ctx":0000
            Style           =   1  'Graphical
            TabIndex        =   4
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton Recebimento 
            Height          =   360
            Left            =   2685
            Picture         =   "NFiscalEntDev.ctx":03D2
            Style           =   1  'Graphical
            TabIndex        =   6
            ToolTipText     =   "Trazer Dados"
            Top             =   180
         ...
         Begin VB.ComboBox TipoNFiscal 
            Height          =   315
            ItemData        =   "NFiscalEntDev.ctx":07A4
            Left            =   1470
            List            =   "NFiscalEntDev.ctx":07A6
            TabIndex        =   7
            Top             =   630
            Width           =   4590
         End
         Begin VB.CommandButton BotaoLimparNF 
            Height          =   315
            Left            =   5700
            Picture         =   "NFiscalEntDev.ctx":07A8
            Style           =   1  'Graphical
            TabIndex        =   11
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame17 
         ...
         Begin VB.ComboBox ProdutoRastro 
            Height          =   315
            ItemData        =   "NFiscalEntDev.ctx":0CDA
            Left            =   990
            List            =   "NFiscalEntDev.ctx":0CE7
            Style           =   2  'Dropdown List
            TabIndex        =   181
            Top             =   960
            Width           =   1740
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "NFiscalEntDev.ctx":0D06
            Left            =   3840
            List            =   "NFiscalEntDev.ctx":0D10
            Style           =   2  'Dropdown List
            TabIndex        =   154
            Top             =   195
            Visible         =   0   'False
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   330
         Left            =   1371
         Picture         =   "NFiscalEntDev.ctx":0D2C
         Style           =   1  'Graphical
         TabIndex        =   27
         ToolTipText     =   "Excluir"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   330
         Left            =   2295
         Picture         =   "NFiscalEntDev.ctx":0EB6
         Style           =   1  'Graphical
         TabIndex        =   29
         ToolTipText     =   "Fechar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   330
         Left            =   1830
         Picture         =   "NFiscalEntDev.ctx":1034
         Style           =   1  'Graphical
         TabIndex        =   28
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   330
         Left            =   903
         Picture         =   "NFiscalEntDev.ctx":1566
         Style           =   1  'Graphical
         TabIndex        =   26
         ToolTipText     =   "Gravar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoConsultaDocCPR 
         ...
         Height          =   330
         Left            =   60
         Picture         =   "NFiscalEntDev.ctx":16C0
         Style           =   1  'Graphical
         TabIndex        =   25
