...
Begin VB.UserControl ArqMFPorData 
   ClientHeight    =   2325
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4695
   ...
   End
End
Attribute VB_Name = "ArqMFPorData"
...
Erro_DataDe_GotFocus:
     ...
     Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 204480)
...
On Error GoTo Erro_DataDe_Validate
    ...
    If lErro <> SUCESSO Then gError 204481
...
Erro_DataDe_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 204482)
...
Erro_DataAte_GotFocus:
     ...
     Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 204483)
...
On Error GoTo Erro_DataAte_Validate
    ...
    If lErro <> SUCESSO Then gError 204484
...
Erro_DataAte_Validate:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 204485)
...
On Error GoTo Erro_BotaoArquivo_Click
    ...
    If Len(Trim(DataDe.ClipText)) = 0 Or Len(Trim(DataAte.ClipText)) = 0 Then gError 204486
    
    If Len(Trim(DataDe.ClipText)) > 0 Then sDe = DataDe.Text
    If Len(Trim(DataAte.ClipText)) > 0 Then sAte = DataAte.Text

    If CDate(sDe) > CDate(sAte) Then gError 204487


    'Função que Vai Chamar Função da Afrac que Vai Executar a Leitura da Memoria Fiscal
    lErro = CF_ECF("ArqMF_Executa", iTipoLeitura, sDe, sAte)
    If lErro <> SUCESSO Then gError 204488
...
Erro_BotaoArquivo_Click:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 204489)
...
On Error GoTo Erro_UpDownDataDe_DownClick
    ...
    If lErro <> SUCESSO Then gError 204784
...
Erro_UpDownDataDe_DownClick:
    ...
    Select Case gErr
        ...
        Case Else
             lErro = Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error, 204785)
...
On Error GoTo Erro_UpDownDataDe_UpClick
    ...
    If lErro <> SUCESSO Then gError 204786
...
Erro_UpDownDataDe_UpClick:
    ...
    Select Case gErr
        ...
        Case Else
             lErro = Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error, 204787)
...
On Error GoTo Erro_UpDownDataAte_DownClick
    ...
    If lErro <> SUCESSO Then gError 204788
...
Erro_UpDownDataAte_DownClick:
    ...
    Select Case gErr
        ...
        Case Else
             lErro = Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error, 204789)
...
On Error GoTo Erro_UpDownDataAte_UpClick
    ...
    If lErro <> SUCESSO Then gError 204790
...
Erro_UpDownDataAte_UpClick:
    ...
    Select Case gErr
        ...
        Case Else
             lErro = Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error, 204791)
...
Erro_UserControl_KeyDown:
    ...
    Select Case gErr
        ...
        Case Else
            Call Rotina_ErroECF(vbOKOnly, ERRO_FORNECIDO_PELO_VB_1, gErr, Error$, 210063)
