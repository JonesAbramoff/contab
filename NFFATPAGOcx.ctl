...
Begin VB.UserControl NFFATPAGOcx 
   ClientHeight    =   5760
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9405
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame6 
         ...
         Begin VB.ComboBox TipoCobranca 
            Height          =   315
            ItemData        =   "NFFATPAGOcx.ctx":0280
            Left            =   4290
            List            =   "NFFATPAGOcx.ctx":0282
            TabIndex        =   31
            Top             =   600
            Width           =   1935
         End
