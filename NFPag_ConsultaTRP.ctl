...
Begin VB.UserControl NFPag_Consulta 
   ...
   Begin VB.Frame Frame 
      ...
      Begin VB.CommandButton BotaoDocOriginal 
         ...
         Height          =   675
         Left            =   6600
         Picture         =   "NFPag_ConsultaTRP.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   5
   ...
   Begin VB.Frame Frame 
      ...
      Begin MSMask.MaskEdBox CTBConta 
         Bindings        =   "NFPag_ConsultaTRP.ctx":2F16
         Height          =   225
         Left            =   60
         TabIndex        =   12
         Top             =   1230
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   675
         Left            =   1425
         Picture         =   "NFPag_ConsultaTRP.ctx":2F21
         Style           =   1  'Graphical
         TabIndex        =   22
         ToolTipText     =   "Excluir"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoConsulta 
         Height          =   675
         Left            =   90
         Picture         =   "NFPag_ConsultaTRP.ctx":30AB
         Style           =   1  'Graphical
         TabIndex        =   21
         Top             =   60
         Width           =   1275
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   675
         Left            =   1870
         Picture         =   "NFPag_ConsultaTRP.ctx":4E6D
         Style           =   1  'Graphical
         TabIndex        =   23
         ToolTipText     =   "Limpar"
         Top             =   60
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   675
         Left            =   2310
         Picture         =   "NFPag_ConsultaTRP.ctx":539F
         Style           =   1  'Graphical
         TabIndex        =   24
         ToolTipText     =   "Fechar"
         Top             =   60
...
Private Sub UserControl_Initialize()
    ...
    'TRP
    Set objCT.gobjInfoUsu = New CTNFPagConVGTRP
    Set objCT.gobjInfoUsu.gobjTelaUsu = New CTNFPagConTRP
End Sub
