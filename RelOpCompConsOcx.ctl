...
Begin VB.UserControl RelOpCompConsOcx 
   ClientHeight    =   5235
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   5955
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "RelOpCompConsOcx.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   24
         ToolTipText     =   "Gravar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "RelOpCompConsOcx.ctx":015A
         Style           =   1  'Graphical
         TabIndex        =   23
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "RelOpCompConsOcx.ctx":02E4
         Style           =   1  'Graphical
         TabIndex        =   22
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "RelOpCompConsOcx.ctx":0816
         Style           =   1  'Graphical
         TabIndex        =   21
         ToolTipText     =   "Fechar"
         Top             =   90
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   315
      ItemData        =   "RelOpCompConsOcx.ctx":0994
      Left            =   780
      List            =   "RelOpCompConsOcx.ctx":0996
      Sorted          =   -1  'True
      TabIndex        =   19
      Top             =   255
      Width           =   2640
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   600
      Left            =   3930
      Picture         =   "RelOpCompConsOcx.ctx":0998
      Style           =   1  'Graphical
      TabIndex        =   18
      Top             =   855
      Width           =   1575
   ...
   End
End
Attribute VB_Name = "RelOpCompConsOcx"
...
Public Function Form_Load_Ocx() As Object
    ...
    Caption = "Comparativo de Consumo Real x Previsto"
    Call Form_Load
...
Dim sProd_I As String, objParam As New ClassRelCompConsParam
Dim sProd_F As String, dtDataIni As Date, dtDataFim As Date
...
On Error GoTo Erro_PreencherRelOp
    ...
    dtDataIni = MaskedParaDate(OPDataInicial)
    ...
    dtDataFim = MaskedParaDate(OPDataFinal)
    ...
    If bExecutar Then
        With objParam
            ...
            .dtDataFimProdAte = dtDataFim
            .dtDataFimProdDe = dtDataIni
            .iIgnorarEmbalagem = 0
            '.lNumIntRel é retorno
            .sOPCodigoAte = OpCodigoFinal.Text
            .sOPCodigoDe = OpCodigoInicial.Text
            .sProdFim = sProd_F
            .sProdIni = sProd_I
        End With
        lErro = CF("RelPCPCompConsumo_Prepara", objParam)
        If lErro <> SUCESSO Then gError 184159
        
        lErro = objRelOpcoes.IncluirParametro("NNUMINTREL", CStr(objParam.lNumIntRel))
        If lErro <> AD_BOOL_TRUE Then gError 184160
...
Erro_PreencherRelOp:
    ...
    Select Case gErr
        ...
        Case 106473 To 106483, 184159, 184160
