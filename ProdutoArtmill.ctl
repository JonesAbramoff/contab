...
Begin VB.UserControl Produto 
   ...
   Begin VB.Frame Frame2 
      ...
      Visible         =   0   'False
      Width           =   9285
      Begin VB.ComboBox ProdEmEscalaRelev 
         Height          =   315
         ItemData        =   "ProdutoArtmill.ctx":0000
         Left            =   2490
         List            =   "ProdutoArtmill.ctx":000E
         TabIndex        =   236
         Text            =   "Combo1"
         Top             =   3690
         Width           =   1755
      ...
      Begin VB.ComboBox OrigemMercadoria 
         Height          =   315
         ItemData        =   "ProdutoArtmill.ctx":001F
         Left            =   4530
         List            =   "ProdutoArtmill.ctx":003E
      ...
      Begin VB.Frame Frame18 
         ...
         Begin VB.ComboBox comboAliquota 
            Height          =   315
            ItemData        =   "ProdutoArtmill.ctx":03A5
            Left            =   1980
            List            =   "ProdutoArtmill.ctx":03A7
            Style           =   2  'Dropdown List
            TabIndex        =   78
            Top             =   720
            Width           =   1500
      ...
      Begin VB.Frame Frame15 
         ...
         End
      End
      Begin MSMask.MaskEdBox FatorAjuste 
         Height          =   285
         Left            =   5970
         TabIndex        =   223
         Top             =   1125
      ...
      Begin VB.Label Label43 
         Caption         =   "Produzido em Escala Relevante (Cláusula 23 do Convenio ICMS 52/2017):"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.Label LabelFCI 
         ...
         Width           =   435
      End
      Begin VB.Label LabelFatorAjuste 
         AutoSize        =   -1  'True
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox NaturezaProduto 
         Height          =   315
         ItemData        =   "ProdutoArtmill.ctx":03A9
         Left            =   1470
         List            =   "ProdutoArtmill.ctx":03D8
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   8
         Top             =   2715
      ...
      Begin VB.CommandButton BotaoProxNum 
         Height          =   285
         Left            =   3120
         Picture         =   "ProdutoArtmill.ctx":04CB
         Style           =   1  'Graphical
         TabIndex        =   1
      ...
      End
      Begin VB.Frame FrmComissao 
         BorderStyle     =   0  'None
         Caption         =   "Comissão padrão"
         Height          =   330
         Left            =   270
         TabIndex        =   231
         Top             =   3105
         ...
         Begin MSMask.MaskEdBox PercComissao 
            ...
            PromptChar      =   " "
         End
         Begin MSMask.MaskEdBox MetaComissao 
            Height          =   312
            Left            =   3435
            TabIndex        =   233
            Top             =   0
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame Frame28 
         ...
         Begin VB.ComboBox ProdutoEspecifico 
            Height          =   315
            ItemData        =   "ProdutoArtmill.ctx":05B5
            Left            =   2190
            List            =   "ProdutoArtmill.ctx":05C9
            Sorted          =   -1  'True
            Style           =   2  'Dropdown List
            TabIndex        =   72
            Top             =   270
         ...
         Begin MSMask.MaskEdBox PrecoMaxConsumidor 
            ...
            PromptChar      =   " "
         End
         Begin MSMask.MaskEdBox cProdANVISA 
            Height          =   315
            Left            =   5850
            TabIndex        =   76
            Top             =   1485
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame Frame5 
         ...
         Begin VB.ListBox ListaCaracteristicas 
            Height          =   1185
            ItemData        =   "ProdutoArtmill.ctx":060E
            Left            =   255
            List            =   "ProdutoArtmill.ctx":0621
            Style           =   1  'Checkbox
            TabIndex        =   31
            Top             =   195
            Width           =   3885
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Frame Frame26 
         ...
         Begin VB.ComboBox Rastro 
            Height          =   315
            ItemData        =   "ProdutoArtmill.ctx":06B7
            Left            =   1470
            List            =   "ProdutoArtmill.ctx":06C7
            Style           =   2  'Dropdown List
            TabIndex        =   39
            Top             =   180
            Width           =   2430
      ...
      Begin VB.Frame Frame8 
         ...
         Begin VB.CommandButton BotaoProxCodBarras 
            Height          =   285
            Left            =   3195
            Picture         =   "ProdutoArtmill.ctx":06F0
            Style           =   1  'Graphical
            TabIndex        =   41
            ToolTipText     =   "Numeração Automática"
            Top             =   255
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.ComboBox ApropriacaoComp 
            Height          =   315
            ItemData        =   "ProdutoArtmill.ctx":07DA
            Left            =   2130
            List            =   "ProdutoArtmill.ctx":07E1
            Style           =   2  'Dropdown List
            TabIndex        =   46
            Top             =   195
            Width           =   2610
         ...
         Begin VB.ComboBox ApropriacaoProd 
            Height          =   315
            ItemData        =   "ProdutoArtmill.ctx":07F2
            Left            =   2130
            List            =   "ProdutoArtmill.ctx":07FC
            Style           =   2  'Dropdown List
            TabIndex        =   125
            Top             =   195
            Visible         =   0   'False
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "ProdutoArtmill.ctx":0828
         Style           =   1  'Graphical
         TabIndex        =   25
         ToolTipText     =   "Fechar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "ProdutoArtmill.ctx":09A6
         Style           =   1  'Graphical
         TabIndex        =   24
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "ProdutoArtmill.ctx":0ED8
         Style           =   1  'Graphical
         TabIndex        =   23
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   120
         Picture         =   "ProdutoArtmill.ctx":1062
         Style           =   1  'Graphical
         TabIndex        =   22
         ToolTipText     =   "Gravar"
         Top             =   90
...
Private Sub FCI_Change()
    Call objCT.FCI_Change
End Sub

Private Sub FCI_Validate(Cancel As Boolean)
    Call objCT.FCI_Validate(Cancel)
End Sub
...
Private Sub UserControl_Initialize()
    ...
    '#########################################
    'Artmill
    Set objCT.gobjInfoUsu = New CTProdutoVGArt
    Set objCT.gobjInfoUsu.gobjTelaUsu = New CTProdutoArt
    '#########################################
End Sub
...
Private Sub Cor_Change()
    Call objCT.gobjInfoUsu.gobjTelaUsu.Cor_Change(objCT)
End Sub

Private Sub Cor_Click()
    Call objCT.gobjInfoUsu.gobjTelaUsu.Cor_Click(objCT)
End Sub

Private Sub Cor_Validate(Cancel As Boolean)
    Call objCT.gobjInfoUsu.gobjTelaUsu.Cor_Validate(objCT, Cancel)
End Sub

Private Sub DetalheCor_Change()
    Call objCT.gobjInfoUsu.gobjTelaUsu.DetalheCor_Change(objCT)
End Sub

Private Sub DetalheCor_Click()
    Call objCT.gobjInfoUsu.gobjTelaUsu.DetalheCor_Click(objCT)
End Sub

Private Sub DetalheCor_Validate(Cancel As Boolean)
    Call objCT.gobjInfoUsu.gobjTelaUsu.DetalheCor_Validate(objCT, Cancel)
End Sub
'??? fim artmill
...
Private Sub Residuo_Validate(Cancel As Boolean)
     Call objCT.Residuo_Validate(Cancel)
End Sub
...
Private Sub Largura_Validate(Cancel As Boolean)
     Call objCT.Largura_Validate(Cancel)
End Sub

Private Sub Espessura_Validate(Cancel As Boolean)
     Call objCT.Espessura_Validate(Cancel)
End Sub

Private Sub Comprimento_Validate(Cancel As Boolean)
     Call objCT.Comprimento_Validate(Cancel)
End Sub
...
Private Sub CustoReposicao_Validate(Cancel As Boolean)
     Call objCT.CustoReposicao_Validate(Cancel)
End Sub

Private Sub FatorAjuste_Change()
     Call objCT.FatorAjuste_Change
End Sub

Private Sub FatorAjuste_Validate(Cancel As Boolean)
     Call objCT.FatorAjuste_Validate(Cancel)
End Sub
...
Private Sub MetaComissao_Change()
     Call objCT.MetaComissao_Change
End Sub

Private Sub MetaComissao_Validate(Cancel As Boolean)
     Call objCT.MetaComissao_Validate(Cancel)
End Sub

Private Sub LabelCEST_Click()
     Call objCT.LabelCEST_Click
End Sub

Private Sub CEST_Change()
     Call objCT.CEST_Change
End Sub

Private Sub CEST_GotFocus()
     Call objCT.CEST_GotFocus
End Sub

Private Sub CEST_Validate(Cancel As Boolean)
     Call objCT.CEST_Validate(Cancel)
End Sub

Private Sub cProdANVISA_Change()
     Call objCT.cProdANVISA_Change
End Sub

Private Sub cProdANVISA_GotFocus()
     Call objCT.cProdANVISA_GotFocus
End Sub

Private Sub cProdANVISA_Validate(Cancel As Boolean)
     Call objCT.cProdANVISA_Validate(Cancel)
End Sub
