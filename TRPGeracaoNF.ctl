...
Begin VB.UserControl TRPGeracaoNF 
   ClientHeight    =   6000
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9510
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.Frame Frame1 
            ...
            Begin VB.ComboBox TipoDocSeleciona 
               Enabled         =   0   'False
               Height          =   315
               ItemData        =   "TRPGeracaoNF.ctx":0000
               Left            =   1470
               List            =   "TRPGeracaoNF.ctx":0002
   ...
   End
End
Attribute VB_Name = "TRPGeracaoNF"
...
Dim gobjGeracaoNF As New ClassTRPGeracaoNF
...
Private Function Move_Selecao_Memoria(ByVal objGeracaoNF As ClassTRPGeracaoNF) As Long
...
On Error GoTo Erro_Move_Selecao_Memoria
    ...
    If OptBaixado.Value Then
        objGeracaoNF.iTipo = TRP_GERACAONF_TITULOS_BAIXADO
    Else
        objGeracaoNF.iTipo = TRP_GERACAONF_TITULOS_EMITIDOS
    End If
    
    For iLinha = 1 To objGridFE.iLinhasExistentes
        If StrParaInt(GridFE.TextMatrix(iLinha, iGrid_FESel_Col)) = MARCADO Then
        
            Set objNFFilial = New ClassTRPGeracaoNFFiliais
...
Dim objGeracaoNF As New ClassTRPGeracaoNF
...
On Error GoTo Erro_Traz_GeracaoNF_Tela
    ...
    lErro = CF("TRPGeracaoNF_Le_Dados", objGeracaoNF)
...
On Error GoTo Erro_Gravar_Registro
    ...
    lErro = CF("TRP_NF_Gera", gobjGeracaoNF)
...
On Error GoTo Erro_mnuTvwAbrirDoc_Click
    ...
    Call Chama_Tela(TRP_TIPO_DOC_DESTINO_TITREC_TELA, objTitRec)
...
On Error GoTo Erro_BotaoTitSemNF
    ...
    Call Chama_Tela("TRPTitulosSemNotaLista", colSelecao, Nothing, Nothing, sFiltro)
