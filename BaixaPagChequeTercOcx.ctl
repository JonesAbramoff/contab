...
Begin VB.UserControl BaixaPagChequeTercOcx 
   ClientHeight    =   6000
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9510
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton BotaoConsultaDocOriginal 
         Height          =   450
         Left            =   -10000
         Picture         =   "BaixaPagChequeTercOcx.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   49
   ...
   Begin VB.PictureBox Picture4 
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1125
         Picture         =   "BaixaPagChequeTercOcx.ctx":0F0A
         Style           =   1  'Graphical
         TabIndex        =   4
         ToolTipText     =   "Fechar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   615
         Picture         =   "BaixaPagChequeTercOcx.ctx":1088
         Style           =   1  'Graphical
         TabIndex        =   3
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   105
         Picture         =   "BaixaPagChequeTercOcx.ctx":15BA
         Style           =   1  'Graphical
         TabIndex        =   2
         ToolTipText     =   "Gravar"
         Top             =   75
   ...
   End
End
Attribute VB_Name = "BaixaPagChequeTercOcx"
...
Private WithEvents objCT As CTBaixaPagChequeTerc
...
Private Sub UserControl_Initialize()
    Set objCT = New CTBaixaPagChequeTerc
