...
Begin VB.UserControl NFiscalEntrada 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CommandButton BotaoTrazerNFe 
            Height          =   360
            Left            =   6165
            Picture         =   "NFiscalEntrada.ctx":0000
            Style           =   1  'Graphical
            TabIndex        =   1
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton Recebimento 
            Height          =   360
            Left            =   2685
            Picture         =   "NFiscalEntrada.ctx":03D2
            Style           =   1  'Graphical
            TabIndex        =   3
            ToolTipText     =   "Trazer Dados"
            Top             =   225
         ...
         Begin VB.CommandButton BotaoLimparNF 
            Height          =   315
            Left            =   5670
            Picture         =   "NFiscalEntrada.ctx":07A4
            Style           =   1  'Graphical
            TabIndex        =   8
         ...
         Begin VB.ComboBox TipoNFiscal 
            Height          =   315
            ItemData        =   "NFiscalEntrada.ctx":0CD6
            Left            =   1485
            List            =   "NFiscalEntrada.ctx":0CD8
            TabIndex        =   4
            Top             =   690
            Width           =   4410
         End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame17 
         ...
         Begin VB.ComboBox ProdutoRastro 
            Height          =   315
            ItemData        =   "NFiscalEntrada.ctx":0CDA
            Left            =   0
            List            =   "NFiscalEntrada.ctx":0CE7
            Style           =   2  'Dropdown List
            TabIndex        =   200
            Top             =   0
            Width           =   1740
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "NFiscalEntrada.ctx":0D06
            Left            =   3840
            List            =   "NFiscalEntrada.ctx":0D10
            Style           =   2  'Dropdown List
            TabIndex        =   178
            Top             =   240
            Visible         =   0   'False
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   330
         Left            =   1365
         Picture         =   "NFiscalEntrada.ctx":0D2C
         Style           =   1  'Graphical
         TabIndex        =   25
         ToolTipText     =   "Excluir"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   330
         Left            =   2295
         Picture         =   "NFiscalEntrada.ctx":0EB6
         Style           =   1  'Graphical
         TabIndex        =   27
         ToolTipText     =   "Fechar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   330
         Left            =   1830
         Picture         =   "NFiscalEntrada.ctx":1034
         Style           =   1  'Graphical
         TabIndex        =   26
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   330
         Left            =   900
         Picture         =   "NFiscalEntrada.ctx":1566
         Style           =   1  'Graphical
         TabIndex        =   24
         ToolTipText     =   "Gravar"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoConsultaNFPag 
         ...
         Height          =   330
         Left            =   60
         Picture         =   "NFiscalEntrada.ctx":16C0
         Style           =   1  'Graphical
         TabIndex        =   23
