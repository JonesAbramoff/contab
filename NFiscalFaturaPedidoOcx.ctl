...
Begin VB.UserControl NFiscalFaturaPedidoOcx 
   ClientHeight    =   6000
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9510
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox TabPrecoItemNF 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "NFiscalFaturaPedidoOcx.ctx":0000
            Left            =   4425
            List            =   "NFiscalFaturaPedidoOcx.ctx":0002
            Style           =   2  'Dropdown List
            TabIndex        =   285
            Top             =   1560
            Width           =   1800
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox TipoNFiscal 
            Height          =   315
            ItemData        =   "NFiscalFaturaPedidoOcx.ctx":0004
            Left            =   2115
            List            =   "NFiscalFaturaPedidoOcx.ctx":0006
            TabIndex        =   4
            Top             =   180
            Width           =   3420
         End
         Begin VB.CommandButton Botao 
            ...
            Index           =   8
            Left            =   5160
            Picture         =   "NFiscalFaturaPedidoOcx.ctx":0008
            Style           =   1  'Graphical
            TabIndex        =   31
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame3 
         ...
         Begin VB.ComboBox TipoPagto 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "NFiscalFaturaPedidoOcx.ctx":053A
            Left            =   2940
            List            =   "NFiscalFaturaPedidoOcx.ctx":054A
            TabIndex        =   228
            Top             =   2265
            Width           =   1965
         End
         ...
         Begin VB.CommandButton BotaoDataReferenciaDown 
            Height          =   150
            Left            =   3030
            Picture         =   "NFiscalFaturaPedidoOcx.ctx":0587
            Style           =   1  'Graphical
            TabIndex        =   133
            TabStop         =   0   'False
            Top             =   810
         ...
         Begin VB.CommandButton BotaoDataReferenciaUp 
            Height          =   150
            Left            =   3030
            Picture         =   "NFiscalFaturaPedidoOcx.ctx":05E1
            Style           =   1  'Graphical
            TabIndex        =   135
            TabStop         =   0   'False
            Top             =   675
         ...
         Begin VB.ComboBox Desconto1Codigo 
            Appearance      =   0  'Flat
            Height          =   315
            ItemData        =   "NFiscalFaturaPedidoOcx.ctx":063B
            Left            =   3120
            List            =   "NFiscalFaturaPedidoOcx.ctx":063D
            TabIndex        =   77
            Top             =   1140
            Width           =   1950
         End
   ...
   Begin VB.Frame Frame1 
      BorderStyle     =   0  'None
      Caption         =   $"NFiscalFaturaPedidoOcx.ctx":063F
      Height          =   4650
      Index           =   7
      Left            =   120
      TabIndex        =   111
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.ComboBox ProdutoRastro 
            Height          =   315
            ItemData        =   "NFiscalFaturaPedidoOcx.ctx":06D2
            Left            =   2400
            List            =   "NFiscalFaturaPedidoOcx.ctx":06DF
            Style           =   2  'Dropdown List
            TabIndex        =   220
            Top             =   1905
            Width           =   1740
         ...
         Begin VB.ComboBox EscaninhoRastro 
            Height          =   315
            ItemData        =   "NFiscalFaturaPedidoOcx.ctx":06FE
            Left            =   3690
            List            =   "NFiscalFaturaPedidoOcx.ctx":070B
            Style           =   2  'Dropdown List
            TabIndex        =   185
            Top             =   270
            Width           =   1215
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame SSFrame4 
         ...
         Begin VB.CommandButton BotaoVendedores 
            ...
            Height          =   615
            Left            =   7560
            Picture         =   "NFiscalFaturaPedidoOcx.ctx":072A
            Style           =   1  'Graphical
            TabIndex        =   207
            Top             =   3300
            Width           =   1380
   ...
   Begin VB.ComboBox DiretoIndireto 
      Height          =   315
      ItemData        =   "NFiscalFaturaPedidoOcx.ctx":0CD4
      Left            =   7320
      List            =   "NFiscalFaturaPedidoOcx.ctx":0CDE
      Style           =   2  'Dropdown List
      TabIndex        =   201
      Top             =   2400
      Width           =   1215
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   2
         Left            =   45
         Picture         =   "NFiscalFaturaPedidoOcx.ctx":0CF4
         Style           =   1  'Graphical
         TabIndex        =   23
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   5
         Left            =   1779
         Picture         =   "NFiscalFaturaPedidoOcx.ctx":0DF6
         Style           =   1  'Graphical
         TabIndex        =   26
         ToolTipText     =   "Excluir"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   3
         Left            =   498
         Picture         =   "NFiscalFaturaPedidoOcx.ctx":0F80
         Style           =   1  'Graphical
         TabIndex        =   24
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   4
         Left            =   1326
         Picture         =   "NFiscalFaturaPedidoOcx.ctx":1802
         Style           =   1  'Graphical
         TabIndex        =   25
         ToolTipText     =   "Gravar"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   6
         Left            =   2232
         Picture         =   "NFiscalFaturaPedidoOcx.ctx":195C
         Style           =   1  'Graphical
         TabIndex        =   27
         ToolTipText     =   "Limpar"
         Top             =   75
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   7
         Left            =   2685
         Picture         =   "NFiscalFaturaPedidoOcx.ctx":1E8E
         Style           =   1  'Graphical
         TabIndex        =   28
         ToolTipText     =   "Fechar"
         Top             =   75
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   1
         Left            =   4020
         Picture         =   "NFiscalFaturaPedidoOcx.ctx":200C
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      Begin VB.CommandButton Botao 
         ...
         Index           =   0
         Left            =   3630
         Picture         =   "NFiscalFaturaPedidoOcx.ctx":231E
         Style           =   1  'Graphical
         TabIndex        =   2
   ...
   End
End
Attribute VB_Name = "NFiscalFaturaPedidoOcx"
