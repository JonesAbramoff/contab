...
Begin VB.UserControl TRPRegerarFaturas 
   ClientHeight    =   5115
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   5025
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox TipoDocSeleciona 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "TRPRegerarFaturas.ctx":0000
         Left            =   1470
         List            =   "TRPRegerarFaturas.ctx":0002
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoGerar 
         Height          =   360
         Left            =   90
         Picture         =   "TRPRegerarFaturas.ctx":0004
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1050
         Picture         =   "TRPRegerarFaturas.ctx":0446
         Style           =   1  'Graphical
         TabIndex        =   11
         ToolTipText     =   "Fechar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   570
         Picture         =   "TRPRegerarFaturas.ctx":05C4
         Style           =   1  'Graphical
         TabIndex        =   10
         ToolTipText     =   "Limpar"
         Top             =   90
   ...
   End
End
Attribute VB_Name = "TRPRegerarFaturas"
...
On Error GoTo Erro_BotaoGerar_Click
    ...
    lErro = CF("TRPFaturas_Regera_Html", StrParaLong(FaturaDe.Text), StrParaLong(FaturaAte.Text), ModeloFat.Text, NomeDiretorio.Text, sSiglaDoc)
