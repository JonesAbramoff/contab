...
Begin VB.UserControl RelOpTRVVouchers 
   ClientHeight    =   7575
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   8070
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.ComboBox Tipo 
         Height          =   315
         ItemData        =   "RelOpTRVVoucher.ctx":0000
         Left            =   615
         List            =   "RelOpTRVVoucher.ctx":0002
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "RelOpTRVVoucher.ctx":0004
         Style           =   1  'Graphical
         TabIndex        =   22
         ToolTipText     =   "Gravar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "RelOpTRVVoucher.ctx":015E
         Style           =   1  'Graphical
         TabIndex        =   23
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "RelOpTRVVoucher.ctx":02E8
         Style           =   1  'Graphical
         TabIndex        =   24
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "RelOpTRVVoucher.ctx":081A
         Style           =   1  'Graphical
         TabIndex        =   25
         ToolTipText     =   "Fechar"
         Top             =   90
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   315
      ItemData        =   "RelOpTRVVoucher.ctx":0998
      Left            =   1275
      List            =   "RelOpTRVVoucher.ctx":099A
      Sorted          =   -1  'True
      TabIndex        =   0
      Top             =   255
      Width           =   2916
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   600
      Left            =   6000
      Picture         =   "RelOpTRVVoucher.ctx":099C
      Style           =   1  'Graphical
      TabIndex        =   20
      Top             =   870
      Width           =   1575
   ...
   End
End
Attribute VB_Name = "RelOpTRVVouchers"
...
On Error GoTo Erro_Form_Load
    ...
    Tipo.AddItem "Por Filial\Promotor"
