...
Begin VB.UserControl ModelosEmailOcx 
   ClientHeight    =   6900
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9315
   ...
   Begin VB.Frame Frame4 
      ...
      Begin MSMask.MaskEdBox De 
         ...
         Left            =   1590
         TabIndex        =   5
         ToolTipText     =   "Email de envio. Deixa em branco para pegar da Configuração"
         Top             =   555
         Width           =   5040
         _ExtentX        =   8890
         _ExtentY        =   556
      ...
      Begin MSMask.MaskEdBox NomeExibicao 
         ...
         PromptChar      =   " "
      End
      Begin MSMask.MaskEdBox EmailResp 
         Height          =   315
         Left            =   1590
         TabIndex        =   7
         ToolTipText     =   "Email de envio. Deixa em branco para pegar da Configuração"
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.ComboBox Tipo 
         Height          =   315
         ItemData        =   "ModelosEmailOcx.ctx":0000
         Left            =   3345
         List            =   "ModelosEmailOcx.ctx":0002
      ...
      Begin VB.CommandButton BotaoProxNum 
         Height          =   285
         Left            =   2160
         Picture         =   "ModelosEmailOcx.ctx":0004
         Style           =   1  'Graphical
         TabIndex        =   1
   ...
   Begin VB.Frame Frame1 
      Caption         =   "Características por Regras"
      Height          =   3885
      Left            =   195
      TabIndex        =   25
      Top             =   2955
      ...
      Begin VB.ComboBox Mnemonicos 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "ModelosEmailOcx.ctx":00EE
         Left            =   195
         List            =   "ModelosEmailOcx.ctx":00FB
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   17
         Top             =   2865
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "ModelosEmailOcx.ctx":011D
         Style           =   1  'Graphical
         TabIndex        =   23
         ToolTipText     =   "Fechar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "ModelosEmailOcx.ctx":029B
         Style           =   1  'Graphical
         TabIndex        =   22
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "ModelosEmailOcx.ctx":07CD
         Style           =   1  'Graphical
         TabIndex        =   21
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "ModelosEmailOcx.ctx":0957
         Style           =   1  'Graphical
         TabIndex        =   20
         ToolTipText     =   "Gravar"
         Top             =   90
   ...
   End
End
Attribute VB_Name = "ModelosEmailOcx"
...
Private Sub De_Validate(Cancel As Boolean)
    Call Valida_Email(De.Text, Cancel)
End Sub
...
'    If lErro <> SUCESSO Then gError 187058
    ...
    Tipo.AddItem TIPO_COBRANCAEMAILPADRAO_NFE & SEPARADOR & STRING_TIPO_COBRANCAEMAILPADRAO_NFE
    Tipo.ItemData(Tipo.NewIndex) = TIPO_COBRANCAEMAILPADRAO_NFE
...
On Error GoTo Erro_Traz_Email_Tela
    ...
    AtrasoDe.PromptInclude = False
    AtrasoAte.PromptInclude = False
    AtrasoDe.Text = ""
    AtrasoAte.Text = ""
        
    If objEmail.iTipo = TIPO_COBRANCAEMAILPADRAO_COBRANCA Then
        'FrameAtraso.Visible = True
        FrameAtraso.Enabled = True
        If objEmail.iAtrasoDe <> 0 Then AtrasoDe.Text = CStr(objEmail.iAtrasoDe)
        If objEmail.iAtrasoAte <> 0 Then AtrasoAte.Text = CStr(objEmail.iAtrasoAte)
    Else
        'FrameAtraso.Visible = False
        FrameAtraso.Enabled = False
    End If
    AtrasoDe.PromptInclude = True
    AtrasoAte.PromptInclude = True
...
'        Modelo.Text = ""
    ...
    EmailResp.Text = objEmail.sEmailResp
    If objEmail.iConfirmacaoLeitura = MARCADO Then
...
On Error GoTo Erro_Move_Tela_Memoria
    ...
    objEmail.sEmailResp = EmailResp.Text
    If Confirmacao.Value = vbChecked Then
        objEmail.iConfirmacaoLeitura = MARCADO
    Else
        objEmail.iConfirmacaoLeitura = DESMARCADO
    End If
...
On Error GoTo Erro_Critica_Dados
    ...
    bCancel = False
    Set objControle = Cc
    Call Regra_Valida(objControle, bCancel)
    If bCancel Then gError 187067
    Set objControle = Assunto
    Call Regra_Valida(objControle, bCancel)
    If bCancel Then gError 187067
    Set objControle = Anexo
    Call Regra_Valida(objControle, bCancel)
    If bCancel Then gError 187067
    Set objControle = Mensagem
    Call Regra_Valida(objControle, bCancel)
    If bCancel Then gError 187067
...
On Error GoTo Erro_Carga_Combobox_Mnemonicos
    ...
    If iTipoAnterior <> Codigo_Extrai(Tipo.Text) Then
    
        Mnemonicos.Enabled = True
        Mnemonicos.Clear
        
        'leitura dos mnemonicos no BD
        lErro = CF("MnemonicoCobrEmail_Le", colMnemonico, Codigo_Extrai(Tipo.Text))
        ...
        iTipoAnterior = Codigo_Extrai(Tipo.Text)
...
'    If Codigo_Extrai(Tipo.Text) = TIPO_COBRANCAEMAILPADRAO_COBRANCA Then
...
Function Limpa_Tela_Email() As Long
    ...
    Call Carga_Combobox_Mnemonicos
...
On Error GoTo Erro_Mnemonicos_Click
    ...
    If Len(Mnemonicos.Text) > 0 Then
        ...
        lErro = CF("MnemonicoCobrEmail_Le_Mnemonico", objMnemonico, Codigo_Extrai(Tipo.Text))
...
Private Sub Tipo_Change()
    ...
    AtrasoDe.PromptInclude = False
    AtrasoAte.PromptInclude = False
    If Codigo_Extrai(Tipo) = TIPO_COBRANCAEMAILPADRAO_COBRANCA Then
        'FrameAtraso.Visible = True
        FrameAtraso.Enabled = True
    Else
        'FrameAtraso.Visible = False
...
Private Sub EmailResp_Change()
    iAlterado = REGISTRO_ALTERADO
End Sub

Private Sub EmailResp_Validate(Cancel As Boolean)
    Call Valida_Email(EmailResp.Text, Cancel)
End Sub

Private Sub Valida_Email(ByVal sEmail As String, Cancel As Boolean)
...
On Error GoTo Erro_Valida_Email

    If Len(Trim(sEmail)) > 0 Then

        iPos1 = InStr(1, sEmail, "@")
        If iPos1 = 0 Then gError 206775
        If iPos1 = 1 Then gError 206776
        
        sP1 = Mid(sEmail, 1, iPos1 - 1)
        
        iPos2 = InStr(iPos1 + 1, sEmail, ".com")
        If iPos2 = 0 Then gError 206777 'Tem que estar após o @ e com um caracter no meio
        
        sP2 = Mid(sEmail, iPos1 + 1, iPos2 - iPos1 - 1)
        
        sP3 = Mid(sEmail, iPos2)
        
        iPosX = InStr(1, sEmail, "..")
        If iPosX <> 0 Then gError 206778
    
        iPosX = InStr(iPos1 + 1, sEmail, "@")
        If iPosX <> 0 Then gError 206779
...
Erro_Valida_Email:
    ...
    Select Case gErr
        ...
        Case 206775 To 206779
            Call Rotina_Erro(vbOKOnly, "ERRO_EMAIL_INVALIDO", gErr)
        
        Case Else
            Call Rotina_Erro(vbOKOnly, "ERRO_FORNECIDO_PELO_VB", gErr, Error, 206780)
