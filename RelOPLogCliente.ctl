...
Begin VB.UserControl RelOpLogClienteOcx 
   ClientHeight    =   1710
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   6765
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   315
      ItemData        =   "RelOPLogCliente.ctx":0000
      Left            =   900
      List            =   "RelOPLogCliente.ctx":0002
      Sorted          =   -1  'True
      TabIndex        =   1
      Top             =   195
      Width           =   2916
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   600
      Left            =   4710
      Picture         =   "RelOPLogCliente.ctx":0004
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   855
      Width           =   1575
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "RelOPLogCliente.ctx":0106
         Style           =   1  'Graphical
         TabIndex        =   8
         ToolTipText     =   "Fechar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1110
         Picture         =   "RelOPLogCliente.ctx":0284
         Style           =   1  'Graphical
         TabIndex        =   7
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "RelOPLogCliente.ctx":07B6
         Style           =   1  'Graphical
         TabIndex        =   6
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "RelOPLogCliente.ctx":0940
         Style           =   1  'Graphical
         TabIndex        =   5
         ToolTipText     =   "Gravar"
         Top             =   90
   ...
   End
End
Attribute VB_Name = "RelOpLogClienteOcx"
...
On Error GoTo Erro_PreencherRelOp
    ...
    If bExecutando Then
        ...
        lErro = CF("RelLogClientes_Prepara", lNumIntRel, giFilialEmpresa, StrParaDate(DataInicial.Text), StrParaDate(DataFinal.Text))
        If lErro <> SUCESSO Then gError ERRO_SEM_MENSAGEM
...
On Error GoTo Erro_Form_Load
    ...
    Call DateParaMasked(DataFinal, Date)
