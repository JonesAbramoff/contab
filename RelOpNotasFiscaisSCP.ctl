...
Begin VB.UserControl RelOpNotasFiscais 
   ClientHeight    =   5085
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   7530
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "RelOpNotasFiscaisSCP.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   14
         ToolTipText     =   "Gravar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "RelOpNotasFiscaisSCP.ctx":015A
         Style           =   1  'Graphical
         TabIndex        =   15
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "RelOpNotasFiscaisSCP.ctx":02E4
         Style           =   1  'Graphical
         TabIndex        =   16
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "RelOpNotasFiscaisSCP.ctx":0816
         Style           =   1  'Graphical
         TabIndex        =   17
         ToolTipText     =   "Fechar"
         Top             =   90
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   315
      ItemData        =   "RelOpNotasFiscaisSCP.ctx":0994
      Left            =   945
      List            =   "RelOpNotasFiscaisSCP.ctx":0996
      Sorted          =   -1  'True
      TabIndex        =   0
      Top             =   210
      Width           =   2670
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   600
      Left            =   5745
      Picture         =   "RelOpNotasFiscaisSCP.ctx":0998
      Style           =   1  'Graphical
      TabIndex        =   12
      Top             =   705
      Width           =   1575
   ...
   End
End
Attribute VB_Name = "RelOpNotasFiscais"
...
On Error GoTo Erro_Formata_E_Critica_Parametros
   ...
   'data inicial não pode ser maior que a data final
    ...
    If Len(Trim(RotaDe.Text)) > 0 And Len(Trim(RotaAte.Text)) > 0 Then
        ...
        If CLng(RotaDe.Text) > CLng(RotaAte.Text) Then gError 205417
