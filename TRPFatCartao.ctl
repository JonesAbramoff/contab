...
Begin VB.UserControl TRPFatCartao 
   ClientHeight    =   6000
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   9510
   ...
   End
End
Attribute VB_Name = "TRPFatCartao"
...
On Error GoTo Erro_Form_Load
    ...
    lErro = CF("TRPFatCartao_Le", colAuto)
...
Dim lErro As Long
Dim colAuto As New Collection
Dim objVouAuto As ClassTRPVouAutoCC
...
On Error GoTo Erro_Gravar_Registro
    ...
    lErro = CF("TRPFatCartao_Grava", colAuto)
    If lErro <> SUCESSO Then gError 200665
...
'Inicializa o Grid
    ...
    objGridInt.colColuna.Add (" ")
    objGridInt.colColuna.Add (" ")
    objGridInt.colColuna.Add ("Bandeira")
    objGridInt.colColuna.Add ("Cliente")
    objGridInt.colColuna.Add ("Número")
    objGridInt.colColuna.Add ("Data")
    ...
    objGridInt.colColuna.Add ("Parcelas")
    ...
    iGrid_AutoData_Col = 5
    iGrid_AutoValorB_Col = 6
    iGrid_AutoTarifa_Col = 7
    iGrid_AutoValorL_Col = 8
    iGrid_AutoNumParc_Col = 9
...
Dim lErro As Long
Dim objAuto As ClassTRPVouAutoCC
Dim iLinha As Integer
...
On Error GoTo Erro_Traz_Dados_Tela
    ...
    For Each objAuto In gcolAuto
        ...
        GridAuto.TextMatrix(iLinha, iGrid_AutoSelecionado_Col) = MARCADO
        ...
        GridAuto.TextMatrix(iLinha, iGrid_AutoNumero_Col) = CStr(objAuto.lNumAuto)
