...
Begin VB.UserControl RelOpCustoImpNFOcx 
   ClientHeight    =   4950
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   7575
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "RelOpCustoImpNFOcx.ctx":0000
         Style           =   1  'Graphical
         TabIndex        =   25
         ToolTipText     =   "Gravar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "RelOpCustoImpNFOcx.ctx":015A
         Style           =   1  'Graphical
         TabIndex        =   24
         ToolTipText     =   "Excluir"
         Top             =   75
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1080
         Picture         =   "RelOpCustoImpNFOcx.ctx":02E4
         Style           =   1  'Graphical
         TabIndex        =   23
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1620
         Picture         =   "RelOpCustoImpNFOcx.ctx":0816
         Style           =   1  'Graphical
         TabIndex        =   22
         ToolTipText     =   "Fechar"
         Top             =   90
   ...
   Begin VB.ComboBox ComboOpcoes 
      Height          =   315
      ItemData        =   "RelOpCustoImpNFOcx.ctx":0994
      Left            =   1305
      List            =   "RelOpCustoImpNFOcx.ctx":0996
      Sorted          =   -1  'True
      TabIndex        =   1
      Top             =   315
      Width           =   2916
   ...
   Begin VB.CommandButton BotaoExecutar 
      ...
      Height          =   600
      Left            =   5715
      Picture         =   "RelOpCustoImpNFOcx.ctx":0998
      Style           =   1  'Graphical
      TabIndex        =   0
      Top             =   840
      Width           =   1575
   ...
   End
End
Attribute VB_Name = "RelOpCustoImpNFOcx"
...
On Error GoTo Erro_PreencherParametrosNaTela
    ...
    lErro = objRelOpcoes.ObterParametro("NNFISCAL", sParam)
    If lErro Then gError 136093
...
On Error GoTo Erro_PreencherRelOp
    ...
    lErro = Monta_Expressao_Selecao(objRelOpcoes, sProd_I, sProd_F, sFornecedor_I, sFornecedor_F)
...
Function Monta_Expressao_Selecao(objRelOpcoes As AdmRelOpcoes, sProd_I As String, sProd_F As String, sFornecedor_I As String, sFornecedor_F As String) As Long
...
On Error GoTo Erro_Monta_Expressao_Selecao
    ...
    If Len(Trim(Numero.Text)) <> 0 Then
        ...
        If sExpressao <> "" Then sExpressao = sExpressao & " E "
        sExpressao = sExpressao & "DINumero = " & Forprint_ConvTexto(Trim(Numero.Text))
    ...
    If Len(Trim(NFiscal.Text)) <> 0 Then
        ...
        If sExpressao <> "" Then sExpressao = sExpressao & " E "
        sExpressao = sExpressao & "NumNotaFiscalImp = " & Forprint_ConvTexto(Trim(NFiscal.Text))
    
    End If
    
    If LCodigo_Extrai(sFornecedor_I) <> 0 Then
        
        If sExpressao <> "" Then sExpressao = sExpressao & " E "
        sExpressao = "CodForn >= " & Forprint_ConvLong(LCodigo_Extrai(sFornecedor_I))
    
    End If
    
    If LCodigo_Extrai(sFornecedor_F) <> 0 Then

        If sExpressao <> "" Then sExpressao = sExpressao & " E "
        sExpressao = sExpressao & "CodForn <= " & Forprint_ConvLong(LCodigo_Extrai(sFornecedor_F))
