...
Begin VB.UserControl RegiaoVenda 
   ...
   Begin VB.ComboBox Pais 
      Appearance      =   0  'Flat
      Height          =   315
      ItemData        =   "RegiaoVendaTRP.ctx":0000
      Left            =   1680
      List            =   "RegiaoVendaTRP.ctx":0002
      TabIndex        =   3
      Top             =   1155
      Width           =   2490
   End
   Begin VB.ListBox Regioes 
      Height          =   2205
      ItemData        =   "RegiaoVendaTRP.ctx":0004
      Left            =   4875
      List            =   "RegiaoVendaTRP.ctx":0006
      Sorted          =   -1  'True
      TabIndex        =   13
      Top             =   1005
      Width           =   2175
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton BotaoFechar 
         Height          =   360
         Left            =   1605
         Picture         =   "RegiaoVendaTRP.ctx":0008
         Style           =   1  'Graphical
         TabIndex        =   12
         ToolTipText     =   "Fechar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoLimpar 
         Height          =   360
         Left            =   1100
         Picture         =   "RegiaoVendaTRP.ctx":0186
         Style           =   1  'Graphical
         TabIndex        =   11
         ToolTipText     =   "Limpar"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoExcluir 
         Height          =   360
         Left            =   595
         Picture         =   "RegiaoVendaTRP.ctx":06B8
         Style           =   1  'Graphical
         TabIndex        =   10
         ToolTipText     =   "Excluir"
         Top             =   90
      ...
      Begin VB.CommandButton BotaoGravar 
         Height          =   360
         Left            =   90
         Picture         =   "RegiaoVendaTRP.ctx":0842
         Style           =   1  'Graphical
         TabIndex        =   9
         ToolTipText     =   "Gravar"
         Top             =   90
   ...
   Begin VB.CommandButton BotaoProxNum 
      Height          =   285
      Left            =   2220
      Picture         =   "RegiaoVendaTRP.ctx":099C
      Style           =   1  'Graphical
      TabIndex        =   1
...
Private Sub UserControl_Initialize()
    ...
    Set objCT.gobjInfoUsu = New CTRegiaoVendaVGTRP
    Set objCT.gobjInfoUsu.gobjTelaUsu = New CTRegiaoVendaTRP
